\chapter{Clocks \& Campaigns}\index{clocks}\index{campaigns}
...
\subsection*{Step 2: Creating Scene Clocks}\index{clocks!creating}

\player{GM} As you enter the Gloam Cistern, I'm establishing three key clocks:

\begin{center}
\textbf{Environmental Collapse Clock}\index{clocks!Environmental Collapse} (8 segments)\\
...
\begin{center}
\textbf{Warden Search Clock}\index{clocks!Warden Search} (6 segments)\\
...
\begin{center}
\textbf{Forbidden Knowledge Clock}\index{clocks!Forbidden Knowledge} (4 segments)\\
...
\outcome{Success \& Cost}\index{Success \& Cost}
...
\gm{Controlled position\index{position!Controlled}, DV 1.}
...
\gm{Risky position\index{position!Risky}, DV 2. You're approaching someone who's clearly hostile to intruders.}
...
\gm{Desperate position\index{position!Desperate}, DV 3. You're trying to counter an active ritual you barely understand.}
...
\gm{Pressured position\index{Difficulty Value!Pressured}, DV 3. You're trying complex magic while dodging falling masonry.}
...
\section*{Clock Resolution: Warden Search Filled}\index{clocks!resolution}
...
\section*{Tutorial Conclusion: Clock Management Lessons}\index{clocks!management}
...
\subsection*{GM Tips for Clock Management}\index{clocks!GM tips}
...
\section{Campaign Design and Long-Term Play}\index{campaign design}
...
\begin{itemize}
    ...
    \item \textbf{Over-Stack Rule}\index{Over-Stack}: If the party enters with 2+ advantages, start rails at +1 OR GM banks +1 CP.
...
\textbf{Complication Debt Management}\index{Complication Points}: Calculate starting CP for the session based on:
\begin{itemize}
