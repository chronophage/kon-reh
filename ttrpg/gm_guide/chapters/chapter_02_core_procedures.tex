...
\begin{itemize}
    ...
    \item \textbf{Swords}: Physical harm, positioning changes, weapon status, tactical wounds
    \item \textbf{Pentacles}: Resource depletion, gear damage, fatigue, ammunition/supply issues
    \item \textbf{Clubs}: Environmental hazards, reinforcements, tactical setbacks, terrain changes
\end{itemize}
