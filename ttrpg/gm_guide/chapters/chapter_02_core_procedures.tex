...
\subsection{High-Tier CP Sinks}\index{High-Tier CP Sinks}
...
\subsection{Banking \& Cashing CP}\index{banking CP}\index{cashing CP}
...
\begin{itemize}
    ...
    \item \textbf{Miss}: No progress; GM spends CP for combat consequences. Award one Boon.
\end{itemize}
