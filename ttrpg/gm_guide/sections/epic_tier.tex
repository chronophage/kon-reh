...
\begin{itemize}
  ...
  \item \textbf{Faction Clocks:} Advance long-term threats (\emph{War [8]}) regardless of player success in individual scenes (see \ref{sec:core-resolution-cycle}).
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item \textbf{A faction clock advances.} \textquotedbl The ritual continues. \emph{Summoning [8]} ticks +1.\textquotedbl
...
Treat armies as high-Cap followers (see \ref{sec:followers-assets-gm}). Use \textbf{Battle Clocks} (4--6 segments) for skirmishes. Do not resolve each soldier's attack -- abstract with leadership rolls.
...
At high tiers, players may reflexively reach for Boons to re-roll failures. Sometimes, the most dramatic outcome is to \textbf{let the failure stand}. As GM, you can say: \textquotedbl You have 0 Boons left. The die is cast. What does failure look like?\textquotedbl\ This forces players to engage with consequences rather than erase them.

\subsection*{Example: A High-Tier Turn with 0 Boons}
The party's archmage, Elara (Tier V), attempts to counterspell a world-ending ritual. She has 0 Boons. She rolls 8 dice (Wits 5 + Arcana 3) vs DV 4. Result: 3 successes -- a Partial.
\begin{itemize}
