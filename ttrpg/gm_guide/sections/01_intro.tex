...
\begin{itemize}
    ...
    \item \textbf{Success with Cost} – You get what you want, but the world pushes back.
...
\begin{itemize}
    ...
    \item \textbf{Clocks:} Visual trackers for ongoing challenges (e.g., 4‑segment lock, 8‑segment faction rise).
...
You don’t need to memorize everything. Use this book as a reference. The most important chapters to internalize are those on core philosophy (this chapter) and basic action resolution (see SRD \ref{ch:core-mechanics}).
...
\hline
Core resolution (roll dice, DV, outcomes) & SRD, Chapter 1 (\ref{ch:core-mechanics}) \\
\hline
Position \& Effect & GM Guide, Chapter 2 (\ref{ch:gm-core}) \\
\hline
Combat (initiative, actions, harm) & SRD, Sections 3–4 \\
\hline
Magic (paths, rites, backlash) & GM Guide, Chapter 4 (\ref{ch:gm-magic}) \\
\hline
Travel (legs, clocks, roles) & SRD, Section 6 and GM Guide, Chapter 2 \\
\hline
Clocks \& Fronts & GM Guide, Chapter 2 (\ref{sec:clocks-fronts}) \\
\hline
Story Beats (SB) spending & GM Guide, Chapter 2 (\ref{sec:story-beats}) \\
\hline
Boons (earning, spending, limits) & SRD, Section 1.4 \\
\hline
Assets \& Followers & SRD, Section 12 \\
\hline
High‑tier play (Tiers IV–V) & GM Guide, Chapter 8 (\ref{ch:gm-epic}) \\
\hline
\end{tabular}
\end{center}
\end{tcolorbox}
...
\begin{enumerate}
    ...
    \item \textbf{Starting situation:} Where does the story begin? (Use the Crown Spread – see Appendix \ref{app:crown-spread} – or a simple opener.)
