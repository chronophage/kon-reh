...
\textbf{Tip:} \textit{Use Fatigue instead of Harm for 1-2 SB spends. Avoid compromising equiptment on < 3 SB spends.}
...
\midrule
Malachai (Curses) & Obligation +2 and bear a visible mark; once/scene your blessing bites an ally (GM may spend 1 SB to trigger). \
...
\subsection{Tactical Combat Options}

\subsubsection{Initiative Variants}

\textbf{Narrative Initiative}:
\begin{itemize}
\item Players and GM describe intended actions simultaneously
\item Order determined by logical sequence of events rather than dice rolls
\item Encourages collaborative storytelling during combat
\item Best for groups comfortable with flexible turn structure
\end{itemize}

\textbf{Pool Initiative}:
\begin{itemize}
\item All participants roll d10 + relevant attribute at start of combat
\item Highest roller acts first, then chooses next actor from remaining pool
\item Creates dynamic turn order that can shift based on situation
\item Adds strategic element to combat pacing
\end{itemize}

\subsubsection{Damage and Healing Variants}

\textbf{Wound System}:
\begin{itemize}
\item Separate track for permanent injuries with lasting effects
\item Wounds heal more slowly than regular Harm and may require special treatment
\item Adds long-term consequences to combat encounters
\item Creates meaningful choice between aggressive tactics and self-preservation
\end{itemize}

\textbf{Stress and Trauma}:
\begin{itemize}
\item Mental and emotional damage tracked separately from physical harm
\item Trauma effects can persist beyond combat and affect roleplaying
\item Requires different recovery methods than physical injuries
\item Adds psychological depth to combat encounters
\end{itemize}

\subsection{Social Combat Framework}

\subsubsection{Structured Social Encounters}

\textbf{Social Combat Setup}:
\begin{enumerate}
\item \textbf{Stakes Definition}: Clearly establish what each party wants to achieve
\item \textbf{Position Assessment}: Determine relative social standing and advantages
\item \textbf{Tactical Preparation}: Identify available social tools, allies, and information
\item \textbf{Engagement Rules}: Define how social actions translate to mechanical effects
\end{enumerate}

\textbf{Social Combat Actions}:
\begin{itemize}
\item \textbf{Influence}: Attempt to change someone's opinion or behavior
\item \textbf{Gather Information}: Extract useful intelligence from social interactions
\item \textbf{Protect}: Shield allies from social attacks or manipulation
\item \textbf{Expose}: Reveal damaging information about opponents
\end{itemize}

\subsubsection{Social Momentum}

\textbf{Building Social Advantage}:
\begin{itemize}
\item Successful social actions create momentum that benefits future interactions
\item Momentum can be spent to gain bonuses or introduce complications
\item Different types of social capital (respect, fear, affection, obligation) provide different benefits
\item Social momentum decays over time or when circumstances change significantly
\end{itemize}

subsubsection{Environmental Hazards}

\textbf{Weather-Based Challenges}:
\begin{itemize}
\item \textbf{Sandstorm}: Impaired visibility, difficult navigation, equipment damage
\item \textbf{Blizzard}: Extreme cold exposure, whiteout conditions, hypothermia risk
\item \textbf{Monsoon}: Flash flooding, unstable terrain, lightning strikes
\item \textbf{Heat Wave}: Dehydration, heat exhaustion, equipment malfunction
\end{itemize}

\textbf{Terrain-Based Challenges}:
\begin{itemize}
\item \textbf{Quicksand}: Slow movement, risk of entrapment, strength/endurance drain
\item \textbf{Avalanche Zone}: Sudden danger, difficult escape routes, burial risk
\item \textbf{Swamp}: Disease exposure, unstable footing, disorientation
\item \textbf{Cave System}: Limited air supply, navigation challenges, rockfall hazards
\end{itemize}

\subsubsection{Supernatural Hazards}

\textbf{Magical Environmental Effects}:
\begin{itemize}
\item \textbf{Wild Magic Zone}: Unpredictable spell effects, spontaneous magical phenomena
\item \textbf{Temporal Distortion}: Time loops, accelerated aging, memory loss
\item \textbf{Reality Bleed}: Phase shifts, gravity anomalies, logic-defying occurrences
\item \textbf{Soul Drain}: Energy depletion, weakened resolve, spiritual vulnerability
\end{itemize}

\subsection{Chase and Pursuit Systems}

\subsubsection{Abstract Chase Mechanics}

\textbf{Two-Clock Chase Structure}:
\begin{itemize}
\item \textbf{Pursuer Clock}: Tracks progress of those giving chase
\item \textbf{Fugitive Clock}: Tracks progress of those fleeing
\item \textbf{Resolution}: When either clock fills, that side achieves their objective
\end{itemize}

\textbf{Chase Actions}:
\begin{itemize}
\item \textbf{Evade}: Increase distance or hide from pursuers
\item \textbf{Pursue}: Close distance or track quarry's movements
\item \textbf{Obstacle}: Create or overcome barriers to movement
\item \textbf{Assistance}: Aid allies or hinder opponents in the chase
\end{itemize}

\subsubsection{Tactical Chase Elements}

\textbf{Environmental Factors}:
\begin{itemize}
\item \textbf{Urban Environment}: Crowds, buildings, narrow alleys, potential hiding spots
\item \textbf{Wilderness}: Natural obstacles, weather effects, terrain advantages/disadvantages
\item \textbf{Aquatic}: Water currents, vessel maneuverability, underwater hazards
\item \textbf{Magical Realm}: Reality distortions, teleportation opportunities, supernatural interference
\end{itemize}

\textbf{Resource Management}:
\begin{itemize}
\item \textbf{Stamina}: Physical endurance affects sustained high-speed movement
\item \textbf{Supplies}: Limited resources may constrain long-term pursuit or evasion
\item \textbf{Equipment}: Specialized gear can provide significant advantages
\item \textbf{Allies}: Assistance from others can dramatically shift chase dynamics
\end{itemize}