...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black, title=Optional – Not a Replacement for SB]
  \textbf{This is optional.} Use it if you want a small “mini‑game” for yourself. It does not replace SB – it adds spice. The game works perfectly fine without it.
\end{tcolorbox}
...
\label{subsec:devils-bargain}
When players are stuck weighing options, offer a **Devil’s Bargain** – success at a cost, and the player chooses the terms.
...
\emph{(Already covered above – see Section \ref{subsec:devils-bargain})}
...
\midrule
Pick a lock & “You fail – but you notice the guard’s patrol pattern. Do you wait for the next shift change or try the window?” \\
Sneak past a sentry & “You stumble – but you see a loose brick in the wall. Do you hide behind it or cause a diversion across the courtyard?” \\
Persuade a noble & “They refuse – but they let slip that their rival has the real power. Do you court the rival or blackmail the noble?” \\
Climb a wall & “You fall – but you land near a drainpipe that leads to a basement door. Do you risk the dark or find another way up?” \\
Forage for food & “You find nothing – but you spot fresh game tracks. Do you follow them deeper into the woods or head back to camp hungry?” \\
\bottomrule
\end{tabular}
\end{center}
