...
\begin{enumerate}
  ...
  \item Clearly state the stakes: \textquotedbl If you fail, the spell will backfire and also alert the guards.\textquotedbl
...
Use these to colour your complications:
...
\begin{itemize}
  \item The Patron appears in a dream: \textquotedbl Do this task for me, or else.\textquotedbl
...
\begin{itemize}
  \item Apply the Patron's \textquotedbl benefit and burden\textquotedbl\ (see Patron tables in the \textbf{Player's Guide}).
...
\begin{itemize}
  ...
  \item Spend SB to represent social fallout, Patron omens, or magical residue from their performances. For example, a Cantor who Pushes a song in a crowded tavern might generate a rumour clock or attract the attention of a witch-hunter.
\end{itemize}
...
\begin{itemize}
  \item The burden (e.g., \textquotedbl cannot refuse a request for a song\textquotedbl) should complicate the Cantor's life in interesting ways. Enforce it gently but consistently.
...
\textbf{Rival Factions:} A neglected Chorus can become a rival faction (see \ref{ch:gm-advanced}, \textit{Advanced GM Techniques}). They may split into a competing sect, spread false rumours about the Cantor, or even ally with a Patron's enemy. Use this to generate long-term plot hooks.
...
3 & Patron omen, magical feedback (Harm 1), new clock (e.g., \textquotedbl Leaking Energy\textquotedbl). \\
