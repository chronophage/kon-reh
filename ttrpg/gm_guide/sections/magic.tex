...
\begin{itemize}
  ...
  \item Track the cult's health with a \textbf{Schism Clock [4]}. Tick it when the player ignores the cult (no contact, refuses a request) or when the cult's demands go unmet. On a full timer, introduce a fracture: a rival sect, false rumors, or alliance with a Patron's enemy.
...
\begin{itemize}
  ...
  \item A Resonant Rite always advances the Corruption Clock (mark 1 segment). If the timer fills, the bloom occurs during the performance -- describe the Patron's touch manifesting in front of the audience.
\end{itemize}
