...
\textbf{HEAL restores Fatigue, not Harm.} When a player uses a cantrip with only \texttt{HEAL}, it removes 1 Fatigue. This is safe, fast, and low‑risk.
...
\begin{itemize}
  ...
  \item use \texttt{HEAL} with another tag (e.g., \texttt{Purify}, \texttt{Strengthen}).
\end{itemize}
