...
\begin{itemize}
    ...
    \item \textbf{Elara}: A Vhasian spy and infiltrator (Wits/Subterfuge), the group's face and trickster.
...
\textbf{The Action}: Elara will use \textbf{Wits + Subterfuge} to identify patrol patterns and a weak point in the security.
...
Elara rolls: \textbf{2d10} (Wits 2 + Subterfuge 0). She gets a \textbf{5} and a \textbf{3} → a \textbf{Partial Success}.
...
\textbf{Elara's Action}: Seeing Valerius in trouble, she throws a smoke pellet (a temporary asset) and uses \textbf{Wits + Subterfuge} to create a diversion.
