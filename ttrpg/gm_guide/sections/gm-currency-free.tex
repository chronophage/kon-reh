...
The table below summarizes the narrative effects of each Supply Clock state.
...
\bottomrule
\end{tabularx}
\caption{Supply Clock conditions and their narrative effects}
\label{tab:supply-clock-states}
\end{table}
...
The table below details the mechanical effect of each Fatigue level.
...
The table below outlines the Asset tiers, their costs, and typical examples.
...
\begin{itemize}
  \item \textbf{Early (1--2 segments):} A messenger arrives with a \textquotedbl reminder.\textquotedbl\ The patron asks for a small favor (deliver a package, spread a rumour).
...
Abbot Valerius (Thepyrgos Synod) & Provides sanctuary for fugitives and letters of indulgence. Debt: demand the party retrieve a \textquotedbl heretical\textquotedbl\ text from a sealed archive -- without being caught. \\
...
\begin{itemize}
  ...
  \item When a player asks for a favor, tell them the cost: \textquotedbl Marcellus will give you the keys to the armory, but that's worth one segment and +1 Obligation. Are you willing?\textquotedbl
...
% =========================================================
% MOVED to Chapter 7 (Combat) - Tactical Clocks
% =========================================================
