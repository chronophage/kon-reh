...
When players express interest in forming a Trust (see \ref{subsec:helping-trust}), guide them through:
\begin{itemize}
...
Spend Story Beats (see \ref{sec:outcome-sb}) to introduce economic complications:
