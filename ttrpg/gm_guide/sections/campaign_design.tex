...
\subsection{Design Clocks, Not Every Element}
...
\subsection{Let Clocks Be Visible}
\index{timers!visibility}

Clocks are not hidden GM tools. Show them to the players. Write \emph{Cult Influence [6]} on an index card and place it on the table. When you tick it, announce: ``The cult's ritual advances. You feel the ground tremble.''

Visible timers create \textbf{tension} and \textbf{informed choices}. Players can prioritize which timer to slow.

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black, title=Physical Trackers for Clocks]
...
\subsubsection{Clocks for the Crown Spread}
...
\subsection{Clocks: The GM's Primary Tool}
\index{timers!GM guidance}

Clocks are the single most useful tool in Fate's Edge. Use them for:
\begin{itemize}
...
\subsubsection{Clock Size Guidelines}
\begin{itemize}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title={Arcs Generate Obligation and Patron Interest}]
  ...
  \begin{itemize}
    ...
    \item \textbf{External arcs} (revenge, ambition, love) create \textit{Debt Clocks} with terrestrial patrons or generate \textit{Crisis}.
