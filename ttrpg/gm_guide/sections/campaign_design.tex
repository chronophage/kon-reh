...
\hline
\multicolumn{1}{|X|}{\vspace{1cm} 1. \hrulefill \vspace{0.5cm} 2. \hrulefill \vspace{0.5cm} 3. \hrulefill \vspace{0.5cm} 4. \hrulefill \vspace{1cm}} &
\multicolumn{1}{|X|}{\vspace{1cm} 1. \hrulefill \vspace{0.5cm} 2. \hrulefill \vspace{0.5cm} 3. \hrulefill \vspace{0.5cm} 4. \hrulefill \vspace{1cm}} \\
\hline
\end{tabularx}
\end{table}
...
\hline
Wild & \textbf{Wild} & \textbf{The Hidden Force} -- The surprise. A monster, a traitor, a natural disaster, a forgotten god. \\
\hline
\end{tabularx}
\end{table}
...
\hline
\textbf{Wild} \textbf{Hidden:} & \hrulefill \\
\hline
\end{tabularx}
\end{table}
...
"What does the Hidden Force want?"}}}   % << extra }
\end{center}
...
\textbf{Draws:}
\begin{itemize}
  \item Spade: 5\spadesuit \rightarrow Tithing Bridge (a small, working-class bridge in the dye district).
  \item Heart: J\heartsuit \rightarrow Mira Venn, the Guildmistress's daughter, who once threw a rival off that bridge.
  \item Club: 9\clubsuit \rightarrow The Rust -- a magical blight poisoning the dye vats.
  \item Diamond: A\diamondsuit \rightarrow The Weeping Oracle, an ancient witness who knows the truth about the new red dye.
  \item Wild: K\spadesuit \rightarrow The Drowned Man, a cursed dyer who haunts the canals.
\end{itemize}
\end{quote}
...
\begin{description}
\item[Winter (Establishment)] -- Introduce elements as rumors or distant threats.
...
A faction is any organized group with goals that intersect the party's. A rival party is a special kind of faction -- a small group of NPC adventurers who mirror the PCs.
...
A rival party is a faction of 3--5 NPCs with their own Patrons, assets, and a visible \textbf{Rival Agenda clock} (6--8 segments). Tick their clock when the PCs ignore them or the GM spends SB on their off-screen activities. When the clock fills, the rivals achieve a major milestone. Reveal their progress through rumors, discovered scenes, or direct confrontation.

For a full template and example (The Ashen Cord), see the GM's Appendix \ref{app:rival-generator}.
...
\noindent \textbf{Rolls:}
\begin{itemize}
  \item Scarlets: 5 \rightarrow Advance \rightarrow now 4/8.
  \item Everflame: 2 \rightarrow Setback \rightarrow now 1/6.
\end{itemize}

\noindent \textbf{One-sentence changes:}
\begin{itemize}
  \item \textit{Scarlets:} ``Mira's agents have bought the loyalty of the harbor master.''
  \item \textit{Everflame:} ``An inquisitor was found murdered; the Church retreats to its cathedral.''
  \item \textit{Drowned Man:} (GM fiat) ``The Drowned Man dragged two Scarlets into the canal. Rumors spread.''
\end{itemize}

\noindent \textbf{Next session opener:} ``You wake to news that the harbor master has doubled tariffs -- and that a body was pulled from the water wearing a Scarlets' token.''
\end{quote}
...
\end{itemize}
Shift standing by $\pm 1$ after major interactions (saving a faction's leader, betraying them, etc.). No dice needed -- just fiction.
...
\begin{itemize}
  ...
  \item \textbf{Use the turn to generate rumors.} ``The Grey Circle is digging a new well -- some say they found bones.''
\end{itemize}
