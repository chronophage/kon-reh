...
\begin{itemize}
  \item Clean loss or public cost paid $\rightarrow$ increase Crisis.
  \item Major victory or public recognition $\rightarrow$ increase Mandate.
  \item Asset neglect or scandal $\rightarrow$ affect both.
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black, title={What is a Front?}]
...
\begin{description}
  \item[Supporting] One clock's progress helps another (\emph{Plague Spread} $\rightarrow$ \emph{Resource Scarcity}).
  \item[Opposing] One clock's progress hinders another (\emph{Public Support} $\downarrow$ \emph{Crime Rate} $\uparrow$).
  \item[Cascade] One clock's resolution triggers another (\emph{War Ends} $\rightarrow$ \emph{Reconstruction Begins}).
\end{description}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title={Worked Example: The Bell at Blackwood Tower}]
  A GM draws:
  \begin{itemize}
    \item \textbf{7 Spades} $\rightarrow$ A ruined watchtower on a contested border, with a single bell that rings without wind.
    \item \textbf{Q Hearts} $\rightarrow$ A grieving widow who blames the party for her husband's death.
    \item \textbf{9 Clubs} $\rightarrow$ A spreading famine; supplies dwindle, the militia conscripts farmers.
    \item \textbf{A Diamonds} $\rightarrow$ A hidden cache of pre-Empire artifacts, including a sealed letter that exposes a noble's treason.
    \item \textbf{K Spades (Wild)} $\rightarrow$ A deserter turned bandit who knows the watchtower's secret passages and wants the artifacts for himself.
  \end{itemize}
...
\textbf{Draws:}
\begin{itemize}
  \item Spade: 5♠ → Tithing Bridge (a small, working‑class bridge in the dye district).
  \item Heart: J♥ → Mira Venn, the Guildmistress’s daughter, who once threw a rival off that bridge.
  \item Club: 9♣ → The Rust – a magical blight poisoning the dye vats.
  \item Diamond: A♦ → The Weeping Oracle, an ancient witness who knows the truth about the new red dye.
  \item Wild: K♠ → The Drowned Man, a cursed dyer who haunts the canals.
\end{itemize}
\end{quote}
