...
When a character accepts a favor from a terrestrial patron, start a \textbf{Debt Clock} with the patron’s name (e.g., “Prefect Marcellus’s Favor [4]”). Mark one segment each time the character accepts a significant favor (e.g., a bribe, a military escort, access to a restricted archive). When the clock fills, the patron calls in the debt – a mission to be performed, a political favor, or a direct demand.

The party also tracks a separate \textbf{Obligation} tally for each terrestrial patron, exactly as they would for a supernatural Patron (see \ref{sec:obligation-capacity}). Each accepted favor typically adds +1 Obligation. When Obligation exceeds the character’s (or party’s) capacity, they mark Fatigue and the patron may send a reminder – a messenger, a withdrawn favor, or a public hint that the debt is due.
...
\textbf{Debt clocks are story fuel.} Every time a player accepts a favor, they are inviting future conflict. Don’t let debts linger – call them in at the worst possible moment:

\begin{itemize}
  \item \textbf{Early (1–2 segments):} A messenger arrives with a “reminder.” The patron asks for a small favor (deliver a package, spread a rumour).
...
\begin{itemize}
  ...
  \item When a player asks for a favor, tell them the cost: “Marcellus will give you the keys to the armory, but that’s worth one segment and +1 Obligation. Are you willing?”
  \item When a Debt Clock fills, the favor is due. Give the players a hook that fits the patron’s personality and resources.
