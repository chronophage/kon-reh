...
\index{Patrons!terrestrial}\index{Influence Clock}
...
When a character accepts a favor from a terrestrial patron, start an \textbf{Influence Clock} with the patron's name (e.g., \textquotedbl Prefect Marcellus's Influence [4]\textquotedbl). Mark one segment each time the character accepts a significant favor. When the timer fills, the patron calls in the debt -- a mission, a political favor, or a direct demand.
...
\index{Influence Clock!GM advice}
