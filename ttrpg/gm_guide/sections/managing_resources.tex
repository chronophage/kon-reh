...
\index{Patrons!terrestrial}\index{Influence Timer }
...
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!75!black,title={Use Influence Timers Aggressively},breakable]
\index{Influence Timer !GM advice}
...
\begin{itemize}
  \item Track each patron's Influence Timer and the party's Obligation visibly.
  ...
  \item When an Influence Timer fills, give a hook that fits the patron's personality.
