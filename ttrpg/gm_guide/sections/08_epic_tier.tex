...
%===========================================================
\section{High-Tier Play Guidance (GM)}
\index{High-Tier Play}
%===========================================================

\subsection*{The High-Tier Principle}
High-tier play is not about larger numbers or higher Difficulty Values.  
It is about \textbf{greater consequence}.

As characters advance into Tier~III and beyond, their talents and tools gain
the ability to:
\begin{itemize}
  \item End conflicts early
  \item Bind factions, oaths, or supernatural forces
  \item Rewrite social or political conditions
  \item Convert failure into lasting narrative change
\end{itemize}

The world does not become harder to roll against simply because characters
are more capable. Instead, success and failure both reshape the fiction in
larger, more permanent ways.

\subsection*{Boon Scarcity Is Intentional}
At high tier, \indexterm{Boons} should feel valuable and slightly scarce.

This scarcity prevents:
\begin{itemize}
  \item Automatic success through repeated Boon expenditure
  \item Artificial inflation of Difficulty Values
  \item Scenes that resolve without meaningful cost
\end{itemize}

Use this guideline:
\begin{itemize}
  \item \textbf{Tier I--II:} Boons stabilize risk and smooth outcomes.
  \item \textbf{Tier III--V:} Boons reshape the fiction and assert authority.
\end{itemize}

If players routinely spend Boons merely to avoid failure at high tier,
the scene likely lacks narrative leverage or meaningful stakes.

\subsection*{Do Not Inflate Difficulty Values}
Avoid raising Difficulty Values simply because characters are powerful.

Instead, scale challenge through:
\begin{itemize}
  \item Consequence and fallout
  \item Clock pressure and cascading effects
  \item Rival action and opposition response
  \item Story Beat escalation
\end{itemize}

A high-tier failure should not negate progress. It should advance the world in
a dangerous or costly direction.

\subsection*{Failure Must Matter}
Failure at high tier should introduce or accelerate consequences such as:
\begin{itemize}
  \item A rival gaining leverage
  \item A secret becoming public
  \item An oath deepening or binding more tightly
  \item A faction or threat clock advancing
\end{itemize}

If failure merely delays action without changing the situation, increase the
narrative cost rather than the mechanical difficulty.

\subsection*{Bonds as the Primary Boon Engine}
At higher tiers, Boons should primarily enter play through:
\begin{itemize}
  \item Calling on Bonds at personal or social cost
  \item Exposing allies, followers, or assets to danger
  \item Spending reputation, sanctuary, or influence
  \item Accepting new obligations or narrative fallout
\end{itemize}

Each Boon gained or spent should reflect a real choice made in the fiction.

\subsection*{Designing High-Tier Scenes}
When preparing high-tier scenes, consider:
\begin{itemize}
  \item What changes if the characters succeed?
  \item What compromises emerge on partial success?
  \item What new dangers arise if they fail but remain standing?
\end{itemize}

If the answer to failure is ``they try again,'' increase the stakes rather than
the Difficulty Value.

\subsection*{The Intended Payoff}
High-tier play should feel:
\begin{itemize}
  \item More dangerous, not safer
  \item More decisive, not slower
  \item More political and relational
  \item More costly, but more meaningful
\end{itemize}

At this level, players should no longer ask, ``Can I afford to spend a Boon?''
but instead, ``What am I willing to give up to make this true?''
