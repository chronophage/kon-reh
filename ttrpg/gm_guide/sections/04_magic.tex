...
Requires Talent: \textbf{Spellcraft} (6 XP). Grants access to Weave & Cast using the Eight Elements. Flexible, creative, and risky (Backlash on 1s).
...
Casters may attempt any effect describable using the Eight Elements and \texttt{[TAGS]} system, but power and scope are strictly bounded by \textbf{cost}, \textbf{risk}, and \textbf{fictional logic}. Magic should feel wondrous yet grounded, with clear stakes for overreach. It's highly recommended that a Free Caster limit themselves to Tier +1 \textem{[TAGS]} to mitigate the effects of \textbf{Backlash}
...
\subsection*{GM Guidance: Cantrips and Free Casting}
\index{magic!cantrips!GM guidance}

Cantrips exist to keep magic \emph{present, fluid, and expressive} without slowing play.

Use them to:
\begin{itemize}
  \item Let spellcasters solve small problems quickly
  \item Keep magic visible in everyday scenes
  \item Avoid rolling twice for effects that are already established
\end{itemize}

Do \textbf{not} use Cantrips to:
\begin{itemize}
  \item Replace meaningful rituals
  \item Circumvent wards, trials, or story gates
  \item Avoid consequences that matter at the scene level
\end{itemize}

A useful rule of thumb:

\begin{quote}
If the spell would matter even if the caster failed, it is not a Cantrip.
\end{quote}

If a player repeatedly pushes a Cantrip toward narrative weight, escalate it naturally:
\begin{itemize}
  \item Require full Weave + Cast
  \item Increase DV
  \item Introduce a Clock
  \item Or mark Weave Tension
\end{itemize}
...
\subsubsection*{Use}
\begin{itemize}
  \item \textbf{Cost:} \textbf{1 Boon or 1 Fatigue}, \textbf{1 action}.
...
\begin{tcolorbox}[
  title={GM Sidebar: Adjudicating Psionics},
  colback=mistgray!6,
  colframe=black,
  fonttitle=\bfseries
]

\textbf{Psionics is power without intermediaries.}  
There are no patrons to placate, no symbols to break—only the mind and its limits.  
As GM, your role is to ensure psionics feels \emph{precise, potent, and costly}.

\medskip

\textbf{Core Principle:}  
Psionics should solve problems \emph{quickly}, but never \emph{quietly}.

\medskip

\textbf{1. Set DVs by Precision, Not Raw Power}  
Psionics is not weaker or stronger than other magic—it is narrower.

\begin{itemize}[leftmargin=1.5em]
  \item Low DV: Clear intent, short range, single target
  \item Medium DV: Complex manipulation, resistance, emotional nuance
  \item High DV: Multiple minds, deep memory access, long distance, future sight
\end{itemize}

If the player can describe \emph{exactly} what they want, reward that clarity with a lower DV.

\medskip

\textbf{2. Story Beats Are the Primary Cost}  
Psionics should generate SB frequently—even on success.

\begin{itemize}[leftmargin=1.5em]
  \item SB represent mental strain, attention drawn, or unintended resonance
  \item Spend SB on:
    \begin{itemize}
      \item sensory bleed (headaches, nosebleeds, emotional echoes)
      \item NPC suspicion or fear
      \item psychic backlash, visions, or intrusive thoughts
    \end{itemize}
\end{itemize}

Avoid nullifying the effect—complicate \emph{after} it lands.

\medskip

\textbf{3. Mental Fatigue Is Not Just Numbers}  
Mental Fatigue should be visible in the fiction.

\begin{itemize}[leftmargin=1.5em]
  \item Slowed speech, fixation, emotional flattening
  \item Tunnel vision or dissociation
  \item Loss of empathy or over-identification with others
\end{itemize}

When Fatigue overflows, choose consequences that affect \emph{judgment}, not just survival.

\medskip

\textbf{4. Respect Consent and Resistance}  
Psionics interacts directly with minds.

\begin{itemize}[leftmargin=1.5em]
  \item Unwilling targets always resist
  \item Strong emotions, beliefs, or training increase DV
  \item On a Partial, offer hard choices:
    \begin{itemize}
      \item surface thoughts only
      \item emotional truth without context
      \item information with a false inference
    \end{itemize}
\end{itemize}

Mind control should feel invasive, unstable, and dangerous—not routine.

\medskip

\textbf{5. Keep Psionics Distinct from Spellcraft}  
If a psionic effect begins to resemble a ritual or broad environmental change, it likely:
\begin{itemize}[leftmargin=1.5em]
  \item Requires multiple actions
  \item Generates escalating SB
  \item Risks immediate Fatigue overflow
\end{itemize}

Psionics excels at \emph{direct influence}, not infrastructure.

\medskip

\textbf{6. Reward Restraint and Creativity}  
Psionic players who:
\begin{itemize}[leftmargin=1.5em]
  \item accept Partial information
  \item disengage before collapse
  \item leverage Bonds instead of brute force
\end{itemize}

should see fewer severe consequences and richer narrative returns.

\medskip

\textbf{Final Guidance}  
Psionics should feel like holding a scalpel to reality.  
It cuts cleanly—but every cut leaves a mark.
