...
\item Managing Obligation (for Runekeepers and Invokers) or Backlash (for free casters)
\end{itemize}
...
\item \textbf{Obligation is story fuel.} When your Patron's presence is felt, answer -- it will lead to adventure.
...
\paragraph{Tactical Advice}:
\begin{itemize}
\item \textbf{Channeling is risky.} Each time you let a spirit speak through you, tick a Spirit Obligation timer. On fill, the spirit may try to stay.
...
\item \textbf{Note:} Psions are \emph{system outsiders}. They don't fit the Obligation/debt structure that governs other magic paths. This makes them powerful --- and deeply mistrusted.
\end{itemize}
...
\begin{itemize}
\item \textbf{System Outsider:} You don't owe Obligation to any Patron. This makes you \emph{free} --- but also \emph{suspect}. The Chain-Lanterns want to license you; the Aeler want to seal you; the Ykrul want to read you. What is the price of freedom?
...
\item \textbf{The Great Silence:} A historical cataclysm that nearly erased psionics. Psions are still feared because they don't fit the Obligation/debt structure that binds other magic paths.
