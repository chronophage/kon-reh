...
\begin{itemize}
\item \textbf{Too many timers.} \textit{Horror Campaigns} (Dread Clock, Reality Fracture) + \textit{Political Intrigue} (Mandate, Crisis) + \textit{The Amaranthine Sea} (Weather Window, Patrol Net) = 6+ timers. Players cannot track that many. Pick 2-3 maximum per session.
...
\hline
Horror Campaigns & 5-6 (Dread Clock), 8-9 (breaking points) & Extended campaign timers (use only for long arcs) \\
\hline
