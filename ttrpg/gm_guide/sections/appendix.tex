...
\section{Final Advice from the Gray Wanderer}

\begin{quote}
\small
\textit{"I have walked every road and carried every book. The weight of unread pages is heavier than any armor. But here is the secret: a single page, well-used, is worth more than a library of unopened tomes. Pick one thing from one expansion. Use it tonight. If it breaks, fix it tomorrow. The road does not care about completeness. It cares about movement."}
\end{quote}

\textbf{An expansion is not a commitment. It is a possibility. Use what serves your table. Leave the rest for another journey.}
