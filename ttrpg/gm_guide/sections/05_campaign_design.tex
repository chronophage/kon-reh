...
\begin{itemize}
  \item \textbf{1 Immediate Clock} — What is about to go wrong \emph{right now}  
  (e.g., \emph{Alarm Raised [4]}, \emph{Ritual Collapse [6]})
  \item \textbf{1 Situational Clock} — The pressure shaping player decisions  
  (e.g., \emph{Crowd Turns Hostile [4]}, \emph{Structural Failure [6]})
  \item \textbf{1 Long-Term Clock} — How this scene echoes forward  
  (e.g., \emph{Faction Retaliation [8]}, \emph{Corruption Advances [6]})
\end{itemize}

More clocks do not create more tension—they create \textbf{noise}.  
If players cannot name the clocks they are pushing against, they cannot make meaningful choices.
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black, title=Concrete Example: The Heist at Lord Silas’s Manor]
  ...
  The players can see all three clocks. They decide to rush the vault (risking \emph{Patrol Pattern}) rather than pick every lock carefully (which would tick \emph{Guards Alerted}). Their choice is informed and tense.
\end{tcolorbox}
...
When the party travels from one region to another, they cross between these subgenres. The **travel rules** (see Chapter 9 of the \textit{Player's Guide}) are designed not merely to measure distance but to **blend these genres organically**. A journey from the mist‑shrouded bogs of the Mistlands to the marble forums of Ecktoria should feel like turning the page from a folk‑horror novella to a political thriller.

As GM, use the travel deck and regional prompts to:
\begin{itemize}
  ...
  \item Let the changing landscape reflect changing story stakes – travel is not a filler between adventures but a **genre‑shifting engine**.
\end{itemize}
...
If a clock matters, \textbf{show it}.  
If it must remain unknown, foreshadow it through visible effects, rumors, or consequences—then reveal it as soon as the players can interact with it.

\textbf{Exception:} Hidden clocks work best when they are short-lived and revealed quickly (e.g., \emph{Ambush Trigger [2]}), not as long-term campaign drivers.
...
Clocks do not exist to punish failure—they exist to \textbf{make consequences legible}.  
When players choose to ignore a clock, that choice should feel informed, intentional, and costly.

\noindent
In Fate’s Edge, tension is not hidden behind the screen.  
It sits on the table—ticking.
...
Position is the GM's most powerful tool for calibrating narrative tension without altering core mechanics. It's not a mechanical bonus—it's your narrative compass.

\subsection*{Position as Narrative Guidance}
Position tells you how to frame the scene, not how many dice to roll. The mechanical effect remains consistent across tiers (re-rolling one die), but what this means grows with your campaign's scope:

\begin{itemize}
\item \textbf{Tier I:} Position frames personal stakes—does the character live or die?
\item \textbf{Tier III:} Position shapes regional outcomes—how much influence does the character have?
\item \textbf{Tier V:} Position reshapes reality—what will the world look like after this moment?
\end{itemize}

\subsection{How to Scale Position Without Bloat}

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black, boxrule=0.5pt, arc=2mm]
\begin{itemize}
\item \textbf{At Tier I:} Position is life and death. A shift from Desperate to Controlled means "You escape with your life."
\item \textbf{At Tier III:} Position is about influence. A shift from Controlled to Dominant means "The city's fate hangs on your decision."
\item \textbf{At Tier V:} Position is world-shaping. A shift from Desperate to Controlled means "The universe holds its breath as you decide the world's fate."
\end{itemize}
\end{tcolorbox}

\subsection{What Position Means for GM Decisions}

\textbf{When to Use Position:} Always, but the weight grows with tier.

\begin{itemize}
\item \textbf{Tier I:} Position guides how close the character is to capture or death
\item \textbf{Tier III:} Position guides how the city responds to the character's actions
\item \textbf{Tier V:} Position guides how the world reshapes around the character
\end{itemize}

\subsection{Position and Narrative Momentum}

Position is your guide to pacing and narrative flow. The same Position shift means different things at different tiers:

\begin{itemize}
\item \textbf{Tier I:} A shift from Desperate to Controlled means "You've bought time to think"
\item \textbf{Tier III:} A shift from Controlled to Dominant means "The city rallies behind your cause"
\item \textbf{Tier V:} A shift from Desperate to Controlled means "The world bends to your will"
\end{itemize}

\subsection{What Not To Do}

\begin{tcolorbox}[colback=red!5!white, colframe=red!75!black, boxrule=0.5pt, arc=2mm]
\begin{itemize}
\item \textbf{Don't add mechanical bonuses} (e.g., +1 die at Tier III, +2 dice at Tier V)
\item \textbf{Don't treat Position as a tactical tool}—it's a narrative compass, not a combat modifier
\item \textbf{Don't make Position the focus}—it's a means to frame the narrative, not the end goal
\item \textbf{Don't let Position dictate the story}—use it to guide your narrative decisions, not determine outcomes
\end{itemize}
\end{tcolorbox}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title=Arcs Generate Obligation and Patron Interest]
  ...
  \begin{itemize}
    \item \textbf{Internal arcs} (fear, doubt, guilt) are perfect sources of **Corruption** or **Obligation**. A character struggling with guilt might be tempted by Malachai. A character seeking redemption might attract the attention of the Gallow’s Bell.
    \item \textbf{External arcs} (revenge, ambition, love) create **Debt Clocks** with terrestrial patrons or generate **Crisis** when they interfere with faction plans.
...
\midrule
Travel Clocks & Track progress through dangerous journey legs (4-10 segments).\emph{ See note on blending fantasy subgenres above.} \\
...
\begin{tcolorbox}[
  ...
  title=Advice: Tension Over Twists,
  fonttitle=\bfseries,
  sharp corners
]
\index{GM guidance!tension vs twists}\index{clocks!hidden clocks}

\textbf{Avoid hidden clocks.} If players cannot see the pressure, they cannot make meaningful choices. Surprise escalation feels arbitrary, not earned.

\textbf{The best stories are tense, not twist‑driven.} A single, well‑placed complication that raises the stakes is worth a dozen surprise betrayals. Let twists emerge naturally from the fiction and player actions – don’t force them.

\vspace{2mm}
\noindent\textbf{Tension > Twists.} Spend your Story Beats on complications that make players lean forward, not on distractions that make them shrug. A clock that ticks is tension. A sudden plot reversal without foundation is noise.

\vspace{2mm}
\textit{Clocks make tension visible. Use them.}
\end{tcolorbox}
...
\subsection*{Why Rivals Work}
\begin{itemize}
  \item \textbf{They multiply Patron presence.} Each rival can serve a different Patron, creating a web of obligations and conflicts.
  \item \textbf{They create shifting alliances.} Today’s rival may be tomorrow’s reluctant ally against a greater threat.
  \item \textbf{They generate Story Beats from both sides.} When rivals act off-screen, the GM gains SB to spend on complications. When the parties clash, the dice produce SB from both pools.
\end{itemize}

\subsection*{Template for Creating a Rival Party}
Use this template to build a rival group in under 5 minutes.

\begin{tcolorbox}[title=Rival Party Template, colback=white!97!gray, colframe=black!80!gray]
  \textbf{Name:} \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ (e.g., “The Ashen Cord”, “The Brass Legion”, “The Thorns of Winter”)
  
  \textbf{Composition:} (3–5 members with basic stats; give each a one-sentence archetype)
  \begin{itemize}
    \item Leader: \_\_\_\_\_\_\_\_\_\_ (class/role, personality)
    \item Muscle: \_\_\_\_\_\_\_\_\_\_ 
    \item Mage/Weird: \_\_\_\_\_\_\_\_\_\_
    \item Scout/Thief: \_\_\_\_\_\_\_\_\_\_
    \item Face/Healer: \_\_\_\_\_\_\_\_\_\_ (optional)
  \end{itemize}
  
  \textbf{Patrons:} (Which Patrons do they serve? At least one should oppose a PC’s Patron.)
  
  \textbf{Goal:} (What do they want? It should overlap with or block a PC goal.)
  
  \textbf{Relationship to PCs:} (Rivals? Hunters? Unwitting competitors? Former allies?)
  
  \textbf{Resources:} (One Asset or high-Cap Follower they can use off-screen.)
  
  \textbf{Clock:} \emph{Rival Agenda [6 or 8]} – each time the PCs ignore them or the GM spends SB on their activities, tick the clock.
\end{tcolorbox}

\subsection*{Example: The Ashen Cord (from Simulation)}
\begin{itemize}
  \item \textbf{Composition:} Vesper (leader, shadow mage, serves Ikasha), Tallow (berserker, serves Malachai), Ember (cantor, serves Palinode), Cinder (scout, no Patron).
  \item \textbf{Goal:} Retrieve the same artifact as the PCs, but for their Patrons’ purposes.
  \item \textbf{Relationship:} Rivals who will negotiate or betray as needed.
  \item \textbf{Clock:} \emph{Cord’s Agenda [6]}.
\end{itemize}

\subsection*{Rival Advancement (Off-Screen)}
Rivals do not sit idle. Between sessions:
\begin{itemize}
  \item Tick their Agenda clock when the PCs fail to hinder them or when the GM spends 2+ SB on off-screen rival activity.
  \item When the clock fills, the rivals achieve a major milestone (e.g., they secure a powerful artifact, gain a new Patron’s favor, or damage a PC Asset).
  \item Reveal their progress through rumors, discovered scenes (a looted shrine, a dead informant), or a direct confrontation.
\end{itemize}

\subsection*{Using Rivals in Play}
\begin{itemize}
  \item \textbf{Introduce early:} Have the rivals show up at the end of the first or second session – not as enemies, but as competitors with a polite rivalry.
  \item \textbf{Tempt negotiation:} Rivals should be open to deals. This creates social scenes and moral dilemmas.
  \item \textbf{Force choices:} The rivals’ clock forces the PCs to decide: stop the rivals or pursue their own goal.
  \item \textbf{Bring them back:} Even if defeated, a rival can survive and return with new Patron backing (increase their Cap by 1 or give them a new Talent).
\end{itemize}
...
\section*{GM Guide: Position as Narrative Leverage (Recap)}

Position is the GM's most powerful tool for calibrating narrative tension without altering core mechanics. For detailed guidance, see Section \ref{sec:position-narrative} (above).

\section*{Boon Economy Across Tiers}
\index{boons!economy}\index{boons!tier scaling}

Boons are the players’ primary resource for re‑rolls, asset activations, and narrative leverage. Their availability changes dramatically as characters advance – and that shift is by design, not an accident.

\subsection*{How Tier Changes Boon Generation}

At \textbf{Tier I–II}, characters have small dice pools (typically 4–6 dice). They roll Misses and Partials often, each of which awards 2 or 1 Boons respectively. A low‑tier party might earn 6–10 Boons per scene.

At \textbf{Tier IV–V}, characters roll 8–10 dice. They rarely Miss, and Partials become the most common outcome. Boons become scarce – a high‑tier party might earn only 2–4 Boons per scene.

\subsection*{Why This Works}

\begin{itemize}
  \item \textbf{Low‑tier characters need the help.} Their small pools produce unreliable results; Boons give them a cushion to re‑roll failures and activate assets.
  \item \textbf{High‑tier characters must rely on skill, not luck.} With huge pools and reliable success, they no longer have a safety net of Boons. Every re‑roll or asset activation is a meaningful choice.
  \item \textbf{The scarcity creates tension.} At high levels, spending a Boon on a re‑roll means you cannot activate your spy network later. The resource becomes a strategic lever, not a crutch.
\end{itemize}

\subsection*{GM Guidance: Don’t “Fix” the Scarcity}

Some GMs see high‑tier players struggling for Boons and want to invent new ways to award them. **Resist.**

The scarcity is intentional. If you inject extra Boons, you remove the resource pressure that makes high‑tier play interesting. Instead, let players adapt:
\begin{itemize}
  \item They will rely more on their high Skills and clever positioning.
  \item They will use Boons on critical moments, not routine rolls.
  \item They will activate assets only when they truly need them.
\end{itemize}
...
For deeper guidance on high‑tier (Tiers IV–V) campaigns, see Chapter \ref{ch:gm-epic} (\textit{Tier IV and V: Running Epic Adventures}).
...
\end{itemize}
For more detailed advice on running epic-tier games, see Chapter \ref{ch:gm-epic}.
...
\end{itemize}
As noted in the green box above, arcs should generate Obligation and Patron interest to keep them mechanically integrated.
