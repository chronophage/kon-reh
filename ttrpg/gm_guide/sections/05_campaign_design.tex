...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black, title=⛔ Warning: Don’t Inflate Difficulty Values]
  ...
  \begin{itemize}
    \item Use **Clocks** to add time pressure and branching consequences.
    \item Spend SB aggressively – a single roll can tick multiple clocks or trigger a Patron demand.
    \item Worsen **Position** when the fiction calls for danger, not DV.
    \item Introduce **tactical complications** (reinforcements, environmental shifts, hostage situations).
  \end{itemize}
