...
% =========================================================
% CHAPTER QUICK-START BOX (place after \chapter)
% =========================================================
\begin{tcolorbox}[
...
\midrule
\multicolumn{1}{p{\textwidth}}{\textbf{The Core Loop (every meaningful action)}}
\begin{enumerate}
...
\end{enumerate}
\midrule
\multicolumn{1}{p{\textwidth}}{\textbf{Outcome Matrix (what you do)}}
\begin{itemize}
  \item \textbf{Clean Success} (S ≥ DV, SB=0) → intent achieved, no complication
  \item \textbf{Success with Cost} (S ≥ DV, SB>0) → intent achieved, spend SB for a twist
...
\end{itemize}
\midrule
\multicolumn{1}{p{\textwidth}}{\textbf{Story Beats (SB) – spend them to create drama}}
\begin{itemize}
...
\end{itemize}
\midrule
\multicolumn{1}{p{\textwidth}}{\textbf{Golden Rule}} \\
...
% =========================================================
% INTRICATE DESCRIPTION (SELLING IT) – GM GUIDANCE
% =========================================================
\begin{tcolorbox}[
  colback=red!5!white,
...
\medskip
When a player describes their action with \textbf{intricate detail} – sensory language, emotional stakes, a nod to the setting’s customs or their own backstory – you have permission to give them a \textbf{mechanical edge}. This is not a tax on the less eloquent; it is a reward for those who help paint the scene.

\subsection*{How to Rule It}
\begin{itemize}
  \item \textbf{Basic description:} “I attack the goblin.” – No bonus.
  \item \textbf{Detailed description:} “I feint high, then drive my shoulder into the goblin’s shield, shoving it aside to open its flank.”  
  → \textbf{Improve Position by one step} (e.g., Controlled → Dominant) for this roll.
  \item \textbf{Intricate description:} “I recall the last time I fought in the rain. Mud sucks at my boots, but I plant my left foot, pivot, and let the goblin’s own momentum carry it onto my point.”  
  → \textbf{Improve Position by one step \textit{and} bank 1 Story Beat} (or upgrade Effect by one step, your choice).
\end{itemize}

\subsection*{Guidelines for Fair Play}
\begin{itemize}
  \item \textbf{No penalty for plain speech.} Never punish a player who is tired, shy, or simply prefers quick resolution. The bonus is a gift, not a tax.
  \item \textbf{Consistency builds trust.} If a player routinely offers rich descriptions, reward them regularly. If they improve over time, acknowledge it.
  \item \textbf{Let the fiction guide the bonus.} A vivid description of desperate, reckless action might improve Effect but worsen Position – the mechanics should mirror the fiction.
  \item \textbf{Invite quiet players.} Ask leading questions: “What does it look like when you pick that lock?” or “What do you say to the guard?” Gentle prompts help shy players join the fun.
  \item \textbf{Group “selling.”} If the whole table contributes to describing a group action (a coordinated ambush, a joint ritual), grant the bonus to the primary roller or give each participant a small benefit (e.g., a one‑time +1 die).
\end{itemize}
...
\textbf{Selling it:} “I wait for the wind to rattle the shutters, then pad across the wet cobblestones – heel-toe, heel-toe – keeping the stack of barrels between me and the sentry’s gaze.”  
The GM nods: “Great. Because you’re using the wind and the barrels, roll at \textbf{Dominant Position}.”
\end{quote}

\noindent
\textit{The dice still decide success or failure. But a well‑told action makes the story richer – and earns the player an edge when the dice fall.}
\end{tcolorbox}
% =========================================================
% Continue with \section{How to Think in Fate's Edge}
% =========================================================
...
\begin{longtable}{p{2.8cm}p{3.2cm}p{2.8cm}p{3.2cm}}
\toprule
