...
\begin{itemize}
  ...
  \item \textbf{Summoner Clash:} Kestra’s Cap~3 elemental takes Harm and crosses a [WARD]; she ticks her Leash twice. On fill, the elemental flares once and departs.
\end{itemize}
...
\item \textbf{On Miss:} Spend SB to make the setback sharper, broader, or longer‑lasting.
\end{itemize}
...
% (tikz code unchanged; ensure it is present in final document)

% ... (insert the tikzpicture from original; label and index as appropriate)
\begin{figure*}[t]
  % ... (tikzpicture code from original, unchanged)
