...
\begin{enumerate}
    ...
    \item \textbf{Establish Position:}\index{Position} GM sets whether the action is \textbf{Dominant}, \textbf{Controlled}, or \textbf{Desperate}.
...
\section{Critical Success}\index{Critical Success}
...
\begin{itemize}
  \item \textbf{Two 10s:} Exceptional success; pick two benefits or one powerful effect.  
