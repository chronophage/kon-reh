...
\end{enumerate}
Do not search for the “right roll.” If the action matters, the procedure already applies.
...
Use Fatigue to say: \emph{“You can keep going, but it will cost you.”}
Use Harm to say: \emph{“You cannot ignore this.”}
...
When unsure how to rule something, ask:  
\emph{“Does this create a more interesting story?”}  
If yes, lean into it. The system rewards bold GM decisions with momentum, not penalties. \\

\addlinespace

2. Spend SB to Create &
Every Story Beat you spend should open a new door, not close one.  
A SB spent on \emph{“the door slams shut”} is weaker than one spent on  
\emph{“the door slams shut—but the echo draws guards closer.”}  
...
When players ask \emph{“What happens if I fail?”}, answer honestly.  
...
\begin{tcolorbox}[colback=black!3!white,colframe=black!40!white,title={Encounter in Action: The Ambush at Raven’s Ford}]
  This example shows how the core systems—narrative initiative, Story Beats (SB), Boons, Bonds, and damage—come together in play. The party consists of \textbf{Thane} (fighter), \textbf{Sariel} (rogue), and \textbf{Kestra} (mage).
  
  \subsection*{Setup}
  The group is crossing a rope bridge when two bandits attack from the far side. The GM sets the scene:
  \begin{quote}
  \emph{“The bridge sways under your feet. Two crossbowmen take aim from behind a boulder. Thane, you’re closest to them. Sariel is mid‑bridge, Kestra still on the near cliff.”}
  \end{quote}
  No initiative is rolled. The GM asks: “Who acts first?” Thane says, “I charge.” The GM agrees—he’s closest and has momentum.
  
  \subsection*{Round 1 — Thane’s Turn}
  Thane rushes the bandits. GM says: “You’re exposed on the bridge, crossbows trained on you—Desperate Position, DV 3 to reach them before they shoot.” Thane rolls Body + Melee (6d10): 7, 5, 4, 2, 1, 1 → two successes (7 only). One success short. Miss.
  
  \paragraph{Result:} The GM gains 2 SB (two 1s) \emph{and} the player gains 2 Boons (Miss). GM narrates:
  \begin{quote}
  \emph{“You make it halfway, but a bolt grazes your arm. Mark Harm 1. The bandits draw swords—they’re in Close now.”}
  \end{quote}
  
  \subsection*{Enemy Turn (No Roll?)}
  Because Thane closed the distance, the bandits simply “draw swords” as a consequence of his Miss. Enemies do not automatically roll to attack. The GM uses the 2 SB from Thane’s roll:
  \begin{itemize}
    \item \textbf{Spend 1 SB:} “The second bandit kicks a loose plank. The bridge lurches—everyone make a Body + Athletics test (DV 3) or be knocked Prone.”
    \item \textbf{Spend 1 SB:} “Sariel, your footing slips; your next action is Desperate.”
  \end{itemize}
  No enemy attack roll needed. SB shape the fiction directly.
  
  Sariel fails her test; she is Prone. Kestra succeeds.
  
  \subsection*{Player Turn — Sariel Uses a Boon}
  Sariel wants to stab the nearest bandit from prone. “Can I roll?” GM: “Desperate, DV 3.” She rolls: no successes. Miss. She gains 2 Boons (now has 2 total). Before the GM narrates failure, she \textbf{spends 1 Boon} to re-roll one die. Re-roll comes up 6 → adds one success, turning Miss into Partial. GM: “You slash his leg—he drops to one knee, but your dagger is lodged. It’ll take a moment to free it.”
  
  \subsection*{Bond Transfer}
  Kestra sees Sariel struggling. She has a Bond with Sariel (“She saved me once; I owe her”). As a free action (Tier III+ rule), Kestra \textbf{transfers 2 Boons} to Sariel, saying, “I shout, ‘The knife! Pull it toward you!’” Sariel now has 3 Boons.
  
  \subsection*{Kestra’s Turn — Boon for Environmental Effect}
  Kestra wants to use magic to collapse part of the bridge behind the bandits, cutting off their retreat. She has the \textbf{Spellcraft} talent and the \texttt{[EARTH]} and \texttt{[BREAK]} tags. GM says: “Controlled, DV 4. Spend a Boon to improve Position to Dominant?” Kestra spends 1 Boon (now Dominant, DV 4). She rolls successfully, generating 1 SB (a 1). The GM spends that SB immediately:
  \begin{quote}
  \emph{“The bridge splinters—the bandits are isolated! But the shockwave also loosens the rope on your side. New Clock: Bridge Collapse [4].”}
  \end{quote}
  Damage is not rolled. The bandits are now stranded, a fictional consequence.
  
  \subsection*{End of the Encounter}
  Sariel, with her extra Boons, frees the dagger and finishes the wounded bandit (Clean Success). The other bandit surrenders. No enemy “damage” was rolled; all consequences came from SB, Position, and player choices.
