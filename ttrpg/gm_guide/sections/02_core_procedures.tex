...
\section*{The Lazy DV Table (GM Guidance)}
\index{DV!lazy table}
\index{GM guidance!DV}

When in doubt, use this table.  
It is intentionally conservative, narrative-forward, and designed to keep play moving without overthinking difficulty math.

\begin{center}
\small
\begin{longtable}{clp{7.5cm}}
\toprule
\textbf{DV} & \textbf{Label} & \textbf{Typical Use} \\
\midrule
1 & Trivial & Routine actions under no pressure; failure should only occur on a narrative misstep or dramatic irony. \\
2 & Easy & Tasks a competent person can usually manage; failure introduces inconvenience, not danger. \\
3 & Standard & The default. Meaningful effort under mild pressure or uncertainty. \\
4 & Hard & Risky actions, time pressure, opposition, or unfamiliar conditions. \\
5 & Extreme & Dangerous, high-stakes actions where failure significantly escalates the situation. \\
6 & Legendary & Feats beyond mortal norms, apex-tier challenges, or climactic moments. \\
\bottomrule
\end{longtable}
\end{center}

\paragraph{Default Rule:}
If you are unsure, set the DV to \textbf{3}.  
Then use \textbf{Position}, \textbf{Clocks}, and \textbf{Consequences} to create tension—not higher DVs.

---

\section*{Lazy Consequence Mapping}
\index{Consequences!lazy mapping}

When resolving costs, default to the following escalation ladder:

\begin{center}
\small
\begin{longtable}{p{3cm}p{9cm}}
\toprule
\textbf{Pressure Level} & \textbf{Preferred Consequence} \\
\midrule
Low & Fictional complication, lost time, narrative exposure \\
Moderate & \textbf{Fatigue} (1), Clock advancement, Position downgrade \\
High & \textbf{Fatigue} (2), Harm~1, serious Clock advancement \\
...
\textbf{Important:}  
Harm is never the first tool. It is the \emph{last} tool.

---

\section*{Why Fatigue Comes Before Harm}
...
\section*{On Equipment Damage (Read This)}
...
\section*{DV Is Not Difficulty — It Is Commitment}
\index{DV!philosophy}

A higher DV does not mean:
\begin{itemize}
\item “Harder math”
...
\item Consequences carry more narrative weight
\end{itemize}
