...
% =========================================================
% The following sections are MOVED to other chapters as per the master plan.
% They are commented out here to keep this file as Chapter 2 only.
% =========================================================

% MOVED TO Chapter 7 (Combat) - Optional Initiative Procedures
% \section{Optional Initiative Procedures}
% \label{sec:optional-initiative}
% ... (content preserved but commented)

% MOVED TO Chapter 4 (Cognitive Load) - Player-Managed Modules
% \section{Standard Rule: Player-Managed Modules}
% \label{sec:player-managed-modules-gm}
% ... (content preserved but commented)

% MOVED TO Chapter 3 (First Session) - Beginner Pathway Sidebar
% \begin{tcolorbox}[title=\textbf{The Core Loop: Your First 10 Games},...]
% ... (content preserved but commented)

% MOVED TO Chapter 3 (First Session) - First Game Scenario: The Sunstone Tower
% \section*{First Game Scenario: The Sunstone Tower}
% \label{sec:sunstone-tower}
% ... (content preserved but commented)

% MOVED TO Chapter 4 (Cognitive Load) - Clocks & Fronts
% \section{Clocks \& Fronts}
% \label{sec:clocks-fronts}
% ... (content preserved but commented)

% MOVED TO Chapter 3 (First Session) - Ready for More? Add These Systems
% \section{Ready for More? Add These Systems}
% \label{sec:modular-systems}
% ... (content preserved but commented)

% MOVED TO Chapter 5 (Resource Management) - Abstracting Time and Currency
% \section{Abstracting Time and Currency}
% \label{sec:abstraction}
% ... (content preserved but commented)

% MOVED TO Chapter 11 (Example Play & Survival Guide) - Session Flow
% \section{Session Flow: A GM Cognitive Checklist}
% \label{sec:session-flow}
% ... (content preserved but commented)

% MOVED TO Chapter 11 (Example Play & Survival Guide) - The GM Mindset box
% \begin{tcolorbox}[colback=blue!5!white,...]
% ... (content preserved but commented)

% MOVED TO Chapter 11 (Example Play & Survival Guide) - Ambush Example
% \begin{tcolorbox}[colback=black!3!white,...]
% \label{box:ambush-example}
% ... (content preserved but commented)

% MOVED TO Chapter 10 (Advanced Techniques) - Threshold Effects Reference
