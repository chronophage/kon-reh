...
\begin{tcolorbox}[title=SB Spend Menu, colback=white!97!gray, colframe=black!80!gray,breakable]
\begin{tabularx}{\linewidth}{lX}
\toprule
...
\begin{tcolorbox}[colback=gray!5,colframe=gray!75!black,title=\textbf{Lane Marker: One Complication per Roll},breakable]
