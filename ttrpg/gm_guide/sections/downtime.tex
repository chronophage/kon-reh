...
\item \textbf{Upkeep \& Clocks.} Players pay upkeep for assets and followers, advance or retreat campaign timers, and clear Obligation through off-screen acts of service.
...
\paragraph{Note on Training Clocks.} For long-term improvement (skills, talents, follower advancement), start a Progress Clock [4--8]. Each successful downtime roll advances the timer by 1 segment. When full, the improvement is complete. Failure adds a complication instead of advancing.
...
\item \textbf{When the Risk Clock fills}, the rushed project fails or succeeds at a heavy cost. The GM chooses one:
  \begin{itemize}
    ...
    \item The character gains the new ability, but immediately marks 1 Harm (overexertion) and gains a Debt Clock [4] to a terrestrial patron who \textquotedbl helped\textquotedbl them cheat time.
  \end{itemize}
