...
\begin{itemize}
\item Players can take actions to tick \textbf{forward} or \textbf{backward} a visible faction clock. For example: \textquotedbl I spend the week bribing officials in the Dyers' Guild.\textquotedbl\ Roll Presence + Sway (DV 4). On success, tick the \textit{Guild Influence} clock \textbf{back} by 1 (less threat). On a Miss, the clock ticks \textbf{forward}.
...
Downtime is an excellent moment to clear lingering Complications (from character creation or story). Players can spend a downtime action to \textquotedbl resolve a complication\textquotedbl -- roll appropriate skill (DV 3--5). On success, the complication is cleared; on a Miss, it worsens (GM ticks a related clock).
