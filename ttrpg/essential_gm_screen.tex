...
Start with \textbf{32 XP} (max 36with Bonds/Complications).
...
You are not a referee or a narrator robot. You are a \textbf{co-creator of drama}. Your tools (SB, timers) are not punishments—they are how you play the game. When you spend a Story Beat to tick a timer, you are making a move. Enjoy it.
...
\begin{itemize}[leftmargin=*]
    ...
    \item Tick a timer: \textit{``While you argue, the fire spreads—Collapse [4] advances 1.''}
