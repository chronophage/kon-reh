...
Quick Lena tries to pry the lantern loose. Confront her: Presence + Sway (DV 3). \textbf{Partial:} She agrees to split the reward but demands a later favor (start Debt Clock [4]).
