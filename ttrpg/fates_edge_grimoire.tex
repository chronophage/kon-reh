...
Playstyle: Use Telepathy to detect lies and track suspects. Use Mind Shield to protect against enemy psions. Use Invoker Rites (Cleansing Light, Marked Prey) to bind supernatural threats. Trade Symbol compromise for Promise Clocks -- then clear those timers by testifying truthfully in court.
