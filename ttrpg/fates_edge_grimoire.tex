...
\vspace*{2cm}
\begin{center}
{\Huge\scshape The Grey Wanderer's Grimoire}\\[0.5cm]
...
\epigraph{"I have worn the chains of a dozen Patrons and broken most of them. Twice."}{\textit{--- The Grey Wanderer}}
...
The voice you hear belongs to no one and everyone -- a wanderer who has stood at the crossroads of every Patron's attention. Call me the \textbf{Grey Wanderer}. These notes are my legacy. Use them, lose them, or burn them for warmth. I won"t mind.
...
\epigraph{"Every Rite is a receipt. Every Patron is a creditor. Pay on time, or they"ll repossess your soul."}{\textit{--- The Grey Wanderer}}
...
% Chapter 4: Patrons of the Grey Wanderer
% Expanded with categorization, cultural variants, and Gift options

\chapter{Patrons of the Grey Wanderer}

\epigraph{"You wish to walk the road of power? Then listen well. The world is old, and older still are the voices beneath it. We call them Patrons, though they were never sworn to us."}{\textit{--- The Grey Wanderer}}
...
\textbf{Effect:} Heal a blighted place or quicken a damaged ecosystem. Clear taint, restore fertility, awaken dormant forces. Begin an \textit{Ecosystem Restoration} [8] timer.
\end{patronbox}
...
\textbf{Alternative Gift -- Shortcut:} Once per session when moving from one location to another (including during travel montages), you may declare a hidden shortcut that reduces the remaining travel timer by 2 segments. The GM may describe a minor cost or complication (e.g., "the path is steep -- mark 1 Fatigue"). This counts as your Patron's Gift activation.
...
\textbf{Standard Rites}
\begin{itemize}
    \item \textit{False Dawn} (8 XP): Bestow a gift with a hidden curse -- target gains an advantage but begins a Corruption timer.
...
\textbf{Cost:} 13 XP, Obligation 7 segments \\
\textbf{Effect:} Channel Malachai directly. Gain +2 dice to one action per beat, but each use marks 1 SB as her influence spreads. Begin a Corruption's Grip timer.
\end{patronbox}
...
\subsection{Why They Exist -- The Grey Wanderer's Defense}

I have heard the other side, of course. The Grey Wanderer -- that meddling ghost -- claims free casting is the oldest magic, older than Patrons, older than covenants. "Before there were gods," they say, "there was fire and a hand that reached into it. That is free casting. Raw. Dangerous. \textit{Human}."
...
\epigraph{"Channel bold, weave true, and may the Story Beats be ever in your favor."}{\textit{--- The Grey Wanderer}}
...
\tag{Curse} & \dangerous{+2} & Affliction & Attach hostile tag/timer to target \\
...
\dangerous{\spell{Fate's Needle}{Fate, Strike, \dangerous{Divination}}{5}{Roll 3d10, keep the highest; that many successes auto-succeed on your next non‑magical action.}{Major Backlash -- caster marks Harm 1 and begins a \textit{Fate Debt} timer [4].}}
...
\epigraph{"I do not command the dead. I ask. And sometimes -- when the price is right -- they answer."}{\textit{--- The Grey Wanderer}}
...
\section{Cults of the Grey Wanderer -- Dark Harvests}

\epigraph{"Not every cult begins with a sermon. Some begin with a song that gets stuck in your head. Some begin with a shadow that follows you home. Some begin with a feast where the bread tastes like memory."}{\textit{--- The Grey Wanderer}}
...
\begin{itemize}
    ...
    \item \textbf{Prepare a cost.} If a PC joins a cult, they gain power -- but they also gain a timer. "The Hollow Queen's Tithe" [6]. "The Copperhead's Favor" [4]. "The Listener's Debt" [8]. When the timer fills, the cult calls in its marker.
...
\epigraph{"A cult is just a family that forgot how to laugh. Or a family that learned to laugh at things that should not be funny. Either way, do not drink their cider."}{\textit{--- The Grey Wanderer}}
...
\epigraph{"Not every prayer needs a patron. Not every door needs a key. Some rites are older than the covenants -- older than the gods themselves."}{\textit{--- The Grey Wanderer}}

The rites in this chapter are not tied to any single Patron. They require no Symbol, no Codex, no Thiasos -- only \textbf{time}, \textbf{components}, and a \textbf{timer}.
...
\begin{itemize}
    ...
    \item \textbf{Test:} Contested timer (size = max of 4 and 2 + entity's Tier)
\end{itemize}
\end{tcolorbox}

Both the exorcist and the entity work against each other. On each turn, the exorcist chooses an approach:
\begin{itemize}
    \item \textbf{Command (Presence + Command):} DV = 3 + Tier. Success ticks Exorcism timer +1.
    \item \textbf{Lore (Wits + Lore):} DV = 4 + Tier. Success ticks Exorcism timer +2.
    \item \textbf{Sacrifice (Spirit + Resolve):} DV = 3 + Tier. Success ticks Exorcism timer +1, exorcist marks 1 Fatigue.
\end{itemize}
If the entity's timer fills first, possession deepens -- the subject suffers Harm 2 and gains a permanent tell.
...
\epigraph{"I have worn the chains of a dozen Patrons and broken most of them. Twice. I have been witch and hunter, shaman and alienist. The power changes you -- but you can always change back."}{\textit{--- The Grey Wanderer}}
...
I am called Sister Alva, though that name died forty years ago, and the woman who bore it is woven into the Cord. I write this for no one -- does not permit confession -- and for everyone who will ever accept a warm meal from a stranger, a cool cloth on a fevered brow, a lullaby hummed beside a sleeping child.
...
If you succeed, you will feel the thread snap -- a small, sharp pain behind your left ear, like a plucked harp string. The Daughter who tied it will taste blood in her mouth for a day and a night. She will know you have broken free. She will not come after you -- does not chase. It waits. And it remembers.
...
\epigraph{"A witch is a threshold worker---one who listens to Echo (what has been), steadies the Veil (what is), and leans into Flow (what wishes to be). Witchcraft is not brute force; it's fit: finding where the world already wants to move and giving it a gentle, precise nudge."}{\textit{--- The Grey Wanderer}}
...
\textbf{Keeper of Thresholds} (4 XP) -- Prereq: Hearth's Memory. Name a dwelling or crossing as your ward. Once per scene you can: reduce a community timer by 1, or upgrade Guest‑Rite to Sanctuary (no initiations of violence).
...
\textbf{Debt‑Binder} (3 XP) -- Prereq: Name‑Keeper. Once per scene, you may mark or clear one segment of a Promise Timer when you resolve or escalate a conflict through story, hospitality, or grief.
...
\textbf{Backlash:} Mercy without memory hollows. Apologies left unsaid become cold rooms -- mark a Promise Timer [4] that ticks when you fail to witness a pledge.
...
\subsection{Curses have a Timer }
...
\subsection{Running a Witch Hunt -- Quick Timers}
\begin{itemize}
...
\section{The Grey Wanderer's Last Advice on Witches}

\epigraph{"The best witches I have known were not powerful. They were patient. They knew which knot to tie and which to leave undone, which name to speak and which to forget. That is the quiet work of names -- and it is enough to change the world, one threshold at a time."}{\textit{--- The Grey Wanderer}}

\chapter{The Mind Ascendant -- Psionics and the Grey Wanderer}
...
\epigraph{"The mind is a door. Psionics is the key. But not every door should be opened -- and not everyone who knocks should be answered."}{\textit{--- The Grey Wanderer, from a letter never sent}}
...
\epigraph{"I have walked every road in this book. Some are paved, some are thorns, some are just a goat track and a prayer. Here is what I wish someone had told me before I started."}{\textit{--- The Grey Wanderer}}
...
\medskip
\noindent \textit{Note:} These are subjective -- your table may find different strengths and weaknesses. The Grey Wanderer reserves the right to be wrong.
...
Witch & Thresholds & Promise Timers & Low--Med & Very High & Med & Storytellers \\
...
Cantor & Patron + audience & Corruption Timer → Patron burden \\
Summoner & The spirit itself & Leash → spirit acts (then departs) \\
Free Caster & Raw Weave & Backlash (SB) → complications \\
Witch & Thresholds (Echo/Veil/Flow) & Promise Timers → price comes due \\
...
\begin{itemize}
    ...
    \item ...magic that generates story hooks automatically: \textbf{Runekeeper} (Patron Intrusions) or \textbf{Witch} (Promise Timers).
...
\begin{enumerate}
    ...
    \item \textbf{Separate Tracks.} You track Obligation (Runekeeper/Invoker), Corruption (Cantor), Leash (Summoner), Promise Timers (Witch), Mental Strain (Psion), and regular Fatigue separately. They do not merge.
...
Promise Timer (1 seg) & Obligation (1 seg) & 1:1 & Hag bargain \\
...
\textbf{Effect:} You may treat any Symbol you carry as a valid \textbf{threshold} for Witch rituals (doorway, altar, token). When you Crack the Seal on a Symbol, you may instead convert the Symbol's compromised state into a \textbf{Promise Timer [4]} (the debt becomes social/spiritual rather than physical damage). The Promise Timer ticks each time you use that Symbol without first making an offering (1 SB worth of wine, bread, or a whispered truth). If the Promise Timer fills, the Symbol shatters permanently.

\textbf{Downside:} You cannot clear Obligation and Promise Timers in the same downtime scene. You must choose which master to serve first.
...
\textbf{Effect:} When you build a spell with TAGS, you may declare it a \textbf{threshold working}. The spell gains +1 Effect if cast at a proper threshold (doorway, crossroads, graveside, etc.) but also creates a \textbf{Promise Timer [2]} that ticks immediately after the spell resolves. On a miss or partial, the Timer ticks twice. When the Promise Timer fills, the world demands a price -- a lost memory, a broken friendship, a door that will not open for you. You may clear Promise Timer segments by making offerings (salt, bread, a truthful confession) before casting.

\textbf{Downside:} Any spell that includes the [DANGEROUS] tag (Leap, Fold, Gate, Create, Summon, Transmute, Animate) automatically creates a Promise Timer [4] regardless of success.
...
\textbf{Effect:} When you use Telepathy or Empathic Manipulation, you may add your Performance skill to the roll (instead of or in addition to, max +3 dice). You also may use your Corruption Timer as a \textbf{psychic battery}: once per session, you may advance your Corruption Timer by 1 segment to immediately recover 2 Mental Strain.

\textbf{Downside:} When your Corruption Timer fills, you do not get a Patron's boon -- instead, you have a \textbf{Mental Break}. Roll on the Psionic Complication table (d12) and apply the result immediately. Your Corruption Timer resets to 0, but you cannot use Cantor or Psionic abilities for the rest of the scene.
...
\textbf{Effect:} You may use your Mental Strain track as a substitute for \textbf{Soft Witness} (Witch talent). When you use Telepathy on a target who has accepted hospitality from you (a cup of tea, a night's shelter), the target's resistance DV is reduced by 1. Additionally, you may convert a Promise Timer segment into 1 Mental Strain recovery once per session (as a free action, but must be narrated as a small act of contrition).

\textbf{Downside:} Whenever you suffer Mental Strain overflow, tick a Promise Timer [4] (the universe notices you are a loose thread). This Promise Timer cannot be cleared except by a full downtime scene of meditation and apology.
...
Playstyle: Use Telepathy to detect lies and track suspects. Use Mind Shield to protect against enemy psions. Use Invoker Rites (Cleansing Light, Marked Prey) to bind supernatural threats. Trade Symbol compromise for Promise Timers -- then clear those timers by testifying truthfully in court.
...
Playstyle: Summon a wolf ancestor or selkie. Use the Cantor's Inspire Chorus to buff allies while the spirit attacks. When the spirit acts against its nature, you tick your Corruption Timer instead of Leash -- you are becoming the mask.
...
Playstyle: Use Clairvoyance to scout ahead and find hidden thresholds. Use Witch rites to bind promises and bless hearths. Convert Promise Timer segments into Mental Strain to keep scrying. Never accept hospitality from someone you might later need to read -- the debt complicates both.
...
\begin{itemize}
    ...
    \item \textbf{Be generous with complications.} Hybrids are magnets for interesting trouble. A Patron might resent the character's other powers. A Promise Timer might tick when they use telepathy without consent. A summoned spirit might be jealous of a Cantor's audience.
    ...
    \item \textbf{Offer hybrid-specific story hooks.} The Grey Wanderer encountered a Psion whose mind had been colonized by a Carrion-King. A Cantor whose voice awakened a dormant spirit. A Summoner who became a Witch's Hollowed. These are campaign seeds, not just builds.
\end{itemize}

\section*{A Final Word on Power}

Hybrid characters are not more powerful than single-path characters. They are more \textit{versatile}, but their versatility comes with double the resource tracking and double the consequence tracks. In a typical session, a pure Runekeeper will invoke three Rites and manage one Obligation timer. A hybrid Runekeeper/Psion will invoke two Rites, use two psionic Arts, and manage Obligation, Mental Strain, and probably a Promise Timer . The mental load is real.
...
Do not play hybrid if you want to be more powerful than everyone else. The Grey Wanderer tried that. He woke up in a ditch, owing favors to a badger.
