...
\epigraph{“Channel bold, weave true, and may the Story Beats be ever in your favour.”}{\textit{— The Gray Wanderer}}
...
\tag{Bless} & +1 & Affliction & Grant favourable tag (luck, favour, ward-key) \\
\bottomrule
\end{longtable}
...
\begin{itemize}
    ...
    \item \textbf{Cord Witches} (Daughters of the Unbroken Chain) who weave obligation into flesh and memory.
\end{itemize}
...
\subsection{The High Mother (Unbroken Chain)}
...
\begin{itemize}
    ...
    \item \textbf{Safe.} Mental Fatigue is real. Mental scars are permanent. The mind that bends reality also bears the cracks.
\end{itemize}

\textbf{Psionics is:}
\begin{itemize}
    \item \textbf{Internal.} A psion’s power is measured by Mental Fatigue, a resource that recovers with rest and discipline.
...
Mental Fatigue represents your capacity for sustained psychic exertion.

\[
\text{Mental Fatigue Capacity} = \text{Spirit}\ (\text{minimum } 2)
\]

Mark Mental Fatigue when you use psionic Arts, resist psychic intrusions, or push your mind beyond its limits. When you cannot pay a Mental Fatigue cost, choose:
\begin{itemize}
    \item Convert the unpaid point to \(+2\) regular Fatigue, or
    \item Convert the unpaid point to \(+1\) Harm (Stress).
\end{itemize}

\textbf{Overflow:} If you ever exceed your Mental Fatigue capacity, immediately suffer \(+1\) Harm (Stress) and set Mental Fatigue to your maximum (no further over-marking this scene).
...
\textbf{Key Attribute:} Spirit. \textbf{Alternate:} Wits (+1 DV for fine manipulation). \textbf{Action:} 1 action; sustain by fiction. \textbf{Range:} Near (+1 DV for Far). \textbf{Cost:} 1 Mental Fatigue to activate; sustained lifts/holds cost 1 Mental Fatigue per scene.
...
\textbf{Key Attribute:} Wits. \textbf{Alternate:} Spirit (+1 DV, trance method). \textbf{Action:} 1 action; ritual scry may take a scene. \textbf{Range:} Scene/locale by fiction; +1 DV per range band beyond Near. \textbf{Cost:} DV 2–3 = 1 Mental Fatigue; DV 4 = 2; DV 5+ = 3.
...
\textbf{Perks:} Convert 1 Harm ↔ 1 Mental Fatigue (up to Psionics, max 3/day). Brief physical enhancement (+1 die).

\subsection{Astral Projection}
\textbf{Key Attribute:} Spirit. \textbf{Alternate:} Wits (+1 DV, skim tether). \textbf{Action:} 1 action to slip; travel by fiction. \textbf{Cost:} 1 Mental Fatigue per scene. \textbf{SB:} +1 per band beyond Near; +1 per additional scene sustained.
...
\textbf{Key Attribute:} Spirit. \textbf{Alternate:} Wits (+1 DV, needle‑strike). \textbf{Action:} 1 action. \textbf{Cost:} DV 2–3 = 1 Mental Fatigue; DV 4 = 2; DV 5+ = 3. \textbf{SB:} always +1, plus DV 4–5 additional.
...
\textbf{Key Attribute:} Spirit. \textbf{Alternate:} Wits (+1 DV, tactical glimpse). \textbf{Action:} 1 action; deeper visions may take a scene. \textbf{Cost:} DV 2–3 = 1 Mental Fatigue; DV 4 = 2; DV 5+ = 3. \textbf{SB (inherent):} Minor +1; Major (DV 4) +2; Detailed (DV 5+) +3.
...
\begin{itemize}
    \item Activation: 1 Mental Fatigue
    \item Maintenance: 1 Mental Fatigue per scene / Significant Time
...
\begin{itemize}
    ...
    \item \textbf{Psychic Reservoir (4 XP):} Increase Mental Fatigue track by +2; recover 1 additional Mental Fatigue during rest.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Mind Walker (8 XP):} Astral Projection requires no concentration; move at normal speed in astral form; reduce projection cost to \(1/2\) Mental Fatigue (round up).
    \item \textbf{Psychic Vampire (8 XP):} When dealing psychic Harm, heal 1 Mental Fatigue; once per scene, drain 1 Mental Fatigue from target (requires successful Psychic Assault).
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Mind Over Body (12 XP):} Mental Fatigue track becomes Spirit + Wits (min 6, cap 12). When you would suffer Mental Fatigue overflow, convert each overflow point into +1 Fatigue instead.
...
\begin{itemize}
    \item \textbf{The Whispering Vaults (Aeler Holds):} Amplify Mental Fatigue by 2 segments but grant +1 Effect to telepathy.
...
\begin{itemize}
    ...
    \item \textbf{Cost:} What you pay each time you use it (Obligation, Mental Fatigue, Leash ticks, etc.).
...
Psion & Internal & Mental Fatigue & Med–High & High & High & Resource managers \\
\bottomrule
\end{longtable}
\normalsize
...
Psion & Your own mind & Mental Fatigue → overflow = Harm \\
\bottomrule
\end{longtable}
\normalsize
...
Psion & Mental Fatigue overflow → Harm & Mental scars, contamination \\
\bottomrule
\end{longtable}
\normalsize
...
\begin{enumerate}
    ...
    \item \textbf{Separate Tracks.} You track Obligation (Runekeeper/Invoker), Corruption (Cantor), Leash (Summoner), Promise Clocks (Witch), Mental Fatigue (Psion), and regular Fatigue separately. They do not merge.
...
Corruption (1 seg) & Mental Fatigue (1) & 1:1 & Cannot exceed cap \\
Mental Fatigue (2) & Corruption (1 seg) & 2:1 & Burnout taints soul \\
Leash (2 ticks) & Fatigue (1) & 2:1 & Spirit drains you \\
Promise Clock (1 seg) & Obligation (1 seg) & 1:1 & Hag bargain \\
Backlash (1 SB) & Mental Fatigue (1) & 1:1 & Crossfeed, unstable \\
\bottomrule
\end{longtable}
\normalsize
...
\textbf{Effect:} When you summon a spirit, you may choose to bind it using Mental Fatigue instead of a Leash. The spirit’s Cap becomes your Psionics rating (min 1, max 3), and its Leash capacity is \texttt{Mental Fatigue capacity + Spirit}. Instead of ticking Leash, the spirit ticks your Mental Fatigue when it acts against its nature, takes harm, or crosses a ward. If Mental Fatigue overflows, the spirit immediately assumes control of your body for one exchange (GM narrates) before departing.

\textbf{Downside:} You cannot use any psionic Art while a spirit is bound – your mind is too crowded. The exception is Mind Shield, which you may use at +1 Mental Fatigue cost to keep the spirit from influencing your thoughts.
...
\textbf{Effect:} When you use Telepathy or Empathic Manipulation, you may add your Performance skill to the roll (instead of or in addition to, max +3 dice). You also may use your Corruption Clock as a \textbf{psychic battery}: once per session, you may advance your Corruption Clock by 1 segment to immediately recover 2 Mental Fatigue.
...
\textbf{Effect:} You may use your Mental Fatigue track as a substitute for \textbf{Soft Witness} (Witch talent). When you use Telepathy on a target who has accepted hospitality from you (a cup of tea, a night’s shelter), the target’s resistance DV is reduced by 1. Additionally, you may convert a Promise Clock segment into 1 Mental Fatigue recovery once per session (as a free action, but must be narrated as a small act of contrition).

\textbf{Downside:} Whenever you suffer Mental Fatigue overflow, tick a Promise Clock [4] (the universe notices you are a loose thread). This Promise Clock cannot be cleared except by a full downtime scene of meditation and apology.
...
Playstyle: Use Clairvoyance to scout ahead and find hidden thresholds. Use Witch rites to bind promises and bless hearths. Convert Promise Clock segments into Mental Fatigue to keep scrying. Never accept hospitality from someone you might later need to read – the debt complicates both.
...
\begin{itemize}
    ...
    \item \textbf{Watch the conversion economy.} If a player finds a conversion rate that feels broken (e.g., converting free Backlash SB into cheap Mental Fatigue), veto it. The rates above are playtested but not perfect. Trust your gut.
