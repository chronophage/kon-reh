...
\textbf{Sample Encounter:}
A Redcap has been hired to sabotage the PCs' mission in the Valewood. The GM can spend their CP to:
\begin{itemize}
\item 1 CP: Illusion makes PCs attack each other
\item 2 CP: Redcap exploits a previously made promise
\item 3 CP: More redcaps join the fight (they travel in murderous gangs)
\item 4+ CP: Ancient geas forces PCs to act against their interests
\end{itemit
...
\hline
\textbf{Level} & \textbf{Typical Harm} & \textbf{CP Generation} \\
\hline
Minor & Harm - or = & 1 CP per significant action \\
\hline
Moderate & Harm = or > & 1-2 CP per action \\
\hline
Major & Harm > or >> & 2-3 CP per action \\
\hline
Epic & Harm >> or † & 3-4+ CP per action \\
\hline
\end{tabularx}
\end{center}
