...
\item 4+ SB: Elder calls upon mountain's will (area hazard timer advances)
\end{itemize}
...
\item Blocked exits: Escape timer advances +1
\item Dust cloud: -1 die to all ranged attacks
\end{itemize}

\textbf{Fire Hazards:}
\begin{itemize}
\item Spreading flames: Area hazard timer (6 segments)
...
\item \textbf{Pacing}: Vary action and dialog
\end{itemize}
