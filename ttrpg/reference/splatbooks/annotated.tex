...
\player{GM} As the standoff continues, you notice something odd. The monastery letter in Kestra's hand is\dots glowing faintly. Strange symbols are appearing on the parchment.
...
\item Travel timer advancement based on resolution quality
\end{itemize}
