...
\subsection*{GM Framing}
\begin{quote}
``As you approach the bridge, you notice makeshift camps in the gorge below - dozens of frightened families. One desperate mother whispers that something terrible happened in Silkstrand - people disappearing, strange echoes\dots''
\end{quote}
...
\begin{itemize}
\item ``My son walked the same path yesterday\dots now he only speaks in riddles''
...
\item \textbf{Investigate}: ``You realize this curse is just one of many\dots someone needs to stop them all''
