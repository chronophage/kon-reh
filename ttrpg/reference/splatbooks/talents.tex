...
\vspace{0.5cm}
{łarge New Abilities for Character Advancement}
\end{center}
...
Once per battle, grant +1 to defense DV for all allies within close range for one scene.
\end{talentbox}
...
Gain +1 die on all rolls in dwarven holds; breath−measure allotments extended by ▒.
\end{talentbox}
...
Create items of exceptional quality; gain +2 dice on all crafting rolls and reduce material costs by ░.
\end{talentbox}
...
Build and repair vessels with exceptional quality; reduce construction time by ░.
\end{talentbox}
...
Create leather goods of superior quality and durability; reduce material waste by ▒.
\end{talentbox}
...
Perform complex medical procedures with exceptional skill; reduce surgery time by ▒.
\end{talentbox}
