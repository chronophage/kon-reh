...
\begin{itemize}
    \item Position shift (Controlled $\rightarrow$ Desperate)
...
\begin{itemize}
    ...
    \item Campaign timer advancement
\end{itemize} \\
\hline
3:00-3:30 & Session wrap-up & 
\begin{itemize}
    \item Award XP for session
    \item Update campaign timers
...
\begin{enumerate}
    \item Review active campaign timers and planned advancements
...
\begin{enumerate}
    ...
    \item Update campaign timers based on character actions
