...
\item \textbf{Scene Timers}: What ongoing pressures drive tension?
...
\item Scene timers with clear advancement triggers
...
\item Timer Advancement Opportunities
...
\item $\square$ Create scene timers with clear advancement triggers
...
\textbf{During Play}:
\begin{itemize}[leftmargin=*]
\item $\square$ Announce timers clearly and update them visibly
\item $\square$ Connect player actions to timer advancement logically
\item $\square$ Offer meaningful choices that affect multiple outcomes
\item $\square$ Let timers fill when fictionally appropriate
