...
\begin{enumerate}
    ...
    \item Set timer size by highest rank
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Set travel timer by highest rank
...
\begin{itemize}
    ...
    \item Wild: Hidden force (Face = patron, Ace = site becomes 10-timer)
\end{itemize}
...
\begin{itemize}
    ...
    \item Maintain campaign timers to ensure long-term consequences
\end{itemize}
\end{framed}
...
\begin{itemize}
    \item Choosing Controlled over Controlled positions
