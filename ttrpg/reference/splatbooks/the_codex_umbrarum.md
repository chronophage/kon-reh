...
*   **Clearing Segments:** To represent the ongoing relationship and the cost of power, each known Rite has a "Patron Obligation Timer " (4-6 segments). Segments fill with (SB) generated by using the Rite. Spending a Boon can clear one segment (representing devotion/propitiation). If the timer fills, the Patron's attention turns problematic.
...
*   **Patron Obligation Timer :** 4-6 segments. Fills with (SB) generated by using the Rite.
*   **Clearing:** Spending 1 Boon clears 1 segment *during play*. Downtime Upkeep (via Codex) clears 1 segment.
*   **Patron Attention:** If the timer fills, the GM introduces a significant complication related to the Patron (e.g., direct intervention, a Geasa, a rival cult's notice, a personal price demanded).
...
*   **Rite: "Veil of the Unseen Observer" (Cost: 7 XP)**
    ...
    *   **Patron Obligation Timer :** 5 Segments. (SB) generated by using this Rite often relate to "Exposure" (being noticed while observing) or "Hearts" (the burden of knowing).
    *   **Patron Attention:** The Witness demands discretion. If the timer fills, you become a known observer, attracting those who wish secrets kept, or the truth you sought becomes a dangerous burden.
**Low-Power Rite:** "Eyes in the Shadow" (Cost: 6 XP)
    ...
    *   **Patron Obligation Timer :** 4 Segments. (SB) relate to "Exposure" (being noticed while observing) or "Hearts" (psychological strain).
...
**High-Stakes Rite:** "Gaze of Absolute Truth" (Cost: 12 XP)
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) relate to "Exposure" (becoming a known observer) or "Hearts" (the burden of knowing dangerous truths).
...
*   **Rite: "Thread the Loom of Chance" (Cost: 9 XP)**
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) often relate to "Diamonds" (magical/spiritual disturbance, reality "noticing" the tweak) or "Clubs" (the "cost" of bending probability manifests elsewhere).
    *   **Patron Attention:** The Geometry abhors chaos. If the timer fills, reality might "correct" your manipulations in an inconvenient way, or you attract the attention of entities who police the fundamental laws.
*   **Low-Power Rite: "Find the Pattern" (Cost: 7 XP)**
    ...
    *   **Patron Obligation Timer :** 4 Segments. (SB) relate to "Diamonds" (magical/spiritual disturbance) or "Clubs" (minor resource consumption).
...
*   **High-Stakes Rite: "Rewrite the Fundamental Equation" (Cost: 13 XP)**
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) relate to "Diamonds" (reality noticing the tweak) or "Clubs" (the cost of bending fundamental laws manifests elsewhere).
...
*   **Rite: "Draw from the Umbral Reservoir" (Cost: 8 XP)**
    ...
    *   **Patron Obligation Timer :** 4 Segments. (SB) often relate to "Spades" (direct harm from shadow stuff, exhaustion) or "Hearts" (psychological strain from the depths).
    *   **Patron Attention:** Ikasha's gifts come from the depths. A full timer might mean she starts to wake within you, demanding more shadow, secrecy, or a significant personal sacrifice to remain dormant.
*   **Low-Power Rite: "Touch the Umbral Veil" (Cost: 6 XP)**
    ...
    *   **Patron Obligation Timer :** 4 Segments. (SB) relate to "Spades" (minor harm from shadow stuff) or "Hearts" (psychological strain).
...
*   **High-Stakes Rite: "Become the Shadow Itself" (Cost: 12 XP)**
    ...
    *   **Patron Obligation Timer :** 5 Segments. (SB) relate to "Spades" (direct harm from shadow stuff, exhaustion) or "Hearts" (psychological disassociation from physical self).
...
*   **Rite: "Command the Grasp of the Abyss" (Cost: 10 XP)**
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) often relate to "Spades" (harm, collateral damage) or "Clubs" (resources consumed by the effort).
    *   **Patron Attention:** Khemesh's power is hungry and destructive. A full timer might mean he begins to manifest physically, demanding sacrifices or dragging the Warlock (or someone close) partially into his realm.
*   **Low-Power Rite: "Grasp of the Minor Depth" (Cost: 7 XP)**
    ...
    *   **Effect (Invoke - Boon):** Add +1 effect to one physical action involving pulling, dragging, or applying pressure. Alternatively, force one opponent to generate (SB) on a successful attack roll against you (their choice of suit).
    *   **Patron Obligation Timer :** 5 Segments. (SB) relate to "Spades" (minor harm, collateral damage) or "Clubs" (resources consumed).
...
*   **High-Stakes Rite: "Command the Abyssal Maw" (Cost: 13 XP)**
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) relate to "Spades" (severe harm, massive collateral damage) or "Clubs" (significant resources consumed by the effort).
...
*   **Rite: "Ride the Tides of Fate" (Cost: 8 XP)**
    ...
    *   **Patron Obligation Timer :** 5 Segments. (SB) often relate to "Diamonds" (magical disturbance, the sea's indifference) or "Clubs" (the "cost" of the tide turning elsewhere).
    *   **Patron Attention:** Raéyn's gifts are fickle. A full timer might mean the tides turn against you in a major way, or the Warlock is compelled to undertake a dangerous journey by sea.
*   **Low-Power Rite: "Read the Gentle Current" (Cost: 6 XP)**
    ...
    *   **Patron Obligation Timer :** 4 Segments. (SB) relate to "Diamonds" (magical disturbance) or "Clubs" (minor resource cost).
...
**6. The Timer work Demon (Archetypal Force of Forbidden Technology & Entropy)**
...
*   **Rite: "Wind the Gears of the Proscribed" (Cost: 9 XP)**
    ...
    *   **Patron Obligation Timer :** 5 Segments. (SB) often relate to "Clubs" (resources consumed, device breaking down later) or "Spades" (harm from unstable/forbidden tech) or "Diamonds" (attracting the notice of those who guard such knowledge).
    *   **Patron Attention:** The Demon's gifts erode the boundary between tool and trap. A full timer might mean a significant piece of technology the Warlock relies on becomes cursed, sentient, or starts to merge with their flesh, or agents of the "proper order" come to confiscate or destroy the Warlock's work.
*   **Low-Power Rite: "Whisper to the Gears" (Cost: 7 XP)**
    ...
    *   **Patron Obligation Timer :** 4 Segments. (SB) relate to "Clubs" (resources consumed) or "Spades" (minor harm from unstable tech).
...
*   **High-Stakes Rite: "Wind the Engine of Forbidden Knowledge" (Cost: 13 XP)**
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) relate to "Clubs" (significant resources consumed, device breaking down spectacularly later) or "Spades" (severe harm from unstable/forbidden tech) or "Diamonds" (attracting the notice of those who guard such knowledge with extreme prejudice).
...
*   **Rite: "Shed the Skin of the Former Self" (Cost: 8 XP)**
    ...
    *   **Patron Obligation Timer :** 4 Segments. (SB) often relate to "Hearts" (psychological dissonance from change, loss of identity) or "Spades" (physical stress or backlash from transformation).
    *   **Patron Attention:** Isoka's gifts demand a price. A full timer might mean the Warlock must undergo a significant, painful, or identity-altering transformation (losing a Skill, gaining a permanent physical Condition) or face a crisis where their old identity returns to haunt them.
*   **Low-Power Rite: "Loosen the Old Skin" (Cost: 6 XP)**
    ...
    *   **Patron Obligation Timer :** 3 Segments. (SB) relate to "Hearts" (psychological dissonance) or "Spades" (physical stress).
...
*   **High-Stakes Rite: "Complete Metamorphosis" (Cost: 12 XP)**
    ...
    *   **Patron Obligation Timer :** 5 Segments. (SB) relate to "Hearts" (severe psychological dissonance, loss of identity) or "Spades" (physical stress or backlash from transformation).
...
*   **Rite: "Weave the Strand of Inevitability" (Cost: 10 XP)**
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) often relate to "Hearts" (manipulation backlash, targets becoming aware) or "Diamonds" (fate noticing the weave and demanding balance).
    *   **Patron Attention:** Inaea's webs are intricate and binding for all involved. A full timer might mean the Warlock becomes trapped in their own web of fate, or an enemy learns to use the same power against them, or a significant "knot" in the Warlock's own fate tightens, demanding resolution.
*   **Low-Power Rite: "Tie a Simple Knot" (Cost: 7 XP)**
    ...
    *   **Patron Obligation Timer :** 5 Segments. (SB) relate to "Hearts" (minor manipulation backlash) or "Diamonds" (fate noticing the weave).
...
*   **High-Stakes Rite: "Weave the Tapestry of Inevitability" (Cost: 13 XP)**
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) relate to "Hearts" (manipulation backlash, targets becoming powerfully aware) or "Diamonds" (fate noticing the weave and demanding significant balance).
...
*   **Rite: "Kindle the Ember of Annihilation" (Cost: 9 XP)**
    ...
    *   **Patron Obligation Timer :** 5 Segments. (SB) often relate to "Spades" (harm to the Warlock from the intensity) or "Clubs" (resources consumed by the fire, unintended damage).
    *   **Patron Attention:** Mor'iraath's hunger is never sated. A full timer might mean the fire turns on the Warlock or their allies, or the Demon demands a larger, more significant sacrifice, or the Warlock gains a permanent "Burning" Condition that flares up under stress.
*   **Low-Power Rite: "Spark of the Inner Flame" (Cost: 7 XP)**
    ...
    *   **Patron Obligation Timer :** 4 Segments. (SB) relate to "Spades" (minor harm from the intensity) or "Clubs" (resources consumed).
...
*   **High-Stakes Rite: "Unleash the Ember of Total Annihilation" (Cost: 13 XP)**
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) relate to "Spades" (severe harm to the Warlock from the intensity) or "Clubs" (massive resources consumed by the fire, unintended catastrophic damage).
...
*   **Rite: "Proclaim the Edict of the Justiciar" (Cost: 8 XP)**
    ...
    *   **Patron Obligation Timer :** 4 Segments. (SB) often relate to "Hearts" (resentment, accusations of hypocrisy) or "Clubs" (bureaucratic entanglements, the law's demand for equal application).
    *   **Patron Attention:** Mykkiel's power is absolute but demands absolute adherence. A full timer might mean the Warlock is called upon to judge a difficult case where the "just" outcome is terrible, or they are targeted by those who hate the law they represent, or they must undergo a trial themselves to prove their worthiness.
*   **Low-Power Rite: "Invoke the Letter of the Law" (Cost: 6 XP)**
    ...
    *   **Patron Obligation Timer :** 3 Segments. (SB) relate to "Hearts" (resentment, accusations of hypocrisy) or "Clubs" (minor bureaucratic entanglements).
...
*   **High-Stakes Rite: "Declare the Judgement of the Justiciar" (Cost: 12 XP)**
    ...
    *   **Patron Obligation Timer :** 5 Segments. (SB) relate to "Hearts" (significant resentment, accusations of tyranny or hypocrisy) or "Clubs" (major bureaucratic entanglements, the law's demand for equal application even when inconvenient).
...
*   **Rite: "Command the Restless Dead" (Cost: 9 XP)**
    ...
    *   **Patron Obligation Timer :** 5 Segments. (SB) often relate to "Spades" (harm, contagion, attracting undead attention) or "Hearts" (horror, desensitization, callousness).
    *   **Patron Attention:** Varn Karak's dominion expands. A full timer might mean the Warlock begins to emit a aura of death and decay (plants wither, food spoils), they attract the attention of a major undead entity who sees them as a rival or tool, or they must undergo a ritual that makes them partially undead (gaining benefits but also vulnerabilities).
*   **Low-Power Rite: "Whisper to Restless Spirits" (Cost: 6 XP)**
    ...
    *   **Patron Obligation Timer :** 3 Segments. (SB) relate to "Spades" (minor harm, attracting minor undead attention) or "Hearts" (psychological strain, feeling death's presence).
...
*   **High-Stakes Rite: "Awaken the Army of Bones" (Cost: 13 XP)**
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) relate to "Spades" (severe harm, attracting major undead attention, contagion) or "Hearts" (severe horror, complete desensitization, callousness to life).
...
*   **Rite: "Bargain Beneath the Hawthorn" (Cost: 8 XP)**
    ...
    *   **Patron Obligation Timer :** 5 Segments. (SB) often relate to "Hearts" (betrayed trust, strained relationships, fae attention) or "Diamonds" (magical entanglements, literal interpretations of bargains).
    *   **Patron Attention:** Mab's gifts come with knots. A full timer might mean a previous bargain comes due in an inconvenient way, the Warlock finds themselves magically bound to serve a fae noble's whim, or their words begin carrying unintended magical weight (sarcasm becomes geas).
*   **Low-Power Rite: "Fae Fortune's Favor" (Cost: 6 XP)**
    ...
    *   **Patron Obligation Timer :** 3 Segments. (SB) relate to "Hearts" (minor social complications, attracting fae attention) or "Diamonds" (magical entanglements).
...
*   **High-Stakes Rite: "Courtship with the Thorned Queen" (Cost: 12 XP)**
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) relate to "Hearts" (major relationship complications, attracting powerful fae attention, becoming a figure of fae politics) or "Diamonds" (powerful magical entanglements, literal interpretations of actions).
...
*   **Rite: "Drink from the Dreaming Deep" (Cost: 10 XP)**
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) often relate to "Hearts" (psychological strain, alien dreams, madness) or "Diamonds" (reality instability, attracting the attention of other ancient entities).
    *   **Patron Attention:** Nidhoggr's dreams reshape reality. A full timer might mean the Warlock begins experiencing prophetic but disturbing visions, reality in their vicinity becomes unstable (spatial distortions, temporal echoes), or they inadvertently awaken a fragment of the World-Worm's consciousness.
*   **Low-Power Rite: "Glimpse the Ancient's Shadow" (Cost: 7 XP)**
    ...
    *   **Patron Obligation Timer :** 4 Segments. (SB) relate to "Hearts" (minor psychological strain, alien thoughts) or "Diamonds" (minor reality instability).
...
*   **High-Stakes Rite: "Dive into the World-Worm's Dreaming" (Cost: 14 XP)**
    ...
    *   **Patron Obligation Timer :** 7 Segments. (SB) relate to "Hearts" (severe psychological trauma, madness, alien possession) or "Diamonds" (major reality instability, attracting the attention of other ancient entities with extreme prejudice).
...
*   **Rite: "Step Sideways" (Cost: 10 XP)**
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) often relate to "Diamonds" (reality distortion, attracting otherworldly attention) or "Clubs" (planar instability, resources becoming "phase-shifted").
    *   **Patron Attention:** The Outsider's realm bleeds through. A full timer might mean a permanent spatial distortion appears near the Warlock (things are bigger on the inside, gravity shifts), they begin to partially exist in two places at once (causing confusion and vulnerability), or a planar entity manifests permanently in their vicinity, demanding tribute or service.
*   **Low-Power Rite: "Peek Through the Veil" (Cost: 7 XP)**
    ...
    *   **Patron Obligation Timer :** 4 Segments. (SB) relate to "Diamonds" (minor reality distortion) or "Clubs" (minor planar instability).
...
*   **High-Stakes Rite: "Tear the Fabric of Reality" (Cost: 14 XP)**
    ...
    *   **Patron Obligation Timer :** 7 Segments. (SB) relate to "Diamonds" (severe reality distortion, attracting powerful otherworldly attention) or "Clubs" (major planar instability, resources becoming permanently phase-shifted).
...
*   **Rite: "Seal with Infernal Ink" (Cost: 9 XP)**
    ...
    *   **Patron Obligation Timer :** 5 Segments. (SB) often relate to "Clubs" (resources owed, accumulating debt) or "Hearts" (moral compromise, attracting the attention of other infernal entities or righteous hunters).
    *   **Patron Attention:** Maelstreus calls in his due. A full timer might mean a previously signed contract's "fine print" becomes active, the Warlock finds themselves pursued by infernal bounty hunters or righteous inquisitors, or they must perform a significant service for the Red Prince that advances his long-term schemes.
*   **Low-Power Rite: "Whisper of the Red Court" (Cost: 6 XP)**
    ...
    *   **Patron Obligation Timer :** 3 Segments. (SB) relate to "Clubs" (minor resources owed) or "Hearts" (minor moral compromise).
...
*   **High-Stakes Rite: "Summon the Red Prince's Contract" (Cost: 13 XP)**
    ...
    *   **Patron Obligation Timer :** 6 Segments. (SB) relate to "Clubs" (massive resources owed, accumulating infernal debt) or "Hearts" (severe moral compromise, attracting the attention of other infernal entities or righteous hunters with extreme prejudice).
