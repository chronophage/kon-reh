...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Shield} (4 XP, 3 days): +1 to defense DV against melee attacks. Can be used offensively for shove actions.
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Swift Mare} (12 XP, 2 weeks): A spirited horse that moves with uncanny speed. When traveling overland, reduces travel timer segments by 1 (minimum 4). Does not require upkeep.
\end{itemize}
