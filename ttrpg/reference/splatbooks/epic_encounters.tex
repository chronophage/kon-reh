...
\item Advance the Awakening Timer 
\end{itemize}
...
\begin{description}[leftmargin=*]
\item[Blood Tribute] Sacrifice a major fleet, coastal city, or Tier V hero. Immediate but temporary solution (Awakening Timer -4, then +1 per week).
...
\item[Consequences] Even ``defeating'' Khemesh advances timers due to the cosmic disruption
\end{description}
...
\item[Appearance] A tall, gaunt figure in tattered gray robes, carrying a staff that glows with soft light. Face obscured by a hood, but eyes shine like distant stars.
...
\item[Consequences] Combat itself disrupts the cycle, advancing timers
\end{description}
...
\textbf{Advancement Triggers}:
\begin{itemize}[leftmargin=*]
\item Army Strength Timer advances: +1 segment
...
\end{itemize}
\item[Consequences] Even ``victory'' advances timers due to further disruption of the dead
\end{description}
...
\end{itemize}
\item[Consequences] Combat itself creates temporal paradoxes, advancing all timers
\end{description}
...
\item $\square$ Design 3-4 interconnected timers with clear triggers
...
\item \textbf{Timers}: Awakening (10), Tidal Chaos (8)
...
\item \textbf{Timers}: Cycle Disruption (8), Shepherd's Attention (6)
...
\item \textbf{Timers}: Army Strength (10), Memory Corruption (6), Boundary Expansion (8)
...
\item \textbf{Timers}: Empire's Awakening (12), Reality Unraveling (10), Personal Integration (8)
...
\begin{itemize}[leftmargin=*]
\item Multiple timers advance simultaneously from single actions
\item Timers have 8+ segments and fill slowly but relentlessly
\item Filled timers create world-changing consequences, not just scene changes
\item Timers may trigger other timers to advance
\end{itemize}
