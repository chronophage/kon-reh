...
7. \textbf{Clock Integration}: Use multiple interconnected timers to show different aspects of the threat growing.
...
\item Clocks may trigger other timers to advance
\end{itemize}
