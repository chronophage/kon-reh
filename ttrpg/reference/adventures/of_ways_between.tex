...
\item \textbf{Sanctified Salt:} Can be used to create protective circles or barriers. One use per session to prevent Dread Clock advancement or gain start Dominant vs. supernatural threats. The salt burns with cold fire when the entity is near.
...
\item \textbf{Existential Threat Clock (15):} Cosmic entity manifestation. Triggers: Other timers filling, communication attempts.
\end{itemize}
