...
\item \textbf{Steal from Malachai's chains:} A direct confrontation with the Chained Angel (she cannot move, but she can curse). Each PC must test Spirit + Resolve vs DV 5 or gain a Curse Timer segment. Success allows one PC to chip a fragment of dried ichor from her binding.
\end{itemize}
