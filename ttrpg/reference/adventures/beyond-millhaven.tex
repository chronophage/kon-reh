...
\item \textit{The Hollow's Breath} (Club, if Hollow Attention timer advanced in previous adventure): A grey fog rolls in. The milestones seem to shift. A character who rolls a 1 on any navigation test hears their own name whispered from the wrong direction. The GM gains 2 SB.
\end{itemize}
