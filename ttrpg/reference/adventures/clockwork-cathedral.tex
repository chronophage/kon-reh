...
\pagestyle{fancy}
\fancyhf{}
\rhead{The Timer work Cathedral}
\lhead{Fate's Edge Adventure}
\rfoot{\thepage}

\title{The Timer work Cathedral}
...
\begin{mechanicbox}
\textbf{Runekeeper Integration:} The adventure is designed to showcase the Runekeeper path. Only a Runekeeper of the Timer work Monad can interface with the central mechanism of the cathedral, but they must first earn the cathedral's trust through ritual.
\end{mechanicbox}

\subsection{Runekeeper of the Timer work Monad}

A Runekeeper of the Timer work Monad has special abilities related to the cathedral:
...
\textbf{Obligation:} Each time a Runekeeper uses their abilities, they mark 1 Obligation to the Timer work Monad. If they exceed their Obligation Capacity (Spirit + Presence), they immediately take 1 Fatigue.
