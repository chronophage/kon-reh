...
\pagestyle{fancy}
\fancyhf{}
\rhead{The Clock work Cathedral}
\lhead{Fate's Edge Adventure}
\rfoot{\thepage}

\title{The Clock work Cathedral}
...
\subsubsection{The Shifting Corridors Timer }
...
\subsubsection{The Heart Corruption Timer }
...
\begin{mechanicbox}
\textbf{Runekeeper Integration:} The adventure is designed to showcase the Runekeeper path. Only a Runekeeper of the Clock work Monad can interface with the central mechanism of the cathedral, but they must first earn the cathedral's trust through ritual.
\end{mechanicbox}

\subsection{Runekeeper of the Clock work Monad}

A Runekeeper of the Clock work Monad has special abilities related to the cathedral:
...
\textbf{Obligation:} Each time a Runekeeper uses their abilities, they mark 1 Obligation to the Clock work Monad. If they exceed their Obligation Capacity (Spirit + Presence), they immediately take 1 Fatigue.
