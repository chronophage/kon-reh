...
\item \textbf{The Oath-Brother.} A Ykrul mercenary (Rekedim's ancestor) offers his sword for safe passage to the steppe. He does not kneel. He waits. If accepted, gain the \textbf{Braid Token}---a future favor from the Gray Ash clan, but mark \condition{Obligation 2} to the Ykrul.
...
The party reaches a river crossing held by the Gray Ash clan. Their chieftain, Khatun Sarnai, blocks the ford. Her riders are not hostile, but they are not welcoming. They are \textit{waiting}.
...
\item \textbf{The Steppe Oath.} Swear a future alliance, sealed with horsehair. Gain passage now, but \textbf{Obligation \timer{4}} to the Gray Ash---they will call in the debt during the fourth sack (a future adventure).
\end{enumerate}
...
\textbf{Harm Track:} 2 boxes. If filled, the child is wounded but not killed; they return to the Gray Ash rather than burden the party.
\end{mechanicbox}
...
Read:
\begin{quoting}
``You build on dead ground,'' she says. ``I can ward it---for a price. The firstborn child of your line, or a memory of the empire, or a promise to be named later.'' She smiles. Her teeth are gray, but her eyes are kind. ``The soup is free. The price never is.''
\end{quoting}
...
\item[\condition{The Braid}] Marked by the Ykrul. The Gray Ash clan may call upon you once per generation; refusal costs Survival 2.
\end{description}
