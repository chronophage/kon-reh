...
\vfill
\noindent\footnotesize\textit{Running Note:} Map Position to DV plainly (Dominant=DV2, Controlled=DV3, Desperate=DV4--5+). Favor Position shifts over raw dice creep. Name costs before rolls. Keep total active clocks $\leq$~5 to avoid overload.
