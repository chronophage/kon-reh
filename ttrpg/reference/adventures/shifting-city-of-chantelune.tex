...
The adventure is structured around three major beats, each with its own timers and challenges. The city itself is alive and hostile, with a "City Mood Clock" tracking its state from Stable to Collapsing. As the mood worsens, the city's architecture becomes more dangerous and unpredictable.
