...
\subsubsection{The Shifting Source Timer }
...
\subsubsection{The Reality Breach Timer }
...
\begin{itemize}
    ...
    \item \textbf{Sealing Ritual:} Can perform a ritual to close the breach (DV 4, Controlled/Standard), reducing the Reality Breach Timer by 1.
...
\begin{itemize}
    ...
    \item Increase the size of the timers by 2 (e.g., Night Survival [8] instead of [6]).
