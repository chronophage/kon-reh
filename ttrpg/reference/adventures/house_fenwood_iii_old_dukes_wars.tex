...
{Łarge\textit{Vignettes from the Life of \braedon}}\\[2em]
{łarge\gray}\\[0.5em]
{\normalsize\textit{Set down from the deathbed ledger}}\\[2em]
\vfill
{\small Tarlington, winter of 908 AR}\\[1em]
...
\vspace{1em}
\noindent\textit{−−− The Archive of the True Masons, Tarlington chapter, winter of 908 AR}
...
≤ttrine{T}{he} old duke is dying. His left arm is dead−−−eight years cold since the Sack of Lence−−−and his breath comes in shallow tides. But his eyes are clear, and his voice, when he speaks, carries the weight of sixty−six years of ledger−keeping.
...
≤ttrine{I}{} had no land, no title, no purpose. So I ran.
...
≤ttrine{T}{he} rape of Alayse Everblood was not a secret. Branton Thornhill made it a boast. He sent the king a lock of her hair wrapped in a marriage contract. \textit{``She came willingly,''} he wrote. \textit{``Your sister is a whore, and I am her lord.''}
...
≤ttrine{E}{lianor} of Adria was a warrior queen. She had fought beside \baldvyn, borne him children, ruled the marches when the king was away at war. But \baldvyn{} grew tired. He took lovers−−−men and women both, openly, cruelly. Elianor's pride curdled into rebellion.
...
\braedon{}'s mercy created a \textbf{Debt Timer } \timer{6} for Valdais. It never filled. When Valdais wept at \baldvyn's funeral, the timer was paid in full, and the debt was erased.

This is rare. Most debts of mercy fill their timers and demand payment in the next generation.
\end{mechanicbox}
...
≤ttrine{T}{he} Vhasian king demanded homage. We had lands in Vhasia−−−old Valvano holdings, granted by the first Everbloods. We had never paid tribute. He sent tax collectors. I sent them back with their papers shredded.
...
≤ttrine{B}{aldvyn} called me to his bedside. He was wasted, yellowed, his breath sour with the canker that had eaten his stomach. The physicians had bled him white. Nothing helped.
...
≤ttrine{M}{yrmis} worshippers rose in the mountains. They killed lords, burned synods, declared a holy war against the Unity of Light. Wyllmot marched to storm their citadel−−−Eryas, a fortress carved into a cliff.
...
≤ttrine{B}{aldvyn} Brightstride was young, handsome, beloved. He had the charm of his father and the restraint of his grandmother. He had been married three months−−−to my granddaughter, Jaennis, a waif of a girl with chestnut hair and silent eyes.
...
\begin{mechanicbox}{The Succession Crisis Timers}
As \braedon{} dies, the following timers begin:

\textbf{Valdais's Claim \timer{6}}: Advances when his legitimacy is discussed. When full, he marches on the capital.

\textbf{Veralyn's Coronation \timer{4}}: Advances when her claim is supported. When full, she is crowned−−−but the realm is divided.

\textbf{The Poison Investigation \timer{8}}: Advances when clues are found. When full, the killer is revealed (Jaennis, Alaysha, or Vhasian agents−−−GM's choice).
\end{mechanicbox}
...
≤ttrine{T}{he} fire is ash. \braedon{} lies still. His chest rises once, twice−−−then stops.
...
ℹtem \condition{The Dead Arm}: −−1 die to two−handed Body rolls; +1 die to patience−based Insight rolls.
ℹtem \condition{The Oath of the Yloka}: Once per campaign, +2 dice to save an Everblood; Obligation 2 to Grey Ash.
ℹtem \condition{The Spared Thornhill}: Logan Thornhill's descendants (if any survived Coldmorrow) have a String on you.
\end{itemize}
...
≤ttrine{T}{his} book was written in the solar at Tarlington, on paper that had once been a grain manifest. The ink is lamp−black cut with the ash of a burned confession. The binding is horsehair, tied with nine knots.
