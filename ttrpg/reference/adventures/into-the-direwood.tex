...
\begin{itemize}
  ...
  \item \textbf{A Bargain:} A ghostly figure visits a character in a dream:  
        \emph{``Find my name, free me\dots or drown with me.''}
\end{itemize}
...
\begin{itemize}
  ...
  \item If spoken prematurely, increase the \textbf{Dread Timer } by +1 and attract a spectral assault.
...
\begin{itemize}
  ...
  \item \textbf{Reflected Self:} mirrors show PCs as future undead --- risk Mental Strain on failed Resolve.
\end{itemize}
...
\begin{itemize}
    \item Increase environmental pressure (Dread Timer ticks)
...
\textbf{Assets:} 
\begin{itemize}
    \item Minor: Engineering Kit (surveyor's tools, measuring chains)
    \item Follower: Gunnvor Ironwright (Cap 2 Siege Specialist)
\end{itemize}
...
\textbf{Assets:}
\begin{itemize}
    \item Minor: Bell-Pouch (ceremonial handbells)
    \item Follower: Bramble Thornwick (Cap 3 Wilderness Guide)
\end{itemize}
...
\textbf{Assets:}
\begin{itemize}
    \item Minor: Hidden Cargo Compartment
    \item Standard: Smuggling Vessel ``Night's Passage''
    \item Follower: Finn the Knife (Cap 3 Deckhand/Scout)
\end{itemize}
...
\textbf{Talents:} Berserker Rage (6 XP), Weapon Mastery (4 XP), Cold Weather Survival (3 XP), Naval Tactics (4 XP) \\
\textbf{Patron:} Thrysos (King of Revels) \\
\textbf{Familiar:} Frostfang (Wolf Companion) \\
\textbf{Codex:} Saga of the Whale-Road \\
\textbf{Assets:}
\begin{itemize}
    \item Minor: Dragon Boat ``Stormbreaker''
    \item Standard: Trading Post in Linnstad
    \item Follower: Sigrun Ironscale (Cap 3 Warrior-Trader)
\end{itemize}
...
\textbf{Assets:}
\begin{itemize}
    \item Minor: Hunter's Bow ``Whisperleaf''
    \item Follower: Moss (Cap 2 Forest Guide/Healer)
\end{itemize}
...
\textbf{Background:} Academic of the Dialogs \\
...
\textbf{Assets:}
\begin{itemize}
    \item Minor: Workshop with Precision Tools
    \item Standard: Calculating Engine (Minor Artifact)
    \item Follower: Tink (Cap 2 Apprentice/Assistant)
\end{itemize}
...
\textbf{Assets:}
\begin{itemize}
    \item Minor: Herb Garden and Apothecary Kit
    \item Follower: Pip Willowfoot (Cap 2 Gatherer/Apprentice)
\end{itemize}
