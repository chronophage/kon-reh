...
\begin{tcolorbox}[title=\textbf{Player-Facing Summary},colback=blue!5!white,colframe=blue!60!black,breakable]
...
\begin{tcolorbox}[title=\textbf{Light Mechanic: Memory Pressure},colback=purple!5!white,colframe=purple!60!black,breakable]
...
\begin{itemize}[leftmargin=*]
  ...
  \item a tense moment when an old enemy of a PC fails to recognize them.
\end{itemize}
...
\begin{tcolorbox}[title=\textbf{Siege Pressure Effects},colback=red!5!white,colframe=red!70!black,breakable]
...
\begin{tcolorbox}[title=\textbf{GM Prompt: Cost of Influence},colback=blue!5,colframe=blue!50,breakable]
...
\begin{description}
  ...
  \item[Cap 3:] spend 1 Token to \textbf{cancel a scene timer tick}.
...
colframe=purple!70!black,breakable]
...
\begin{creature}[The Wells-Worm --- Shame Devourer]
    ...
    \begin{itemize}
      ...
      \item \textbf{Trigger:} PCs reveal vulnerability $\rightarrow$ The Worm surfaces
    ...
    \begin{itemize}
      ...
      \item Shift one district toward:
        ...
        \end{description}
      \item Crusade Timers advance: ``Proof of Sin'' or ``Purging Justified''
    \end{itemize}
...
\begin{description}
  \item[Effect:] Each time the Worm surfaces publicly, the \emph{Crusader Moral Timer }
    ticks +1.
