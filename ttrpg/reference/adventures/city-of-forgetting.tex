...
The city of \Place{Heugen} stands where the \Term{Amaranthine River} meets the deserts of Galanina --- a bustling port of exiles, runaways, and those who have bargained away their shame.
...
\Place{Heugen} is:
\begin{itemize}[leftmargin=*]
  \item a \textbf{river-port} on the Amaranthine, wedged between dunes and marsh;
