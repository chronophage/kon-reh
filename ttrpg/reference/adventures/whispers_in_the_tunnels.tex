...
\item \textbf{Timer Interactions:} Dread fills → Environmental +2 | Environmental fills → Deep Drake +1 | Deep Drake fills → Dread +2 | All timers +1 when party average Dread 5+
\end{itemize}
