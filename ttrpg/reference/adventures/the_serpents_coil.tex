...
% [Previous sections remain the same until Core Mechanical Innovation]
...
% [Continue with Session-by-Session Structure, but enhance scene descriptions:]
...
\item \textbf{Clock Movement:} Momentum (varies by approach and combat success), City Corruption (2), Cult Ascendancy (1)
\end{itemize}
