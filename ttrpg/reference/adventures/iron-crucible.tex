...
All rules from the core SRD apply. Use Position/Effect for every roll. Clocks track progress and pressure. Story Beats are the GM’s tool to introduce unexpected complications. The company timers replace detailed resource tracking.
