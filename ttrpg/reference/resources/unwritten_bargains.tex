...
\begin{itemize}
    \item \textbf{Invoke:} Spend the required Boon(s) and mark +1 segment on the Rite's Obligation Timer .
    \item \textbf{Push It:} Use the Rite's alternative, more potent clause. This always marks an \textbf{additional +1 segment}.
    \item \textbf{Backlash:} If a roll aided by a Rite results in a Miss or a Success with a Cost, mark +1 segment on its Timer .
