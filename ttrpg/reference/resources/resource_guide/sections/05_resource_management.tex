...
Library & Fund copying; buy indices. & Catalog a shelf; cross-ref a case; bind a damaged tome. \\
...
\begin{description}
    ...
    \item[\textbf{Patron Favor Swap}] Spend a \textbf{Boon} to treat missed upkeep as paid for one follower / asset if the scene honors the Patron.
\end{description}
...
\begin{tcolorbox}[title={Upkeep Quick Reference},colback=gray!5,colframe=black,breakable]
...
Tie scenes to your Patron for flavor, not discounts.
\end{tcolorbox}
...
Major Asset & 12 XP (city license, regional network, major institution influence) \\
...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!70!black,title=Quick Reference,breakable]
...
8 & Upgrade Asset (Minor $\rightarrow$ Standard) \\
