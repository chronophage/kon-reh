...
\begin{center}
    ...
    \begin{quote}
        \itshape ``The road remembers. Every broken wheel leaves a mark, every lit lamp bears witness. The only question is: what are you willing to owe?''
...
\begin{itemize}
    ...
    \item \textbf{3+ tens:} Legendary---decisive victory; clear 1 segment from a relevant timer.
\end{itemize}
...
Lame King's Claimants & Oren ``Tin Crown'' & Be recognized as true sovereign \\
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Close:} Touching distance
...
\begin{enumerate}[leftmargin=*]
    \item \textbf{Lines \& Veils} -- Off-limits or implied content?
    \item \textbf{Tone} -- Action, survival, intrigue, or horror?
    \item \textbf{Campaign length} -- One-shot, short arc, or long campaign?
    \item \textbf{Character hooks} -- Each player shares one goal and one fear.
    \item \textbf{Patron interest} -- Which Patrons are already watching?
    \item \textbf{Starting situation} -- Where does the story begin?
    \item \textbf{House rules} -- Any optional subsystems?
    \item \textbf{Scheduling \& attendance} -- Logistics for your table.
...
% BACK MATTER
%=====================================================================
\onecolumn % Switch back to single column for the epilogue
\newpage
\thispagestyle{empty}
\vspace*{2cm}
\begin{center}
