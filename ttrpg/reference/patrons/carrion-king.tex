...
\textbf{Effect:} Accelerate natural decay to weaken or destroy: \textbf{+2 Effect} to \emph{Break/Sabotage} on organic materials (ropes, leather, wood). Gain \textbf{1 Boon} if the decay creates an opportunity for you or allies. \\
...
\textbf{Effect:} Extract value from endings: from a defeated enemy, gain \textbf{+1 die} to next action; from a failed plan, re-roll one \textbf{1} on your next roll; from a broken item, gain 1 SB to spend immediately. \\
...
\paragraph{Rite of the Compost Offering (Standard, 6 XP)} \hfill \\
\emph{Scene; Touch; No.} \\
\textbf{Materials:} A personal memory (written on a leaf or spoken aloud) and a handful of soil. \\
\textbf{Effect:} Bury the memory in the soil. The GM gains \textbf{1 SB} (the King accepts the ending). In exchange, you may choose one: clear 1 Fatigue, remove a minor Condition, or gain \textbf{+1 die} on your next roll related to growth or healing. \\
\textbf{Push It:} Bury a deeper memory (a fear, a failed oath). The GM gains \textbf{2 SB}, but you gain \textbf{+2 dice} on your next roll or clear 1 Harm (not a Condition). \\
\emph{Requires: Familiar (\textit{Invoke:} 1 Boon).}
