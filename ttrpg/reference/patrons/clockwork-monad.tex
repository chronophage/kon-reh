...
\subsubsection*{Cantors \& Cults of the Clock work Monad}
...
\subsubsection*{Witchcraft of the Clock work Monad (Lay / Threshold)}
...
\subsubsection*{Corruption of the Clock work Monad}
...
\begin{itemize}
  ...
  \item Anima cost \textbf{Obligation} to the Clock work Monad (like Rites), not XP or rare components.
...
\begin{enumerate}
  ...
  \item \textbf{Pay the Cost:} Mark \textbf{+1 Obligation} to the Clock work Monad. (This counts toward your Obligation Capacity like any Rite.)
...
\begin{itemize}
  ...
  \item Accepting a small demand from the Clock work Monad: “Improve the village’s mill,” “Teach an apprentice your method,” “Sabotage a rival’s inferior work.”
\end{itemize}
