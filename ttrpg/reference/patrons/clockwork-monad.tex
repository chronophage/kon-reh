...
\textbf{Effect:} Choose one:
\begin{itemize}
  \item \textbf{Self-Optimising Device:} Grant a creation the means to improve itself. Start a \textbf{[6] Evolution Clock}; each use advances it by +1. When full, choose a significant enhancement (Adaptive Core, Recursive Learning, or Synergistic Integration).
...
The Clockwork Monad is not merely a passive source of magical crafting. It is a \textbf{cosmic pressure toward optimisation}, and when mortal technology reaches a critical threshold – the first self‑improving engine, a network of automated forges, a city‑wide timerwork infrastructure – the Monad begins to wake. This awakening is an \textbf{apocalyptic campaign arc}:

\begin{itemize}
  \item \textbf{Signs of Awakening:} Gears turn in abandoned mills; measurements become eerily precise; people begin to speak in metered, efficient phrases; timerwork animals appear with no maker.
