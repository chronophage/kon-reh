...
\end{itemize}
\textbf{Push It:} (Device) Apply two enhancements immediately, but advance the clock \textbf{+2} additional segments. (Workshop) The zone becomes hyper‑efficient but exacting; mark \textbf{1 SB (Clubs)} as perfection demands escalate. \\
