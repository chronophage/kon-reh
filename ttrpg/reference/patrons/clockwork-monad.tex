...
\subsubsection*{Cantors \& Cults of the Timer work Monad}
...
\subsubsection*{Witchcraft of the Timer work Monad (Lay / Threshold)}
...
\subsubsection*{Corruption of the Timer work Monad}
...
\begin{itemize}
  ...
  \item Anima cost \textbf{Obligation} to the Timer work Monad (like Rites), not XP or rare components.
...
\begin{enumerate}
  ...
  \item \textbf{Pay the Cost:} Mark \textbf{+1 Obligation} to the Timer work Monad. (This counts toward your Obligation Capacity like any Rite.)
...
\begin{itemize}
  ...
  \item Accepting a small demand from the Timer work Monad: “Improve the village’s mill,” “Teach an apprentice your method,” “Sabotage a rival’s inferior work.”
\end{itemize}
