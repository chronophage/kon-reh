...
\begin{itemize}
  ...
  \item \textbf{Empower:} Once per scene, spend 1 Action + 2 Boons:
    \begin{itemize}
      \item Target gains +1 Corruption level per round for 3 rounds
      \item While empowered, gain +1 die to all rolls
    \end{itemize}
  \item \textbf{Empower Push:} Spend 1 Action + 1 Boon + 3 Obligation:
    \begin{itemize}
      \item Target gains +3 Corruption levels until end of scene
      \item While empowered, gain +1 die to all rolls
    \end{itemize}
