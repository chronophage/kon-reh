...
\begin{itemize}
  ℹtem \textbf{Purity and Order:} eradicating corruption, enforcing sacred law
  ℹtem \textbf{Judgment:} condemning the guilty, burning the heretical
  ℹtem \textbf{Protection from the Tainted:} warding against the supernatural
  ℹtem \textbf{Domination:} binding the impure to serve the pure
\end{itemize}
...
\paragraph{Rite of the Unclouded Eye (Low, 5 XP)} ℎfill \\
\emph{Scene; Self; No.} \\
...
\paragraph{Rite of the Cleansing Light (Standard, 8 XP)} ℎfill \\
...
\begin{itemize}
  ℹtem On Hit: Dispel.
  ℹtem On Partial: Weaken.
  ℹtem On Miss: The effect lashes back, generating 1 SB.
\end{itemize}
\textbf{Push It:} Dispel absolutely and trace its caster; mark \textbf{+1 Obligation} and \textbf{1 SB (Spades)}. \\
\emph{Requires: Familiar + Codex (\textit{Invoke:} 1 Boon).}

\paragraph{Rite of the Marked Prey (Standard, 7 XP)} ℎfill \\
\emph{Scene; Near; No.} \\
...
\paragraph{Rite of the Consecrated Ground (High, 13 XP)} ℎfill \\
...
\textbf{Push It:} Permanently sanctify a larger area, but start a \textit{Magical Dead Zone [6]} timer and mark \textbf{+2 Obligation}. \\
\emph{Requires: Familiar + Codex + Tier III (\textit{Invoke:} 2 Boons).} \\
\emph{Obligation:} 7 segments.

\paragraph{Rite of the Final Admonition (High, 14 XP)} ℎfill \\
\emph{Scene; Touch; No.} \\
...
⫕section*{Cantors & Cults of the Inquisitor Prime}
...
⫕section*{Witchcraft of the Inquisitor Prime (Monastic / Exorcist)}
...
\textbf{A Hedge Gift: Rite of the Soot Line (2 XP).} Once per scene, the witch may draw a line of ash and salt across a threshold (a door, a bridge, a window) while reciting a single verse from the Inquisitor’s Litany. Until the next dawn, that line functions as a \texttt{[WARD]} against minor spirits (Cap 1–2) and all undead of Cap 2 or lower. A creature attempting to cross must test Spirit+Resolve (DV 3) or be turned back for that exchange. The line glows faintly when a lie is spoken within Near range.

⫕section*{Inquisitor Prime's Corruption Table}
