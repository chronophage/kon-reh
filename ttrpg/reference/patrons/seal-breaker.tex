% ============================================================================
% PATRON ENTRY: THE SEAL-BREAKER (FORGOTTEN NAMES & BROKEN SEALS)
% ============================================================================
...
\textbf{Push It:} The official also forgets your face immediately after the interaction. Mark \textbf{1 SB (Diamonds)} as the memory gap causes suspicion later. Cost: Mark +1 Obligation (total +2) or Mark +1 Fatigue. \\
\textbf{Cost:} Mark +1 Obligation. \\
\textit{Requires:} Familiar (\textit{Invoke:} 1 Boon). \\
\textbf{Invoke:} 1 action. \\
\textbf{Duration:} Scene.

\paragraph{Rite of the Anonymous Blade} (Advanced, 8 XP) \hfill \\
...
\textbf{Push It:} The victim's name is also erased from the memory of their closest kin. Mark \textbf{2 SB (Hearts)}; the Seal-Breaker may ask you to forget a friend's face in return. Cost: Mark +1 Obligation (total +3) or Mark +1 Fatigue. \\
\textbf{Cost:} Mark +2 Obligation. \\
\textit{Requires:} Familiar + Codex (\textit{Invoke:} 1 Boon). \\
\textbf{Invoke:} 1 action. \\
\textbf{Duration:} Instant.

\paragraph{Rite of the Broken Seal} (Master, 14 XP) \hfill \\
...
\textbf{Push It:} Void a contract without the consent of one party. They will know something has changed, but not what. Mark \textbf{+3 Corruption} and the hollow coin has a pulse. Cost: Mark +1 Obligation (total +3) or Mark +1 Fatigue. \\
\textbf{Cost:} Mark +2 Obligation. \\
...
\textbf{A Hedge Gift: Erased Footsteps (Basic, 4 XP).} Once per scene, the witch may touch a set of tracks (footprints, hoofprints, wheel ruts) and whisper a name that is not theirs. The tracks vanish as if never made. The Hollow, however, notices the absence --- the GM gains 1 SB to spend on a pursuit complication later in the session.

\subsubsection*{Corruption of the Seal-Breaker}
...
6+ & \textbf{The Unsealed:} Once per session, become completely anonymous --- no one can recognize you, describe you, or remember meeting you. This lasts for one scene. & \textbf{Unnamed:} Mark +3 Obligation. You have forgotten your own name. Until you recover it, you cannot be the subject of any oath, blessing, or curse --- but neither can you swear one. Your reflection shows a blank space where your face should be. \\
\end{tblr}
