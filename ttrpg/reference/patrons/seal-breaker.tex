...
5 & \textbf{Name‑Eater:} Once per session, speak a person’s true name and erase it from their own memory for one hour. & \textbf{The Hollow’s List:} Every name you erase adds 1 tick to a Hollow Attention clock. The Hollow wants them back. \\
