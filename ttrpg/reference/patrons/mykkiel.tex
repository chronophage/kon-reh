...
\begin{itemize}
  ℹtem \textbf{Divine Law:} sacred commandments, contractual obligations, ritual purity
  ℹtem \textbf{Zealous Justice:} righteous judgment, purge of impurity, holy retribution
  ℹtem \textbf{Covenant Bonds:} sacred oaths, tribal loyalty, the chosen community
  ℹtem \textbf{Absolute Order:} hierarchy, tradition, unchanging truth
  ℹtem \textbf{Lawful Neutral:} justice without mercy, order without compassion
\end{itemize}
...
\paragraph{Rite of the Consecrated Mandate (Low, 5 XP)} ℎfill \\
...
\begin{itemize}
  ℹtem \textbf{Burning Banner:} Consecrate an area for a righteous cause. Followers gain \textbf{+1 die} to resist fear; enemies suffer \textbf{−−1 die} to oppose your proclamation. Create a 4‑segment \textit{Divine Mandate} timer.
  ℹtem \textbf{Hallowed Ground:} Create sacred space where divine law prevails. All oath‑breaking, theft, or violence suffers \textbf{−−1 die}. Creates a 6‑segment \textit{Sacred Space} timer.
\end{itemize}
...
\paragraph{Rite of the Blazing Decree (Standard, 8 XP)} ℎfill \\
...
\paragraph{Rite of the Covenant Seal (Standard, 9 XP)} ℎfill \\
...
\paragraph{Rite of Divine Judgment (High, 13 XP)} ℎfill \\
...
\paragraph{Rite of the Chosen Legion (High, 14 XP)} ℎfill \\
...
⫕section*{Cantors & Cults of Mykkiel}
...
⫕section*{Witchcraft of Mykkiel (Lay / Covenant)}
...
⫕section*{Mykkiel's Corruption Manifestations}
...
\begin{itemize}
  ℹtem \textbf{Divine Law:} the covenant is absolute, unchanging, and unforgiving
  ℹtem \textbf{Zealous Justice:} righteousness without mercy
  ℹtem \textbf{Chivalric Code:} protection of the weak, punishment of the wicked
  ℹtem \textbf{Absolute Order:} hierarchy, tradition, and the weight of oath
  ℹtem \textbf{Lawful Neutral:} the scales do not tilt; they only weigh
\end{itemize}