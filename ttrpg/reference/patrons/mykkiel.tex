...
\textbf{Effect:} Formalize a binding covenant. All participants suffer concrete penalties for breach (--1 die to relevant actions). Creates an 8-segment \textit{Covenant Bond} timer. \\
...
\textbf{Effect:} Sanctify an area for the faithful. Believers gain \textbf{+1 die} to defense; unbelievers suffer \textbf{--1 die}. Supernatural desecration (undead, demons, heretical rites) within the zone risks immediate retaliation (1 SB and a divine warning). \\
...
\begin{tcolorbox}[colback=black!5,colframe=gold!70!black,title=\textbf{Covenant Justiciar (Chivalric Zealot)},breakable]
...
\textbf{Sworn Defender} & When you take the \textit{Defend} action, you may also grant an adjacent ally +1 Armor until your next turn. & Passive & Body 3, Melee 2 \\
...
\textit{The Unbroken Covenant.} Once per session, you may declare a single oath you have sworn (to protect a person, to destroy a foe, to uphold a law) as \textit{inviolable}. For the remainder of the session, you gain +2 dice to all rolls that directly advance that oath, and you ignore the first Harm 2 each scene that would prevent you from fulfilling it. When the oath is fulfilled (or if it becomes impossible to fulfill), you immediately gain 1 permanent Corruption and mark +2 Obligation to Mykkiel -- the covenant remembers what you swore.
\end{tcolorbox}
...
5 & \textbf{Prophetic Decree:} Once/session, speak judgment that carries supernatural weight. & \textbf{Blind to Nuance:} --1 die to perceive gray areas or partial truths. \\
