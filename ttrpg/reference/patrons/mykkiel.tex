...
\begin{itemize}
  \item \textbf{Burning Banner:} Consecrate an area for a righteous cause. Followers gain \textbf{+1 die} to resist fear; enemies suffer \textbf{--1 die} to oppose your proclamation. Create a 4‑segment \textit{Divine Mandate} clock.
  \item \textbf{Hallowed Ground:} Create sacred space where divine law prevails. All oath‑breaking, theft, or violence suffers \textbf{--1 die}. Creates a 6‑segment \textit{Sacred Space} clock.
\end{itemize}
...
\textbf{Effect:} Pronounce divine judgment. The target suffers escalating penalties (–1 die, then –2 dice) until they atone. Serious crimes (oath‑breaking, sacrilege, murder) may warrant greater effects (e.g., Harm, exile, or the attention of Covenant inquisitors). Start a 10‑segment \textit{Judgment} clock. \\
...
\textbf{Push It:} The area becomes permanently consecrated; start a \textit{Maintenance [8]} clock. If maintenance lapses, the consecration fades, and the site becomes vulnerable to corruption. \\
\emph{Requires: Familiar + Codex + Tier III (\textit{Invoke:} 2 Boons).} \\
\textbf{Invoke:} Extended rite; mark \textbf{+2 Obligation}. \\
