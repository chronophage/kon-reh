...
\begin{tcolorbox}[colback=black!5,colframe=red!80!black,title=\textbf{Riven-Fist (The Riven Path)}]
  ...
  \textbf{Cracking Lightning} (Standard, 9 XP) & Close range cone. All targets test Body+Athletics (DV 4) or take Harm 2. Success = Harm 1. & 1 Boon & Spirit 3, Tier II \\
  \textbf{Battle Rage} (Standard, 8 XP) & For 3 exchanges: +2 dice melee, ignore first Harm 1/round, ignore Fatigue penalties, Position Desperate. End: 1 Fatigue. & 1 Boon & Body 3, Tier II \\
  \textbf{Sundering Blade} (Standard, 8 XP) & Next melee attack with light blade: +2 dice, ignore 1 Armor, +1 Harm. Crit = permanent Scar. & 1 Fatigue + 1 Boon & Tier II \\
  \end{tblr}
