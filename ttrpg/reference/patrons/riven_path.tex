% --- Patron: The Riven Path (Passion and Power) ---
...
\paragraph{Rite of Feasting on Fear (Low, 4 XP)} \hfill \\
...
\paragraph{Rite of the Crushing Grip (Low, 5 XP)} \hfill \\
...
\paragraph{Rite of the Cracking Lightning (Standard, 9 XP)} \hfill \\
...
\paragraph{Rite of the Battle Rage (Standard, 8 XP)} \hfill \\
\emph{Scene; Self; No.} \\
\textbf{Tags:} \texttt{[PASSION]}, \texttt{[BOOST]} \\
\textbf{Materials:} A roar, a war cry, or a moment of silent, building fury. \\
\textbf{Effect:} For the next three exchanges, you gain \textbf{+2 dice} to all melee attacks, ignore the first Harm 1 each round, and ignore all Fatigue penalties. However, your Position becomes \textit{Desperate} (re-roll successes) for the duration—you are reckless, not careful. When the rage ends, mark 1 Fatigue. \\
\textbf{Push It:} The rage lasts for the full scene. Mark 2 Obligation and mark 1 SB (Diamonds) as collateral damage. \\
\emph{Requires: Familiar + Codex (\textit{Invoke:} 1 Boon).} \\
\textbf{Invoke:} 1 action; mark \textbf{+1 Obligation}.

\paragraph{Rite of Dominating Will (High, 13 XP)} \hfill \\
\emph{Scene; Near; Yes (resist).} \\
\textbf{Tags:} \texttt{[MIND]}, \texttt{[COMMAND]}, \texttt{[AREA]} \\
\textbf{Materials:} Eye contact with the strongest target, maintained without blinking. \\
\textbf{Effect:} All targets within Near must test \textit{Spirit + Resolve} (DV 5) or obey a single short command for one exchange. The command cannot be suicide, but can be self-destructive (e.g., “Attack your ally,” “Drop your weapon,” “Kneel”). \\
\textbf{Push It:} The command lasts for the full scene. Mark 2 Obligation and mark 1 SB (Spades) as the dominated target shows visible signs of breaking—weeping, twitching, or laughing. \\
\emph{Requires: Familiar + Codex + Tier III (\textit{Invoke:} 2 Boons).} \\
\textbf{Invoke:} Extended action; mark \textbf{+2 Obligation}. \\
\emph{Obligation:} 7 segments.

\paragraph{Rite of the Sundering Blade (Standard, 9 XP)} \hfill \\
\emph{Instant; Self; No.} \\
\textbf{Tags:} \texttt{[STRIKE]}, \texttt{[BRUTAL]} \\
\textbf{Materials:} A light blade (one-handed sword, knife, or equivalent), held in a white-knuckled grip. \\
\textbf{Effect:} Your next melee attack with a light blade gains \textbf{+2 dice}, ignores 1 Armour, and deals \textbf{+1 Harm}. On a critical success, the target gains a permanent Scar (GM chooses: lost finger, blinded eye, cracked rib, severed tendon). \\
\textbf{Push It:} The attack also severs a worn item (shield strap, weapon cord, coin purse). Mark 1 Fatigue. \\
\emph{Requires: Familiar + Codex (\textit{Invoke:} 1 Boon).} \\
\textbf{Invoke:} 1 action; mark \textbf{+1 Obligation}.
