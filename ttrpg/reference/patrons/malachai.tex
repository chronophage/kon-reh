## **Malachai, the Cruel Messenger (Curses & Corruption)**

\subsubsection{Malachai, the Cruel Messenger (Curses \& Corruption)}
\textit{Lore.} Once a devoted messenger of divine will, Malachai was tasked with delivering the hardest truths—words of warning, prophecies of doom, and revelations that would shatter faith. She became obsessed with the terrible beauty of truth that destroys, the message that heals by wounding. When she began delivering false hope alongside real curses, she was torn from heaven and bound in chains of black iron beneath a forgotten chapel. There, she learned that the cruelest message is the one that sounds like salvation. Her followers master the art of gifts that devour from within, learning that power always demands a price paid in suffering.

\begin{quote}
``I was meant to speak truth. Instead, I learned to whisper lies that taste like honey. What I touch, I corrupt—not with malice, but with the terrible weight of beautiful deception.'' — Malachai, the Cruel Messenger
\end{quote}
...
\paragraph{Rite of the False Dawn (Low, 5 XP)} \emph{Scene; Near; No.}
\textbf{Materials:} A shard of meteoric iron blessed by false sunlight.\\
...
\paragraph{Mark of the Cruel Truth (Standard, 8 XP)} \emph{Scene; Touch; No.}
...
\paragraph{The Messenger's Burden (Standard, 9 XP)} \emph{Scene; Self; No.}
\textbf{Materials:} Wear manacles while speaking her true name.\\
\textbf{Effect:} Malachai's power flows through you directly. Gain \textbf{+2 dice} to one action per beat for the scene, but each use marks \textbf{1 SB (suit by GM)} as her influence spreads. You cannot refuse her whispered commands.\\
...
\paragraph{Curse of Beautiful Lies \textnormal{[BANE]} (High, 12 XP)} \emph{Scene; Near; No.}
...
\paragraph{The Corrupted Gospel (High, 14 XP)} \emph{Extended; Zone; No.}
