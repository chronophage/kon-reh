...
\begin{itemize}
  ℹtem \textbf{Wayfinding:} navigation, route‑finding, safe passage
  ℹtem \textbf{Journeys:} travel, pilgrimage, exploration
  ℹtem \textbf{Thresholds of Movement:} doors, bridges, crossroads, borders
  ℹtem \textbf{Road Covenants:} promises made on the road, hospitality to travellers
\end{itemize}
...
⫕section*{Rites of the Traveler}

\paragraph{Rite of Road−Sense (Low, 4 XP)} ℎfill \\
\emph{Scene; Self; No.} \\
...
\paragraph{Rite of the Traveler's Boon (Low, 5 XP)} ℎfill \\
...
\paragraph{Rite of the Waymark (Standard, 8 XP)} ℎfill \\
\emph{Scene; Near; No.} \\
...
\paragraph{Rite of the Bridge Between (Standard, 7 XP)} ℎfill \\
...
\paragraph{Rite of the Crown of Crossings (High, 13 XP)} ℎfill \\
\emph{Scene; Zone; No.} \\
...
\paragraph{Rite of the Wayfarer's Covenant (High, 14 XP)} ℎfill \\
...
⫕section*{Cantors & Cults of the Traveler}
...
⫕section*{Witchcraft of the Traveler (Craft / Wayfinding)}
...
⫕section*{The Traveler's Corruption Table}
...
\begin{itemize}
  ℹtem \textbf{Wayfinding:} the art of never being lost
  ℹtem \textbf{Road Covenants:} a promise made on the road is binding
  ℹtem \textbf{Journey as Transformation:} the road changes the walker
  ℹtem \textbf{Thresholds of Movement:} doors, bridges, borders, and the spaces between
  ℹtem \textbf{Hospitality to Travellers:} the road gives, and the road expects
\end{itemize}
...
\begin{tcolorbox}[colback=black!5,colframe=blue!70!black,title=\textbf{Way‑Walker (The Traveler)}]
  ...
  \textbf{Way‑Step} & Teleport to any unoccupied space you can see within Near range. You must have line of sight and an unobstructed path (the road folds, not breaks). & 1 Fatigue & Wits 3 \\
  \textbf{Road‑Sense} & Unerringly pick the fastest safe route in Near/Far. Gain +1 die to avoid ambushes or delays. Create a 4‑segment Path Memory timer. & 1 Boon & Wits 2 \\
  \textbf{Traveler’s Boon} & Ignore one level of difficult terrain or bureaucratic delay. +1 Effect to travel or escape checks. & 1 Fatigue & Spirit 2 \\
  \textbf{Waymark} & Declare a lane as permitted or easy. Allies gain improved Position/Effect or ignore one obstacle. Create a 6‑segment Marked Path timer. & 1 Boon & Tier II \\
  \textbf{Bridge Between} & Relocate a willing target within Far along a visible or named route. Unwilling targets resist with Body+Resolve (DV 3). & 1 Fatigue + 1 Boon & Wits 3, Spirit 2 \\
  \textbf{Crown of Crossings} & For one scene, allies gain +1 die to move or evade; pursuers suffer –1 die. Once, declare “the long way is short” to finish a travel timer segment for free. & 1 Fatigue & Tier III \\
  \end{tblr}
