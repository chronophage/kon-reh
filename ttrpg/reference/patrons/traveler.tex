...
\begin{tcolorbox}[colback=black!5,colframe=blue!70!black,title=\textbf{Way‑Walker (The Traveler)}]
  ...
  \textbf{Road‑Sense} & Unerringly pick the fastest safe route in Near/Far. Gain +1 die to avoid ambushes or delays. Create a 4‑segment Path Memory clock. & 1 Boon & Wits 2 \\
  ...
  \textbf{Waymark} & Declare a lane as permitted or easy. Allies gain improved Position/Effect or ignore one obstacle. Create a 6‑segment Marked Path clock. & 1 Boon & Tier II \\
  ...
  \textbf{Crown of Crossings} & For one scene, allies gain +1 die to move or evade; pursuers suffer –1 die. Once, declare “the long way is short” to finish a travel clock segment for free. & 1 Fatigue & Tier III \\
  \end{tblr}
