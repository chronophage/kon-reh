...
\begin{itemize}
  ℹtem \textbf{Thresholds:} Doors, portals, borders between realms
  ℹtem \textbf{Containment:} Wards, bindings, imprisonment of dangerous forces
  ℹtem \textbf{Exclusion:} Banishment, quarantine, protection through separation
  ℹtem \textbf{Permission:} Safe passage, authorised access, controlled crossing
\end{itemize}
...
⫕section*{Rites of the Sealed Gate}

\paragraph{Rite of the Sealed Threshold (Low, 4 XP)} ℎfill \\
...
\paragraph{Rite of the Key's Rebuke (Low, 5 XP)} ℎfill \\
...
\paragraph{Rite of the Circle of Denial (Standard, 8 XP)} ℎfill \\
...
\paragraph{Rite of the Writ of Passage (Standard, 7 XP)} ℎfill \\
\emph{Scene; Zone; Standard Push} \\
...
\paragraph{Rite of the Banishment Knot (High, 13 XP)} ℎfill \\
...
\paragraph{Rite of the Consecrated Barrier (High, 14 XP)} ℎfill \\
...
⫕section*{Cantors & Cults of the Sealed Gate}
...
⫕section*{Witchcraft of the Sealed Gate (Lay / Scholarly)}
...
⫕section*{The Sealed Gate's Corruption Manifestations}
...
\begin{itemize}
  ...
  ℹtem \textbf{Exclusion:} banishment, quarantine, protection through separation
  ℹtem \textbf{Permission:} safe passage, authorised access, controlled crossing
  ℹtem \textbf{Immovable Guardian:} the follower becomes a wall given will
\end{itemize}
