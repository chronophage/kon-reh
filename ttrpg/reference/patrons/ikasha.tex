...
5 & \textbf{Shadow Debt:} Once per session, call in a favour from someone who owes you a secret – no questions asked. & \textbf{Obligation Web:} Every secret you learn creates a subtle tie to its keeper; mark 1 SB (Diamonds) when ignoring these connections. \\
