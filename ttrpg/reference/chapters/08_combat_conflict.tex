...
\begin{itemize}
    ...
    \item Complications: 1-2 CP causes delays, 3+ CP causes partial collapse
\end{itemize} \\
\hline
Dig Approach Trench & 
\begin{itemize}
    ...
    \item Complications: 1-2 CP causes work delays, 3+ CP results in cave-in or enemy counter-mining
\end{itemize} \\
\hline
Build Battering Ram & 
\begin{itemize}
...
\hline
Legendary (Cap 6) & 1000+ & +6 & Mythic status, artifact support \\
\hline
\end{tabular}
\end{center}
