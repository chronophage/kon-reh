...
\begin{dtable}{\dN{6}}
1 & Hoard Chamber arranged as a \emph{memory theater}; narrative paths \Tag{SCRY}. \\
...
4 & Fossil courts demand a plea; fail $\rightarrow$ turned aside. \\
...
\textit{Heraldry}: Black bramble on iron-gray.\\
...
\paragraph{Moves}
\begin{itemize}[leftmargin=*]
\item \textbf{Set the Hedge}: Mark 1 Supply to lace thorns; enemies entering a Zone act at \textit{Dominant} and suffer \textit{Harm 1 (Bleed)} on a miss.
...
\item \textbf{Heart-Forge Ember} --- Heat of a dying world; can reforge any blade; next time it draws blood, GM may tick a Doom timer.
...
Your smith reforges a relic $\rightarrow$ gain a unique item tag (GM chooses one):
\begin{itemize}[leftmargin=*]
...
\item \textbf{Name-Binding Coil}---A creature who speaks their name aloud is bound to fulfill a sworn term. Breaking it causes immediate Harm 3 and a Doom timer begins.
...
\item \textbf{Climax:} Do the PCs restore the wards\dots or awaken a god-king who remembers betrayal?
...
\item \textbf{Power:} A leader struck by Mantle rolls social actions with +1d while blood spills---they become decisive, ruthless, brilliant.
