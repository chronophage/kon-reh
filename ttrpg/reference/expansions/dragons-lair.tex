...
\paragraph{Moves}
\begin{itemize}[leftmargin=*]
\item \textbf{Set the Hedge}: Mark 1 Supply to lace thorns; enemies entering a Zone act at \textit{Controlled} and suffer \textit{Harm 1 (Bleed)} on a miss.
...
\textbf{Pressure}: In tight spaces, actions with \textit{cloth/leather} act at \textit{Controlled}.\\
...
Those under the veil resemble “favored kin.” NPCs feel a prickle of dread. Mortal foes at Near must test Resolve (Controlled) to strike first. Backlash: the veil cracks; one participant gains serpentine eyes for a night, acting at --1d vs. bright light.
