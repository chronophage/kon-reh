...
\lettrine{T}{hese} monks practice \textit{paired meditation}---two or more psions sharing Mental Strain across a Circle. They believe that debt is not individual but \textit{communal}. Their signature technique is \textbf{The Circle of Stillness}: as an action, link with up to 3 willing psions within Near. Mental Strain generated by any member is divided evenly among the Circle. On a miss or complication, all members mark 1 SB.
