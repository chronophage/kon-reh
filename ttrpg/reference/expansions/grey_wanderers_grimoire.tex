...
\begin{itemize}
    ...
    \item \textbf{The Promise Timer :} Every binding creates a debt, tracked as a timer of 4 to 6 segments. When it fills, the price comes due. A witch's ledger is written in flesh and time, not ink.
