...
\textbf{The Threshold Keeper (Witch):} You are the hedge-mother, the Breath-Warden. Your magic is in cup-mark stones, red thread, and three knots tied counter‑clockwise.
...
Effect: Heal a blighted place or quicken a damaged ecosystem. Clear taint, restore fertility, awaken dormant forces. Begin an \textit{Ecosystem Restoration} [8] clock.
\end{patronbox}
...
You have learned to seed rebellion in silence. Over the course of a downtime scene, you may whisper a single doubt into the ear of a crowd, a guard, or a court. The GM starts a \textit{Discontent} [6] clock. When it fills, the target community or faction suffers a public crisis (riots, desertions, a vote of no confidence). You cannot use this talent again until the clock completes or is thwarted.
...
\hfill --- \textit{Justice Kaelen, Vhasian Parlement}
...
\begin{itemize}
    ...
    \item \textit{False Dawn} (Standard, 8 XP): Bestow a gift with a hidden curse—target gains an advantage but begins a Corruption clock.
...
Inaea sits in patient silence at the centre of the unseen lattice. Where others see isolation, she sees threads—debt, affection, rivalry, loyalty.
...
Once per session, name a relationship between two NPCs (friend, rival, debtor, lover). The GM must reveal one secret about that relationship—a hidden grievance, a secret loyalty, an unpaid debt. Mark 1 Fatigue after using this talent.
...
\begin{itemize}
    ...
    \item Settle a death‑bound debt—pay what the deceased owed, or collect what they were owed.
...
Once per session, touch a physical trace of a death (a body, a grave, an object that witnessed a passing) and instantly know one \textit{unresolved obligation} connected to that death—a promise unfulfilled, a secret unspoken, a debt unpaid. Mark 1 Fatigue after using this talent.
...
\begin{itemize}
    ...
    \item \textit{Rite of the Ancestral Consultation} (5 XP): Ask one question of an ancestral spirit regarding family history, hidden legacies, or inherited debts.
\end{itemize}
...
You possess a personal \textbf{Corruption Clock} with segments equal to your Spirit rating. Mark Corruption when:
\begin{itemize}
...
A Hedge Gift is not a spell. It is the world tilting slightly in the witch's favor because she has paid attention to the right thresholds. Hedge Gifts require no dice roll; they simply work within their limited scope. A witch begins with two Hedge Gifts from the \textbf{Craft of the Hedge} talent and may learn more for 2 XP each.

\subsection*{Quick Workings}
A Quick Working is a single-action roll that relies on the witch's knowledge of thresholds, elements, and will. Its effects are limited, subtle, and always carry the risk of debt. The witch names a threshold, chooses a Layer (Echo, Veil, or Flow), and rolls Attribute + Skill (typically Wits + Lore or Spirit + Insight). On success, a minor effect manifests: a door sticks, a candle gutters, a pursuer slips. Partial results bring complications; failures invoke Promise Clocks.

\subsection*{Full Rituals}
When a witch has Significant Time, she may perform a Full Ritual using the five-step Threshold Working: Identify the Threshold, Choose a Witness, Name the Will, Set the Price, Make the Exchange. Full Rituals produce permanent or long-lasting effects: curses, blessings, marks, bindings, and unravellings.

\section*{The Witch's Arts: Healing, Exorcism, Consecration}
Witchcraft excels at three sacred tasks: unknotting harm, casting out the clinging dead, and reminding a place that it was once safe.

\subsection*{Healing}
The \textbf{Steady Hand} (Hedge Gift) removes 1 Fatigue with a touch, once per scene. The \textbf{Knot of Mercy} (Hedge Gift, once per session) removes a Condition by spending Significant Time and properly disposing of the unknotted affliction. \textbf{Stabilize the Dying} (Quick Working) prevents death from a wound. \textbf{Unravel the Wound} (Full Ritual) restores 1 level of Harm, requiring a threshold, a witness, and a personal price.

\subsection*{Exorcism}
The \textbf{Bell and Breath} (Hedge Gift) distracts a visible spirit for one exchange. \textbf{Banish Minor Spirit} (Quick Working) repels a spirit of Cap 1–2. \textbf{Unbind the Anchor} (Full Ritual) permanently releases a spirit by discovering its anchor, naming terms, and paying the price. Exorcism is negotiation, not combat.

\subsection*{Consecration}
The \textbf{Salt Line} (Hedge Gift) blocks spirits from crossing a line of salt for one exchange. \textbf{Calm Ground} (Quick Working) consecrates a small zone for one scene, reducing fear and hindering hostile spirits. \textbf{Hallow Threshold} (Full Ritual) permanently wards a door, well, or bridge against harmful supernatural entities, lasting until the threshold is physically broken or the offering removed.
...
\begin{itemize}
    ...
    \item \textbf{Hedge Gifts and Quick Workings:} A witch’s fast magic is woven into the same tools: a knot tied in haste, a bell rung mid-sentence, a pinch of salt thrown behind. The tools are humble; the intent is everything.
\end{itemize}
...
\textit{(This page was found pressed between the leaves of a herbalist’s handbook in a burned cottage outside Ecktoria. The cottage had no owner on any record. The handwriting matches none of the Daughters known to the Inquisition. The Gray Wanderer refuses to discuss how they obtained it.)}
    ...
    I'll integrate the Scholarly Debate and the three Silent Orders into your chapter, keeping the origin mysterious. Below is the revised chapter with the new material inserted after the "Cultural Faces" section and before "The Thought Trade". The PC rules for each order appear as sidebars or subsections with talents and techniques.

---

## \section{The Silent Orders — Fragments of a Scattered Tradition}

\lettrine{N}{o one} knows where psionics came from. The Thepyrgos Synod has a standing bounty for any evidence dated to the Great Silence. The bounty has never been claimed. What follows are whispers collected by the Gray Wanderer from a dozen dusty archives and one very expensive bottle of brandy.
...
\lettrine{T}{hese} monks live in tents around the Empty Circle—a depression in the steppe where no psionics work. They enter the Circle only to meditate in absolute silence. They believe the Silence was a \textit{lesson}, not a wound. Their signature technique is \textbf{The Still Mind}: reduce the Story Beat generation from Mental Fatigue by 1 for all non-psionic actions, but you cannot use any psionic Art above Tier I in the same scene.
...
\lettrine{T}{hese} monks practice \textit{paired meditation}—two or more psions sharing Mental Fatigue across a Circle. They believe that debt is not individual but \textit{communal}. Their signature technique is \textbf{The Circle of Stillness}: as an action, link with up to 3 willing psions within Near. Mental Fatigue generated by any member is divided evenly among the Circle. On a miss or complication, all members mark 1 SB.
...
\hfill --- \textit{The Gray Wanderer, from a conversation at the Dusty Page}
    ...
    % Colors (consistent with Grey Wanderer's Grimoire)
    ...
    \subsection*{1. Vex — the Grifter (Body 2, Wits 3, Spirit 3, Presence 2)}
    \textbf{Psionics} 3 (Telepathy, Empathic Manipulation). \textbf{Talents:} Thought Thief, Psychic Reservoir.  
    \textbf{Strings:} “Master’s spare key,” “Debt to the Tulkani courier.”  
    ...
    \textbf{Strings:} “Stole the Master’s meditation bell,” “Owe a favour to the Port Shed dockmaster.”  
    ...
    \begin{itemize}
        \item \textbf{The Master’s Breath [8] —} Ticks every scene (or when a PC mark Mental Fatigue). When full, the Master’s body stops breathing. The dream collapses; all PCs mark 2 Harm and gain the \textit{Haunted} condition.
        \item \textbf{Debt’s Approach [6] —} Ticks each time the party speaks a lie, fails a Resolve test, or damages a dream‑construct. When full, the final Burden (the abandoned woman’s spirit) appears early and attacks.
        \item \textbf{Name Unspoken [4] —} The party must discover the forgotten name (Kaelen). Each successful Investigation or Telepathy roll in a memory chamber fills one segment. When full, the name is known and can be spoken at the heart.
    \end{itemize}
    
    \subsection{Threshold Journey (Nine Chambers, played as montage or key scenes)}
    
    \begin{enumerate}
        \item \textbf{The Meditation Hall (Echo).} The party must relive a training session. A Burden appears as a younger student who failed—they must pass without fighting, only remembering.
        \item \textbf{The Vault of Stolen Secrets (Veil).} Floating memory‑orbs. One contains the first clue: \textit{“Not treasure. A woman. The Ash‑Fenn market.”}
        \item \textbf{The Anxious Stair (Flow).} Steps that grow teeth. Each PC must confess a regret aloud to proceed.
        \item \textbf{The Court of the Witness (Echo).} A mirror‑hall. The party sees their Burdens. To pass, they must speak the name of their own Burden (no mechanical effect, but the GM gains 1 SB per confession).
        \item \textbf{The Iron Well (Veil).} A deep shaft where the Master drowned a secret. Dive using Biofeedback (DV 4) to retrieve a locket with the woman’s portrait.
        \item \textbf{The Harrow (Flow).} A chamber of thorns. Each PC must sacrifice a String (erase it from their sheet) to open the door.
        \item \textbf{The Forgotten Oath (Echo).} A courtroom where the Master is being judged by their own conscience. The party must defend them—not with logic, but by describing one act of kindness the Master did for each of them.
        \item \textbf{The Hollowed Garden (Veil).} The woman waits, faceless. She asks: \textit{“Why did he leave?”} The party must guess: \textit{“He was afraid of you becoming a Burden.”} She weeps; the name \textit{Kaelen} appears on her chest.
        \item \textbf{The Heart (Obishaal pure).} The final chamber is a bare stone altar. Speaking the name \textit{Kaelen} fills the \textit{Name Unspoken} clock. The Master’s spirit rises, thanks the party, and crumbles into grey thread. The secret is out. The debt is paid.
    \end{enumerate}
    
    \subsection{Resolution}
    
    The party wakes in the room. The Master’s body is still; the breath has stopped. But the Hollowed bird opens its sewn eyes, chirps once, and flies out the window. In the Master’s hand is a slip of paper: \textit{“You found it. The treasure was my shame. Now I can rest. The Academy is yours—if you can keep it.”}
    ...
    \epigraph{“They never spoke of the heist again. But sometimes, in the small hours, one of them would wake with a name on their lips—Kaelen—and they would pour a cup of water on the ground, mutter ‘paid,’ and go back to sleep. That is the closest our kind comes to prayer.”}{\textit{--- The Gray Wanderer, closing a bottle of Sidhi port}}
