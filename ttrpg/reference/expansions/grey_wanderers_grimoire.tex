...
\epigraph{``You want power? Fine. But don't come crying when the weight finds you.''}{\textit{--- The Gray Wanderer}}
...
\section{Aeler -- The Deep Watchers}
...
\epigraph{``I have worn the face of a knight, a warlock, a hedge-priest, and a hunted freak. The path chooses you as much as you choose it, and the price is always the same weight, though the coin differs.''}{\textit{--- The Gray Wanderer}}
...
\textbf{Cultural Variants:}
\begin{itemize}
    \item \textbf{Vhasia:} \textit{the Dust-Speaker}. Soldiers leave a button from a fallen comrade on a cairn---the King turns that button into a bullet for the next battle.
    \item \textbf{Aeler:} \textit{the Under-Gardener}. Dwarven crypts have bioluminescent fungus fed by the dead.
\end{itemize}

\textbf{Playing a Follower of the Carrion-King:} Dust-Speaker (Runekeeper), compost-witch (Witch), desperate gambler (Invoker).
...
\textit{Prerequisite:} Follower of Isoka.  
When you successfully resist or break free from a Condition, you gain a burst of furious energy. Your next action within the same scene gains +1 die and treats its Position as one step higher (Desperate $\rightarrow$ Dominant, Dominant $\rightarrow$ Controlled). You may use this talent once per session.
...
\begin{itemize}
    ...
    \item Offer shelter to a lost traveler for a night---no questions, no payment.
...
\begin{enumerate}
    ...
    \item Your signature appears on a document you have never seen---a contract, a treaty, a marriage license.
...
Inaea sits in patient silence at the center of the unseen lattice. Where others see isolation, she sees threads---affection, rivalry, loyalty, fear.
...
\textbf{Suggested Acts of Service:}
\begin{itemize}
    \item Mend a broken relationship---two friends who quarreled, a parent and child estranged.
...
\textbf{Cultural Variants:}
\begin{itemize}
    \item \textbf{Aeler:} \textit{the Breath-Watcher}. Dwarven mortuary priests audit the spiritual ledgers of the Deep Vaults.
...
\begin{tcolorbox}[colback=warningred!5, colframe=warningred!70, sharp corners, title={\textbf{Backlash Severity}},breakable]
\begin{multicols}{2}
\textbf{Minor (1--2 SB)} \\
$\bullet$ Fatigue +1 \\
...
\begin{itemize}
    ...
    \item \textbf{Appearance:} A gray wolf the size of a pony, with eyes that reflect scenes from the summoner's childhood.
...
\epigraph{``I do not kneel. I sign. I do not pray. I calculate. The Patron receives my offering---a Symbol polished, a contract whispered---and in exchange, I am permitted to borrow the flame. But make no mistake: when the covenant closes, the weight is mine alone.''}{\textit{--- The Gray Wanderer}}
...
\textit{``She gives you the gold, but not the weight it carries. She grants your heart's desire, but not the hunger it awakens. She answers your plea, but not the price that pleases her. In Morag's court, every 'yes' is a 'yes, but\dots' ''}
...
\begin{warningbox}[title={\scshape The Triangular Trap \& The Tidal War}]
    ...
    \begin{tcolorbox}[colback=black!3,colframe=black!40,title=The Thorn's Bargain,breakable]
    ...
    \begin{tcolorbox}[colback=black!3,colframe=black!40,title=Rite of the Leashed Gift,breakable]
    \textbf{Standard, 7 XP}
    \medskip
    ...
    \begin{tcolorbox}[colback=black!3,colframe=black!40,title=Rite of the Spreading Stain,breakable]
    \textbf{Standard, 8 XP}
    \medskip
    ...
    \begin{tcolorbox}[colback=black!3,colframe=black!40,title=Rite of the Borrowed Scar,breakable]
    \textbf{High, 10 XP}
    \medskip
...
Every Daughter receives a Hollowed -- a child or animal, taken from a home that no longer remembers them, hollowed out by the High Mother's needle. The heart is removed, preserved in the Kettle, replaced with a bundle of gray thread and the ash of a forgotten name. The eyes are sewn open with silver wire. They watch, always. They witness every working, every whispered price, every tear shed at a deathbed.
...
Once a year, on the night of the dark moon, the Daughters gather in the House Without Doors. We drink a tea brewed from feverfew and the dried milk of the Hollowed. We lie on pallets of gray wool. And we dream.

In the dream, we see the High Mother as she truly is -- not a woman on a throne, but a vast, pulsing tangle of gray cord, stretching from floor to ceiling, filling every room. Each thread is a memory, a sacrificed name, a price paid. They hum with hunger. They whisper the names of everyone we have ever touched -- the sick we have nursed, the dying we have comforted, the children we have hollowed.
...
Every Daughter carries a spool of gray thread, spun from the hair of the Hollowed. When she offers you food, she ties a thread around your wrist -- invisible, weightless, unless you know to look for it. When you accept, she ties the other end to the Cord. Now you are bound. Not in a way you would notice -- no, never that. But the next time you face a choice, you will lean slightly toward the option that benefits the Chain. You will forget a name you meant to speak. You will lose a letter you meant to send. Small things. Small erasures.
...
\textbf{Skill Debt:} Psions enter arrangements to provide mental services over time for immediate payment, creating complex obligations tracked not in ledgers of ink but in \textit{Promises of the Mind}. These obligations are enforced not by law but by the guilds of the Silent Orders---and by the fact that a psion who reneges on a mental weight finds their own thoughts strangely\dots leaky.
...
The room smells of old paper, dried herbs, and the faint copper tang of blood. Master Kai lies on a pallet of gray wool, eyes half-open, lips moving in a language none of the students recognize. The breath is shallow; the pulse is a drum that beats once, then waits, then beats again. The Hollowed---a small gray bird with sewn-shut eyelids---perches on the headboard, unblinking.
...
\textbf{Look:} Gray robes, hair shorn in mourning, carries a silver tuning fork.
...
\begin{enumerate}
    ...
    \item \textbf{The Harrow (Flow).} A corridor of gray-thread thorns. Each PC sacrifices one String. \textit{Traps:} String Snare (Alien, steals extra String). \textit{Shadows:} Shadow of a betrayed ally.
...
\epigraph{``They never spoke of the heist again. But sometimes, in the small hours, one of them would wake with a name on their lips---Finley---and they would pour a cup of water on the ground, mutter ''paid,`` and go back to sleep. That is the closest our kind comes to prayer.''}{\textit{--- The Gray Wanderer, closing a bottle of Sidhi port}}
    ...
    \epigraph{``Before you carve your first Rite, hum your first Song, or swallow your first coin, ask yourself: do you want to serve, gamble, sing, tend, think, or bind? The answer determines which weight you will drown in.''}{\textit{--- The Gray Wanderer}}
    ...
    \epigraph{``Every Road can kill you. The question is whether you kill them with fire, song, weight, or a very polite spirit.''}{\textit{--- The Gray Wanderer}}
