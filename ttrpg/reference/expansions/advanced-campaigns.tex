...
\begin{description}
  \item[Supporting Timers] One timer's progress helps another (Plague Spread → Resource Scarcity)
  \item[Opposing Timers] One timer's progress hinders another (Public Support ↓ Crime Rate ↑)
  \item[Cascade Timers] One timer's resolution triggers another (War Ends → Reconstruction Begins)
...
\begin{itemize}[leftmargin=1.2em]
  ...
  \item \textbf{Apply:} High Momentum → escalate timers; Low Momentum → ease difficulty.
\end{itemize}
