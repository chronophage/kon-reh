...
\begin{description}
  \item[Supporting Clocks] One timer's progress helps another (Plague Spread → Resource Scarcity)
  \item[Opposing Clocks] One timer's progress hinders another (Public Support ↓ Crime Rate ↑)
  \item[Cascade Clocks] One timer's resolution triggers another (War Ends → Reconstruction Begins)
...
\begin{itemize}
    ...
    \item \textbf{Clock Pressure:} Fast timers during storms, slow timers during festival seasons.
\end{itemize}
