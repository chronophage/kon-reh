...
When the players accept a job from the Court, the GM sets up a \textbf{Heist Clock} [6] (simple) to [12] (complex) to track overall progress toward the objective. Additionally, the GM may establish \textbf{Threat Timers} to track escalating danger during the heist.
