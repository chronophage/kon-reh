...
When the players accept a job from the Court, the GM sets up a \textbf{Heist Clock} [6] (simple) to [12] (complex). The clock advances when players:
...
\chapter{The Velvet Oath (Reaffirmed)}
