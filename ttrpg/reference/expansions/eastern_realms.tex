...
\begin{itemize}
    ...
    \item \textbf{Hollow Attention [6]}: Ticks when the party ignores a ninth cup, a ninth step, or a ninth name. When full, the Hollow manifests as a \textit{Debt‑Walker} – a spirit that cannot be fought, only bargained with. It demands a story, a memory, or a public confession.
