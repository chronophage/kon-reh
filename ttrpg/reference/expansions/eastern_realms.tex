...
Finally, you will find nine new Patrons---spirits of grain, sun, storm, rivers, commerce, war, foxes, the sky, and the unnamed seal-breaker---each with Rites and obligations suited to the Eastern threshold.

\begin{infobox}
\textbf{The Hollow’s Ninth Debt (Eastern Threshold)}
In the East, the Hollow is not merely a barrow-thing; it is the \textit{unpaid interest on the Mandate of Heaven}. Every dynasty borrows legitimacy; every silence is a debt.
\begin{itemize}
    \item Every character (and faction) has a hidden \textbf{Ancestral Ledger} – a record of oaths sworn and broken by their bloodline. The GM may reveal a segment when a character fails a roll involving honour, hospitality, or a forgotten promise.
    \item \textbf{Hollow Attention [6]}: Ticks when the party ignores a ninth cup, a ninth step, or a ninth name. When full, the Hollow manifests as a \textit{Oath‑Keeper} – a spirit that cannot be fought, only bargained with. It demands a story, a memory, or a public confession.
    \item \textbf{Mandate Clock [8]}: Replaces the usual Mandate/Crisis dials in Eastern courts. When it fills, the current dynasty loses the Mandate; chaos spreads, but the Hollow’s hunger is briefly sated.
\end{itemize}
\end{infobox}
...
\begin{infobox}
\textbf{Twist: The Silent Ledger (Lethai‑thora)}
A Lethai‑thora’s most dangerous secret is not a scroll – it is a \textbf{Memory‑Thread} woven into their hair. Each thread is a debt owed to the dead. When a thread is cut:
\begin{itemize}
    \item The GM gains 1 Story Beat per thread.
    \item The secret becomes \textit{unwitnessed} – the Lethai‑thora forgets it, and it may resurface as a hostile spirit.
    \item A rival faction can use a cut thread as a \textbf{String} against the Lethai‑thora’s clan.
\end{itemize}
A character who accepts a Lethai‑thora’s memory (by touching a thread) gains a Clue but marks 1 Obligation (the dead now watch them).
\end{infobox}
...
\vspace{0.5em}
\noindent\textit{The Eastern Ninth:} Here the Hollow does not live under hills – it breathes in the salt foam. The ninth wave is never the largest; it is the one that \emph{remembers}. When a Lethai‑al drowns, their name becomes a tide‑charm; living kin may whisper it to calm a storm, but the Hollow will collect the debt at the next full moon.
...
\begin{itemize}
    ...
    \item \textbf{Broken Oath Compensation:} When you break a promise (even a minor one), you must immediately offer compensation---a gift, a service, or a truth. If you refuse, you gain the condition \textit{Wave‑Walker’s Shame} (--1 die to all social rolls until you make amends). A Lethai‑al who accepts a geas may gain +1 die to actions that serve it, but breaking it costs 2 Harm (Spirit).
...
\begin{infobox}
\textbf{Eastern Travel Strings \& SB}
When you draw a card from these decks, the GM may also note the following:
\begin{itemize}
    \item \textbf{Heart (Actor)} – If the rank is J or higher, you gain a temporary String with that person (e.g., “the salt merchant owes you a favour”). Mark it on your sheet; it lasts until the end of the journey.
    \item \textbf{Club (Pressure)} – On a 2–5, the GM gains 1 SB. On a 6–10, they gain 2 SB. On J–A, they gain 3 SB and may immediately tick a Hollow Attention clock.
    \item \textbf{Diamond (Leverage)} – The first time you use a Diamond from these decks, you may also clear 1 segment from a personal Obligation clock (the road has paid a small debt for you).
\end{itemize}
\end{infobox}
...
\section{The Seal‑Breaker --- The Unnamed Ninth}

\noindent\textbf{Domain:} Forgotten names, broken seals, the space between dynasties.\\
\textbf{Lore:} When a dynasty falls, the first thing the conquerors burn is the seal of the old emperor. The Seal‑Breaker is the spirit of that ash – the one who whispers “you are not your father’s debt.” Followers are ronin who have cut their own names, escaped slaves, and those who have been erased from clan ledgers. Her shrines are abandoned gatehouses and broken milestone markers.

\textbf{Favored Deeds:} Destroying a false contract, helping someone shed a hated name, hiding a fugitive from a blood debt.\\
\textbf{Taboos:} Using a name to threaten, claiming credit for a deed done in anonymity, sealing a letter with a seal you did not earn.

\vspace{0.5em}
\dusana{"The Seal‑Breaker does not ask for your name. She asks what you are willing to forget. I met her in a collapsed archive, wearing the face of a drowned scholar. She offered to erase my debt to the baronet – if I would burn my own journal. I did not. She laughed. ‘Then pay in stories,’ she said. ‘The ink remembers.’"}

\begin{infobox}
\textbf{Rites}
\begin{itemize}
    \item \textit{Low – Unwritten Petition (4 XP):} You may present a document to an official without speaking your name. For one scene, they cannot use your lineage or past against you. (Mark +1 Fatigue; the document smokes slightly.)
    \item \textit{Standard – The Anonymous Blade (8 XP):} Your next attack leaves no trace – no wound pattern, no blood type, no memory. If you kill, the victim’s name is struck from all ledgers for a generation. (Mark +2 Obligation; the Seal‑Breaker may ask you to forget a friend’s face in return.)
    \item \textit{High – The Broken Seal (14 XP):} Permanently void one formal contract, marriage, or oath of fealty. The two parties no longer owe each other anything, but \textit{you} become the witness – any future betrayal between them adds 1 Story Beat to the GM’s pool. (Mark +3 Corruption; the seal itself melts and reforms into a coin that cannot be spent.)
\end{itemize}
\end{infobox}
...
\subsection*{The Bell‑Moot (Eastern Dispute Resolution)}
When a dispute cannot be settled by the Censorate or the God‑King’s courts, the parties may call a \textbf{Bell‑Moot}. A neutral bell‑warden rings a copper bell eight times. If the ninth ring is never struck, the Moot is binding.

\textbf{Procedure:}
\begin{enumerate}
    \item Each party states their grievance while touching the bell’s clapper. (\texttt{Presence + Sway}, DV 3)
    \item The warden asks a single question: “What is the ninth word of this dispute?” The GM secretly determines the true ninth word (usually a hidden debt or a forgotten name).
    \item A successful \texttt{Wits + Lore} test (DV 4) reveals the ninth word; speaking it aloud resolves the dispute in the speaker’s favour. On a failure, the Moot dissolves, and the Hollow gains 1 tick on its Attention clock.
\end{enumerate}
