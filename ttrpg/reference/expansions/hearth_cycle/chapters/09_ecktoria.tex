...
\item At the end of each scene where the mask is worn, the wearer must confess a secret flaw to another person. The GM may ask: \textit{What guilt does the mask show you right now?} If the player refuses, the timer \textit{Confession} [4] ticks.
\item When the timer fills, the wearer is compelled to make a full public confession in the next forum or marketplace they enter. The compulsion is absolute. After confession, the mask can be removed.
