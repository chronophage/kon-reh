...
\item Timer : \textit{The Barrel's Limit} [6]. Ticks each time the barrel creates an effect in a new location. When full, the barrel cracks. It can still be used, but anyone within Near range hears a faint whisper: \textit{empty}. The jig is up.
\end{itemize}
