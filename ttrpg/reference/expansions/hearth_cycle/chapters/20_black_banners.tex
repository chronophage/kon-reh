...
\item The character can reset the timer by finding a new approach---a side path, a different tactic, a sacrifice the enemy did not expect. This requires a Wits + Tactics test (DV 4). On a failure, the timer does not reset. It simply\dots watches. Waiting is the hardest breath.
\end{itemize}
