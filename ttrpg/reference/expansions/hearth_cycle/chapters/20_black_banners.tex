...
\begin{itemize}
ℹtem [PRESSURE] [DREAD] [TRUTH]
ℹtem When the timer appears, the character gains +1 die to all actions directly related to the objective—panic focus, the body's cruel gift of narrow attention. But they suffer −−1 die to all other actions. Tunnel vision. The enemy in the corner of the eye. The step they did not see.
ℹtem If the timer reaches zero, the objective fails—but failure is not the end. Failure is a door. The GM may offer a Devil's Bargain: succeed anyway, but lose something else. A memory. A name. A breath you will never get back.
ℹtem The character can reset the timer by finding a new approach—a side path, a different tactic, a sacrifice the enemy did not expect. This requires a Wits + Tactics test (DV 4). On a failure, the timer does not reset. It simply... watches. Waiting is the hardest breath.
\end{itemize}
