...
\item Timer : \textit{Return the Shadow} [8]. Ticks each session the child remains shadowless. When full, the original bargain finds a new debtor --- possibly one of the characters.
\end{itemize}
