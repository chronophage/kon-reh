...
\begin{itemize}
ℹtem Tags: [CURSE] [LOCATION] [SOCIAL]
ℹtem −−1 Position on social rolls while on or near the bridge.
ℹtem Once per day, the GM may force a reroll on any Command or Sway roll attempted while crossing. Take the lower result.
ℹtem Timer : \textit{Repair the Bridge} [6] −−− ticks when someone crosses without courtesy, or when the bridge is used for argument or threat. Needs an offering of courtesy (bread, salt, a spoken apology) and a public act of repair −−− planting, cleaning, mending a cracked rail. Each full segment cleared requires one such act, witnessed by at least three people.
\end{itemize}
