...
Years later, he returned, bent and gray. The bridge had not fallen. It had not forgiven either. He knelt at the Vigil's threshold. "What must I pay?"
...
\item Timer : \textit{Repair the Bridge} [6] --- ticks when someone crosses without courtesy, or when the bridge is used for argument or threat. Needs an offering of courtesy (bread, salt, a spoken apology) and a public act of repair --- planting, cleaning, mending a cracked rail. Each full segment cleared requires one such act, witnessed by at least three people.
\end{itemize}
