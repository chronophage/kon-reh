...
\begin{tcolorbox}[colback=black!5,colframe=black!30,width=\linewidth,arc=2mm,auto outer arc,boxrule=0.5pt,left=0.5cm,right=0.5cm,fontupper=\itshape]
...
The Wanderer maintains a \textit{Grimoire}—not a spellbook but a collection of dream-diagrams, each page a map of a different ascent. The maps are inconsistent. The stair, it seems, changes its geometry depending on the dreamer's fears. The Wanderer's marginalia are cryptic: \textit{Step nine is always warm. Step eighteen is always cold. Step twenty-seven does not exist, but you will step on it anyway.}
