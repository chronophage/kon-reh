...
\end{atTheTable}
\textit{Quotas as Clocks:} \textbf{Boat-Timber Quota [6]}, \textbf{Lanternwood Allotment [4]}—fill timer to unlock export; overfill triggers Canopy Censure
...
\textit{Clocks:} \textbf{Ridge--Root Stalemate [4]} (project stalls until mixed design signed); \textbf{Sluice vs. Salmon [4]} (silt, tariffs, tempers). \\
...
\textit{Clocks:} \textbf{Furlong Breach [4]} (speech/grazing/felling in strip); \textbf{Banner at the Hedge [3]} (Meadow banners crowd edge; tempers tighten). \\
...
\begin{itemize}
    \item When Lethai uses talents from both paths in same scene, mark 1 segment on Curse Clock [4]
