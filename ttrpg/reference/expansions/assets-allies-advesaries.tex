...
\item \textbf{Pick an \asset:} Choose a type (safehouse, workshop, etc.). Mark Integrity \timer{6} and Resources \timer{6}. Attach 1-2 Strings (permits, seals). Choose 1-2 Project Clocks \timer{4}-\timer{8}.
...
\begin{center}
    ...
    \begin{itemize}
    \item \textbf{Too Many Clocks?} Combine related timers (e.g., asset Exposure and patron Sanction can share a unified "Trouble" timer)
...
\textbf{Mechanics:}
\begin{itemize}
  \item Shared timers with the PCs (Moral Clocks, Relationship Clocks)
