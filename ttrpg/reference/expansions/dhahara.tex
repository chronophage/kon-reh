...
The ledger of Dhahara has two columns. Neither balances.
...
Dhahara is defined by its two halves and the seasonal wind that connects them to the wider world.
...
\section{The Sidhi (Coastal Cousins of Ashaan)}

\subsection*{Pillars}
Sea trade, lighthouse courts, mixed ancestry, fierce independence. The Sidhi are the original coastal people of Dhahara, now a minority in the Brass Coast. Many fled Ashaani slavery generations ago; they remember.
...
\subsection{The Race}
Three factions want the amulet:
\begin{itemize}
