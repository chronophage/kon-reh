...
The prince's kingdom became the Red Desert. Not overnight, but over a single generation. The rivers dried. The grass turned to dust. The people who did not flee died of thirst or madness. Some say the prince had a lavish tomb built for himself as he was dying. Others clain that he was last seen walking into a sandstorm, still wearing the amulet, still smiling.
...
The amulet appears to do very little. Once per session, the wearer may reroll a single die. That is all. Scholars debate its true power. Some say it cursed the prince; others say it was cursed \textit{by} him.

The truth is that the amulet is a liability. Every time it is used, the demon stirs. The GM secretly tracks a \textbf{Fate Corruption} clock [6]. Each use ticks it. When the clock fills, the amulet manifests a major twist — a betrayal, a sudden storm, a forgotten debt that must be paid in blood. The players will not know the clock exists, but they will feel the pattern.

\textit{Kalrantha is one of the most powerful items in the world. That power is not mechanical. It is narrative. It is the slow erosion of agency, the seduction of certainty, the price of never being wrong. Let it be subtle. Let it be horrifying.}
...
\begin{itemize}
    \item \textbf{Ashaani (Veiled Sisters):} To use it as a weapon against their enemies. Their agent is a charming merchant named \textbf{Nadia} who offers a fortune.
    \item \textbf{Oshiiran Grain Auditors:} They fear the amulet will destabilise the grain trade. Their agent is a cold woman named \textbf{Mei‑Lin} who offers safe passage.
    \item \textbf{Kahfagian Admiralty:} They want to study it, possibly to use against Oshiira. Their agent is a cynical privateer named \textbf{Captain Red‑Hook} who offers a ship.
    \item \textbf{Dhaharan Monk (the True Believer):} A silent figure in burnt orange robes, \textbf{Brother Ananda}, who wants only to seal the amulet. He has no money, but he knows the temple's wards.
\end{itemize}
The party must travel from Ashaan → a Sidhi port (Port Shed) → north through Dhahara (the Scarred Plain) → the Himdahl temple. Each leg has a betrayal, a deal, and a choice of which faction to trust.
...
\begin{enumerate}
    ...
    \item \textbf{The Himdahl Temple:} The wards are failing. Brother Ananda performs a ritual that requires the amulet to be placed on an altar. The other factions attack. The demon wakes. The party must hold the line for five rounds while the ritual completes.
...
If the party seals the amulet, they gain a permanent boon: \textbf{The Demon's Debt} -- once per session, they may reroll a failed die, but the GM gains 1 SB. (The demon still stirs.) If they destroy it, Brother Ananda dies, and the party gains a curse: \textbf{The Unsealed Vow} -- the demon will hunt them in their dreams (roll a Dread Clock each session). If they use the wish, the demon is freed; the campaign shifts to a new arc: hunting the demon.
