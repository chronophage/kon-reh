...
\begin{itemize}
    ...
    \item \textbf{2 Successes, 2 Failures (partial):} The marriage goes forward, but at a cost. Increase Renown by +0. Gain a String, but also a Debt Timer [6] (the other house expects a future favour).
...
\begin{enumerate}
    ...
    \item \textbf{Feast (Presence+Performance, DV 3):} Success – 3 successes, 1 failure. \textbf{Partial success.} The marriage is agreed, but the dowry negotiations were strained; the party incurs a Debt Timer [6] (a future political favour).
\end{enumerate}
