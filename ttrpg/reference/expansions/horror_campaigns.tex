...
\textbf{Clock Size}: 9 (Queen) = 8-segment primary timer
...
The Horror Campaign Clocks Generator creates thematically appropriate multi-timer systems for any horror scenario, providing escalating tension and meaningful consequences that drive narrative forward while maintaining mechanical coherence.
...
\textbf{Secondary Clocks (2-3 timers, 8-15 segments)}
\begin{itemize}
