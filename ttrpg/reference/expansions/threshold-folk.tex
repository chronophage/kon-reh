...
\item \textbf{Complications:} Instability in bright light (scenes under harsh illumination start Controlled), Ward-lamp Attention (municipal lights ``track'' offenders).
\end{itemize}
...
Treat covered light as a one-shot DV –1 vs ward systems, spend mirror shards to invoke Witness, and trade Memory Echo for fast clues with the risk of Ward-Lamp Attention climbing. Bright scenes start Controlled until you bend light or find shade.
