...
{\LARGE\scshape\color{frostblue} The Frost Cycle}\\[0.8cm]
...
\begin{itemize}
    \item When a character dies with an unfulfilled oath (mechanically, a String held against them by another character or an NPC), they may rise as a draugr after 1d4 days.
    ...
    \begin{itemize}
        ...
        \item \textbf{Oath-Driven}: The draugr cannot be reasoned with---only fought. But if a character offers to settle the original oath (by fulfilling what the draugr owed), the draugr will stop fighting and listen.
    \end{itemize}
    \item \textbf{Clock: The Draugr's Patience [6]} --- Ticks each time the draugr is denied payment. When full, the draugr drags its oath-breaker's closest living relative into the grave with it.
\end{itemize}
...
Skjöld the Jarl, a man with a gray beard and a missing ear, who had ruled his fjord for forty years and never lost a battle---because, he said, he never fought one he could not win.
...
Egil walked into the Mistland. He walked for three days. The fog was thick and gray. He heard voices---his son's voice, calling from the water.
...
A longship---the \textit{Fjord-Wyrm}---had sailed for forty years. It had carried raiders to the Inland Sea, traders to Zakov, and one jarl to his funeral pyre. The wood was gray. The nails were rusted. The ship could not float.
...
\begin{itemize}
    ...
    \end{itemize}
    \item If the character burns or breaks the ship intentionally, the ship's spirit manifests as a draugr-like entity and haunts the character until the oath is fulfilled in blood.
...
The Direwood lies west of the Mistland, a forest of black trees and gray moss where the sun does not reach the ground. The wraiths of forgotten kings walk between the trunks. The dead do not stay buried there---they rise as mist-shrouded things with hollow voices and colder hands.
...
\paragraph{Tags / Mechanics:}
\begin{itemize}
    \item A character who takes anything from the Direwood without offering a story first gains the Condition \textbf{Forest Oath}. For each item taken (a branch, a stone, a handful of moss), the character owes one story.
    \item The story must be told to the forest itself. On a successful Spirit + Performance test (DV 4--7, depending on the value of what was taken), the forest accepts the story and clears the oath. On a failure, the forest demands another story---and may send a wraith to remind the character.
    \item \textbf{Clock: The Wraith-Lord's Hunger [10]} --- Ticks each time an oath is unpaid for a month. When full, the wraith-lord rises. He cannot be reasoned with. He will take what he is owed---a memory, a finger, a life.
\end{itemize}
...
We sailed south. The wind was cold. The sea was gray. I watched the Linn coast disappear into the mist.
