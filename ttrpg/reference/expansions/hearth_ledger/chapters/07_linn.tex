...
\item Clock: \textit{Sea-Change} [4]. Ticks each time the bandages are used. When full, the user gains a permanent minor mutation: webbed digits, salt-crusted skin that never dries, or eyes that reflect moonlight even indoors. No magic removes it short of a full renaming ritual at a crossroads at midnight.
\item Once the clock fills, the bandages become inert. They have given everything.
\end{itemize}
