...
Aeler typically bond with Patrons related to \textbf{Order, Infrastructure, Wealth, or Craft} (Sacred Geometry, Clock Work Monad, Mab, The Witness, Oath of Flame \& Light). Their approach to patronage is often contractual - they make deals and expect precise repayment.
...
\begin{itemize}
  ...
  \item \complicationtype{Surety Obligation:} You've guaranteed resources to a community. If you fail to deliver, mark 2 segments on your Obligation timer with your primary Patron (or gain a permanent Complication if you don't have one).
\end{itemize}
...
\begin{itemize}
  ...
  \item Creating timers for ``Audit [4]'' when contracts are violated
\end{itemize}
