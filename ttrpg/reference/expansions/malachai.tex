...
\textbf{Corruption:} Your Corruption timer is replaced by a \textbf{Desperation Clock}. When full, you gain a \textit{Bloom} (silver eyes, a second voice, a thirst for blood).
...
Bestow a gift with a hidden curse -- target gains an advantage (e.g., +1 die to all rolls for one scene) but begins a \textbf{Corruption Clock} that ticks each time they use the gift. When the timer fills, the curse manifests (GM chooses).
