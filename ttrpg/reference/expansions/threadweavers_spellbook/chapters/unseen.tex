...
\begin{itemize}
    ℹtem \textbf{[VEIL]} — The caster blurs a single target's appearance. Not invisibility. \emph{Plausible denial}.
    ℹtem \textbf{[SILENCE]} — A zone or target becomes mute. The Weave does not steal sound; it \emph{postpones} it.
    ℹtem \textbf{[ILLUSION]} — The Weave paints a false image. It does not move unless the caster concentrates. It does not cast a shadow unless the caster remembers.
    ℹtem \textbf{[SCRY]} — The Weave lends the caster a distant eye. A glimpse of a room, a face, a document. Never the whole truth.
    ℹtem \textbf{[MEMORY]} — The Weave touches the past. A recollection may be blurred, sharpened, or—with care—removed. The Weave charges interest.
\end{itemize}
...
∩tion{Spells of the Unseen Hand}\\
∣rule
...
\textbf{Folded Face (Partial)} & Your features blur, but a distinctive scar or piece of jewellery remains visible. The witness may recognise the detail later. The GM gains a Story Beat. \\
...
\textbf{Distant Gaze (Miss)} & You see nothing. Worse, the Weave shows you a \emph{wrong} image—a room you have never entered, a face you do not recognise. The GM may use this false vision as a complication later. \\
\textbf{Gloss of the Forgotten (Miss)} & The word you tried to blur becomes \emph{emphasised}. A subtle glow surrounds it. The reader will notice immediately. The GM gains a Story Beat. \\
\end{tabular}
