...
\begin{itemize}
  \item Improve Position by one step for a faith-based action (e.g.\ Risky$\to$Controlled).
...
\begin{itemize}
  ...
  \item Once per session, convert a \emph{faith-based Position penalty} (e.g.\ from venue or
        Devotion) into an equivalent \textbf{bonus} for a single roll (e.g.\ Risky$\to$Controlled),
