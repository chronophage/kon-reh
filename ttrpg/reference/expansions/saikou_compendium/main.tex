...
\begin{center}
\vspace*{2cm}
{\huge\bfseries\color{witnessSilver} The Threshold Compendium}\\[0.8cm]
{\Large\itshape An Investigation into the Unquiet Dead, the Cursed, and the Hungry}\\[1.5cm]
\rule{0.6\textwidth}{1pt}\\[0.5cm]
{\large Saikou Ira, Captain (Ret.), Kahfagian Marine Corps}\\[0.3cm]
