...
I did not seek this work. It found me, as such things always do, in the space between the tide and the truth---that gray, salt-scoured margin where the ocean's memory and a drowned sailor's last breath become indistinguishable.
...
\item[Varnek Karn] The Death's Negotiator, broker of the gray between. I call on Varnek Karn when the dead will not stay silent, when a witness has gone beyond the veil, or when I must speak across the threshold of the last breath. Its power is not command but parley---a contract signed in memory and sealed with a name. The dead remember; Varnek Karn ensures they speak truth, for a price.
