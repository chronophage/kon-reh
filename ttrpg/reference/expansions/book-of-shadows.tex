...
\begin{itemize}[noitemsep]
    ...
    \item New Witch Orders, Witch Hunter factions, relics, Observances, and talents
...
suppression tools, patron bargains, or narrative Observances.
...
\begin{itemize}[leftmargin=*]
    ...
    \item Use Observances, hexes, and hunter tools in unrelated campaigns  
...
Custodians of the wells—genderless, nameless, masked—shepherd pilgrims through shedding Observances.
...
Crusader forces breach outer wards; witchcraft flickers under Mykkielite dampening Observances.
...
\begin{itemize}[leftmargin=*]
    ...
    \item Aveh shedding Observances and dissolution boons
...
\begin{itemize}
    ...
    \item All Observances require +1 DV to cast within this zone.
\end{itemize}
...
%-----------------------------------------------------------
\subsection{5.3 Aveh Shedding Observances}
\index{Observances!Aveh}
%-----------------------------------------------------------}

Aveh's Observances revolve around anonymity, dissolution of self, and the transcendence found in shedding one's past.
...
Every time a PC uses advanced Aveh Observances, fill one segment.  
...
The Thorns do not cast Observances — they enact \textbf{extractions}.  
...
Major miracles, storm Observances, Thorn incursions, memory-loss episodes.
...
\textbf{Lantern Surge:} Suppress witchcraft within Near range. Witch Observances require +1 DV.

\textbf{Condemnation Step:} When stepping forward in ritual stance, force a PC 
to roll Spirit (DV 3) or become Shaken.

\subsubsection*{Observances / Miracles}
\begin{itemize}[leftmargin=*]
...
\subsubsection*{Shedding Observances}
\begin{itemize}[leftmargin=*]
...
\textbf{Motifs:} Diplomacy, Secret Warfare, Oaths of Silence, Knife-Observances
...
\begin{itemize}[leftmargin=*]
    ...
    \item Captured "blasphemers" undergo purification Observances  
...
redeemed—if it abandons the Wells of Forgetting and Aveh's Observances.
...
The emissaries demand a doctrinal review of Aveh's Observances.
...
\begin{itemize}
    ...
    \item Track the missing shadow (requires specialized Observances)
...
\begin{itemize}
    ...
    \item witchcraft orders, Observances, bargains, and taboos
...
Such places are fertile for Observances---  
...
\begin{itemize}[leftmargin=1.5em]
    ...
    \item Wards, blessings, and holy Observances react violently:
...
\begin{itemize}[leftmargin=1.5em]
    \item \textbf{Lesser Observances} from your Witch Order
...
\begin{itemize}[leftmargin=1.5em]
    ...
    \item You cannot attempt \textbf{Grand Observances}
    \item Your Position on witchcraft rolls is capped at \textbf{Controlled}
\end{itemize}
...
and grants full access to the Order’s Observances, Hexes, Cords, and mysteries.
...
\subsubsection{Observances of the Silver Quiet}
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{With Morag’s Hags:} Morag wObservances hidden costs into every bargain; Lunera illuminates them. The two orders sometimes collaborate to protect a village and other times wage quiet war over whose version of ``justice'' stands.
...
\begin{itemize}[leftmargin=*]
    \item Curses and Observances you perform gain \textbf{+1 Effect}.
...
%====================================================
\subsubsection{Observances of Morag}
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{With Witch-Hunters:} Chain-Lanterns fear Morag’s Observances most: her curses are “law-shaped,” hard to expose, and harder to break.
\end{itemize}
...
%====================================================
\subsubsection{Observances of Mab}
...
\begin{itemize}[leftmargin=*]
    \item \textbf{With Lunera’s Witches:} Lunera illuminates truth; Mab re-wObservances it. They clash over “what the story wishes to be.”
...
%====================================================
\subsubsection{Observances of the Veiled Ledger}
...
\paragraph{Cultural Hosts}
\begin{itemize}[leftmargin=*]
    \item \textbf{Isoka}: Homeland; bone-marked Observances, desert pyres, shrines where names are buried.  
...
%====================================================
\subsubsection{Observances of the Shed Vigil}
...
%====================================================
\subsubsection{Observances, Hexes, and Curses}
...
\begin{enumerate}[leftmargin=*]
    ...
    A sect of Rainmaidens is hunting one of their own for forbidden Observances.
\end{enumerate}
...
\begin{creature}[The Faceless Road — Devotees of Aveh]
    ...
    their Observances falter and lose Position.
    }
    \end{creature}
    %===========================================================
...
\paragraph{Observances of the Hearth}
\begin{description}
...
\textit{the long work, the gentle tending, the quiet Observances that keep the world from fraying at the seams.}
...
\subsection*{Sisters of the Oath: The Veiled Order of Flame and Light}
...
%===========================================================
\paragraph{Observances of the Veiled Order}
%===========================================================
...
%===========================================================
\paragraph{Curses and Punitive Observances}
%===========================================================
...
\end{itemize}
    ...
    \begin{longtable}{p{0.25\linewidth} p{0.33\linewidth} p{0.33\linewidth}}
    \toprule
    \textbf{Order} &
    ...
    %-------------------------------------------------------------
    \subsubsection*{Observances of the Wild Choir}
    ...
    \begin{itemize}[noitemsep]
      ...
      \item \textbf{World-Rooted} --- You cannot be surprised in lands where you’ve offered Observances.
    \end{itemize}
...
\begin{itemize}[noitemsep]
  ...
  \item \textbf{Ritual Scourging} --- Perform Observances to permanently weaken certain magic.
\end{itemize}
...
\begin{itemize}[noitemsep]
    ...
    \item Midnight: spirit-listening, forbidden Observances
...
\index{Observances!Grand Rite of Severance}
...
the most potent transformations enacted through coven Observances.
...
These workings are not Observances but structured group effects.
...
\subsubsection{Hunter Observances (Anti-Observances)}
Unlike witches, Hunters have \textbf{no Patrons}.  
Their “Observances” are destructive inversions—oaths, suppressions, nullifications.
...
\begin{itemize}[noitemsep,leftmargin=1.5em]
    ...
    +1d to bypass, shatter, or dispel witch wards and Lesser Observances.
\end{itemize}
...
\begin{itemize}[noitemsep,leftmargin=1.5em]
    ...
    Prevent a witch from using Observances for one scene (DV 4 Resist to break).
\end{itemize}
...
\begin{itemize}[noitemsep,leftmargin=1.5em]
    ...
    Lesser Observances unravel near you; Grand Observances suffer -1d.  
...
\begin{itemize}[leftmargin=*]
    ...
    While bound, casters suffer \(-1\)d and cannot activate Observances requiring gestures.
...
\begin{itemize}[leftmargin=*]
    ...
    Until broken, Observances that cross the threshold suffer \(-2\) Effect.
\end{itemize}
...
\begin{itemize}[noitemsep,leftmargin=1.5em]
    ...
    Your familiar can swallow Lesser Observances or minor curses.  
...
\subsection*{New Hybrid Observances}
\begin{itemize}[leftmargin=1.5em]
...
It merely rewObservances the cost of the hybrid’s future actions.
...
\begin{description}
    ...
    Witch Hunters may escalate directly into violence or binding Observances.
...
\begin{itemize}[leftmargin=1.5em]
    ...
    \item Uneasy: Controlled
    \item Divided: Controlled (improve Position on 6)
