...
You bind yourself to a Patron through cord, blood, or name-work, stepping into
the hidden world of witchcraft. This Talent represents an irreversible shift in
identity, power, and fate.

\paragraph{Cord Scar (Permanent Cost).}
When you take this Talent, choose one Attribute (Body, Wits, or Spirit).  
\textbf{Reduce it by 1 permanently.}  
This scar reflects the price extracted by the Patron as your soul takes on its first knot.

\paragraph{Witchcraft Access.}
You gain the ability to perform:
\begin{itemize}[leftmargin=1.5em]
    \item \textbf{Lesser Rites} from any Witch Order you are affiliated with
    \item \textbf{Basic Cordwork}: sensing curses, identifying bindings, or “softening” magic for 1 scene
\end{itemize}

\paragraph{Early Limitations (Novice Witch).}
Until you acquire at least one Tier I Witch talent:
\begin{itemize}[leftmargin=1.5em]
    \item You may perform \textbf{only one Working per scene}
    \item You \textbf{cannot attempt Grand Rites}
    \item Your Position on Witchcraft rolls is capped at \textbf{Controlled}
\end{itemize}

\paragraph{Patron Taboo (Narrative Cost).}
Your Patron marks you with a subtle obligation.  
Work with your GM to define a \textbf{Taboo}.  
Violating it inflicts \textbf{2 Fatigue} and \textbf{+1 SB}.

\paragraph{Becoming a True Witch.}
Taking any Tier I Witch Order talent removes the novice limitations and allows you to:
\begin{itemize}[leftmargin=1.5em]
    \item Perform full Workings
    \item Join a coven or declare your own path
    \item Access that Order's Rites, Hexes, and Cordwork
\end{itemize}
