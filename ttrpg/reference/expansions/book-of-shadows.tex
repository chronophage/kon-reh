...
\section*{The Three-Fold Working}
Witchcraft is an art of intention, sacrifice, and the judgment of unseen powers. 
When a witch calls upon a Working, the balance between Will and Cost determines 
what answer the Witness offers.

%-----------------------------------------------------------
\subsection*{1. State the Witness}
The witch declares the Witness before whom the Working is performed: a Patron, 
a lesser spirit, a relic of old power, a haunted crossroads, or the quiet world 
beyond mortal sight.

The GM sets a Difficulty Value (DV) based on:
\begin{itemize}[noitemsep]
    \item the nature and temperament of the Witness,
    \item the danger or sanctity of the moment,
    \item the witch's standing, devotion, or recent defiance.
\end{itemize}

A Witness may adjust the DV by \textbf{+1 or --1} if the witch has recently 
pleased or offended them.

%-----------------------------------------------------------
\subsection*{2. Speak Your Will}
The witch declares the effect they seek. They roll and Count Successes for Will.  
These successes represent the clarity of intention, alignment with the Patron's 
nature, and the witch’s spiritual authority.

If the witch gains \textbf{0 Will successes}, the Working falters and the Witness 
turns their gaze elsewhere.

%-----------------------------------------------------------
\subsection*{3. Name Your Cost}
The witch offers a sacrifice: harm, memory, bond, promise, taboo, Fatigue, or 
future consequence. They then roll and Count Successes for the Cost.

If the witch gains \textbf{0 Cost successes}, the Witness rejects the offering 
and exacts the entire named Cost at once.

%-----------------------------------------------------------
\subsection*{4. Resolve the Balance}
Subtract Will successes from Cost successes:
\[
\text{Total} = \text{Cost} - \text{Will}
\]

\begin{itemize}[noitemsep]
    \item \textbf{If Total $\ge$ DV:}  
    The Working succeeds. The Witness accepts the sacrifice and grants the effect 
    as declared.

    \item \textbf{If Total $<$ DV:}  
    The Working manifests imperfectly or incompletely.  
    The GM determines the form of the partial success: weakened effect, hidden 
    consequence, a new Clock, or a demand for further payment.

    \item \textbf{If Total $\ge$ DV + 2:}  
    The Witness grants a boon in addition to the Working: an omen, a whispered 
    truth, a protective blessing, or a fleeting advantage.

\end{itemize}

%-----------------------------------------------------------
\subsection*{5. Consequences of Favor and Disfavor}
A Patron or spirit may alter the Working’s outcome through subtle signs.  
A witch who has honored the rites or acted in harmony with their Order may 
receive leniency. One who has denied their nature may be judged more harshly.

A Working resolved before a sacred place, relic, or ancestral bond may shift 
its DV according to the deeper power that listens.

%-----------------------------------------------------------
\subsection*{6. The Shape of a Partial Working}
When the Working’s Total does not meet the DV, its effect is not wholly denied. 
Instead, it bends or breaks:

\begin{itemize}[noitemsep]
    \item a diminished version of the intended effect appears,
    \item a flaw or twist shadows the result,
    \item the Working succeeds but invites a new spiritual debt,
    \item an unintended truth is revealed,
    \item a Patron’s whisper marks the witch for future judgment.
\end{itemize}

Partial Workings sustain the tone of witchcraft: no certainty, no safety, only 
bargain and consequence.

%-----------------------------------------------------------
\subsection*{7. The Cost of Power}
Every Working is a pact, and every pact must be paid.  
When a witch names their Cost, they bind themselves to its truth whether or 
not the Working succeeds. A Witness may accept, delay, or twist the sacrifice, 
but never ignore it.

Costs that suit the Patron’s nature are more easily accepted; those that deny 
it may increase the DV or call forth unforeseen debt.

%-----------------------------------------------------------
\subsection*{8. The Voice of the Witness}
The GM speaks for the Witness only in outcome. Its form—radiance, shadow, 
wind, dream, or quiet sign—belongs to the fiction. A benevolent Patron may 
answer in warmth; a cold one in silence. Some spirits speak through failure 
as clearly as success.

A witch who listens may learn much, even when power is denied.

\section*{Examples by Order}

The Three-Fold Working takes many forms across the Orders, each shaped by its 
Patron’s nature and the witch’s place within that mystery. The examples below 
illustrate how Will, Cost, and Witness combine in play.

%===========================================================
\subsection*{Order of Ikasha --- The Unseen Covenant}

\textbf{Working: Opening a Locked Archive in Moonless Darkness}

\textbf{Witness:} The Quiet Shadow beneath the threshold (DV 3)

\textbf{Speak Your Will:}  
To unweave the lock’s memory of being sealed and slip within unnoticed.

\textbf{Name Your Cost:}  
A single personal recollection, surrendered to the dark.

\textbf{Outcome:}  
Will 2, Cost 4. Total = 2 $\Rightarrow$ Partial Success.  
The door opens, but the witch forgets a detail of someone they once trusted; 
the Witness takes that memory as payment.

%===========================================================
\subsection*{Order of Livaea --- The Velvet Hand}

\textbf{Working: Calming a Gathering Before Tempers Break}

\textbf{Witness:} The Unseen Mirror of Desire (DV 2)

\textbf{Speak Your Will:}  
To smooth hearts with a whispered glamour and draw attention to one's grace.

\textbf{Name Your Cost:}  
A fleeting moment of true vulnerability revealed to another.

\textbf{Outcome:}  
Will 3, Cost 2. Total = --1 $\Rightarrow$ Proportional Success.  
The crowd warms, yet one guest glimpses the witch’s unguarded heart; fascination 
or danger may follow.

%===========================================================
\subsection*{Order of Raéyn --- Storm and Tide}

\textbf{Working: Calling the Tide to Swallow a Pursuer’s Footprints}

\textbf{Witness:} The Tide’s Shadow Beneath the Waves (DV 4)

\textbf{Speak Your Will:}  
To summon a sudden swell and erase all trace of the hunted.

\textbf{Name Your Cost:}  
Surrendering one cherished certainty to the storm’s shifting nature.

\textbf{Outcome:}  
Will 4, Cost 5. Total = 1 $\Rightarrow$ Partial Success.  
The tide rises and the footprints vanish, but the witch becomes unsure whether 
a trusted ally still stands by them.

%===========================================================
\subsection*{Order of Aveh --- The Faceless Patron}

\textbf{Working: Passing Unseen Through a Guarded Gate}

\textbf{Witness:} The Mask Without Form (DV 3)

\textbf{Speak Your Will:}  
To blur one’s presence and walk as a forgotten shape.

\textbf{Name Your Cost:}  
Setting aside one aspect of personal identity for the next day.

\textbf{Outcome:}  
Will 1, Cost 4. Total = 3 $\Rightarrow$ Success.  
The guards see nothing unusual. The witch later struggles to recall their own 
voice until dawn restores it.

%===========================================================
\subsection*{Hearth Witches --- Keepers of Quiet Flames}

\textbf{Working: Soothing the Agony of a Grievous Wound}

\textbf{Witness:} The Ember-Spirit of the Hearth (DV 2)

\textbf{Speak Your Will:}  
To draw the pain into a clay charm and cool it with gentle hands.

\textbf{Name Your Cost:}  
Bearing a portion of the pain for the remainder of the night.

\textbf{Outcome:}  
Will 2, Cost 3. Total = 1 $\Rightarrow$ Partial Success.  
The wound eases, but the witch wakes gasping with borrowed suffering.

%===========================================================
\subsection*{Order of Malachai --- The Chained Angel}

\textbf{Working: Granting a Warrior the Strength to Stand Again}

\textbf{Witness:} A Broken Halo in the Dust (DV 3)

\textbf{Speak Your Will:}  
To bind a radiant blessing that restores vigor for one final effort.

\textbf{Name Your Cost:}  
A vow taken upon one’s own fate: to perform a difficult act before the next dawn.

\textbf{Outcome:}  
Will 3, Cost 5. Total = 2 $\Rightarrow$ Success.  
The blessing takes hold, but the vow now burns; failure to fulfill it invites 
Malachai’s judgment.

%===========================================================
\subsection*{Order of Ikasha --- The Unseen Covenant (Assassination Example)}

\textbf{Working: Silencing a Foe Before a Cry Escapes}

\textbf{Witness:} The Sleeper Beneath the Shadowed Road (DV 4)

\textbf{Speak Your Will:}  
To still the breath of the marked one with a quiet motion of the blade.

\textbf{Name Your Cost:}  
Surrendering a bond of the heart, forgotten forever.

\textbf{Outcome:}  
Will 3, Cost 6. Total = 3 $\Rightarrow$ Success.  
The target falls without sound, but the witch can no longer recall why a certain 
friend once mattered to them.

\section*{GM Table: Setting Difficulty by Witness}

The DV of a Working reflects not only the power of the Witness, but its temperament,
its interest in the witch, and the nature of the request. Use the tables below as 
guidance when judging a Working.

\subsection*{Nature of the Witness}

\begin{center}
\begin{tabular}{p{0.45\textwidth} c}
\toprule
\textbf{Witness Type} & \textbf{DV} \\
\midrule
A small or household spirit               & 1 \\
A friendly hearth-spirit or ancestor      & 1--2 \\
A familiar Patron shrine or symbol        & 2 \\
A wandering shade or lesser night-force   & 2--3 \\
An Order Patron’s distant attention       & 3 \\
A sacred place tied to a Patron           & 3--4 \\
A wrathful or slumbering spirit           & 4 \\
A major Patron’s direct gaze              & 4--5 \\
A relic of great age or deep memory       & 4--6 \\
The crossroads between mortal and unseen  & 5--6 \\
\bottomrule
\end{tabular}
\end{center}

\subsection*{Temperament of the Witness}

\begin{center}
\begin{tabular}{p{0.45\textwidth} c}
\toprule
\textbf{Witness Disposition} & \textbf{DV Modifier} \\
\midrule
The witch has recently honored the Patron’s rites         & --1 \\
The witch acts wholly in harmony with the Patron’s nature & --1 \\
The witch bears a rightful token or offering              & --1 \\
\midrule
The Witness is indifferent or inattentive                 & +0 \\
\midrule
The witch has broken taboo or slighted the Patron         & +1 \\
The request strains the Patron’s nature                   & +1 \\
The Witness is angered, bound, or wounded                 & +1--2 \\
The Working contests another Patron’s domain              & +2 \\
\bottomrule
\end{tabular}
\end{center}

\subsection*{Nature of the Request}

\begin{center}
\begin{tabular}{p{0.45\textwidth} c}
\toprule
\textbf{Request Type} & \textbf{DV Modifier} \\
\midrule
Minor omen, guidance, or subtle change                    & +0 \\
Strengthening a spirit, ward, or blessing                 & +1 \\
Shaping emotion, shadow, tide, or memory                  & +1 \\
Revealing hidden truths or forgotten paths                & +1--2 \\
Striking down a foe in silence                            & +2 \\
Reshaping fate, death, or sworn vows                      & +2--3 \\
Calling upon a Patron for direct intervention             & +3--4 \\
\bottomrule
\end{tabular}
\end{center}

\subsection*{Scene and Setting Conditions}

\begin{center}
\begin{tabular}{p{0.45\textwidth} c}
\toprule
\textbf{Condition} & \textbf{DV Modifier} \\
\midrule
The Working occurs in darkness, threshold, or storm       & --1 \\
The Working occurs in open daylight or under scrutiny     & +1 \\
The Working is rushed, interrupted, or fearful            & +1 \\
The environment resonates with the Patron’s domain        & --1--2 \\
The environment opposes the Patron’s nature               & +1--2 \\
\bottomrule
\end{tabular}
\end{center}

\subsection*{Putting It Together}
To determine the final DV:

\[
\text{DV} = \text{Base Witness DV} 
           + \text{Disposition Modifiers}
           + \text{Request Modifiers}
           + \text{Scene Modifiers}
\]

A Witness’s judgment may shift without warning; even spirits have moods.

\section*{Costs by Order}

Each Patron accepts certain offerings more readily than others. These Costs 
shape the nature of every Working performed in their name. The tables below 
offer examples suited to each Order.

\begin{center}
\begin{tabular}{p{0.3\textwidth} p{0.6\textwidth}}
\toprule
\multicolumn{2}{c}{\textbf{Order of Ikasha --- The Unseen Covenant}} \\
\midrule
Memory & Forgetting a name, a face, or a cherished detail. \\
Shadow Mark & Leaving behind a trace of one’s presence for the Covenant to collect. \\
Bond & Loosening a tie of friendship or trust. \\
Fear & Accepting a moment of dread, swallowed in silence. \\
Identity & Setting aside a preference, habit, or small part of oneself. \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{p{0.3\textwidth} p{0.6\textwidth}}
\toprule
\multicolumn{2}{c}{\textbf{Order of Livaea --- The Velvet Hand}} \\
\midrule
Vulnerability & Revealing an honest truth that wounds pride. \\
Desire & Admitting a want long hidden from oneself. \\
Charm & Offering affection or attention to an undesired suitor. \\
Poise & Losing control of emotion or composure. \\
Favor & Granting a boon to someone who may misuse it. \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{p{0.3\textwidth} p{0.6\textwidth}}
\toprule
\multicolumn{2}{c}{\textbf{Order of Raéyn --- Storm and Tide}} \\
\midrule
Certainty & Surrendering a belief or conviction to the shifting tide. \\
Calm & Accepting a surge of raw emotion. \\
Vow & Making a promise bound to the sea’s temperament. \\
Balance & Losing footing—literally or figuratively. \\
Breath & Offering a held breath or moment of suffocation. \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{p{0.3\textwidth} p{0.6\textwidth}}
\toprule
\multicolumn{2}{c}{\textbf{Order of Aveh --- The Faceless Patron}} \\
\midrule
Name & Surrendering the memory of being addressed fondly. \\
Reflection & Accepting that one's appearance may shift unknowingly. \\
Role & Letting go of a social standing or mask. \\
Trace & Removing one’s mark, presence, or recognition from a place. \\
Voice & Losing the clarity or tone of speech for a time. \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{p{0.3\textwidth} p{0.6\textwidth}}
\toprule
\multicolumn{2}{c}{\textbf{Hearth Witches --- Keepers of Quiet Flames}} \\
\midrule
Comfort & Bearing another’s pain or fear. \\
Warmth & Allowing one’s own spirit to grow cold for a night. \\
Time & Devoting a portion of the day to a small spirit’s need. \\
Burden & Taking on a sorrow left in the home. \\
Memory & Reliving a moment once thought healed. \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{p{0.3\textwidth} p{0.6\textwidth}}
\toprule
\multicolumn{2}{c}{\textbf{Order of Malachai --- The Chained Angel}} \\
\midrule
Vow & Swearing an oath bound to fate’s chain. \\
Suffering & Enduring a measure of pain or sorrow in place of another. \\
Burden of Doom & Accepting a fragment of one’s destined downfall. \\
Duty & Agreeing to perform a difficult task before dawn. \\
Truth & Revealing a fault, sin, or regret without defense. \\
\bottomrule
\end{tabular}
\end{center}

\section*{Partial Success Consequences}

When a Working does not meet the DV but is not wholly denied, the Witness may 
answer in part. These consequences reflect uncertain favor, strained bargains, 
and the hidden nature of witchcraft.
...
Withered Effect &
The Working manifests only a fragment of what was intended. Its strength, duration, 
or clarity is diminished. \\

Twisting of Intent &
The power acts askew: the result is useful, but not in the manner hoped. \\

Calling of a Debt &
A spiritual obligation forms. The Patron or Witness will demand fulfillment later. \\

Revelation of an Unwanted Truth &
The Working reveals an omen, memory, or secret the witch did not seek. \\

Marked by the Unseen &
A subtle sign clings to the witch: a shadow that lingers, a whispering draft, or 
eyes that cannot look away. \\

Disturbance of Spirits &
Nearby spirits notice the witch’s attempt and react with curiosity, hunger, or ire. \\

Faltering Cost &
The sacrifice is taken imperfectly, misdirected, or magnified; the witch suffers 
a lesser or warped form of what they offered. \\

Echo of the Attempt &
Traces of the Working remain, attracting attention from spirits, witches, or 
those sensitive to such things. \\

Emergent Complication &
A new Clock appears, representing unforeseen danger, debt, or entanglement. \\

Favor with a Hook &
The Working succeeds more than expected, but grants a boon that binds the witch 
to future consequence. \\

Loss of Balance &
The witch is shaken or unmoored: fatigue, disorientation, or emotional imbalance 
follows the partial Working. \\

Unquiet Witness &
The Witness responds in a manner that alters the surrounding environment: a gust 
of cold, a shift in shadow, a trembling light, or a whispered name. \\
