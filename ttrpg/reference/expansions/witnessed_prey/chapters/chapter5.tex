...
This chapter catalogues the beasts that walk the spaces between towns: predators of the steppe, the forest, the coast, and the deep places beneath the world. Some are natural; most are not. All are hungry.
...
\grey{I have seen an Earth‑Shark breach beneath a horse. The horse did not scream. The shark pulled it under. The ground closed. There was no blood.}

\subsection*{Dust Hulk}

\noindent\textbf{Description}: Wind‑packed silhouette that rises from dunes. It is not a creature; it is a **memory** of a creature, given weight by the desert’s thirst.
...
\noindent\textbf{Clock}: \emph{Thirst [6]} – ticks each time the Hulk is denied water. When full, it becomes a **Dust Walker** (Tier IV) – corporeal, aggressive, and able to drain the moisture from living flesh.
...
\noindent\textbf{Traits}: 
\emph{Scavenger’s Bite} (DV 2, Harm 1) – prefers to attack the wounded. \emph{Rune Sight} – can see the weight of a creature’s unfulfilled promises. A creature with an active Debt Clock is visible from twice the normal range.
...
\noindent\textbf{Description}: Pale eel in dry salt pans; voices like flutes. They are not eels. They are the **nerves** of the desert, exposed and singing.
...
\noindent\textbf{Complications}: The Salt Screamer’s scream is not an attack; it is a **question**. The question is always: “What is your name?” Answering truthfully grants +1 die to all actions for the scene. Answering falsely advances the \emph{Scream’s Patience} clock.
...
\noindent\textbf{Description}: Shadow‑striped cat that steps between gusts. Its stripes are not fur; they are **cracks** in the air, where the panther has learned to fold itself.
...
\grey{I have seen a Phase Panther’s shadow without its body. The shadow was hunting alone. It had forgotten its flesh.}

\subsection*{Lichen‑Bear}

\noindent\textbf{Description}: Moss‑matted ursine with rock‑teeth. The moss is not a covering; it is the bear’s **memory** of a forest that no longer exists.
...
\noindent\textbf{Clock}: \emph{Forest’s Memory [8]} – ticks each time the bear is wounded. When full, the moss grows over the bear’s eyes, and it becomes blind but berserk (+2 dice to attack, −2 dice to defend).
...
\noindent\textbf{Description}: Empty helm grown through with thorn. It is not a knight. It is a **hedge** that learned to walk, still dreaming of the wall it once was.
...
\noindent\textbf{Description}: Kelp‑maned constrictor nesting in pilings. It is not a snake; it is a **rope** that forgot it was tied.
...
\noindent\textbf{Resolution}: Beat a drum in a rhythm the serpent does not recognise. It will become confused and withdraw. To kill it, you must sever the kelp mane; without it, the serpent loses its cover and becomes Vulnerable (−1 die to defense).
...
\noindent\textbf{Description}: Burrows through barrow loam; tastes names. It is not an eel. It is a **question** that learned to wiggle.
...
\noindent\textbf{Complications}: Grave‑Eels are not aggressive. They are **scholars**. They will follow a party for hours, observing, tasting names from the air.
...
\noindent\textbf{Description}: Serpent of polished copper and malachite, slithering through stone as if it were water. It is not a serpent. It is the mountain’s **blood** given form.
...
\grey{The Aeler do not kill Vein‑Serpents. They hire them. The serpent is paid in copper dust and silence.}
...
\noindent\textbf{Description}: Swarm of iron‑scaled moths that taste memory. They are not insects; they are the dungeon’s **forgetting** given wings.
...
\noindent\textbf{Clock}: \emph{Rust Memory [6]} – ticks each time the swarm consumes a memory. When full, it becomes a **Rust Walker** (Tier III, Cap 4) – a humanoid figure of rust that can wield corroded weapons.
...
\noindent\textbf{Description}: Floating orb of watchlight; jealous of secrets. It is not a creature; it is the dungeon’s **attention** made visible.
...
\noindent\textbf{Complications}: The Lantern‑Eye is not malevolent. It is **curious**. It will follow the party, watching, until a secret is spoken.
...
\grey{The wilds do not hate you. They do not love you. They simply remember. And memory is a debt that never closes.}
