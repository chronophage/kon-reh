...
\noindent\textbf{Traits}: \emph{Legal Warfare} – The Auditor may spend 2 SB to impose a \emph{Seizure Clock} on a character’s Asset. When the timer fills, the Asset is confiscated. The notice is always polite; the bailiffs are not.
