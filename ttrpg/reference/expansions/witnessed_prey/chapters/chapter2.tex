...
This chapter catalogues the unquiet: from the faint echo of a scream repeated at midnight to the poltergeist that has learned to count your breaths. Saikou Ira taught me that a ghost is not a monster; it is a debt that has forgotten how to be paid. I have tried to honour that distinction here.

\section*{The Spirit Taxonomy (After Saikou Ira)}

Ira’s taxonomy is not a scientific classification; it is a **pragmatic ledger** of how the dead manifest and how they may be quieted. I have reproduced it with his permission – and with the caveat that no ghost ever read a taxonomy before deciding to haunt.
...
\noindent\textbf{Complications}: Aura of Fear – all actions Desperate within Near range. Environmental Collapse – clocks advance.
...
\grey{I have seen a Poltergeist in Stage Four. It wore the face of a child. The child had been dead for three days. The host was the mother. Do not let it fill.}
...
\saikou{I negotiated a feeding schedule with a ghoul in Port Shed. Animal blood, provided by a butcher, in exchange for her labour as a night watchman. She has not harmed a human in five years. Her mother knows. The butcher knows. I have told no one else until now.}
...
\noindent\textbf{Description}: Appears when someone miscounts – nine steps, nine cups, nine breaths. It is not a ghost of a person; it is a ghost of an **error**. The error is its anchor; the witness is its prey.
...
\noindent\textbf{Complications}: The Wraith cannot be fought; it can only be **counted**. A silver mirror will show its outline, but not its face.
...
\noindent\textbf{Clock}: \emph{Wraith’s Patience [6]} – ticks each time the victim miscounts. When full, the Wraith takes a **significant** memory: a name, a face, a year. I have seen a merchant forget his daughter’s name. He did not weep. He could not remember why he should.
...
\noindent\textbf{Traits}: 
\emph{Demand} – The Debt‑Walker speaks a single sentence: “You owe.” It does not specify the debt; the debtor must remember. \emph{Interest} – Each time the Debt‑Walker appears, the original debt grows. A forgotten promise to return a book becomes a curse on the bloodline.
...
\noindent\textbf{Clock}: \emph{Debt’s Interest [8]} – ticks each time the debt is ignored. When full, the Debt‑Walker claims the debtor’s name. The debtor becomes a stranger to everyone who knew them.

\saikou{The Debt‑Walker is not a demon. It is a **creditor**. I have seen a village pay a collective debt with a single story told around the fire. The Walker listened, nodded, and did not return. The story was about a woman who forgot to name her child. The child’s name was the debt.}
...
\noindent\textbf{Complications}: The Shade cannot be reasoned with directly; it cannot speak. It can only be **named**.
...
Not all unquiet dead require steel. Some require **witness**. Use this table as a guide.
...
| Debt‑Walker | Pay original debt in coin, kind, or story | Witnessed payment | Debtor’s name is erased |
...
\grey{Exorcism is negotiation. Negotiation is memory. Memory is debt. Pay attention to the first line.}
