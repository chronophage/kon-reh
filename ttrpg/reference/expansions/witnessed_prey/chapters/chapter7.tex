...
\textbf{Armor}: Medium (scavenged plate) --- \textit{Harm 2 $\rightarrow$ Fatigue 1, Harm 3 $\rightarrow$ Fatigue 2}
...
\textbf{Armor}: Light (thick fur) --- \textit{Harm 1 $\rightarrow$ Fatigue 1}
...
\textbf{Armor}: Light (thick hide) --- \textit{Harm 1 $\rightarrow$ Fatigue 1}
...
\textbf{Hobgoblin} & II---III & 3 & Threshold's Discipline, Tactical Awareness & 4 & Medium (1$\rightarrow$1, 3$\rightarrow$2) & Earn respect, pay in service \\
\textbf{Bugbear} & III & 4 & Threshold's Patience, Surprise Strike & 5 & Light (1$\rightarrow$1) & Offer a secret, be interesting \\
\textbf{Warg} & II---IV & 3 & Threshold's Echo, Pack's Patience & 3 & Light (1$\rightarrow$1) & Match stillness, acknowledge imbalance \\
\hline
\end{tabular}
