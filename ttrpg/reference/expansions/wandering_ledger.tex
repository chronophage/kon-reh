...
\section*{What Lurks in the Shadow of the Tale}
\begin{infobox}
\textbf{The Water-Timer of the Solstice} --- A Fhara timepiece that measures water, not hours. It can be calibrated to tell different truths. On the solstice, it lies. Those who know its secrets can use the lie to break any timed contract.
