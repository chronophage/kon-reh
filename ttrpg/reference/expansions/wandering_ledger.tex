...
\section*{Told by}
Suleiman the Oasis-Master, a Fhara caravaneer who carried a water-clock made of brass and glass. He never arrived late to any rendezvous.
...
A water-clock is a vessel with a small hole in the bottom. It fills at dawn, empties by noon, and is refilled three times before the evening prayer. There is a story that the first water-clock was not a clock at all, but a marriage contract.
...
“Let the water-clock decide,” she said. “If it empties before I return from the deep well, I will marry you. If it still holds water when I climb out, you will leave this oasis and never return.”

The merchant laughed. The deep well was thirty fathoms. She would be gone for hours. He agreed.

Fatima climbed down. She did not climb up. She sat at the bottom of the well, waiting. The water-clock dripped. One hour. Two. Three.
...
At the sixth hour, the water-clock was empty. The merchant called down, “The clock is dry! You have lost!”

Fatima laughed. “You filled the clock at dawn. Today is the summer solstice. The water evaporates faster than it drips. The clock has been telling lies since noon.”

The merchant looked at the clock. The brass was hot. The water was gone. He had been tricked by his own contract.

He left. Fatima married a well-digger’s son. They built a new water-clock that compensated for heat and cold. It is still used in that oasis, and every year on the solstice, they add a stone to a cairn — one for each hour the clock is allowed to lie.
...
\begin{itemize}
\item Once per year (GM’s discretion), a character who understands the clock’s mechanism may declare that a time-sensitive contract is invalid due to “evaporation error.” The contract is voided; the other party suffers –2 dice to all actions for a day (confusion).
\item Using the clock for this purpose requires a \textit{Wits + Craft} test (DV 5). On a miss, the clock cracks and becomes useless until repaired (a downtime project).
\item \textbf{Clock: The Dripping Debt [4]} – ticks each time the clock is used outside of the solstice. When full, the water spirit inside the clock awakens and demands a sacrifice (a memory, an oath, or a finger).
\end{itemize}

\textbf{Adventure Hook:} A merchant is trying to force a caravan master to pay a bond that comes due at noon. The caravan master has a water-clock — but it was damaged in a storm. The party must repair it before the deadline, or find another way to prove the contract fraudulent.
\end{infobox}
...
Water-clock contracts expire at solstice. & Fhara (oasis courts) & The contract is void; the liar pays double. \\
