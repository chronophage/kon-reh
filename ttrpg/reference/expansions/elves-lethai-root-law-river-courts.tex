...
\textit{Clocks for breaches:} \textbf{Under-Root Grudge [4]}, \textbf{Stream-Clouding [4]}. When a timer fills, expect formal censure, raised tariffs, or wardens on the path.
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Quotas as Clocks:} \emph{Boat-Timber Quota [6]}, \emph{Lanternwood Allotment [4]}. Fill the timer to unlock export; overfill and trigger \emph{Canopy Censure}.
\end{itemize}
