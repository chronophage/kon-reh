...
\begin{itemize}
    \item \textbf{Master's Breath Clock [8]:} Ticks every scene. When full, the Master's body stops breathing. The dream collapses; all PCs mark 2 Harm and gain the Haunted condition.
    \item \textbf{Debt's Approach Clock [6]:} Ticks when the party speaks a lie, fails a Resolve test, or damages a dream-construct. When full, the woman's spirit manifests and attacks.
    \item \textbf{Name Unspoken Clock [4]:} Fills as the party discovers clues about the woman's identity. When full, the name is known and can be spoken in the final chamber.
\end{itemize}
...
If the party fails—if the Master's Breath clock fills before the name is spoken—they wake to find the Master dead, his eyes still open, his lips still moving. The Spector has claimed him. The monastery will remember the party's failure for a generation.
