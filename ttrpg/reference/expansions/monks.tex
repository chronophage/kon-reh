...
Twenty years later, I have broken twelve men with my bare hands and healed twice that many. The Abbot trusts me to teach the Way of the Open Palm. The Temple Council owes me three favors. And the Silkstrand thugs avoid the alley behind the Three-Temples Monastery because they know the sound of my sandals on wet stone.
...
& You understand the geometry of stillness. When you do not move during your turn, gain +1 die to your next defense roll. This benefit lasts until you move or take an aggressive action. The mountain does not chase the wind. The wind breaks against the mountain. \\
...
\begin{traittable}
The Unstruck Bell & \textit{Tags: Defense, Flow, Overload} \\
...
The Unstruck Bell tradition teaches that the greatest defense is to not be where the strike lands. Followers of this path learn to read the gaps in perception, to become forgettable, and to move through shadows as if the shadows themselves had parted for them.
...
\begin{supertabular}{p{0.2\linewidth}p{0.35\linewidth}p{0.35\linewidth}}
\hline \textbf{Tier} & \textbf{Benefit} & \textbf{Cost / Quirk} \\ \hline
1 & +1 die to Insight when detecting lies or broken promises. & Rigid Honor: Must uphold vows even when disadvantageous; -1 die to flexible actions. \\
...
A psionic monk treats their Mental Strain (see the Psionics chapter of the Gray Wanderer's Grimoire) as a secondary resource pool alongside Fatigue. The two are not interchangeable, but certain talents allow conversion:
...
The Three-Temples Monastery is not a fortress. It is a collection of stones, oak trees, and breath. It has no walls, no guards, no treasury. Its only defense is the reputation of its monks: those who enter with violence in their hearts find that violence returned to them tenfold, and those who enter with empty hands find tea and a place to sleep.
...
\textit{Leverage:} She trained half the healers in the city. They owe her favors, and she calls them in. \\
...
\part{Adventure Hooks and Rumors}
...
\begin{enumerate}
    ...
    \item \textbf{The Inquisition's Visit.} The Chain-Lanterns of Ecktoria have arrived. They have heard rumors of ``unsanctioned psionic activity'' within the monastery. They demand to search the cells. The Elders refuse. The party is caught between.
...
\chapter{Rumors Heard in the Monastery Courtyard (d12)}
...
\begin{enumerate}
    ...
    \item The Unstruck Bell was not forged. It was found. It lay in a field, half-buried, next to a skeleton in gray robes. The skeleton wore the Abbot's seal.
    ...
    \item The Hollow does not collect debts from monks. It is afraid of them. This is not a rumor. This is a warning.
    ...
    \item The Gray Wanderer once stayed at the monastery for three days. He meditated in the courtyard, spoke to no one, and left a single coin on the well. The coin is still there. No one will touch it.
\end{enumerate}
...
The party is summoned to the monastery's infirmary. An old monk lies on a pallet of gray wool, eyes open but unseeing, lips moving in a language none of the novices recognize. His name is Master Kai, and he was once a teacher of the Way of the Unstruck Bell. Thirty years ago, he walked into the hills and did not return. Last night, a shepherd found him sitting cross-legged in a field, still breathing, still warm, but utterly absent.
...
Until the name is spoken aloud in the heart of the dream, the Master cannot wake---and the Spector (a gray figure representing his un-faced death) will stalk the party through the chambers.
...
If the party speaks the name, the Master's eyes close, then open. He looks at Brother Tarn and says, ``I am ready now.'' He dies within the hour, at peace. The party gains +1 Favor with the monastery and may each clear 1 Obligation or Corruption segment.
...
\section{The Gray Wanderer's Note on the Adventure}
