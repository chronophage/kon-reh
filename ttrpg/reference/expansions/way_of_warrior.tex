...
\begin{itemize}
    ...
    \item \textit{Called Shot} (6 XP): \textit{Active, once per scene.} When you attack an \textbf{Unaware} target or a target you have \textbf{aimed at for a full round}, you may declare a Called Shot. On a hit, deal +1 Harm, ignore 1 Armor, and choose one: Blind (--2 dice to sight), Disarm (drop held item), Hamstring (half speed), or Vitals (+2 Harm instead of +1). On a miss, you are Exposed (Desperate Position and mark 1 Harm).
...
\subsection*{Foundation Talents (2-4 XP)}
\begin{itemize}
    \item \textbf{Flesh Codex (2 XP)} --- \textit{Body 3+}. Rites tattooed on body; cannot be stolen.
    ...
    \item \textbf{Talking Weapon (2 XP)} --- \textit{Sentient Thiasos}. Your Thiasos speaks aloud and counts as a witness.
\end{itemize}
