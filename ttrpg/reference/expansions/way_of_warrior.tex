...
Once per scene, you may make three unarmed attacks against a single target as one action. Roll each separately. After using Flurry of Blows, you suffer –1 die to defence for one exchange.
\end{talentbox}
