...
This book is not a catalog of techniques. You will not learn the perfect lunge or the unbreakable guard by reading. What you will learn is \textit{how to think} when the steel sings.
...
\textit{Requires: Disciplined Body, Tier II, Body 4+.} \\
...
\begin{itemize}
    ...
    \item \textit{Called Shot} (6 XP): \textit{Active, once per scene.} When you attack an \textbf{Unaware} target or a target you have \textbf{aimed at for a full round}, you may declare a Called Shot. On a hit, deal +1 Harm, ignore 1 Armor, and choose one: Blind (--2 dice to sight), Disarm (drop held item), Hamstring (half speed), or Vitals (+2 Harm instead of +1). On a miss, you are Exposed (Desperate Position and mark 1 Harm). \textbf{\textit{Must be a ranged attack.}}
...
\begin{itemize}
    \item \textbf{Advantage:} Cannot be confiscated. Always accessible. No action to retrieve.
    \item \textbf{Risk:} Visible to everyone. Damage to your skin may damage the Codex. Some cultures fear flesh-writing.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Advantage:} Can serve as armour or weapon. Durable. May grant social advantage.
    \item \textbf{Risk:} Can be stolen, confiscated, or broken.
\end{itemize}

\subsection*{Steel Codex (Sentient, rare)}
Rites are engraved on a sentient weapon or object that speaks and remembers.
\begin{itemize}
    \item \textbf{Advantage:} Functions as both Codex and Thiasos. Counts as a witness for all Rites. Can offer counsel.
    \item \textbf{Risk:} Has its own personality and opinions. Cannot be easily replaced. Attracts attention.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Minor (1-2 segments):} A small scar, a bruise that doesn't fade, an aching tooth.
    \item \textbf{Moderate (3-4 segments):} A visible scar on the face or hands, a limp, a smouldering brand.
    \item \textbf{Significant (5-6 segments):} A missing finger, a clouded eye, bark‑like skin.
    \item \textbf{Critical (7+ segments):} A numb limb, a face that reflections avoid, a forgotten name.
\end{itemize}

A scar is not a punishment. It is a receipt. Touch a scar to recall the Rite that caused it; an NPC may recognize it as the mark of a specific Patron.
...
\begin{itemize}
    \item \textbf{Cap:} 2--5
    \item \textbf{Harm:} Cap + 2
    \item \textbf{Independent action:} Once per scene, on your turn
    \item \textbf{Witness:} Always counts for Rites
    \item \textbf{Shared Burden (talent):} Transfer Fatigue to your Thiasos (it becomes Winded)
\end{itemize}

\subsection*{Sentient Thiasos (Object) --- Optional}
A weapon, shield, or tool that speaks and remembers. Cannot act independently.
\begin{itemize}
    \item \textbf{Witness:} Always counts
    \item \textbf{Communication:} Speaks aloud
    \item \textbf{Codex:} Can serve as both Thiasos and Codex
    \item \textbf{Cannot accept Shared Burden}
\end{itemize}
...
\subsection*{Foundation Talents (2-4 XP)}
\begin{itemize}
    \item \textbf{Flesh Codex (4 XP)} --- \textit{Body 3+}. Rites tattooed on body; cannot be stolen.
    \item \textbf{Living Thiasos (3 XP)} --- \textit{A living Thiasos}. Your Thiasos gains +1 Cap and may act independently once per scene.
    \item \textbf{Scarred Resilience (3 XP)} --- \textit{Body 2+}. Once per scene, ignore 1 Fatigue from physical exertion.
    \item \textbf{Oath-Bound (4 XP)} --- \textit{A sworn oath}. Once per session, reroll a failed Body roll when serving a sworn oath.
    \item \textbf{Talking Weapon (6 XP)} --- \textit{Sentient Thiasos}. Your Thiasos speaks aloud and counts as a witness.
\end{itemize}

\subsection*{Advanced Talents (6-8 XP)}
\begin{itemize}
    \item \textbf{Engraved Defense (6 XP)} --- \textit{Physical Codex}. Your Codex grants +1 Armour. You may mark 1 Obligation to reduce incoming Harm by 1.
    \item \textbf{Shared Burden (6 XP)} --- \textit{Living Thiasos}. Transfer 1 Fatigue to your Thiasos; it becomes Winded (-1 die) for the scene.
    \item \textbf{Witnessed Scar (8 XP)} --- \textit{Three permanent Obligation scars}. Once per session, touch a scar and gain +1 die on any roll tied to that event.
    \item \textbf{Iron Resolve (7 XP)} --- \textit{Body 3+, resilience talent}. When reduced to 0 Harm, remain standing with 1 Harm and mark 2 Fatigue.
\end{itemize}

\subsection*{Prestige Talents (10-12 XP)}
\begin{itemize}
    \item \textbf{The Unbroken Vow (10 XP)} --- \textit{Kept a sworn oath for one year}. When you swear an oath before a witness, gain +2 dice to all actions serving it.
    \item \textbf{Avatar of the Codex (12 XP)} --- \textit{Tier III+, physical Codex}. Once per session, become the embodiment of your Codex: Body +2, your Thiasos fights as a second combatant. Mark 2 Fatigue and 1 Obligation after.
    \item \textbf{The Scar That Remembers (11 XP)} --- \textit{Witnessed Scar, Tier III+}. Once per session, touch a scar and speak a sentence about the event that caused it. That sentence is considered witnessed truth in any court.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Rite of the Kindled Blade (Oath of Flame \& Light) --- 4 XP}. Your weapon ignites with radiant light. For one scene, melee attacks deal +1 Harm against undead and oath-breakers.
    \item \textbf{Rite of the Blood Offering (Grimmir) --- 4 XP}. Gain +1 die to Survival and Stealth in natural terrain for one scene.
    \item \textbf{Rite of the Unlit Candle (Ikasha) --- 4 XP}. Gain +1 die to a single Stealth or Subterfuge roll; on success, declare one minor detail ``forgotten'' by any observer.
    \item \textbf{Rite of the Shared Bowl (Oath of Mercy \& Grace) --- 4 XP}. You and a touched ally each clear 1 Fatigue.
\end{itemize}

\subsection*{Standard Rites (7-9 XP)}
\begin{itemize}
    \item \textbf{Rite of the Unbroken Vow (Oath of Flame \& Light) --- 7 XP}. Swear an oath before a flame and a witness; gain +1 Armour. Allies who hear the oath gain +1 die to actions serving it.
    \item \textbf{Rite of the Sealed Threshold (The Sealed Gate) --- 7 XP}. Mark a doorway as sealed. Unauthorised crossing tests Resolve (DV 3) or suffers a Position penalty.
    \item \textbf{Rite of the Spinner's Debt (Inaea) --- 9 XP}. Offer a willing creature a boon (clear 1 Fatigue or +1 die). They accept a Promise Timer [4] named ``Debt to the Web''.
\end{itemize}

\subsection*{High Rites (12-14 XP)}
\begin{itemize}
    \item \textbf{Rite of the Dawnfire Covenant (Oath of Flame \& Light) --- 12 XP}. Consecrate a zone; allies gain +1 die to resist fear. Undead or oath-breaker enemies suffer -1 die.
    \item \textbf{Rite of the Umbral Dream (Ikasha) --- 14 XP}. Become intangible to mundane harm for one scene, or bypass a major obstacle as if a secret way had always been there.
    \item \textbf{Rite of the Eternal Cycle (Carrion-King) --- 14 XP}. Destroy one major asset, enemy, or obstacle, and create something new of equal value. Player and GM collaborate on the transformation.
\end{itemize}
...
\subsubsection{Core Talents (Existing)}
\begin{itemize}
    \item \textit{Disciplined Body} (2 XP)
...
\subsubsection{Signature Talent Chain --- Oath of the Khopesh}
...
\subsubsection{Signature Talent Chain --- Way of the Horse}
...
\subsubsection{Signature Talent Chain --- The Shed Skin}
...
\subsubsection{Signature Talent Chain --- The Kontos}
...
\subsubsection{Signature Talent Chain --- The Feigned Flight}
...
\subsubsection{Signature Talent Chain --- The Howdah}
...
\subsubsection{Signature Talent Chain --- The Falcon's Return}
...
\begin{itemize}
    \item Body 3 (9 XP)
    \item Spirit 2 (6 XP)
    \item Presence 2 (6 XP)
    \item Wits 1 (3 XP) \hfill \textit{Total: 24 XP}
\end{itemize}
...
\begin{itemize}
    \item Melee 2 (4 XP)
    \item Command 1 (2 XP)
    \item Athletics 1 (2 XP) \hfill \textit{Total: 8 XP}
\end{itemize}

\noindent
\textbf{Talents:}
\begin{itemize}
    \item Flesh Codex (4 XP)
    \item Oath-Bound (4 XP)
    \item Scarred Resilience (3 XP) \hfill \textit{Total: 9 XP}
\end{itemize}

\noindent
\textbf{Rites:}
\begin{itemize}
    \item Rite of the Kindled Blade (4 XP)
\end{itemize}
...
Monks do not wear armour. They do not carry shields. They walk the world with nothing but their bodies and their breath---and they are among the deadliest fighters alive. This chapter summarizes the \textit{Complete Guide to Monks}, giving you the core tools to build an Unstruck Bell monk in minutes.
...
\begin{itemize}
    \item \textbf{The Coin That Does Not Move:} Never resist what cannot be stopped. Yield, and the enemy's own force becomes their downfall.
    \item \textbf{The Witness Who Breathes:} Stillness is the greatest disguise. Be unremarkable.
    \item \textbf{The Debt That Is Never Incurred:} When you do not strike, you create no debt. Victory is a chain. The open hand offers nothing, and so nothing can be taken from it.
\end{itemize}
...
\begin{enumerate}
    \item \textbf{The Entering Breath:} Inhale the world's noise, threat, opportunity.
    \item \textbf{The Holding Breath:} The pause where decisions are made.
    \item \textbf{The Releasing Breath:} The exhale that becomes action.
    \item \textbf{The Empty Breath:} The space after the exhale. Act from here to become invisible to predictions.
\end{enumerate}

\subsection*{Meditation Procedure}
\begin{enumerate}
    \item \textbf{Settle the Body (Wits + Medicine, DV 2):} On a hit, gain +1 die to the Meditation roll.
    \item \textbf{Settle the Breath (Spirit + Meditation skill, DV 3):} On a hit, enter a light meditative state.
    \item \textbf{The Still Point (Spirit + Resolve, DV 3 for clarity, DV 4 for healing, DV 5 for transcendence):} Achieve your intent.
\end{enumerate}

\subsection*{Meditation Benefits}
\begin{itemize}
    \item \textbf{Healing:} Clear 1 Fatigue and remove one minor Condition (Fear, Shaken, Guilty) with a test.
    \item \textbf{Clarity:} Gain +1 die to your next Wits-based roll.
    \item \textbf{Transcendent:} Once per session, reroll any single failed roll; the GM gains 1 Story Beat.
\end{itemize}
...
When you do not move during your turn, gain +1 die to your next defense roll. This benefit lasts until you move or take an aggressive action.
\end{talentbox}
...
\subsubsection*{Basic Technique -- Shadow Meld (6 XP)}
...
\subsubsection*{Advanced Technique -- The Unobserved (8 XP)}
...
\subsubsection*{Basic Technique -- Stagger Step (4 XP)}
...
\subsubsection*{Advanced Technique -- Drunken Fist (6 XP)}
...
\begin{itemize}
    ...
    \item Wits 3 (9 XP)
    \item Spirit 2 (6 XP)
    \item Presence 1 (3 XP) \hfill \textit{Total: 27 XP}
\end{itemize}
...
\begin{itemize}
    \item Stealth 2 (4 XP)
    \item Melee 1 (2 XP)
    \item Meditation 1 (2 XP) \hfill \textit{Total: 8 XP}
\end{itemize}
...
\begin{itemize}
    ...
    \item Disciplined Body (2 XP)
    \item Still Point (2 XP)
    \item Monk's Breath (2 XP)
\end{itemize}
...
\noindent
\textbf{Flavor:} Your knuckles are calloused, your eyes are calm, and your shadow sometimes moves a heartbeat after you do.
...
\begin{itemize}
    ...
    \item \textbf{Use Boons:} Boons can be spent to improve Position or re-roll one failure. Do not hoard them.
\end{itemize}
...
The Black River lay ahead---a slow, dark ribbon drinking the first gray light of dawn.
