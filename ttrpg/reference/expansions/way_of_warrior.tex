...
\begin{itemize}
    ...
    \item \textbf{Rite of the Spinner's Debt (Inaea) --- 9 XP}. Offer a willing creature a boon (clear 1 Fatigue or +1 die). They accept a Promise Clock [4] named ``Debt to the Web''.
\end{itemize}
