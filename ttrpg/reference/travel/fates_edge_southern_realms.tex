...
\begin{itemize}
  ...
  \item \textbf{Stone Legs (Ngomebe)}: Travel with a walking city; roller integrity and ancestor favour timers.
\end{itemize}
...
\begin{enumerate}
  ...
  \item \textbf{Keystone Crack (Ngomebe)}: City stops; ancestor favour timer advances.
