...
And then there are the others. Sekogo's jungle folk whisper to trees. The Crimson Valley's silk-wardens tie promises into cords that tighten when you lie. And Ashaan\dots Ashaan is a tragedy. A once-great empire that sold its soul to keep its throne. I do not envy them. I do not forgive them. I simply note their tariffs and move on.
...
\begin{itemize}
  ...
  \item Then a full set of generator tables (\spadesuit\ places, \heartsuit\ people, \clubsuit\ complications, \diamondsuit\ rewards), imported from separate files. To use them, draw cards and consult the appropriate rank as described in the Core book's \textit{Cartomancer's Compass}.
\end{itemize}
...
Thin air; breath-counting; passes that close for storms. A \textbf{Pass-Stone} or a \textbf{Horse Bond} grants passage. Never refuse the second cup of coffee -- it is a test of honor.
...
\noindent
Kofi whispers: \textit{``The Crimson Valley is a wound of red stone, carved by a river that runs rust-colored after every rain. The Lethai-ar guard the bridges. Their web-law is unwritten. Cross a bridge without a witness, and the silk will remember your weight -- and your name.''}
...
\textbf{What does no one talk about but everyone knows?} The valley is not a place. It is a creature -- a sleeping serpent whose spine is the canyon walls, whose scales are the silk bridges, whose heart is the rust-colored river. The Lethai-ar are its parasites. They do not know it is asleep.

\textbf{Where do people go when they die?} To the river. Bodies wrapped in silk and cast into the rust-colored water. The river carries them downstream, into the Ukwe's territory. The Ukwe drinks. The Ukwe remembers.
...
\textbf{What is the secret that could destroy a powerful person?} The river's rust color is not iron. It is blood -- the blood of the serpent that sleeps beneath the canyon. The serpent is wounded. The wound has been bleeding for nine centuries. The Lethai-ar know. They do nothing. If the serpent wakes, the law ends.
\end{almanac}
...
This appendix summarizes the unique travel modes and trade goods of the Southern Realms. For core travel procedures (legs, timers, roles), see the \textit{Fate's Edge SRD or Player/GM Guides}.

\section*{Travel Modes}
\begin{itemize}
  \item \textbf{River Legs (Oshiira, Crimson Valley)}: Canals, weigh-houses, and canal mothers. Travel timers advance when barges queue at locks.
  ...
  \item \textbf{Stone Legs (Ngomebe)}: Travel with a walking city; roller integrity and ancestor favor timers.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Taharka}: Pass-stones, horse-bonds, coffee measures. Honor currency in the highlands.
...
When traveling through the Southern Realms, the GM may roll on this table for a regional hazard:
\begin{enumerate}
  ...
  \item \textbf{Keystone Crack (Ngomebe)}: City stops; ancestor favor timer advances.
