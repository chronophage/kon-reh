...
\subsection*{Overview}
Once a vast empire that ruled from the Amaranthine to the northern foothills, Utar fractured into quarreling successor states. Now the north is a land of crumbling marble roads, disputed charters, and the bitter memory of order.
...
\begin{itemize}[leftmargin=*]
    ...
    \item Condotta brokers who sell companies by the month; their seals change color with every payday.
...
\section*{17. Ikari --- First Plow, First Oath}
...
\begin{itemize}[leftmargin=*]
    ...
    \item The \textbf{Jade Oases} -- springs that change color with the season, sacred to the Spice Lords.
...
\subsection*{Overview}
A confederation of canals and ledgers, built on the bones of a fallen river-kingdom. Oshiira measures wealth in bushels, justice in weights, and honor in interest.
...
\begin{itemize}[leftmargin=*]
    ...
    \item The Black Hand -- secret police who wear no uniform; they could be your neighbor, your clerk, your lover.  
...
\begin{itemize}[leftmargin=*]
    ...
    \item The Samurai -- a warrior caste bound by honor and debt; their swords are registered like deeds.
...
\begin{itemize}[leftmargin=*]
    ...
    \item The Royal Guard -- warrior monks who wear wooden armor and carry no metal; they believe steel attracts storms.
