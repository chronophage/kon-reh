...
The amulet is not a combat item. It is a plot device. Possessing it advances a \textbf{Kalrantha’s Attention} clock [8]. When the clock fills, the demon manifests as a Tier IV adversary – not to fight, but to bargain. The price is always a memory, a name, or a promise.
