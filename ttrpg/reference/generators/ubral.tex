...
\hline
Lady Morwen & Clan‑chief of the Grey Tor, Lady of Tor & Keep the old oaths and resist Viterran encroachment & She lost a hand to a Viterran knight; her iron hook has a built‑in bell. \\
\hline
...
\hline
Stone‑Speaker Baerd & Dwarf envoy from Khaz‑Vurim & Negotiate tolls and keep the passes open & He carries a tuning fork; strike it, and the mountain answers. \\
\hline
...
Inspired by the highland clans and the old stone circles: short, hard, with spirant consonants (ll, ch, th) and names that evoke hill, water, or cattle.
...
\begin{itemize}
  \item \textbf{Saint Eluned of the Unbroken Chain (The Traveler):} A legendary hill guide who walked the Wolf Road backwards during a blizzard and never lost a step. Her shrines are cairns with a single iron ring embedded in the stone; travellers who touch the ring and speak a destination find the fog lifts for one hour. The Temple of Light venerates her; the old clans claim she was a hedge‑witch who tricked the Hollow.
  \item \textbf{The Grey Tor Covenant (Mykkiel):} A small order of notaries who adjudicate feuds without violence. They carry no weapons, only a set of iron scales and a copy of the *Wergild Tables*. A ruling from the Grey Tor Covenant is binding on both clans, but any party who lies before them forfeits their guest‑right for a year and a day.
  \item \textbf{The Cairn‑Keepers of the Grey Palm:} Sister Niamh runs a hospice at Grey Tor, treating wounded reivers and lowland knights alike. She asks no payment, but she writes every patient's name on a slate that never fills. The clans tolerate her because she also tends the cairns, leaving a cup of fresh water at each one at dawn. The Viterran Crown has tried to close her hospice twice; both times the investigating magistrate vanished into the mist and returned with no memory of the journey.
  \item \textbf{Saint Madoc of the Silent Cairn (The Witness):} A clan chief who discovered that one of the Council of Cairns had falsified a wergild payment to start a feud. He spoke the truth aloud at the Moot Hollow, and the stones cracked. His own name was carved into a new cairn that night. The Council now keeps a sealed chamber under Grey Tor containing the *Ledger of Unspoken Truths*—debts that were never paid and oaths that were never sworn. Opening it is said to reignite every feud Ubral has ever settled.
  \item \textbf{The Savage Heart (Red Maw):} A bear cult has taken root in the remote glens, believing that the only way to resist Viterran encroachment is to become as fierce as the old predators. They wear cured bear‑skins and carve runes into their ribs. The clans fear them nearly as much as the lowland tax men. The Lady of Tor has forbidden their rites, but every winter a bull is found torn open on the Pass of Ashes, and the cult grows stronger.
  \item \textbf{The Ninth:} In any Ubral scene, the ninth stone in a cairn is always warm. Touch it, and you will remember an oath you never swore. Those who touch the ninth stone three times are said to become a cairn themselves—silent, still, and waiting for the next hand.
\end{itemize}
...
\index{Stone-Clause}
\index{Saint Eluned}
\index{Grey Tor Covenant}
\index{Cairn-Keepers of the Grey Palm}
\index{Saint Madoc}
\index{Savage Heart}
