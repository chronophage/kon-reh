...
\hline
Stone‑Speaker Baerd & Aeler outcast, envoy from Khaz‑Vurim & Negotiate tolls and keep the passes open & He carries a tuning fork; strike it, and the mountain answers. He still measures ceilings in dwarf‑feet. \\
\hline
...
Inspired by the highland clans: short, hard, with spirant consonants (ll, ch, th) and names that evoke hill, water, or cattle. Many families still use the old patronymic prefixes (mac, ap, ferch) even after centuries of lowland pressure.
...
\paragraph*{(Tor/Cairn/Hill‑fort)} Sheepwalk Ledge with goat path and room for one honest lie; Warden's Cairn on windy tor with signal‑fire basket; Aeler outcast smithy where the bellows sing in dwarven.
...
\paragraph*{(Clan/Dwarf/Reiver)} Hearth‑aunt who holds guest‑cup and house's temper; hill guide with thorn‑staff and quiet shortcuts; Aeler outcast smith who forges iron that never rusts.
...
\paragraph*{(Mist/Feud/Toll)} Upland mist---hear horns but not edges; feud rekindled---cousin spits on guest‑law; Viterran royal herald arrives with parchment and spears.
...
\paragraph*{(Oath/Right/Token)} Guest‑right token---one hearth owes food, bed, and steel at dawn; guide's braid for lawful passage on sheepwalks; Aeler outcast forge-stamp — one free repair of iron goods.
...
\item \textbf{The Great Feud Clock [8]:} Tracks the simmering conflict between the two oldest clans (Mac Tern and O'Creagh). Each time a Viterran agent provokes a border incident, or a clan chief refuses a marriage offer, tick the clock. At 4: a cattle raid. At 8: full‑scale war. The Council of Cairns can pause the clock by sacrificing a valuable hostage — or by telling a story that makes both clans weep.
...
\item Remember the Aeler outcasts — they are exiles, not tourists. They have long memories and longer grudges. They will help a clan for a story, but they will never forget a slight.
\end{itemize}
