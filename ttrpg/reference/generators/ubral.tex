...
\paragraph{Mechanics:}
Spirit + Resolve (DV 6). Success: the GM answers truthfully (one sentence). Failure: the character gains the Condition \textit{Marked by the Hollow} (the GM may spend 2 SB to have a Oath‑Keeper appear).
