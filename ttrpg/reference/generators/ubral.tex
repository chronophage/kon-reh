...
\textbf{Genre / Mood:} Highland clan honour, misty glens, wergild and blood feuds, exiled dwarves.
...
Along the eastern coast, the sea cliffs drop sheer into the Dolmis. Fisherfolk in black‑hulled boats speak of drowned cairns beneath the waves — ancient stones that mark the graves of clans who lost everything to the sea. Some say the Hollow rises from those waters on the ninth wave of the ninth tide.
...
\item \textbf{Tor's Hold [6]} – Lady Uria's personal authority. Advances when she wins a moot, brokers peace, or gains an ally. Retreats when she loses a feud or a client clan defects. On 0: she is deposed; civil war follows.
...
\paragraph{Mechanics:}
Spirit + Resolve (DV 6). Success: the GM answers truthfully (one sentence). Failure: the character gains the Condition \textit{Marked by the Hollow} (the GM may spend 2 SB to have an Oath‑Keeper appear).
...
\hline
Lady Uria & Clan‑chief of the Grey Tor & Keep the old oaths and resist Viterran encroachment & She lost a hand to a Viterran knight; her iron hook has a built‑in bell. \\
\hline
...
4 & The host's kin challenge you to a duel to first blood (Body+Melee, DV 3). \\
...
6 & The Hollow takes notice. GM gains 2 SB to spend on supernatural complications. \\
\hline
\end{tabular}
\end{center}
...
\item \textbf{Sheepwalk Ledge} --- Goat path with room for one honest lie at a time. `[THRESHOLD]` `[OATH]`
  \hfill \textit{The lie must be about an oath you broke. Tell it, and the ledge holds. Refuse, and the path crumbles – start a \textbf{Fallen Kin [4]} clock (the ancestor whose oath you broke is watching).} \\
...
\item \textbf{Warden's Cairn} --- Windy tor; signal‑fire basket and dry cache; eyes of the hills. `[WATCH]`
  ...
  \textbf{Guest‑right cost:} Asking for shelter here requires you to name a debt you still owe. If you refuse, the Warden marks you – start \textbf{Suspicion [4]}. \\
...
\item \textbf{Wergild Ford} --- Flat stones, deep pools, table rock for counting silver. `[LAW]` `[TRADE]`
  ...
  \textbf{Wergild paid here is witnessed by the stones.} If you cross without paying a due debt, the water rises – test Body+Athletics (DV 4) or lose 1 Supply (drowned cargo).
...
\item \textbf{Hearth-Aunt} --- Holds guest‑cup and house's temper; hospitality as power.
  ...
  \textbf{Guest‑right cost:} She owes a blood‑debt to the Mac Tern clan. If you help her pay it (a quest), she gives you a \textbf{Guest-Token} (Diamond). Guest‑right cost: share a true story of a broken oath. If you refuse, start \textbf{Grudge of the Hearth [4]}.
...
\item \textbf{Wergild Counter} --- Keeps tallies, ends grudges, starts others; law as math.
  ...
  \textbf{Service:} He can audit a blood‑debt for 1 Supply. On a success (Wits+Lore DV 3), he finds a hidden wergild that clears 2 segments of a Feud clock. On a Miss, he finds a debt you owe – tick \textbf{Wergild Breach [4]}.
...
\item \textbf{Dwarf Warden (Aeler Outcast)} --- Khaz‑Vurim road; toll first, friendship later.
  ...
  \textbf{Toll:} 1 Supply or a story about a betrayal. She is collecting evidence for a case she will never bring. If you lie, she marks you – start \textbf{Ledger Notice [3]}.
...
\item \textbf{Bride-Escrow} --- Hold the purse; both sides must humour you. `[SOCIAL]` `[DEBT]`
...
\item[A] \textbf{Stone-Clause} --- Temporary exception to dwarf toll or law, sealed. `[AUTHORITY]` `[OATH]`
  \hfill \textit{The clause is a single rune. Carve it on the toll post, and the mountain will honour it — once. The rune was taught to the clans by an Aeler outcast who wanted to see a Viterran knight pay double.} \\
...
In Ubral, power flows through clan bonds, guest‑right, and the careful balance of honour and iron. Clan chiefs maintain authority through wergild, moots, and the respect of their people, while the Aeler outcasts of Khaz‑Vurim wield influence through their control of mountain passes and forges. Law is personal and passed down through generations, with each oath and debt creating a web of obligation that can last centuries. The Viterran crown claims suzerainty; the clans call that claim ``the ink of thieves.''
