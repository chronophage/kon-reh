...
Power here is measured in vow-cords, story-debts, and the number of nights camped on a lord's land. The Tulkani have no king, no judges, no written law — only the Caravan Circle, where disputes are settled by storytelling. A liar is exposed not by evidence but by the knots on his cord: if a knot is tied in false witness, it will tighten until blood is drawn. Ikasha's cult is not a religion; it is a survival tactic — the dream inside the wagon, the whisper in the creaking wheel. The Tulkani pay no permanent taxes, but they pay tolls in stories. A lord who demands coin will be told a story so boring that his crops fail. A lord who offers hospitality will be told a story so beautiful that his harvest doubles.

\textbf{Starting Location:} A wagon circle at a crossroads, where nine painted wagons form a ring. A Caravan Judge sits on a overturned barrel, a knotted cord in her hand. ``You are standing on ground that belongs to the lord of the eastern valley. He will be here at dawn to demand rent. But you are in the circle. You are safe until the ninth hour. Tell me a story — a true one — and I will tell you how to leave before the lord arrives.''
...
\hline
Elder Sarnai & Caravan Judge of the Nine Knots & Keep the neutrality of the road & She ties a knot for every judgment; her cord drags on the ground. \\
\hline
Temur Wagon-Keeper & Master of the painted wheel & Find a new grazing ground before the ninth night & He paints a new colour on his wagon each season; the colours are memories. \\
\hline
...
\hline
Vow-Broken & An exile who cut his own cord & Earn back his name & He carries a single knot tied in his own hair; the knot is his promise to redeem himself. \\
\hline
\end{longtable}
...
\item \textbf{Wagon Circle (Night)} --- Nine wagons arranged in a ring, lanterns burning, wheels touching.
  \hfill \textit{Inside the circle, the Hollow cannot enter. Outside, it waits. The lanterns must never go out.}
\item \textbf{Caravan Court (Day)} --- A carpet spread on grass; a judge on a barrel; a cord on the ground.
  \hfill \textit{The cord is the law. Step over it, and you accept the judge's verdict.}
\item \textbf{Dream-Wagon (Ikasha's Shrine)} --- A painted wagon with no wheels, sitting on stones. The door is a curtain of knots.
  \hfill \textit{Inside, a single candle and a bed of straw. Ikasha dreams there. Do not wake her.}
\item \textbf{Cord-Maker's Stall} --- A canvas awning where a woman braids horsehair and silk.
  \hfill \textit{Each cord is a promise. The colour tells the weight: white for truth, red for blood, black for death.}
\item \textbf{Crossroads of the Ninth Road} --- A meeting of nine paths, only eight of which are visible.
  \hfill \textit{The ninth road is for the dead. The Tulkani leave an offering there each full moon.}
\item \textbf{Abandoned Circle} --- A ring of burnt grass and wheel ruts. No wagons. No people.
  \hfill \textit{The circle was broken on the ninth night. The Hollow came. The grass will not grow back.}
\item \textbf{Vow-Cord Tree} --- An old oak with hundreds of knotted cords hanging from its branches.
  \hfill \textit{Each cord is a promise kept. The tree remembers. The wind unties one each season.}
\item \textbf{Hollow's Gate (Seasonal)} --- A place where the boundary is thin, marked by a single painted stone.
  \hfill \textit{The Tulkani camp here only on the new moon. On the full moon, they are a day's ride away.}
\item \textbf{Tinkanar (Itinerant Caravanserai)} --- A mobile market of wagons, open for one day each season.
  \hfill \textit{The location changes. The Tulkani announce it by dream — the dream of a sleeping merchant.}
\item[J] \textbf{Story-Well} --- A dry well where the Tulkani throw written stories on parchment.
  \hfill \textit{The stories are offerings to Ikasha. The well is full. The parchment never rots.}
\item[Q] \textbf{The Ninth Cord's Post} --- A wooden post at the centre of every circle, with nine notches.
  \hfill \textit{The ninth notch is never carved. It is left for the Hollow. The Hollow never takes it.}
\item[K] \textbf{The Wandering Hearth} --- A wagon that is never hitched, always moving. It carries the council fire.
  \hfill \textit{The fire has been burning for three hundred years. It has never touched the ground.}
\item[A] \textbf{Ikasha's Dreaming Place (Myth)} --- A cave beneath a hill, where She Who Sleeps lies on a bed of knotted cords.
  \hfill \textit{If you untie a cord, she wakes. If she wakes, the world ends.}
\end{enumerate}
...
\item \textbf{Caravan Judge} --- Old, grey-braided, a cord so long it drags on the ground.
  \hfill \textit{She ties a knot for every judgment. Untying a knot voids the judgment. She has never untied one.}
\item \textbf{Wagon-Keeper} --- A woman with paint on her hands, a brush behind her ear.
  \hfill \textit{She paints a new colour on her wagon each season. The colours are memories. She is running out of colours.}
\item \textbf{Story-Seller (Gulshat)} --- A young woman with a dream-cord around her wrist. She speaks in rhymes.
  \hfill \textit{Her stories are true — but only if you listen with your eyes closed.}
\item \textbf{Ikasha's Knife} --- A hooded figure with a mask of knotted cord. No face underneath.
  \hfill \textit{He cuts the cords of oath-breakers. The cut cord becomes a ghost. The ghost follows the breaker.}
\item \textbf{Vow-Broken (Exile)} --- A man with a single knot tied in his own hair. He never smiles.
  \hfill \textit{He is saving stories to buy back his name. He needs nine. He has eight.}
\item \textbf{Cord-Maker} --- A woman with braids of horsehair and silk between her fingers.
  \hfill \textit{She can tell the weight of a promise by the feel of the hair. Horsehair is heavy. Silk is light.}
\item \textbf{Hollow-Watcher} --- A boy who sits at the edge of the circle at dusk, watching the dark.
  \hfill \textit{He can see the Hollow when it walks. He points. The adults throw salt.}
\item \textbf{The Dreamer} --- A woman who sleeps in the Dream-Wagon. She never wakes during the day.
  \hfill \textit{She dreams the caravan's path. The wagon follows her dreams.}
\item \textbf{Tinkanar Merchant} --- A fat man with nine bells on his hat. He sells knots and stories.
  \hfill \textit{He accepts only promises as payment. His ledger is a cord. It has nine thousand knots.}
\item[J] \textbf{The Ghost of the Ninth Night} --- A translucent figure seen at abandoned circles.
  \hfill \textit{It was a Tulkani who stayed too long. It asks: ``Is it the ninth hour yet?''}
\item[Q] \textbf{The First Wagon-Keeper (Legend)} --- A skeleton driving a wagon of bones. The wheels are skulls.
  \hfill \textit{It appears when a circle is broken. It offers a ride. The ride leads to the Hollow.}
\item[K] \textbf{Ikasha's Voice} --- A whisper heard in the Dream-Wagon at midnight. It speaks in riddles.
  \hfill \textit{``The ninth cord is not a cord,'' it says. ``It is the space between the knots.''}
\item[A] \textbf{The Unwitnessed} --- A Tulkani who never tied a single knot. No one remembers her name.
  \hfill \textit{She walks through circles unnoticed. She can break any vow because no one saw her make it.}
\end{enumerate}

\paragraph*{(Debt/Toll/Hollow)} A debt collector recognises your vow-cord — pay in story or favour; a lord demands rent for camping on his land — negotiate nights or fight; the Hollow walks on the ninth night — a character hears their own name whispered.

\section*{Clubs --- Complications/Threats}
\label{sec:tulkani-complications}
\begin{enumerate}
\setcounter{enumi}{1}
\item \textbf{Debt Collector (Vow-Cord Recognised)} --- Someone from your past sees the knots you carry. They demand payment.
  \hfill \textit{The payment is a story. The story must be about a promise you broke. If you have none, the collector takes a knot.}
\item \textbf{Lord's Rent Demand} --- The local lord arrives at the circle at dawn. ``You have been here seven nights. Pay the eighth.''
  \hfill \textit{The price is not coin — it is a story that flatters him. If the story fails, he seizes a wagon.}
\item \textbf{Hollow Walks (Ninth Night)} --- Someone in the circle has miscounted. The ninth hour approaches.
  \hfill \textit{The lanterns flicker. A shadow stands at the edge. It whispers a name. The name is the debtor's.}
\item \textbf{Vow-Cord Tangled} --- Two promises conflict. The knots tighten. Blood is drawn.
  \hfill \textit{The judge must cut one cord. The severed cord becomes a ghost. The ghost accuses the cutter.}
\item \textbf{Wagon Wheel Broken} --- A wheel cracks. The circle is incomplete. The Hollow can enter.
  \hfill \textit{The wheel must be repaired before dusk. The repair requires a story — a true one — told to the wood.}
\item \textbf{Tulkani Schism} --- Two judges dispute the meaning of a knot. The circle splits.
  \hfill \textit{Each judge claims authority. The party must choose which cord to follow. The other cord will remember.}
\item \textbf{Ikasha's Dream Disturbed} --- A stranger enters the Dream-Wagon. The Dreamer wakes.
  \hfill \textit{Ikasha stirs. The ground trembles. The stranger must tell a story so good that Ikasha falls back asleep.}
\item \textbf{Story Toll (Bridge/Pass)} --- A guard demands a story to cross. Your story is not good enough.
  \hfill \textit{The guard demands a truth instead. The truth must be a secret. The secret must hurt.}
\item \textbf{Vow-Broken's Redemption Attempt} --- An exile tries to rejoin the circle. The judge refuses.
  \hfill \textit{The exile demands the party speak for him. If they refuse, he cuts his own throat. If they speak, they owe a knot.}
\item[J] \textbf{The Ninth Cord Cut} --- Someone cuts the ninth knot on the central post. The Hollow floods in.
  \hfill \textit{The lanterns go out. The circle becomes a cage. The party must re-tie the knot in the dark.}
\item[Q] \textbf{Ikasha's Knife Betrayed} --- The Knife is offered a bribe to cut a false cord. He refuses. The briber attacks.
  \hfill \textit{The Knife is wounded. He asks the party to carry his mask. The mask weighs nothing — until you put it on.}
\item[K] \textbf{Tinkanar Closed (No Stories)} --- The mobile market is empty. The merchant has run out of knots.
  \hfill \textit{He is selling his own name. The price is a story that makes him weep. He has not wept in forty years.}
\item[A] \textbf{Ikasha Wakes} --- The Dreamer dies. Ikasha opens her eyes. The sky turns white.
  \hfill \textit{She asks one question: ``Who cut the ninth cord?'' The answer must be a name. If no name is given, she takes all.}
\end{enumerate}

\paragraph*{(Cord/Bead/Charm)} Vow-bead (a single knot, can be used to demand a favour once); safe-haven oath (a knotted cord that guarantees sanctuary in any Tulkani circle); dream-cord (gift from Ikasha, one question answered in a dream).

\section*{Diamonds --- Rewards/Leverage}
\label{sec:tulkani-rewards}
\begin{enumerate}
\setcounter{enumi}{1}
\item \textbf{Vow-Bead (Single Knot)} --- A small knot on a leather thong. Present it to demand a single favour from a Tulkani.
  \hfill \textit{The knot will loosen after use. If it is not retied within a year, the favour becomes a debt.}
\item \textbf{Safe-Haven Oath (Knotted Cord)} --- A braided cord with three knots. Hang it on your wagon to guarantee sanctuary in any Tulkani circle.
  \hfill \textit{The cord must be renewed each season. A new knot is added. After nine knots, it becomes a dream-cord.}
\item \textbf{Dream-Cord (Ikasha's Gift)} --- A silk cord with nine knots, the ninth loose. Once, sleep on it to ask Ikasha one question. She will answer in a dream.
  \hfill \textit{The answer is always a riddle. The ninth knot tightens after use. When it tightens fully, Ikasha wakes.}
\item \textbf{Caravan Judge's Cord (Borrowed)} --- A length of braided horsehair. Tie it around your wrist to gain +1 Position in any negotiation with Tulkani.
  \hfill \textit{The cord is the judge's own. She will want it back. The return is a negotiation.}
\item \textbf{Wagon-Keeper's Paint (Pot)} --- A clay pot of blue pigment. Paint your own wagon wheel, and no lord will demand rent for nine days.
  \hfill \textit{The paint is made from crushed sky-stone. It glows under moonlight. The Hollow avoids it.}
\item \textbf{Story-Seller's Verse} --- A single verse of a true story. Recite it to calm a spirit or end a feud.
  \hfill \textit{The verse works once. After that, the story belongs to the listener. You cannot tell it again.}
\item \textbf{Ikasha's Mask (Knotted)} --- A mask of knotted cord. Wear it to become invisible to the Hollow for one night.
  \hfill \textit{The mask has no eye holes. You must walk by memory. The memory may fail.}
\item \textbf{Hollow-Watcher's Salt Pouch} --- A leather pouch of salt blessed by the boy who watches the circle. Throw it to banish a Debt-Walker.
  \hfill \textit{The salt is bitter. The Debt-Walker will taste it. It will remember your face.}
\item \textbf{Tinkanar Merchant's Bell} --- One of nine bells from the merchant's hat. Ring it to summon him anywhere.
  \hfill \textit{He will come. He will demand payment in stories. He will not leave until paid.}
\item[J] \textbf{Vow-Broken's Hair Knot} --- A single knot tied in human hair. It contains a broken promise. Use it to void a contract.
  \hfill \textit{The knot is from an exile. He wants it back. He will pay a story for it.}
\item[Q] \textbf{The Ninth Cord's Post Fragment} --- A splinter of wood from the central post. Touch it to any knot to learn who tied it.
  \hfill \textit{The splinter is warm. It will burn your hand if the knot was tied in false witness.}
\item[K] \textbf{First Wagon-Keeper's Skull} --- A human skull painted with wheel patterns. Place it at the centre of a circle to keep the Hollow away for nine nights.
  \hfill \textit{The skull whispers on the ninth night. It asks: ``Is it time?'' Say no.}
\item[A] \textbf{Ikasha's Dream (Bottle)} --- A glass bottle containing a sleeping breath. Break it to send a question to Ikasha. She will answer in a vision.
  \hfill \textit{The vision lasts one minute. The cost is one memory. The memory is forgotten forever.}
\end{enumerate}
...
\item If any A appears, echo \textbf{knot-omens}—a cord that tightens without being pulled, a knot that unties itself, a wheel that stops turning.
\end{itemize}
...
\textbf{Mechanic:} When a lord demands rent, the Caravan Judge mediates. The party may offer a story (one Measure), a promise (a future favour, represented by a Debt Clock [4]), or a service (a quest). Refusing to pay means the lord may attack the circle — which breaks the neutrality and summons the Hollow.

\subsubsection*{Vow-Cords and Knots}
Every Tulkani carries a vow-cord — a braided strand of horsehair and silk, with knots tied for every promise made and kept. A Tulkani who breaks a promise must cut the corresponding knot; the cut cord becomes a ghost that follows the oath-breaker until the promise is fulfilled. Outsiders may borrow a Tulkani vow-cord; the knots then record their promises.

\textbf{Mechanic:} A character who accepts a vow-cord gains +1 die to any roll made to keep a promise related to the cord. However, if they break that promise, they must cut a knot — mark 1 Corruption and gain a Condition: \emph{Followed by a Ghost} (-1 die to stealth until the promise is fulfilled). A character may tie a new knot to make a new promise; each knot beyond the first increases the penalty for breaking.

\subsection*{Lore Echoes (Cross-Expansion Hooks)}
\begin{itemize}
  \item \textbf{Tulkani Vow-Cords and the Sidhi Freedman's Seal:} Sidhi merchants on the Brass Coast accept Tulkani vow-cords as proof of credit. A well-knotted cord can buy a ship. A cut cord can sink one.
  \item \textbf{Ikasha and the Veiled Sisters (Ashaan):} The Tulkani are the primary spreaders of Ikasha's cult outside Ashaan. A Breath-less agent may be disguised as a Tulkani story-seller; a Tulkani caravan may be a mobile safe house.
  \item \textbf{The Ninth Night and the Hollow (Eastern Realms):} The Tulkani's ninth-night rule is the only reason the Hollow has not overrun the eastern trade routes. Aelaerem hedge-keepers sometimes hire Tulkani guides to reset the Hollow's attention clocks.
  \item \textbf{Story Debts and the Ukwe (Sekogo):} The Tulkani believe that the Ukwe is the first vow-cord tree. They leave offerings of knotted grass at its roots. A Tulkani judge may consult the Ukwe to verify a story's truth.
\end{itemize}

\subsection*{Tulkani Superstitions (burn for +1 die once)}
\begin{itemize}
  \item \textbf{Bread to the Circle:} Crumble a crust at the centre of the wagon ring. Ignore the first \emph{Debt Collector} penalty.
  \item \textbf{Knot the Lantern:} Tie a single knot in the rope of a lantern. Cancel \emph{Lord's Rent Demand} or take –1 die on your next negotiation (your choice).
  \item \textbf{Name to the Ninth Post:} Whisper a dead judge's name into the central post. Gain +1 Effect when telling a story this scene, but mark \emph{Obligation} to Ikasha.
\end{itemize}
...
\index{Hollow}
\index{Tinkanar}
\index{Saint Adar!Tulkani}
\index{Saint Hervor!Tulkani}
\index{Tide-Washed Covenant!Tulkani}
...
\item \textbf{Trace:} Evidence of your passage marks your route for \textbf{debt collectors or vow-breakers}.
