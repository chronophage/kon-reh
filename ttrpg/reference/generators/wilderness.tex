...
\item[Q] \textbf{Bad Omen} --- Will‑lights, taboo day, saint bells silent; locals refuse to move.
  \hfill \textit{The omen is written in bird droppings on a milestone. It is still accurate.}
...
% 1. Terrain Stock (d20) → after "The Unfinished Map" or inside Spades section
% 2. Lair Seeds (d12) → after Diamonds (Rewards), under "Lair Seeds (One‑Page Crawls)"
% 3. Wilderness Bestiary → after Lair Seeds, under "Wilderness Bestiary"
% 4. Relic & Find Table (d10) → inside Diamonds section as "Strange Finds" call‑out
% 5. Omens & Sign (d8 each) → inside "Travel at a Glance" section
