...
\textbf{Boon (choose 1):}
\begin{itemize}
\item HEAL gear (repair one damaged item).
...
\begin{itemize}
\item \textbf{Boon (choose 1):} HEAL gear; clear 1 Fatigue total; scout tomorrow's \emph{Weather Window}; parley with road spirits (see below).
