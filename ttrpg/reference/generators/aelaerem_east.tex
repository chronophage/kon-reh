...
\item \textbf{Debt-Walker's Path} \hfill \textit{[DEATH] [CURSE]} \\
  A straight line of bare earth through the grass, seen only at dawn. \\
  \textit{The path was walked by a Debt-Walker. Follow it, and you will find what it was collecting.}
...
\item \textbf{Debt-Walker (Visible)} \hfill \textit{[SPIRIT] [DEBT]} \\
...
\item \textbf{Hollow Walks (Debt Called)} \hfill \textit{[DEBT] [SPIRIT]} \\
  A Debt-Walker appears at the crossroads. It points at a party member. \\
...
\item \textbf{Debt-Walker's Path Crossed} \hfill \textit{[CURSE] [DEBT]} \\
  The party camps on the straight line of bare earth. The Hollow comes. \\
  \textit{It asks: ``Why are you on my path?'' The answer must be a promise. Break it, and you become a Debt-Walker.}
...
\item \textbf{Debt-Walker's Finger (Bone)} \hfill \textit{[SUMMON] [ONCE]} \\
  A dried finger bone from a Debt-Walker. Use it to call a Debt-Walker once. \\
  \textit{The Debt-Walker will collect one debt for you. Then it will ask for yours.}
\item \textbf{Hedge-Keeper's Salt Pouch} \hfill \textit{[BANISH] [ONCE]} \\
  A leather pouch of salt blessed by a hedge-keeper. Throw it to banish a Debt-Walker for one scene. \\
  \textit{The salt is bitter. The Debt-Walker will taste it. It will remember your face.}
...
\begin{itemize}
  ...
  \item \textbf{The Hollow's Name and the Veiled Sisters (Ashaan):} The name of the Hollow is said to be a forgotten aspect of Ikasha — the part of her that did not fall asleep. Breath-less agents sometimes whisper the name to distract Debt-Walkers.
