...
\begin{itemize}
  \item \textbf{Saint Marcellus (Mykkiel) of the Gilded Scale (Order of Justiciars):} The Censor's Hall keeps a sealed archive of \emph{unwritten laws} — precedents that were never spoken aloud. The Order of Justiciars claims that reading even one of these laws binds the reader to enforce it. The Grand Magistrate has never opened the archive. The Red Clerk has, and his inkwell is now a skull.
  \item \textbf{Saint Valeria (Isoka) of the Serpent (Order of the Shed Robe):} In the Everflame Cloister, a side chapel is dedicated to the \emph{Shedding Saint}, whose mosaic shows a snake eating its own tail. Pilgrims who leave a confession there wake the next morning having forgotten one sin — but also one kindness they received. The High Priest permits the chapel because the offerings keep the basilica warm.
  \item \textbf{The Hospice of the Soot‑Stained Hands:} A hospice in the Shatterline Bazaar is run by grey‑robed healers who ask no payment. They are tolerated because they treat wounded mercenaries for free, but the Black Purse faction suspects they also erase debts — ledgers left near their doors have been found blank. The Order’s rule: ``You do not pay back. You pay forward. But woe to the one who strikes a healer.''
  \item \textbf{The Ember Prefect (Heretic Cult):} A schism within the Everflame believes the flame should \emph{not} be contained in basilicas. They meet in the arena hypogeum at midnight, chanting the \emph{Unspoken Ninth Citation}. The Grand Magistrate has outlawed them three times. Each time, the edict was found burned the next morning, with a single word left intact: \emph{``Audit.''}
  \item \textbf{The Ninth:} In any Ecktorian court, the ninth citation of precedent voids all previous. The wise stop at eight and settle. Those who cite the ninth are said to hear a faint laughter from the marble walls — and their cases are never heard again.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Patron Touchpoints (as Saints \& Orders):}
  \begin{itemize}
    \item \textbf{Saint Maelstraeus (the Reckoner):} Coin‑houses keep shadow ledgers; once/session convert one social success into a \emph{Coin-House Credit} Diamond but start a \emph{Karmic Debt} [6].
    \item \textbf{Saint Mykkiel (the Justiciar):} Any \emph{Procession Permit} can be notarised as an \emph{Oath Irons} lite: breaking its terms applies --1 die to legal actions for a scene.
    \item \textbf{Saint Lunara (the Silver Quiet):} \emph{Everflame Cloister} niches hide ``silver mirrors''; on use, ask one yes/no about civic intrigue; mark Exposure +1.
    \item \textbf{Saint Traveler (the Wayfinder):} Map the \emph{Triumph Stairs} as a living route: spend 1 Boon to treat one crowd scene as \emph{overland progress} for clocks.
  \end{itemize}
