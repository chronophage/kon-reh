...
\textbf{Genre / Mood:} Imperial decay, mercantile noir, flame-lit judgment.
...
\hline
Valerius & Grand Magistrate & Preserve the forms of law while the empire crumbles & His gavel is a sundial; it only strikes at noon. \\
\hline
Flavia & High Priest of the Everflame & Balance the factions and keep the flame lit & She has never raised her voice; the flame speaks for her. \\
\hline
Cassia & Duchess-Regent of the Dolmis Gate & Protect her family's trading rights & She rules from behind a silk screen; a dagger‑hole is cut at eye level. \\
\hline
Marcus & Coin-House Factor & Survive the next credit panic & He seals deals with three ribbons: white (ask), red (now), black (never). \\
\hline
Lucius & Lanista (arena master) & Own the next champion and the secrets of the hypogeum & His fighters' brands are his signature; he never repeats a mark. \\
\hline
The Red Clerk & Censor's Hall scribe & Control which names are remembered & His inkwell is a skull; the skull belonged to a name he erased. \\
\hline
\end{longtable}
...
\item \textbf{Arena Hypogeum} --- Practice sand and whispered secrets beneath the games.
  \hfill \textit{The sand is from the Tiber. It still remembers the blood of the last revolt.} `[DEATH]`
\item \textbf{Everflame Cloister} --- Candle markets and side‑chapels where flame speaks truth.
  \hfill \textit{The flame has a voice. It is the voice of the last liar who tested it.} `[TRUTH]`
\item \textbf{Shatterline Bazaar} --- Between quake‑toppled columns, merchants hawk broken dreams.
  \hfill \textit{The columns were toppled by an earthquake that killed a senator. He still haunts the rubble.} `[TRADE]`
\item \textbf{Coin-House Floor} --- Counting ledgers under glass; factors seal credit with three ribbons.
  \hfill \textit{The ribbons are colored: white for "ask," red for "now," black for "never."} `[AUTHORITY]`
\item \textbf{Mile-Zero Obelisk} --- Surveyors' starting point; all roads measured from here.
  \hfill \textit{The obelisk has a crack. The crack is a mile long---in the other direction.} `[LAW]`
\item \textbf{Triumph Stairs} --- Processional Way switchback; marble worn smooth by ambition.
  \hfill \textit{The stairs have a name: "The Rise of the Forgotten." No one remembers why.} `[SOCIAL]`
\item \textbf{Aqueduct Walk} --- Narrow guardpath above the city's arteries; perfect for ambush or escape.
  \hfill \textit{The water below tastes of iron. It is the city's memory of its own blood.} `[STEALTH]`
\item[J] \textbf{Ducal Loggia} --- High above a packed square; a duchess watches and waits.
  \hfill \textit{The duchess has not blinked in three hours. She is counting.} `[AUTHORITY]`
\item[Q] \textbf{Censor's Hall} --- Red‑lacquered tablets record every name, every shame.
  \hfill \textit{The tablets are redacted in invisible ink. The truth is underneath.} `[LAW]`
\item[K] \textbf{Grand Forum} --- Statues tarped, echoes loud; where crowds become mobs.
  \hfill \textit{The tarps were a gift from a dead emperor. The statues do not thank him.} `[SOCIAL]`
\item[A] \textbf{Imperial Arena} --- The Marble Bowl, gates chained -- for now.
  \hfill \textit{The chains are warm. Something inside is breathing.} `[LEGEND]`
\end{enumerate}
...
\item \textbf{Torchbearer Child} --- Ash‑smudged hands; knows every shortcut through the ruins.
  \hfill \textit{She has never been lost. The ruins speak to her in dust.} `[STEALTH]`
\item \textbf{Ferrymaster} --- Knows which banners pay late; collects more than coin.
  \hfill \textit{His ledger is a net. The names are the catch.} `[TRAVEL]`
\item \textbf{Coin-House Factor} --- Seals credit with three ribbons; eyes twitch at defaults.
  \hfill \textit{His eyes are the color of old silver. They see through your purse.} `[AUTHORITY]`
\item \textbf{Lanista} --- Owns fighters -- and their secrets; sells victory in the sand.
  \hfill \textit{His grin is a brand. The brand is on his fighters' necks.} `[COMBAT]`
\item \textbf{Decumanus-Master} --- Surveyor who "moves" stones; rewrites the city's shape.
  \hfill \textit{His rod is a finger bone. The bone belonged to the last surveyor who argued.} `[LAW]`
\item \textbf{Procession Marshal} --- Permits and whistle; keeps order in ceremonial chaos.
  \hfill \textit{His whistle is for the living. His bell is for the dead.} `[SOCIAL]`
\item \textbf{Grain-Prefect} --- Allots loaves; knives in the margins of every ledger.
  \hfill \textit{His ledger has a stain. The stain is wine---or blood.} `[DEBT]`
\item \textbf{Censor's Clerk} --- "Misfiles" careers; knows which names to forget.
  \hfill \textit{His inkwell is a skull. The skull belonged to a name he forgot.} `[LAW]`
\item \textbf{Veteran Standard-Bearer} --- Sells honor as a retainer; medals heavier than sword.
  \hfill \textit{His medals are from a war that never happened. The corpses are from one that did.} `[COMBAT]`
\item[J] \textbf{Gladiatrix} --- Darling of the crowds; owes no one but the sand.
  \hfill \textit{Her sword has no name. The sand has many.} `[COMBAT]`
\item[Q] \textbf{Duchess-Regent} --- Behind a silk screen; speaks through cousins, rules through silence.
  \hfill \textit{The screen has a hole. The hole is for a dagger---hers.} `[POLITICS]`
\item[K] \textbf{High Priest of Everflame} --- Smiles like law; flame judges truth and debt.
  \hfill \textit{His smile is a candle. It can warm---or burn.} `[TRUTH]`
\item[A] \textbf{Grand Magistrate} --- Guardian of forms, breaker of them when needed.
  \hfill \textit{His gavel is a sundial. It only strikes at noon.} `[AUTHORITY]`
\end{enumerate}
...
\item \textbf{Local Patrons (Syncretic Saints \& Cults):}
  \begin{itemize}
    \item \textbf{St. Marcellus of the Gilded Scale (Mykkiel)} — *The Justiciar*. His order enforces unwritten laws; reading a sealed precedent binds the reader to enforce it. His shrine is the Censor's Hall.
    \item \textbf{St. Valeria of the Serpent (Isoka)} — *The Shedding Saint*. Pilgrims who confess at her chapel forget one sin — and one kindness. Her mosaic shows a snake eating its tail.
    \item \textbf{St. Lucia of the Undying Flame (Oath of Flame \& Light)} — *The Witness of Embers*. Any oath sworn over her shrine's flame cannot be broken; the breaker sees their own face in every wave until they drown.
    \item \textbf{The Reckoner (Maelstraeus)} — *The Ledger Keeper*. A mystery cult of coin‑house factors. They offer credit at the cost of a hidden interest that compounds in blood.
    \item \textbf{The Ember Prefect (Heretic Cult)} — A schism that believes the flame should not be contained. They meet in the arena hypogeum, chanting the *Unspoken Ninth Citation*. The Grand Magistrate has outlawed them three times.
  \end{itemize}
\end{itemize}

\subsection*{Lore Echoes (Cross‑Expansion Hooks)}
\begin{itemize}
  \item \textbf{The Bitter Root:} Daughters of the Cord run a hospice in the Shatterline Bazaar. They ask no payment — but they cut threads. A renegade Sister hides among the arena slaves, trying to untie her cord from a coin‑house debt.
  \item \textbf{Malachai, the Chained Angel:} A silver coin that never spends circulates among the grain‑prefects. Take it, and your store never runs dry — but the coin will reappear in the mouth of a starving child.
  \item \textbf{The Grey Wanderer's Grimoire:} Ecktorian psions are called “Flame‑Readers.” They see the future in the Everflame's flicker. The High Priest employs three — and has never trusted a forecast that didn't smell of smoke.
  \item \textbf{The Threshold Compendium:} The Imperial Arena is a Class IV Poltergeist site — the collective rage of every gladiator who died for the crowd. Saikou Ira would ring a bell eight times and leave a wreath of laurel.
  \item \textbf{The Ninth:} In any Ecktorian court, the ninth citation of precedent voids all previous. The wise stop at eight and settle. Those who cite the ninth hear a faint laughter from the marble walls — and their cases are never heard again.
\end{itemize}
