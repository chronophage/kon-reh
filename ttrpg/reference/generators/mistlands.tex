...
\begin{itemize}
  \item \textbf{The Bitter Root:} Daughters of the Chain run a hospice on a drained pan. They ask no payment—but they take names. A renegade Sister hides among the salt‑monks, trying to unbind her Hollowed.
  \item \textbf{The Threshold Compendium:} Bell‑Lines are Saikou Ira's preferred containment for Class II Anchors. The Weeping Gate is a Class IV Poltergeist waiting to happen.
  \item \textbf{Malachai, the Chained Angel:} The fog sometimes carries silver coins. Pick one up, and you can breathe underwater—but the mist will know your face forever.
  \item \textbf{The Grey Wanderer's Grimoire:} Mistlands psions are called ``Breath‑Readers.'' They taste your last exhalation and know how you will die. The Protectorate employs them as investigators—and disposes of those who see too clearly.
  \item \textbf{The Ninth:} In any Mistlands scene, the ninth person to speak in a room draws the mist's attention. The wise hold their tongues until someone else breaks the count.
\end{itemize}
