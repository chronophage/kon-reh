...
% ====== MISTLANDS: DIREWOOD UNDEAD, FAE ODDNESS, LINN RAIDS, AELER STEWARDSHIP ======
...
\paragraph{Counters (one-scene rites)}
\begin{itemize}
...
\subsection*{Linn Raid Cycle (Skerry Pressure, Plug-in)}
\begin{itemize}
...
\subsection*{Start-of-Night Undead Table (1d6)}
\begin{enumerate}
