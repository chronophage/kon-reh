...
\subsection*{The Aeler of the Southern Ranges}
\label{sec:ngomebe-aeler-south}

Deep in the mountains south of Oshiira, where the iron‑dark skin of the Ngomebe meets the black rock of the peaks, dwell the Aeler of the Southern Ranges. They are partners, not masters, to the Mason‑Kin – their vent‑priors design the bearings that let walking cities roll, and their breath‑bonds seal the pacts that keep the stone alive. Unlike their northern kin, these Aeler have intermarried with Ngomebe for generations; their skin is the same iron‑black, their hair dusted with ore, and their breath‑counters are carved from walking‑city keystone.

\textbf{When to swap:} In any scene set in the Aeler highlands south of Ngomebe (or inside an Aeler‑maintained walking city bearing), replace the \textbf{Hearts} and \textbf{Clubs} entries from the Ngomebe generator with the tables below. Spades and Diamonds remain as written (the places and rewards are shared).

\subsubsection*{Suite Swap: Aeler of the Southern Ranges}

\paragraph{Hearts – People & Factions (Aeler variant)}
\begin{enumerate}
\item \textbf{Vent-Prior (Tunnel Engineer)} – A dwarf with a tuning fork and a level. She can hear a crack in a bearing from a mile away. She never walks under a keystone. `[CRAFT]`
\item \textbf{Breath-Counter (Aeler Ngomebe)} – Wears a brass bell on a leather cord. She counts her breaths in eights. The bell rings when she reaches eight – and when she lies. `[OATH]`
\item \textbf{Keystone Scribe} – Carves contracts into living stone. Her chisel is a dragon's tooth, passed down through seven generations. She has never lost a word. `[LAW]`
\item \textbf{Iron Messenger} – Runs between walking cities with sealed breath‑bonds. She carries a staff of meteoric iron that rings when danger is near. Her shadow has no feet. `[TRAVEL]`
\item \textbf{Forge-Father (Aeler Priest)} – Tends the furnace that tempers roller bearings. He speaks to the flame as if it were his ancestor. The flame answers in the colour of the melt – red for truth, blue for lies, white for a secret. `[RITUAL]`
\item \textbf{Bearing-Caster} – A woman who pours molten iron into roller moulds. She signs each bearing with her thumbprint. The thumbprint is a prayer to the mountain. `[LABOR]`
\item \textbf{Stone-Singer (Aeler)} – Hums in the deep galleries to wake the stone. Her voice can seal a crack – or open a new vein. She has not spoken a word in forty years. She sings everything. `[MAGIC]`
\item \textbf{Roller-Grease Monastic} – A silent order that tends the great rollers. They wear felt robes soaked in ox‑fat and speak only by tapping wrenches. Their monastery is a moving city. `[COMMUNITY]`
\item \textbf{Hollow Watcher (Aeler)} – Guards the sealed door where a demon fragment sleeps. Her breath‑counter ticks backwards. She has not slept in nine years. She is not tired. `[DEATH]`
\item \textbf{Ancestor-Whisperer} – A vent‑prior who speaks to the dead engineers carved into keystones. She carries a slate tablet on which the ancestors write in dust. The dust never stays still. `[SPIRIT]`
\end{enumerate}

\paragraph{Clubs – Complications/Threats (Aeler variant)}
\begin{enumerate}
\item \textbf{Breath-Bond Break} – An Aeler contract is voided by a miscount. The forger is a Ngomebe mason who wanted the city to stop. The mountain is angry. The ancestors are voting. `[DEBT]`
\item \textbf{Bearing Seizure} – A roller locks. The city groans. The Aeler engineer blames the Ngomebe grease. The Ngomebe blame the Aeler casting. The party is caught in the middle – and the city is drifting toward a ravine. `[DISASTER]`
\item \textbf{Keystone Crack} – A load‑bearing stone fractures. The crack is singing in a language no one remembers. The song is a warning about the sealed door. The door is warm. `[OMEN]`
\item \textbf{Hollow Breath} – The demon fragment in the sealed mine exhales. All breath‑counters tick forward by one. Characters must test Resolve (DV 4) or mark 1 Fatigue. The air tastes of copper. `[FEAR]`
\item \textbf{Vent-Prior Audited} – A True Mason from the northern Aeler arrives to inspect the southern breath‑books. She suspects corruption. She is right. The party's contract is one of the forgeries. `[AUTHORITY]`
\item \textbf{Forge-Fire Dies} – The sacred furnace goes cold. The bearing‑casters cannot work. The city stops. The Forge-Father says the flame was stolen – by a shadow that had no bell. The shadow is on the party's ship. `[MAGIC]`
\item \textbf{Bell-Code Conflict} – Two vent‑priors disagree on the emergency chime sequence. One rings evacuation; the other rings lockdown. The party is stuck between two doors, and the ceiling is groaning. `[TRAP]`
\item \textbf{Memory Flood} – A keystone shard releases the stored memory of a dead engineer. The memory is a blueprint for a weapon that could break the Hollow's seal. The Ngomebe want it. The Aeler want to bury it. `[KNOWLEDGE]`
\item \textbf{Gravity Shift} – An Aeler gravity well activates in a phasing ruin. Characters feel twice as heavy. Movement is Desperate. The well was set by a vent‑prior who wanted to trap a demon – and now the party is the bait. `[HAZARD]`
\item \textbf{Stone-Song Curse} – The humming stone‑singer's tune turns discordant. The walls sweat rust. Everyone who hears the song must test Spirit + Resolve (DV 5) or forget one breath‑bond they hold. The bonds are their own. `[DEBT]`
\end{enumerate}

\subsection{Aelinnel of the Southern Coast}
\label{subsec:ngomebe-aelinnel}

\begin{quote}
  \textit{``The city moves because we bargained. The bargain endures because we remember. Every dawn, a child of the coast tosses a knucklebone. If it lands true, the city walks another day. If it lands false, the Hollow wakes. We have not failed yet. The bones are patient. The fae are not.''}
\end{quote}

\paragraph{Quick Reference}
\textbf{Tagline:} \textit{The bargain is a wheel. The coast remembers. Roll the bone, or the city stops.}

\textbf{Genre / Mood:} Fae‑touched maritime gnomes, clockwork oracles, debt to the deep.

\paragraph{Who They Are.} Along the southern shores where Ngomebe’s savannah meets the salt flats, a small population of Aelinnel gnomes dwells in tide‑cut cliffs and sea‑cave workshops. They are not native to the stone cities; they came from the north generations ago, fleeing the collapse of a gnomish court. The Ngomebe gave them shelter. In return, the Aelinnel brokered a pact with the fae spirits of the earth and the deep — a covenant that allows the great walking cities to cross the southern plains without sinking into the soft ground or waking the Hollow that sleeps beneath the grass.

The pact has a price. Each dawn, an Aelinnel oracle — called the \textbf{Bone-Spinner} — rolls a set of carved knucklebones. The pattern of the fall determines whether the city’s path remains safe for another day. If the bones lie still, the bargain holds. If they jump or crack, the city must stop until a new offering is made. The Ngomebe do not understand the bones; the Aelinnel do not fully explain. They only say: \textit{``The fae love games. We gave them one they cannot solve. That is our art.''}

\paragraph{What you notice first:} The scent of salt and copper. The constant, soft rattle of bones in a leather pouch. The way every Aelinnel wears a small brass gear on a chain — the gear of a forgotten clock, still warm.

\textbf{The one rule that kills newcomers:} Never touch the bones before dawn. The pattern is sacred to the pact. A foreign hand can break the covenant — and a broken covenant means the city sinks.

\paragraph{The Bone-Spinner’s Art.} Each Aelinnel coastal clan maintains a single set of knucklebones, carved from the fossilised joint of a beast that died in the old empire. The bones are kept in a silver bowl filled with seawater. At dawn, the Bone-Spinner reaches into the bowl, draws the bones, and casts them onto a woven mat. The pattern is interpreted not by sight but by sound: the click of each bone against the mat creates a rhythm. If the rhythm matches the city’s heartbeat, the day is safe. If the rhythm is off, a spirit must be placated — often with a memory, a lock of hair, or a small carved gear.

The Ngomebe have learned to listen for the Bone-Spinner’s announcement: one bell for safe, two bells for caution, three bells for \textit{``the city will stop before noon, and we must roll again.''} Four bells have never rung.

\paragraph{Fae Bargain, Coastal Price.} The Aelinnel of the coast do not live inside the walking cities. They keep to their sea‑caves and watchtowers, maintaining the wards that line the city’s routes. In exchange for the pact, the Ngomebe provide iron, salt, and protection from lowland raiders. But the Aelinnel are not servants — they are partners in a debt older than memory. The fae who hold the covenant are called the \textbf{Stone-Singers}, and they speak only to the Bone-Spinner. No Ngomebe has ever seen one. Some say the Stone-Singers are the ghosts of the first Aelinnel who made the bargain; others say they are the bones themselves.

\section*{Spades — Aelinnel Coastal Places (d6)}
\label{subsec:aelinnel-places}
\begin{enumerate}
\setcounter{enumi}{1}
\item \textbf{Tide-Vein Cave} --- A sea‑cavern where the walls are scored with spiral grooves.
  \hfill \textit{The grooves are old calendars. Each spiral is a year the city did not sink.} `[RITUAL]`
\item \textbf{Bone-Spinner’s Mat} --- A woven circle of sea‑grass, stained with brine.
  \hfill \textit{The mat has no pattern, but the bones remember where they fell. Touch it, and you may hear the echo of a failed throw.} `[ORACLE]`
\item \textbf{Gear-Hoard Grotto} --- A low cave filled with broken clocks, brass wheels, and ticking shadows.
  \hfill \textit{The gears were offerings to the Stone‑Singers. They still move, even without power.} `[CRAFT]`
\item \textbf{Watchtower of the Third Bell} --- A stone spire on a cliff, facing the city’s path.
  \hfill \textit{The tower has no stairs. The Aelinnel climb the outside. They say the fae hate doorways.} `[WATCH]`
\item \textbf{Sunken Clock} --- An ancient mechanism half‑buried in the tidal flats, its face pointing to the horizon.
  \hfill \textit{The clock’s hands move with the city’s pace. When they stop, so does the bargain.} `[MYSTERY]`
\item \textbf{The Ninth Bone’s Rest} --- A small, sealed alcove behind the Bone-Spinner’s hut.
  \hfill \textit{Inside lies the bone that never falls — a knucklebone that cracked on the day the city first walked. The hollow is warm.} `[DEATH]`
\end{enumerate}

\section*{Hearts — Aelinnel People (d6)}
\label{subsec:aelinnel-people}
\begin{enumerate}
\setcounter{enumi}{1}
\item \textbf{Bone-Spinner} --- The clan’s oracle, always carrying a leather pouch.
  \hfill \textit{She has not slept through a dawn in forty years. The bones talk to her in her dreams.} `[ORACLE]`
\item \textbf{Gear-Mender} --- A gnome with brass fingertips, forever repairing old clocks.
  \hfill \textit{He has never seen the inside of a walking city. He prefers the ticking of the tide.} `[CRAFT]`
\item \textbf{Tide-Watcher} --- A young gnome who reads the city’s speed in the foam.
  \hfill \textit{She is the Bone-Spinner’s apprentice. Her hearing is so sharp she can hear the bones click from a mile away.} `[SCOUT]`
\item \textbf{Stone-Singer’s Emissary} --- A gnome who has spoken with the fae once and survived.
  \hfill \textit{Her left eye is a polished gear. She sees the rhythm of the pact in the movement of clouds.} `[MYSTIC]`
\item \textbf{Debt-Knotter} --- A gnome who ties red thread around the city’s anchor stones.
  \hfill \textit{Each knot is a promise to the Stone‑Singers. She has never untied one.} `[JUSTICE]`
\item \textbf{The Silent Gear} --- An ancient gnome who no longer speaks, only winds clocks.
  \hfill \textit{When he stops winding, the city will stop moving. He has not stopped in nine years.} `[OMEN]`
\end{enumerate}

\section*{Clubs — Aelinnel Complications (d6)}
\label{subsec:aelinnel-complications}
\begin{enumerate}
\setcounter{enumi}{1}
\item \textbf{Bones Fall Silent} --- At dawn, the knucklebones make no sound. The mat is still.
  \hfill \textit{The Stone‑Singers are listening. The party must find an offering of a forgotten promise before the city reaches the next ridge.} `[DEBT]`
\item \textbf{Gear Seizure} --- A clock in the Sunken Clock stops. The city slows.
  \hfill \textit{The gear is rusted with salt from a sea‑cave where a Ngomebe oath was broken. The Aelinnel need someone to recover the broken half.} `[TRAP]`
\item \textbf{Third Bell Rings at Noon} --- The Bone-Spinner calls for an emergency roll.
  \hfill \textit{The fae are restless. A stranger in the party has touched the bones. The penalty is a memory — or a finger.} `[FEAR]`
\item \textbf{Tide-Vein Floods} --- The sea‑cave where the calendars are carved fills with water.
  \hfill \textit{The grooves are washing away. If they vanish, the pact forgets its own terms. The Aelinnel need divers to re‑carve the year count.} `[DISASTER]`
\item \textbf{Gear-Hoard Thief} --- A foreign merchant steals a brass gear from the grotto.
  \hfill \textit{The gears are offerings. Without them, the Stone‑Singers may demand a life. The party must track the thief across the savannah.} `[THEFT]`
\item \textbf{Stone-Singer Speaks} --- The fae manifest as a voice in the salt foam, demanding a new clause.
  \hfill \textit{The clause is impossible: ``The city must roll a ninth bone on the next new moon, or the hollow walks.'' The Bone-Spinner offers the party a way to forge a false bone.} `[LEGEND]`
\end{enumerate}

\section*{Diamonds — Aelinnel Rewards (d6)}
\label{subsec:aelinnel-rewards}
\begin{enumerate}
\setcounter{enumi}{1}
\item \textbf{Bone-Spinner’s Knucklebone (Spare)} --- A carved fossil bone that can be rolled once as a substitute.
  \hfill \textit{Roll it to reroll any failed test involving fate, omen, or pact — but the bone may crack.} `[MAGIC]`
\item \textbf{Gear-Wound Compass} --- A brass compass whose needle points to the nearest walking city.
  \hfill \textit{The needle spins when the bargain is in danger. The gear must be wound each dawn.} `[TRAVEL]`
\item \textbf{Tide-Knot Thread} --- A length of red wool that never tangles.
  \hfill \textit{Tie it around a stone to mark a place where a promise was kept. The stone will remember.} `[JUSTICE]`
\item \textbf{Clockwork Lullaby} --- A small music box that plays a rhythm the fae recognise.
  \hfill \textit{Wind it to calm a restless spirit or to buy a single breath of safe passage. The tune fades after one use.} `[RITUAL]`
\item \textbf{Stone-Singer’s Echo} --- A hollow shell that whispers in a language older than the cities.
  \hfill \textit{Whisper a question into the shell; the echo will answer in a single word. The word is always a condition.} `[ORACLE]`
\item \textbf{The Ninth Bone (Forged)} --- A false knucklebone carved from sea‑glass and a stolen memory.
  \hfill \textit{Use it to substitute for a failed dawn roll once. The hollow will know, but it may accept — if the memory was bitter enough.} `[LEGEND]`
\end{enumerate}

\paragraph{Adventure Seed: The Broken Roll}
At dawn, the Bone-Spinner casts the bones. They land in a pattern no one has ever seen: a cross and a circle and a crack. The third bell rings. The city stops. The Stone‑Singers demand a new clause: \textit{``One of your company must roll a bone every hour until the sun sets. If any roll is false — a single click off — the hollow takes them.''} The party must keep moving, keep rolling, and discover why the pact was broken: a Ngomebe child found an old bone on the savannah and kept it as a toy. The child’s forgotten promise is the only thing that can reset the covenant. The Aelinnel offer a reward: one knot untied, one debt forgiven.

\index{Aelinnel!Ngomebe coast}
\index{Bone-Spinner}
\index{Stone-Singers}
\index{Walking cities!pact}
\index{Aelinnel of the Southern Coast}
\index{Knucklebones}
\index{Hollow!dawn roll}