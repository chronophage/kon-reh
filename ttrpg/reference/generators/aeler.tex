...
\begin{itemize}[leftmargin=*]
    \item \textbf{Traditionalist / "Reactionary"} -- These holds idealize the old mountain‑empire: closed gates, iron tariffs, and the certain knowledge that surface‑dwellers cannot be trusted. They resemble the dwarves of fireside tales: stubborn, insular, and quick to reach for an axe when a human mentions "progress." Their kings speak of the days when no foreigner stepped past the vaultmouth.  
    \emph{Clocks: \textsc{Foreigner Suspicion} [4], \textsc{Hold Sealed} [6].}
    
    \item \textbf{Cooperative / "Open Hand"} -- These holds trade freely with Aelaerem, Kahfagia, and even the Vilikari. They staff the under‑markets, send engineers to repair bridges in Viterra, and treat the surface as a resource to be managed, not a threat to be shunned.  
...
\index{Aeler faction spectrum}
\index{Traditionalist holds}
\index{Cooperative holds}
\index{Isolationist holds}
