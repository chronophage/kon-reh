...
\begin{itemize}[leftmargin=*]
    \item \textbf{Traditionalist / ``The Old Ways''} -- These holds idealize the ancient mountain‑empire: closed gates, iron tariffs, and the certain knowledge that surface‑dwellers cannot be trusted. They resemble the dwarves of fireside tales: stubborn, insular, and quick to reach for an axe when a human mentions ``progress.'' Their kings speak of the days when no foreigner stepped past the vaultmouth.  
    \emph{Clocks: \textsc{Foreigner Suspicion} [4], \textsc{Hold Sealed} [6].}
    
    \item \textbf{Cooperative / ``Open Hand''} -- These holds trade freely with Aelaerem, Kahfagia, and even the Vilikari. They staff the under‑markets, send engineers to repair bridges in Viterra, and treat the surface as a resource to be managed, not a threat to be shunned. They prefer soft power: standardised measures, certified weights, and bell‑code protocols that make others \emph{want} to trade on Aeler terms.  
    \emph{Clocks: \textsc{Trade Route Prosperity} [6], \textsc{Cultural Friction} [4].}
    
    \item \textbf{Isolationist / ``Silent Stone''} -- Deep holds that have not answered a Kingsmoot call in living memory. Their gates are lost, their peoples rumoured to have turned inward, worshiping forgotten depths. They neither help nor harm the surface -- but when a White Flood or a gas flare occurs, their silence becomes a hazard of its own.  
...
\hline
Grunhelda Thrainsdottir & Vault-Queen of Irondeep & Expand trade routes while keeping the Old Ways satisfied & She keeps a pet geode that hums when a contract is fair. \\
\hline
...
\hline
Thromm Stone‑Tongue & Under-Mason (Commoner exemplar) & Hear the mountain’s warnings and keep the tunnels safe & He can identify a false weight by tapping it once with his hammer. \\
\hline
Orthen White‑Ribbon & Tunnel Courier & Deliver sealed writs across hostile jurisdictions & He has run the Spine Underway in darkness without a lamp. Twice. \\
\hline
