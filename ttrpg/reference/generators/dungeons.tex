Here's the updated **Dungeon Generator** following the new template structure. This version is fully compatible with `pdflatex` (no `fontspec`) and aligns with your specified layout and indexing conventions.
