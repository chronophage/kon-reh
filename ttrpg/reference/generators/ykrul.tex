...
Ykrul elders settle disputes not by shouting but by drawing two circles in the dirt: the \textbf{Bowl} for fairness, then the \textbf{Board} for routes and concessions. A successful \emph{Wits + Lore} (or relevant skill) roll creates a \emph{Seasonal Concession String} at a ford, harbor, or pass. On a miss, the \textbf{Market Moot} [4] clock advances as factions argue.
...
\begin{itemize}[nosep]
  ...
  \item \textbf{Supply Strain:} Mark +1 segment on fodder or water clock.
\end{itemize}
