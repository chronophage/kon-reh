...
\item \textbf{Salt Pan} --- Crusted white; hoof‑prints like stars across the void. `[DEBT]`
...
\item \textbf{Salt Shortage} --- Meat spoils; tempers thin like winter air. `[DEBT]`
...
\item \textbf{Feud Spark} --- A name spoken wrong reopens an old cut; blood remembers. `[DEBT]`
...
\item \textbf{Local Patrons (Syncretic Names):}
  \begin{itemize}
    \item \textbf{The Hoof} — The Traveler. *The path that never ends, the remount that never tires.*
    \item \textbf{The Wolf’s Tooth} — The Witness. *Every oath is counted. Every broken promise is a scar.*
    \item \textbf{The Salt Throat} — Maelstraeus. *The debt that salts your tongue; the interest that blinds your horses.*
    \item \textbf{The Sky Father} — Kuva. *The wind that carries names; the storm that erases them.*
  \end{itemize}
\end{itemize}
...
\begin{quote}
  ...
  ``The westerners count their debts in silk and verses. We count ours in frost and iron. A broken oath here is not a story for the skald — it is a hole in the winter larder. We do not forgive because we cannot. The Hollow rides with us every night. We have no room for mercy.''
\end{quote}
...
\begin{enumerate}
  ...
  \item \textbf{The Iron Grandmother (Bone-Singer Revenant):} A ancient bone-singer who refused to die. \emph{Phases}: Song of Names $\rightarrow$ Kurgan Rising $\rightarrow$ The Dead Vote. \emph{Cracks}: sing a true name she does not know, return a stolen kurgan stone, or answer her riddle: “What debt is never paid?”
