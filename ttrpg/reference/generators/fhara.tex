...
Power here is measured in well‑depth, date groves, and the length of a coffee ritual. Each oasis is a sovereign court, ruled by a Sheikh and a Well‑Judge. The Fhara have no single king; their confederacy is a web of marriage alliances, water‑sharing treaties, and caravan tariffs. The desert is not empty – it is a ledger of dry wells, abandoned caravanserais, and the bones of those who could not share. A Fhara merchant can cross the waste with only a waterskin and a coffee pot, because every well has a keeper, every keeper a price, and every price can be negotiated – but the negotiation is a ritual of reciprocity, not of debt.
...
But Qalat al‑Madina’s true secret was older than the city itself. Beneath its deepest well, a faction of scholars unearthed a vault of **forbidden knowledge** – fragments of a civilisation that had turned to ash twenty thousand years before the first Utaran legion marched. The knowledge was not magic; it was a *reckoning*. It spoke of a fire that could scour the world clean.

The three Omens – **Inaea, Ikasha, and Isoka** – appeared to the Eastern Ykrul and the Kuvani as whispers in the grass and cracks in the sky. They gave a single command: *Bury it. Seal it. If it wakes, the world burns.* The horse‑lords rode against Qalat al‑Madina, not for plunder, but to honour the Omens’ warning. They poisoned the wells, drowned the city in its own aquifer, and salted the earth. The curse they carved into the central well was not cruelty – it was a lock: *“Let no Fhara ever drink here without paying a death.”* The death was the knowledge, buried alive.

Now Qalat al‑Madina is a sinkhole field, half‑submerged in brackish water, its towers leaning into the mud. The ghosts of the drowned well‑keepers rise at dusk, still trying to measure water that no longer exists – and to guard the vault that no one has found. The Kuvani and Ykrul have long since left, but the **Omen‑Whisper** remains: in certain wells, at certain tides, a traveller may hear a voice speaking a single word: *“Remember.”*
...
\begin{itemize}
  ...
  \item The Kuvani are sending an expedition to the ruins to *renew* the curse. The Fhara need someone to sabotage them – or to learn why the Omens’ seal is cracking.
...
\begin{tcolorbox}[colback=black!2,colframe=red!70!black,title={The Last Scribe of Qalat al‑Madina}]
  ...
  Samir gave the scroll to the Tulkani. He did not ask for payment. He asked only that they keep it moving – that no single camp hold it for more than nine nights, no single wagon keep it sealed for more than a season. \textit{“The ledger is warm,”} he said. \textit{“The ink is still wet. The Hollow reads over my shoulder.”}
...
\item \textbf{Well‑Court} – A stone bench under a palm; a judge with a clay dipper.
  \hfill \textit{The dipper has a chip. The chip is from a sword that broke a well – and a trust.} `[JUSTICE]`
\item \textbf{Coffee Bazaar} – Stalls under canvas; the smell of roasting beans.
  \hfill \textit{The best coffee is served in a chipped cup. The chip is a signature.} `[TRADE]`
\item \textbf{Date Grove} – Rows of palms; the ground soft with fallen fruit.
  \hfill \textit{The fruit ferments at night. The drunk monkeys are the guards. They accept bribes of honey.} `[COMMUNITY]`
\item \textbf{Dry Riverbed (Old Caravan Route)} – A wide, sandy channel with bleached bones.
  \hfill \textit{The bones are not human. They are camels that died of thirst. Their ghosts still groan a warning.} `[TRAVEL]`
\item \textbf{Tent Court (Mobile)} – A carpet under a canvas roof; a judge with a scale.
  \hfill \textit{The scale weighs water, not silver. One side is always empty – for the next dispute.} `[JUSTICE]`
\item \textbf{Caravanserai of the Three Wells} – A walled courtyard with three different springs.
  \hfill \textit{The sweet well is for guests. The brackish well is for animals. The bitter well is for prisoners.} `[TRAVEL]`
\item \textbf{Salt Pan (Western Edge)} – A white flat where the caravans load salt.
  \hfill \textit{The salt is mixed with ancient tears. It tastes of old grief. Cooks use it sparingly.} `[TRADE]`
\item \textbf{Lighthouse of the Drowned} – A stone tower on the coast, never lit.
  \hfill \textit{The keeper is blind. He rings a bell when he hears ships. The ships are ghosts.} `[DEATH]`
\item \textbf{Oasis of the Ninth Palm} – A legend: a grove with nine palms, but the ninth is invisible.
  \hfill \textit{Drink from the ninth well, and you will forget your name for a day. Your friends will remind you.} `[LEGEND]`
\item[J] \textbf{Abandoned Well‑Keeper’s Hut} – A collapsed stone shelter with a dry basin.
  \hfill \textit{The basin is carved with a name. The name is the keeper’s. He died of thirst – but the well is full.} `[DEATH]`
\item[Q] \textbf{Coffee Warehouse} – A cool, dark building with sacks of beans from a dozen oases.
  \hfill \textit{Each sack is stamped with a well’s mark. The marks are family crests. The beans gossip.} `[TRADE]`
\item[K] \textbf{Well‑Judge’s Archive} – A cave filled with clay tablets. Each tablet is a water judgment.
  \hfill \textit{The tablets are baked hard. They are also porous. They weep when a judgment is reversed.} `[JUSTICE]`
\item[A] \textbf{The First Well} – A mythic spring at the centre of the peninsula, said to never dry.
  \hfill \textit{No one has found it. Those who claim they have are always lying – or dead. The dead are not lying.} `[LEGEND]`
\item[A+] \textbf{Qalat al‑Madina (Sunken City)} – A field of sinkholes and half‑submerged towers.
  \hfill \textit{The water is brackish. The ghosts are polite. They offer you a cup. The cup is empty. Drink it anyway.} `[RUIN]` `[DEATH]`
\end{enumerate}
...
\item \textbf{Well‑Judge} – Grey‑bearded, blind in one eye. He tastes the water before each ruling.
  \hfill \textit{``Salt means guilt,'' he says. ``Sweet means innocence. Bitter means appeal – and a cup of coffee.''} `[JUSTICE]`
\item \textbf{Coffee‑House Poet} – A woman with hennaed hands and a silver bell on her ankle.
  \hfill \textit{She recites a verse. The verse is a price. The price is never in coin – it is a favour, a memory, a silence.} `[SOCIAL]`
\item \textbf{Caravan Master} – Leathery skin, a brass whistle on a thong.
  \hfill \textit{He can find water by the colour of the sand. He has never been wrong. He charges for the lesson.} `[TRAVEL]`
\item \textbf{Water‑Clerk} – A young woman with a clay tablet and a reed pen.
  \hfill \textit{She records every bucket drawn. Her ink is water mixed with soot. A dry tablet means a dry well.} `[COMMUNITY]`
\item \textbf{Date Merchant} – Fat, cheerful, missing two fingers to a knife fight.
  \hfill \textit{He offers a date to every customer. The date is always from his own grove. He knows its story.} `[TRADE]`
\item \textbf{Oasis Lord (Sheikh)} – Robed in white, a bronze key on his belt.
  \hfill \textit{The key opens the sluice gate. He never lets it leave his sight. He sleeps with it under his tongue.} `[AUTHORITY]`
\item \textbf{Well‑Spirit (Kulub)} – A shimmer of heat above the water at noon.
  \hfill \textit{It asks: ``Who drew without sharing?'' Answer truthfully, or the well will dry. The sharing is a story.} `[SPIRIT]`
\item \textbf{Camel Breeder} – A tall, silent man with a staff of acacia wood.
  \hfill \textit{He names each camel after a dead wife. The camels answer to the names. They never forget a slight.} `[COMMUNITY]`
\item \textbf{Salt Carrier} – A slave (illegal, but present in the deep desert). He wears a collar of braided rope.
  \hfill \textit{He is saving to buy his freedom. The price is a thousand measures of salt. His guild saves with him.} `[LABOR]`
\item[J] \textbf{The Drowned Well‑Keeper’s Ghost} – A woman in wet robes, standing at a dry well.
  \hfill \textit{She offers a cup of water. The cup is empty. Drink it anyway. The taste is memory.} `[DEATH]`
\item[Q] \textbf{Coffee Roaster} – A man with blackened hands and a brass drum.
  \hfill \textit{He roasts beans while reciting the genealogy of each grove. The beans remember. They also judge.} `[TRADE]`
\item[K] \textbf{The Ninth Palm’s Guardian} – A hooded figure who appears at the legendary oasis.
  \hfill \textit{He asks: ``Why do you seek the invisible well?'' The answer determines if you see it. There is no wrong answer – only a price.} `[MYSTERY]`
\item[A] \textbf{The First Well‑Keeper (Myth)} – A skeleton sitting on a stone bench, still holding a dipper.
  \hfill \textit{If you take the dipper, you become the new well‑keeper. You cannot leave. The water is sweet. The silence is sweeter.} `[LEGEND]`
\item[A+] \textbf{Harith al‑Qalat} – The immortal survivor of the Sunken City.
  \hfill \textit{He drinks only rainwater. He has not aged in three centuries. He knows where the Drowned Coin lies. He will not say.} `[LEGEND]` `[CURSED]`
\end{enumerate}
...
\item \textbf{Dry Well} – The oasis keeper is dead. Lose 1 Supply.
  \hfill \textit{The keeper’s body is curled around the basin. He died of thirst. The well is full – but the spirit is angry.} `[DEATH]` `[SURVIVAL]`
\item \textbf{Coffee Ritual Interrupted} – A stranger refuses the third cup. The host draws a knife.
  \hfill \textit{The stranger is a rival clan member. The insult is a declaration of feud. The coffee is still hot.} `[SOCIAL]` `[COMBAT]`
\item \textbf{Water Dispute} – Two well‑keepers claim the same spring. The judge demands a story.
  \hfill \textit{The story must be true. The judge will know if you lie. She has heard them all.} `[JUSTICE]` `[SOCIAL]`
\item \textbf{Date Blight} – A fungus attacks the groves. Prices triple. Starvation looms.
  \hfill \textit{The blight was spread by a merchant from the coast. The merchant’s ship flew no flag. The dates weep.} `[DISASTER]` `[TRADE]`
\item \textbf{Sandstorm (Khamsin)} – Red dust obscures the path. Navigation DV +1, mark Fatigue.
  \hfill \textit{The dust carries whispers. The whispers are the names of dead caravaners. They are asking for directions.} `[WEATHER]`
\item \textbf{Customs Inspection (Forged Seal)} – A local governor demands papers. Yours are false.
  \hfill \textit{The seal is a copy. The forger is in the party. He is sweating. The governor is counting the drops.} `[AUTHORITY]` `[TRAP]`
\item \textbf{Elephant Stampede (Rare)} – A herd of stray elephants thunders through camp.
  \hfill \textit{The elephants are from a Dhaharan stable. They are escaped. They are looking for their mahout. He is hiding in your tent.} `[DISASTER]` `[COMBAT]`
\item \textbf{Mirage (False Well)} – A shimmer on the horizon. Lose 1 Supply chasing it.
  \hfill \textit{The mirage is a memory. The memory is of a well that dried a century ago. The ghost of the well drinks your water.} `[WEATHER]` `[TRAP]`
\item \textbf{Debt Collector (Tulkani Memory‑Cord)} – Someone recognises a knot you carry. They demand a story.
  \hfill \textit{The story must be about a broken promise. The knot tightens as you speak.} `[SOCIAL]` `[DEBT]`
\item[J] \textbf{Well‑Spirit Offended} – A traveller urinated in the basin. The well refuses water.
  \hfill \textit{The spirit demands a story. The story must be true. The well will remember.} `[SPIRIT]` `[SOCIAL]`
\item[Q] \textbf{Coffee House Fire} – A roasting drum explodes. The bazaar is burning.
  \hfill \textit{The fire was set by a rival oasis. The rival wants to monopolise the coffee trade. The smoke smells of cinnamon and spite.} `[DISASTER]` `[TRADE]`
\item[K] \textbf{Well‑Judge’s Verdict Forged} – A clay tablet is found altered. The judge is blamed.
  \hfill \textit{The forger is the judge’s own clerk. The clerk owes a favour to the Salt Syndicate. The tablet weeps – but the tears are ink.} `[JUSTICE]` `[TRAP]`
\item[A] \textbf{The First Well Appears} – The mythic spring manifests. All who drink from it forget their broken promises.
  \hfill \textit{The forgetting is permanent. The sand shifts. The Hollow is pleased. The creditors are not.} `[LEGEND]` `[MAGIC]`
\item[A+] \textbf{Qalat al‑Madina’s Curse} – The Sunken City’s ghosts rise and follow the party.
  \hfill \textit{They are polite. They offer water. The water is brackish. They will not leave until someone pays the Drowned Coin – or speaks the word the Omens whispered.} `[DEATH]` `[CURSE]`
\end{enumerate}
...
\item \textbf{Water‑Share Tablet (Stewardship)} – A clay tile. Right to draw from a named well for one season.
  \hfill \textit{The tablet is a seal of trust. Break it, and the well’s water becomes free for all – but the breaker becomes the new steward.} `[COMMUNITY]`
\item \textbf{Caravan Court Writ} – A palm‑leaf document. Demands neutral arbitration for any dispute.
  \hfill \textit{The writ is sealed with coffee grounds. The seal is edible. Eat it to void the writ – and the dispute.} `[JUSTICE]`
\item \textbf{Well‑Judge’s Dipper} – A clay cup on a stick. Once, reroll a failed negotiation involving water.
  \hfill \textit{The dipper has a chip. The chip is from a sword that broke a well – and a trust. It knows a lie by taste.} `[SOCIAL]`
\item \textbf{Coffee Cup (Royal Seal)} – A chipped cup used by a Sheikh. Gain +1 Position in any Fhara court.
  \hfill \textit{The chip is a signature. No one will question it. The cup is still warm.} `[SOCIAL]`
\item \textbf{Date‑Palm Seed} – A single seed from a sacred grove. Plant it to claim water rights.
  \hfill \textit{The seed grows into a palm within a year. The well‑spirit will recognise you. The dates are a tithe.} `[COMMUNITY]`
\item \textbf{Oasis Lord’s Key} – A bronze key to a sluice gate. Open any well’s flow for one hour.
  \hfill \textit{The key is warm. It glows when a well is being poisoned. It burns the hand of a liar.} `[AUTHORITY]`
\item \textbf{Coffee Merchant’s Ledger} – A record of every coffee sale for a decade. Contains names of spies.
  \hfill \textit{The ledger is written in disappearing ink. It reappears when heated. The spies are listed in the margins.} `[TRADE]` `[SECRET]`
\item \textbf{Salt Carrier’s Rope Collar} – A braided rope that once held a slave. Present it to free a captive.
  \hfill \textit{The rope is old. It smells of sweat and freedom. One use. The freed slave will owe you a story.} `[COMMUNITY]`
\item \textbf{Well‑Spirit’s Boon} – A vial of water from a haunted well. Drink it to see the nearest spring.
  \hfill \textit{The water is cold. It tastes of copper. The vision lasts one hour. The spring may be guarded.} `[MAGIC]`
\item[J] \textbf{The Drowned Keeper’s Cup} – An empty clay cup. Offer it to a dry well, and the dead keeper will fill it once.
  \hfill \textit{The cup weeps water. The water is salty. Drink it anyway. The dead keeper will ask for a story in return.} `[DEATH]`
\item[Q] \textbf{Coffee Roaster’s Drum} – A brass drum. Roast beans in it, and the smoke forms words.
  \hfill \textit{The words are the future price of coffee. The price is always a warning. The smoke smells of regret.} `[MAGIC]` `[OMEN]`
\item[K] \textbf{The Ninth Palm’s Date} – A single fruit from the invisible tree. Eat it to forget a single broken promise.
  \hfill \textit{The date is sweet. The forgetting is permanent. The well‑spirit will still remember – but it will not collect.} `[MAGIC]`
\item[A] \textbf{The First Well’s Water} – A flask from the mythic spring. Drink it to clear all obligations to Fhara patrons.
  \hfill \textit{The water tastes of nothing. The spirits will not forgive you for drinking it. But they will forget you owed.} `[LEGEND]` `[MAGIC]`
\item[A+] \textbf{Drowned Coin of Qalat al‑Madina} – A silver piece minted in the lost capital.
  \hfill \textit{Present it to any Fhara well‑spirit, and it will grant safe passage once. The coin was paid to a murderer. It still smells of blood – and of the Omens’ whisper.} `[LEGEND]` `[DEBT]`
\end{enumerate}
...
\begin{itemize}
  ...
  \item \textbf{Name to the Well:} Whisper a dead well‑keeper’s name into the water. Gain +1 Effect when haggling over water rights this scene, but mark Obligation to the Well‑Spirit. `[SUPERSTITION]`
  \item \textbf{Coin to the Ghost:} Toss a Drowned Coin into a dry well. The ghost of Qalat al‑Madina will guide you to water once – and whisper the first syllable of the Omens’ warning. `[SUPERSTITION]`
\end{itemize}
