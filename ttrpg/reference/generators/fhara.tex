...
\begin{tcolorbox}[colback=black!2,colframe=red!70!black,title={The Last Scribe of Qalat al-Madina},breakable]
  ...
  That evening, he unrolled a scroll sealed with a symbol he did not recognize -- three interlocking rings, each a different shade of green. The ink was still wet. The scroll had been written that morning, by a hand that no longer existed. It was the \textbf{Overseer's fragment}, smuggled out of a vault that should have stayed sealed.
  ...
  Samir al-Qalat died in the desert three years later, alone except for a single date-palm that grew from a seed he had carried from his mother's grove. The tree still stands. Travelers who rest in its shade sometimes hear a whisper: \textit{``Count to eight. Then stop.''}
...
\hline
The Drowned Well-Keeper & A ghost of a well that went dry & Warn travelers of poisoned springs & She appears as a column of steam at dusk. She points at safe wells. \\
\hline
...
\item[A] \textbf{The First Well} -- A mythic spring at the center of the peninsula, said to never dry.
...
\begin{enumerate}
\setcounter{enumi}{1}
\item \textbf{Well-Judge} -- Gray-bearded, blind in one eye. He tastes the water before each ruling.
...
\item \textbf{Caravan Master} -- Leathery skin, a brass whistle on a thong.
  \hfill \textit{He can find water by the color of the sand. He has never been wrong. He charges for the lesson.} \texttt{[TRAVEL]}
...
\item[L] \textbf{The Drowned Poet (Safiya al-Fhara)} -- A translucent woman in ink-stained caravan robes, appearing at wells during eclipses.
  \hfill \textit{She recites verses from the \textit{Ford-Counting Sutra}. Those who listen gain +1 die on navigation, but the next well they visit will ask for a story she has not already recorded. Her eyes are inkwells; her voice echoes twice -- once for the living, once for the dead.} \texttt{[DEATH]} \texttt{[KNOWLEDGE]}
...
\item[N] \textbf{Nerethi Mind-Thief} -- A faceless figure wrapped in sand-colored silk.
...
\item \textbf{Obligation Collector (Tulkani Memory-Cord)} -- Someone recognizes a knot you carry. They demand a story.
  \hfill \textit{The story must be about a broken promise. The knot tightens as you speak.} \texttt{[SOCIAL]} \texttt{[OBLIGATION]}
\item[J] \textbf{Well-Spirit Offended} -- A traveler urinated in the basin. The well refuses water.
...
\item[K] \textbf{Well-Judge's Verdict Forged} -- A clay tablet is found altered. The judge is blamed.
  \hfill \textit{The forger is the judge's own clerk. The clerk owes a favor to the Salt Syndicate. The tablet weeps -- but the tears are ink.} \texttt{[JUSTICE]} \texttt{[TRAP]}
...
\item \textbf{Date-Palm Seed} -- A single seed from a sacred grove. Plant it to claim water rights.
  \hfill \textit{The seed grows into a palm within a year. The well-spirit will recognize you. The dates are a tithe.} \texttt{[COMMUNITY]}
...
\item[L] \textbf{The Unfinished Folio (Safiya al-Fhara's Manuscript)} -- A water-stained collection of the historian's final writings, including the \textit{Setu-Gana-Niti} (Ford-Counting Sutra).
  \hfill \textit{Read it aloud to gain +1 die on any negotiation involving water rights, but the Hollow will hear your voice and remember it for nine days. The ninth page is blank -- reserved for the reader's own debt.} \texttt{[LEGEND]} \texttt{[KNOWLEDGE]}
...
\begin{itemize}
  ...
  \item \textbf{The Edgewalker's Copy of Safiya al-Fhara:} The historian's collected writings still circulate among Edgewalkers as a primer on leverage. A copy can be traded for a story at any Tulkani circle -- but the ninth page of every copy is blank, reserved for the reader's own debt. The Edgewalker who annotates a copy finds that their marginal notes sometimes answer themselves, in a handwriting that is not their own.
\end{itemize}
...
\textbf{For the GM:}  
Power in Fhara society is measured in well-depth, coffee cups, and clay tablets. Patronage often takes the form of water-share rights, court writs, or a judge's dipper -- each tied to a specific oasis. To emphasize community and reciprocity rather than obligation:
\begin{itemize}
...
\index{Nerethi}
\index{Safiya al-Fhara}
\index{The Drowned Poet}
\index{Edgewalker}
...
\begin{itemize}
    \item \textbf{Commune:} Spend a scene in meditation to ask the GM one yes/no question about a recent event within the Deep Desert. The dream shows a fragment.
    \item \textbf{Draw Power:} Once per session, spend 1 Fatigue to gain +1 die on a roll involving psionics, perception, or insight. The crystal grows warm.
    \item \textbf{Follow a Discipline:} Narethi who dedicate themselves to one of the two dreams may learn Rites and Talents from the \textbf{Unbroken Way} or \textbf{Riven Path} Patrons (see Chapter 15). Their crystal is their Thiasos; their Codex is a chant passed down orally.
\end{itemize}
...
\textbf{Factions:}
\begin{itemize}
    \item \textbf{Keepers} --- Followers of the Unbroken Way. They maintain the crystals and the dream's stability.
    \item \textbf{Breakers} --- Followers of the Riven Path. They believe the Unburied wants to wake, and that the Narethi should help it break free.
    \item \textbf{The Unbound} --- Narethi who have left the Courts. They are viewed with suspicion, but they are the only source of news from outside.
\end{itemize}
...
\begin{enumerate}
    \item \textbf{The Sunken Courts} --- Subterranean chambers lit by pulsing crystals. [PSIONIC] [SECRET]
    \item \textbf{The Unburied's Chamber} --- The crystalline Sorcerer-King on a throne of petrified wood. The air tastes of copper. [DEATH] [PSIONIC]
    \item \textbf{The Hall of Lost Syllables} --- Walls carved with harmonic chants. The ninth syllable is missing. [MEMORY] [RIDDLE]
    \item \textbf{The Resonant Well} --- A basin of still, dark water. Touch it and hear the dream. [PSIONIC] [OMEN]
    \item \textbf{The Watchers' Perch} --- A salt-crusted outcropping overlooking the Waste. [WATCH] [STEALTH]
    \item \textbf{The Salt Pan of Forgotten Names} --- Cracked white flat where exiled Narethi walk. Do not follow. [DEATH] [MYSTERY]
\end{enumerate}

\paragraph{People \& Factions (Hearts)}
\begin{enumerate}
    \item \textbf{Father of Resonance} --- Ancient ruler who interprets the dream. Has not left the Chamber in twenty years. [AUTHORITY] [SECRET]
    \item \textbf{Listener Chanter} --- Priest seeking the lost ninth syllable. [PSIONIC] [LORE]
    \item \textbf{Mute Sentinel} --- Warrior sworn to silence. Communicates with clay slates. [STEALTH] [COMBAT]
    \item \textbf{Unbound Exile} --- Narethi who left the Courts. Works as a caravan scout. Cannot return. [TRAVEL] [TRAGEDY]
    \item \textbf{The Dream-Echo} --- Haunted by the Unburied's dream. Speaks in two voices. [PSIONIC] [CURSE]
    \item \textbf{Keeper of Teeth} --- Blind elder who tends the crystals. They are growing. She is afraid. [CRAFT] [OMEN]
\end{enumerate}

\paragraph{Complications (Clubs)}
\begin{enumerate}
    \item \textbf{Resonance Bleed} --- The dream intensifies. Crystals glow brighter. Visitors hear whispers. [PSIONIC] [FEAR]
    \item \textbf{The Ninth Syllable Spoken} --- Someone speaks the lost syllable. The Unburied's mouth twitches. Start \textit{Waking Dream} [6]. [DEATH] [APOCALYPSE]
    \item \textbf{Unbound Hunted} --- An exile begs for passage. Helping earns gratitude --- and the Father's attention. [STEALTH] [POLITICS]
    \item \textbf{The Crystals Sing} --- A harmonic tone induces waking visions. Test Spirit+Resolve (DV 4) or mark Fatigue. [PSIONIC] [OMEN]
    \item \textbf{Mute's Vow Broken} --- A Silent One speaks a warning: something wakes beneath the salt. She will not speak again. [TRUTH] [TRAGEDY]
    \item \textbf{The Salt Pan Walks} --- Footprints of dead exiles move toward the Courts. They are curious. That is worse. [DEATH] [FEAR]
\end{enumerate}

\paragraph{Rewards \& Leverage (Diamonds)}
\begin{enumerate}
    \item \textbf{Dream Crystal Shard} --- Once/session, gain +1 die on a psionic roll. The Unburied knows you used it. [PSIONIC] [LEVERAGE]
    \item \textbf{Mute's Clay Slate} --- Present to any Narethi to demand one truthful answer. The slate cracks after use. [SOCIAL] [TRUTH]
    \item \textbf{Listener's Cord} --- Eight tight knots, one loose. Untie a knot to ask a yes/no question about the dream. [MEMORY] [RIDDLE]
    \item \textbf{Watcher's Salt Pouch} --- Scatter to create a temporary threshold spirits cannot cross. [WARD] [PROTECTION]
    \item \textbf{Unbound's Map} --- Safe route through the Deep Desert. Drawn by an exile who never returned. [TRAVEL] [STEALTH]
    \item \textbf{The Dream-Echo's Confession} --- A fragment of the ninth syllable. Speaking it grants +1 Position with Narethi --- but the Unburied remembers your voice. [LEGEND] [DANGER]
\end{enumerate}

\paragraph{Adventure Hooks}
\begin{enumerate}
    \item \textbf{The Lost Unbound.} A Narethi exile has resurfaced as a mercenary captain. The Father wants them returned --- or silenced.
    \item \textbf{The Resonance Bleed.} A Fhara well tastes of copper. Those who drink dream of black glass. The Unburied is restless.
    \item \textbf{The Silent One's Plea.} A mute Narethi appears with a clay tablet. Deliver it to Thepyrgos. The tablet is growing warm.
    \item \textbf{The Ninth Syllable.} A Tulkani story-singer hums a nine-syllable chant. The Listeners want the singer captured. The Mutes want them silenced.
    \item \textbf{The Salt Pan Pilgrims.} Dead exiles walk toward the Courts, singing a lullaby. The Father wants to know why.
    \item \textbf{The Crystal's Hunger.} The crystals are growing toward the surface. They are feeding on something. That something is almost gone.
\end{enumerate}
...
\begin{itemize}
    \item Why did you leave the Courts?
    \item Do you follow the Unbroken Way (calm), the Riven Path (rage), or neither?
