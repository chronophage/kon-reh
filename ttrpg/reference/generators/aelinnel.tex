...
Yet no single crown rules the gnomish lands. Dozens of courts, guilds, and seasonal pacts weave a shifting lattice of loyalty. Some Aelinnel hold fast to ancient fae treaties; others barter in the Green Market with pragmatic coin; still others vanish into the deep woods, speaking only to stag‑roads and stone‑singers. The gnomish heart is divided -- and that division is their strength.
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Atmosphere:} Moonlit math, polite iron, and the uncanny certainty of numbers.
    \item \textbf{Key Conflict:} Said versus meant; fae courtesy versus mortal bluntness.
...
\begin{itemize}
\item \textbf{Numbers \& Magic (1--2 SB):} Antler‑posts rearrange themselves, petals cut like blades, moonlight reveals a path that was not there a moment ago.
\item \textbf{Fae Courtesy (1--3 SB):} A hawthorn arch closes behind you; copper tools glow with fae attention; a polite phrase becomes a binding geas.
\item \textbf{Glamour (1--2 SB):} Conversations arrive folded and misaddressed; time drifts unexpectedly; your footfalls no longer match your steps.
\end{itemize}
...
% ====== EXTENSIONS (unchanged from original) ======
