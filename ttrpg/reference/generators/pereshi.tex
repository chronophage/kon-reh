...
\textbf{Tagline:} \textit{The fire remembers. The ash endures. The name is a lock.}
...
\begin{quote}
  ...
  ``My grandfather copied a reckoning that had not been opened in three centuries. He found a flaw---a single miscounted bale of silk. That flaw started a war. We do not write for the living. We write for the dead who cannot amend their record. And we write to remind ourselves: the empire of ash will not rise again. But the Prince's shadow is long, and the ninth coal has started to hum. The lowland merchants send envoys who cannot meet our eyes. The Tulkani leave knots at our thresholds. We do not explain. We burn.''
\end{quote}

\textbf{Genre / Mood:} High alpine spirit-craft, firelit memory, name-erasure as politics, cursed return.

\textbf{Starting Location:} The scriptorium of a mountain caravanserai, where lamps burn at noon and scribes copy old reckonings by candlelight. A Flame-Keeper looks up from a brazier: ``You have come for a seal of passage, or for a verse to cross the pass, or to consult a book that should have been burned. First, tell me a truth---something the Ash Prince tried to erase. Then I will decide which fire shows you the way. And be quick: the ninth coal is warmer than it should be. It has been humming in my sleep.''
...
But the Pereshi are not a nation. They are a memory of one. Long ago, a highland empire stretched from the western passes to the eastern salt flats---a confederation of fire-shrines, fortress monasteries, and clan valleys that answered to a council of Flame-Keepers. That empire fell when the Ash Prince marched east, burning libraries and breaking the hearths. What remains is a scatter of independent holdings---sacred peaks like Khvarena, temple towns like Adur-Gah, and countless villages that recognize no king, only the fire and the ninth coal in every hearth.
...
\vspace{2mm}
\textbf{What you notice first:} The smell of woodsmoke and old parchment. The way every valley has a different accent. The constant call to prayer from fire-shrine towers---but the prayers are in a language no one speaks outside the highlands, a tongue that predates the Prince's rule. And the way every Flame-Keeper touches the ninth coal before sleep, checking if it has grown hotter. Lately, they check twice.
...
\item \textbf{Fire-Shrine of the Unquenched}---A stone tower with a copper dome. The fire inside is said to be the first flame. It has never gone out---but it flickers when a king dies.
  \hfill \textit{The flame's color changes with the season. The ninth coal sits in a brass brazier, untouched since the Prince's fall. Recently, the coal has started to glow at midnight. The glow casts no shadow.} `[RITUAL]` `[MEMORY]`
...
\item[J] \textbf{The Sunken Archive (Lowland Border)}---A flooded chamber where water-tablets and fire-tablets meet.
  \hfill \textit{The water is warm. The tablets float. The lowland water-clerks who come here never leave. The Pereshi do not explain why.} `[THRESHOLD]`
...
\item \textbf{Fire-Keeper Zahra (new)}---A young priestess of the eastern shrine, secretly writing to a lowland water-clerk.
  \hfill \textit{She writes letters on bark. The bark is from a grove that the Prince burned. She signs with a drop of her own blood. The lowland clerk has never seen her face.} `[CONFLICT]`
...
\item \textbf{A Name Demanded}---A Pereshi fire-keeper demands a name you do not wish to give.
  \hfill \textit{The name must be true. It must be someone you know. The fire-keeper will write it on a clay tablet and place it in the Archive of Severed Names. That person will begin to be forgotten---first by strangers, then by family, then by you.} `[OBLIGATION]` `[SOCIAL]`
...
\item \textbf{Lowland Envoy Refused}---A water-clerk from the lowlands arrives with gifts. The Pereshi burn them.
  \hfill \textit{The envoy is the Nameless---a merchant whose name was erased. He offers the party a shard of the cursed gem in exchange for a promise to intercede. The Pereshi will not negotiate. The party must choose between the merchant's gratitude and the fire-keeper's ire.} `[POLITICS]`
...
\item \textbf{The First Emperor's Scroll Found}---A copy of the scroll containing the Prince's true name surfaces in a lowland market.
  \hfill \textit{The Pereshi will pay anything---a name, a coal, a memory---to recover it. The party is hired to retrieve it. But other factions want it too: the Veiled Ones (to free the Prince), the resistance (to destroy it), and a lowland merchant (to sell it to the highest bidder).} `[QUEST]`
\item \textbf{The Ninth Verse Spoken Aloud}---Someone recites the missing line of the epic.
  \hfill \textit{The line is: ``And the heart that burned, the name that ash---the ninth is warm, the shadow waits.'' The moment it is spoken, the ninth coal pulses. An Oath-Keeper appears. It asks: ``Who taught you that verse?'' The speaker must answer truthfully or lose their voice.} `[CURSE]`
...
\item \textbf{The Archive Weeps}---Water seeps from the walls of the Archive of Severed Names.
  \hfill \textit{The water tastes of salt and old ink. It is the tears of the erased names. They are trying to return. A character who touches the water hears a single name whispered---a name they have never heard. That name now belongs to them. The Hollow will expect it.} `[OBLIGATION]`
\item[J] \textbf{The Prince's Shadow Points}---The shadow appears in a mirror and points at a party member.
  \hfill \textit{That character must yield a name to the Prince. They have nine days to find someone else's name to offer, or the Prince will take theirs. The shadow will appear in every reflection until the claim is settled.} `[CURSE]` `[OBLIGATION]`
\item[Q] \textbf{The Rose Garden Burns (Again)}---Someone sets fire to the ruined garden. The black roses scream.
  \hfill \textit{The smoke forms the shape of a crown---the Prince's crown. The fire was lit by a lowland merchant who thought he could destroy the Prince's memory. Instead, he woke it. The Prince's shadow now walks toward the lowlands. The party must warn the Pereshi---or bargain with the Prince.} `[DISASTER]`
...
\item \textbf{Rose from the Ruined Garden}---A black rose, dried, from the bush that survived the Prince's pyre.
  \hfill \textit{Burn it to ask a yes/no question of the fire. The fire will answer with a color: red for yes, blue for no, white for the question is forbidden. The rose crumbles after use.} `[MAGIC]`
\item \textbf{Tablet of a Severed Name}---A clay tablet from the Archive, inscribed with a name that was erased.
  \hfill \textit{The name belongs to a person who has been forgotten---even by themselves. Speak the name aloud, and that person will remember who they are. Use it to compel someone who once bore an unkept promise to that person. The tablet crumbles after one use.} `[SECRET]` `[OBLIGATION]`
...
\item \textbf{The Ninth Verse (Scroll)}---The missing line of the epic, written on a scrap of leather.
  \hfill \textit{Recite it aloud to summon an Oath-Keeper. The Oath-Keeper will answer one question about the Prince's shadow---but it will then ask you a question in return. You must answer truthfully or lose your voice.} `[KNOWLEDGE]` `[OBLIGATION]`
...
\item \textbf{Lowland Water-Clerk's Red Register (Stolen)}---A register that records every name the Pereshi have lifted from lowland merchants.
  \hfill \textit{The register is a weapon. Present it to a lowland well-judge, and they will release a claim. Present it to a Pereshi fire-keeper, and they will grant you a boon---but they will also ask whose name you want to lift in return.} `[TRADE]` `[OBLIGATION]`
...
\item[Q] \textbf{The Nameless's True Name (Whispered)}---The name that the lowland merchant lost.
  \hfill \textit{Whisper it to him, and he will grant you a boon: a shard of the cursed gem, or a map to the archive of severed names. But the Pereshi will know you spoke his name. They will mark you.} `[TRADE]` `[OBLIGATION]`
...
\begin{itemize}
  \item \textbf{Bread to the Fire:} Crumble a crust into the shrine brazier. Ignore the first \emph{A Name Demanded} penalty. \hfill `[SUPERSTITION]`
