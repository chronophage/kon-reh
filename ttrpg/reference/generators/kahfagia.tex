...
\begin{itemize}
  \item \textbf{The Bitter Root:} Daughters of the Chain run the hospice on Deadman's Quay. They ask no payment—but they remember faces. A renegade Sister hides in the reedbelt creeks.
  \item \textbf{The Threshold Compendium:} Mirror Towers double as observation posts for those who hunt the unquiet dead. The Lantern Code can reveal spirits—or trap them in reflection.
  \item \textbf{Malachai, the Chained Angel:} The Pointe's storms answer to a drowned cult of the Cruel Messenger. Sailors whisper that the Black Squall has a face.
  \item \textbf{The Grey Wanderer's Grimoire:} Psions who read tides are called ``Weather Readers.'' The Admiralty licenses them—and disposes of the ones who see too far.
  \item \textbf{The Ninth:} In any lantern-lit scene, the ninth lamp lit in a room reveals a threshold. The wise stop at eight.
\end{itemize}
