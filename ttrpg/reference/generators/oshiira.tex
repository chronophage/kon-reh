...
The Narrow of Sorrows is a reef‑laced channel where Oshiiran grain barges and Kahfagian privateers play a game of deniable violence. No shots are fired – officially. But spies trade cipher books in weigh‑houses, beacons flash warnings that mean the opposite, and every captured ``pirate'' is a deniable asset with a fake name and a real bullet.

\textbf{The rule for spies:} Never trust a lantern that flashes the same signal twice. The code changes with the tide – and the tide has been bought.

\subsubsection*{Cold War Incidents (d8)}
When the party crosses the Narrow of Sorrows or navigates disputed waters, roll on this table for a complication.

\begin{enumerate}
\item \textbf{Flag of Truce Misused} – A Kahfagian cutter flies the white crab flag. It is not a truce. It is an ambush. The cutter's crew are not pirates – they are Admiralty marines in disguise. The party is the target. `[DECEPTION]`
\item \textbf{Lighthouse Code Poisoned} – The beacon on the Oshiiran side is flashing a warning – but the warning is a lie. A Kahfagian spy has bribed the lighthouse keeper. The safe channel is now a reef. `[AUTHORITY]`
\item \textbf{Grain Barge Hijacked} – A barge loaded with millet is reported ``lost in a storm.'' The storm was a rowboat with cutlasses. The grain is now in a Kahfagian warehouse. The party is hired to steal it back – or to steal the insurance payout. `[TRADE]`
\item \textbf{Cipher Book Half‑Key} – A spy drops a leather notebook. Half the pages are in Oshiiran cipher; half are blank. The blank pages are a map to a Kahfagian safe house. The spy is not dead – he is waiting. `[SECRET]`
\item \textbf{Captured Privateer} – A Kahfagian ``privateer'' (deniable agent) is caught in Oshiiran waters. He offers to name his handlers in exchange for passage to Dhahara. The handlers are in the Oshiiran admiralty. `[POLITICS]`
\item \textbf{Tariff Spy} – A Vermilion Corps auditor is selling sailing schedules to Kahfagia. The party intercepts a payment – a chest of silver that smells of salt and betrayal. The auditor's contact is a Sidhi freedman with a brass hook. `[DEBT]`
\item \textbf{Widow's False Flag} – An Oshiiran warship flies Kahfagian colours and attacks a merchant convoy. The goal is to provoke a war. The party is on the merchant ship. `[COMBAT]`
\item \textbf{The Narrow Captain's Gambit} – An Oshiiran Narrow Captain offers the party a bribe to sink a Kahfagian patrol boat. The bribe is a ship. The ship is stolen. The patrol boat is friendly. The captain is testing their loyalty – or their greed. `[TRAP]`
\end{enumerate}

\subsubsection*{Deniable Assets (d6)}
When the party needs a cover identity or a false flag operation, they may encounter one of these assets – each useful, each dangerous.

\begin{enumerate}
\item \textbf{The Cipher Clerk (Kahfagian double agent)} – She writes dispatches for both navies. Her price is a story – a true one. The story must be about a debt she does not know she owes. `[SECRET]`
\item \textbf{The Lighthouse Keeper (Neutral)} – He charges both sides for safe passage. His light is a lie. His fee is a memory. He has forgotten his own name. He answers to ``Keeper.'' `[AUTHORITY]`
\item \textbf{The Smuggler Captain (Sidhi)} – She runs guns, grain, and spies. Her ship flies no flag. Her loyalty is to the tide. She will carry anything for a share of the cargo – and a story about why you are running. `[STEALTH]`
\item \textbf{The Vermilion Corps Turncoat} – An auditor who sells his own ledgers. He has been doing it for nine years. He wants to retire. His price is a new identity – and a guarantee that the Widow's ghost does not follow. `[DEBT]`
\item \textbf{The Narrow Captain (Retired)} – An old warrior who lost his ship to a Kahfagian mirror trap. He now runs a tavern on the Strait. He knows every current, every reef, and every spy. He will guide you – if you promise to let him steer. `[TRAVEL]`
\item \textbf{The Drowned Agent (Ghost)} – A spy who died mid‑exchange. His ghost still carries a cipher book. He will deliver it – for a single breath. Give him one, and he will sink your ship in thanks. `[DEATH]`
\end{enumerate}
