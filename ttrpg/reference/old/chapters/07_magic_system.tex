...
\item \textbf{Risk Embodied}: Each spell generates Story Beats. These points do not vanish; they manifest as Backlash, unpredictable consequences that ripple outward.\index{Magic!Risk}
...
\begin{itemize}
    ...
    \item \textbf{SB distribution}: SB from Channel resolves on that roller. SB from Weave is assigned to the primary caster.\index{Magic!Ritual!SB Distribution}
\end{itemize}
...
\begin{description}
\item[1--2 SB] Minor nuisance or tell; short-lived cost, noise, or reveal.\index{Magic!Backlash!Minor}
\item[3--4 SB] Noticeable setback: a real hazard, condition, or new pressure clock.\index{Magic!Backlash!Moderate}
\item[5+ SB] Major turn: scene shifts, a new foe/clock enters, or severe condition.\index{Magic!Backlash!Major}
\end{description}
...
Channel Phase: Elena rolls Wits + Arcana (6 dice): 9, 8, 6, 4, 1, 1 = 4 successes, 2 SB
GM spends 1 SB: The life force drawn causes nearby plants to wither
Weave Phase: Elena Weaves Mend Flesh with Detailed description: Wits + Vitalism (6 dice): 10, 7, 5, 3, 2, 1 = 4 successes, 1 SB
Effect: She steps down the ally's Severe injury to Moderate
GM spends remaining SB: The life drawn from surroundings creates an unsettling stillness—small creatures flee the area, and an ominous quiet falls over the battlefield
\end{chapter}
