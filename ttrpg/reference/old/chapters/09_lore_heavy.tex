...
\subsection{Talent (Prestige): Inspire (Bonded)}\index{Talents!Inspire}
...
\section{Rites and Pact Magic Integration}\index{Magic!Rites Integration}
...
\subsection{Rite-Bound Scholar}\index{Backgrounds!Rite-Bound Scholar}
...
\subsection{Pact Scholar}\index{Magic!Pact Magic!Scholar}
...
\section{Bardic and Warlord Applications}\index{Backgrounds!Bardic}\index{Backgrounds!Warlord}

The Inspire talent opens new possibilities for leadership and support characters.

\subsection{Court Bard}\index{Backgrounds!Court Bard}
...
\subsection{Warleader}\index{Backgrounds!Warleader}
A military commander who uses both tactical knowledge and inspirational leadership.

\textbf{Signature Talent:} Inspire (Bonded) - Used to coordinate military units and boost morale

\textbf{Synergy with Backgrounds:}
\begin{itemize}
    \item Margravine's Warrant background provides authority to make Inspire more effective
    \item Legate of the Silent Gate background enhances Inspire in defensive scenarios
    \item Stone-Speaker background makes Inspire effects last longer or be more potent
\end{itemize}

\textbf{Combat Applications:}
\begin{itemize}
    \item Use Inspire before major combat actions to ensure allies start with advantages
    \item Combine with mass combat rules to amplify army effectiveness
    \item Use background Perks to enhance Inspire effects in specific tactical situations
\end{itemize}
