...
Track a \textbf{Corruption Clock} with \(\text{segments}=\) \textbf{Body}. Mark toward accumulation when: \emph{Push}, perform a \emph{Resonant Rite}, or the Keeper spends an SB tied to psionic/occult activity.
