...
\begin{itemize}
  ...
  \item \textbf{Obligation Transference:} Whenever a Rite would increase Obligation, it instead increases Corruption—the debt taken into the soul, not the ledger.
\end{itemize}
...
\begin{description}
  ...
  At the beginning of each Downtime, reduce a character's current \textbf{Corruption} by~1~segment.  
  Lingering or ``pesky'' effects, such as Patron whispers or moral distortions, persist until they are addressed through roleplay or explicit purification.  
  Natural Fading represents the quiet grace of time and distance, but not absolution.

  \medskip
  \item[\indexterm{Act of Contrition}]  
  Perform a genuine act that contradicts the Patron’s influence or repairs its harm.  
  Suitable examples include:
  \begin{itemize}
    \item Publicly oppose the Patron's themes or agents.
    \item Aid those harmed by similar Corruption.
    \item Destroy symbols or relics of the Patron’s dominion.
    \item Make amends with those offended by your past actions.
  \end{itemize}
  \textbf{Effect:} Remove~1~Corruption segment and clear one persistent effect.  
  Contrition must cost the character something—reputation, certainty, or comfort—to be genuine.

  \medskip
  \item[\indexterm{Ritual Purification}]  
  Undertake an act of cleansing aligned with faith, penance, or sacred balance.  
  Common examples include:
  \begin{itemize}
    \item Seek absolution from an opposing or rival divine figure.
    \item Complete a pilgrimage or penitent journey.
    \item Perform service for those harmed by your actions.
  \end{itemize}
  \textbf{Effect:} Remove~2~Corruption segments and clear all persistent effects.  
  The Keeper may require the character to mark temporary Fatigue or Obligation to represent penance.

  \medskip
  \item[\indexterm{Patron Bargain}]  
  Negotiate directly with the Patron that marked you.  
  A bargain may take many forms:
  \begin{itemize}
    \item Accept a divine or infernal quest in service to the Patron’s goals.
    \item Trade \textbf{Obligation} for \textbf{Corruption} at a 1:2 ratio.
    \item Offer something of deep personal or moral value.
  \end{itemize}
  \textbf{Effect:} Remove~1--3~Corruption segments depending on the quality and gravity of the exchange.  
  This method never comes without consequence; the Keeper should introduce a narrative cost or condition.

  \medskip
  \item[\indexterm{Bound Grace}]  
  If a character retains unresolved \textbf{Obligation} to the same Patron, their \textbf{Corruption} cannot fall below~1.  
  Divine debt stains even the most earnest repentance until service is rendered or renounced.

  \medskip
  \item[\indexterm{Persistence}]  
  Corruption effects do not clear through rest or routine healing.  
  They require deliberate narrative resolution, confession, or meaningful acts of change.  
  Every method above is an opportunity for character development and moral play, not bookkeeping.
...
You may now learn and cast \textbf{Standard Rites}, as a \textbf{High Cant}.  
