...
\begin{description}
\item[Requirement] \textbf{Caster's Gift} Talent (6 XP).
...
\textbf{Type:} Free Invoker Talent — \textit{Lesser Imbuement}
...
\centering
\begin{longtable}{p{3.1cm}p{4cm}p{4cm}p{4cm}p{4cm}}
\toprule
\textbf{Aspect} & \textbf{Caster (Freeform)} & \textbf{Runekeeper (Rites)} & \textbf{Invoker (Symbols)} & \textbf{Summoner (Pact)} \\
\midrule
Access Cost & Caster's Gift (6 XP) & Thiasos + Codex (6 XP) & Symbol (4 XP per Patron) & Lesser/Greater Pactwright \\
...
\begin{enumerate}
  ...
  \item \textbf{Leash}: Set Leash = Cap + Spirit segments (Cap is the Outsider's tier, typically 1/3/5 for Lesser/Greater/Elder).
...
\subsection{Spirit Specialization Paths}
...
\subsection{Enhanced Action Economy}
\begin{itemize}
...
\begin{description}[leftmargin=1.5em, style=nextline]
  \item[WARD:] Creates a magical edge/zone that Outsiders must
