...
\begin{itemize}
    ...
    \item Critical success creates a temporary \emph{Stay of Writ} (debt flip: clerk demands future favour).
...
\begin{itemize}
    ...
    \item \textbf{Total:} \textbf{34 XP} (uses enhanced‑starting options cap)
\end{itemize}
