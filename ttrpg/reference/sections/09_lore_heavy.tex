...
\begin{itemize}
    ...
    \item GM must honour properly established geasa.
\end{itemize}
\textbf{Complications:} Failed geasa grant GM +2 SB as oath backlash or minor personal bind.

\section{Specialised Talents}\label{sec:specialised_talents}
\index{Talents!Specialised}
...
\begin{itemize}
    ...
    \item Specialised knowledge reduces helper‑cap requirements for complex rituals.
...
\begin{itemize}
    ...
    \item Mentor younger characters in specialised traditions.
\end{itemize}
...
\begin{itemize}
    \item Include scenes that showcase specialised knowledge.
...
\begin{itemize}
    ...
    \item Create consequences for specialised knowledge failures.
\end{itemize}
...
\begin{itemize}
    ...
    \item Offer unique opportunities tied to specialised knowledge.
\end{itemize}

\subsection{Balancing Specialised Content}\label{subsec:balancing_content}
