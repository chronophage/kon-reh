...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=\textbf{Quick Rule: Defend}]
...
\textit{\textbf{Design Note:} The core loop handles all conflict through narrative positioning. However, the GM may wish to consider the Tactical Layer as a visual aid when the fiction demands high precision (e.g., tight corridors, complex terrain, or large-scale skirmishes). This is a modular choice; the core narrative loop remains the primary engine regardless of whether miniatures are present.}
...
Magic uses \textbf{[TAGS]} (e.g., [WARD], [AREA]). Casting while Engaged worsens Position unless [INSTANT] or aided by Talent. Rituals require clear space; disrupted rituals fail or require Spirit + Resolve to maintain.

\begin{tcolorbox}[title=\textbf{Miniatures Quick Reference},colback=white!98!gray,colframe=black!50!gray,boxrule=0.4pt,fontupper=\small]
...
\textbf{Tags:} Max $2$ active tags/unit. [WARD] $= -1$ die; attacker may take $2$ Fatigue to ignore.
\end{tcolorbox}
