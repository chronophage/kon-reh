...
\index{Ledger Credits}\index{Union Rules}\index{Patron Favour Swap}
...
\begin{description}
    ...
    \item[\textbf{Patron Favour Swap}] Spend a \textbf{Boon} to treat missed upkeep as paid for one follower / asset if the scene honours the Patron.
\end{description}
