...
\item \textbf{Execution} — Build a dice pool equal to \textbf{Attribute + Skill} and roll that many d10s. Each die showing \textbf{6+} counts as a success. Each \textbf{1} rolled generates \textbf{1 Complication Point (SB)} for the GM. \index{Core Mechanic!Execution}\index{Complication Point (SB)}
...
\noindent\textbf{Important:} Re-rolling 1s does \emph{not} remove SB already generated; new 1s add more SB. \index{Complication Point (SB)!Re-rolling 1s}
...
\index{Complication Point (SB)!spend menu}

\subsection{Universal SB Options}
\label{subsec:universal-sb}
\index{Complication Point (SB)!universal}

\begin{description}
\item[\textbf{1 SB}] Minor pressure: suspicious noise, trace left behind, +1 Supply segment, minor time loss. \index{Complication Point (SB)!1 SB}
\item[\textbf{2 SB}] Moderate setback: alarm raised, lose favorable position/cover, lesser foe appears, added obstacle. \index{Complication Point (SB)!2 SB}
\item[\textbf{3 SB}] Serious trouble: reinforcements arrive, key gear breaks, significant complication introduced. \index{Complication Point (SB)!3 SB}
\item[\textbf{4+ SB}] Major turn: trap springs, authority arrives, scene shifts dramatically. \index{Complication Point (SB)!4+ SB}
\end{description}

\subsection{Combat-Specific SB Options}
\label{subsec:combat-sb}
\index{Complication Point (SB)!combat}
...
\index{Complication Point (SB)!stealth}
...
\index{Complication Point (SB)!social}
...
\index{Complication Point (SB)!travel}
...
\index{Complication Point (SB)!arcana}
...
\paragraph{High-Tier SB Sinks} \index{Complication Point (SB)!high-tier}
