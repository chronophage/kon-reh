...
\noindent \textbf{10s are never re-rolled. Critical hit effects always take place if the roll is successful, despite any SB rolled. Critical successes may reduce Backlash/Obligation/Corruption severity by one tier.}
