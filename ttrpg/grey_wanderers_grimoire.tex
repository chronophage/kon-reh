...
\usepackage[colorlinks=true,linkcolor=darkblue,citecolor=darkblue,urlcolor=darkblue,
    pdftitle={Fate's Edge - Complete Grimoire},pdfauthor={The Gray Wanderer}]{hyperref}
...
{\LARGE\scshape\color{darkblue} The Gray Wanderer's Grimoire}\\[0.8cm] % Reduced from \fontsize{28}{32}
...
{\small\textit{``You want power? Fine. But don't come crying when the debt comes due.''}}\\[1.5cm] % Reduced from \large
...
\epigraph{``You want power? Fine. But don't come crying when the debt comes due.''}{\textit{--- The Gray Wanderer}}
...
In Thepyrgos, a Synod clerk once called me a \textit{psy-ee-on}---some term from the Vhasian badlands for those who hear thoughts without asking. I told him I do not read minds; I read the \textit{weight} of what people owe. He wrote me down anyway, in his ledger of freaks and witch-marked. He was not entirely wrong, but he missed the point by a mile. The powers I have touched leave fingerprints that look like many things. I have worn the chains of a dozen Patrons and broken most of them. Twice. I have been called a Runekeeper in Aeler, a witch in Aelaerem, a Cantor in Silkstrand, a Summoner in Zakov, and a fool everywhere. The road changes the walker, and I have walked them all.
...
Every Aeler mage, regardless of path, must learn the \textbf{Breath Bond}: a meditation that converts psychic strain into measured breaths. A Psion in Aeler carries a bell on a leather cord. Each Mental Fatigue point is one bell-ring. When the bell rings three times too fast, a Corrector appears.
...
\epigraph{``I have worn the face of a knight, a warlock, a hedge-priest, and a hunted freak. The path chooses you as much as you choose it, and the debt is always the same weight, though the coin differs.''}{\textit{--- The Gray Wanderer}}

There are not three paths through the thornwood, but six. Six roads that diverge from the crossroads where power and price shake hands. Do not mistake these for guilds or orders—there are no charters signed in ink, no grandmasters to bow before. These are \textit{approaches}, lenses through which the world’s hidden gears become visible. A Runekeeper sworn to the Inquisitor Prime shares more with that burning zealot than with a Runekeeper of Grimmir, though both carry Codices. An Invoker of Aveh has more in common with a gambler drowning in debt than with a Witch who tends the same crossroads. The road shapes the walker.
...
The Runekeepers are the \textbf{agents} of the great powers—not merely users of magic, but its dedicated representatives, its priests and its executioners. To become a Runekeeper is to cease being merely yourself and become an extension of your Patron’s will in the world. You are the ledger made flesh, the vow walking on two legs.

But do not think this creates uniformity. A Runekeeper is as varied as the Patron they serve:

\begin{itemize}
    \item \textbf{The Mykkielan Templar} serves the Stone-Judge with gavel and flame. She is paladin and notary both, her Codex bound in chain-mail, her Thiasos a hound of ash and seal-wax. She does not heal; she adjudicates wounds, declaring them lawful or heretical.
    ...
    \item \textbf{The Artificer of Aelinnel} treats her Patron’s Rites as formulae, her Codex a notebook of impossible geometries. She builds devices—clocks that measure time backwards, lenses that see obligations as glowing threads—arguing that she does not perform miracles, but merely applies context.
...
\begin{itemize}
    ...
    \item You have never met your Patron. You are not certain they know you exist. But the debt grows anyway, and lately, you have seen their servants watching from across crowded rooms.
\end{itemize}
...
\subsection*{Roleplay Hooks}
\begin{itemize}
    \item You owe debts to three different spirits: the river that borders your village, the oak at the crossroads, and the crow that follows you. None have called them in yet, but they will.
...
\vspace{1cm}
\noindent These are the Six Roads. They cross, they diverge, and sometimes they run parallel until the walker looks down and realizes they have been walking the same path all along. Choose yours. But choose knowing that the road changes the walker, and the debt is never fully paid.
...
This chapter presents fourteen Patrons chosen for their utility and distinct themes, organized into five categories. Each entry includes the Patron’s lore, cultural variants across the peoples of Fate’s Edge, and the obligations they demand---whether you are Agent, Gambler, Touched Voice, Threshold Keeper, Isolated Mind, or Door-Opener.
...
\textbf{The Agent (Runekeeper):} You are the Root-Father’s hand in the world, his engineer of the invisible. Your Codex is carved in slate or bark, your Thiasos a fungal thing or a beast of green shadow. You do not merely cast Rites---you maintain the treaty between field and forest, ensuring neither forgets its bounds. Your obligations are seasonal: plantings, cullings, the maintenance of boundaries.

\textbf{The Gambler (Invoker):} You carry a sprig of rowan wood or a wolf’s tooth, renting power for the moment of need. You are useful to farmers and terrifying to city folk. When you Crack the Seal, the wild comes fast and hungry---roots through cobblestones, wolves in the marketplace. The price is always paid in cultivation: you must tend something wild, or wild something tended.

\textbf{The Threshold Keeper (Witch):} You need no Codex. You are the hedge-mother, the Breath-Warden. Your magic is in the cup-mark stones, the red thread, the three knots tied counter-clockwise. Grimmir pays you in favors, not debts, but he always collects at harvest.
...
\textbf{The Agent (Runekeeper):} You are the navigator-priest, the keeper of the wave-roads. Your Codex is a logbook of tides and ley-lines, your Thiasos a gull or a small fish that never dies. You consecrate ships and bless crossings, maintaining the covenant between vessel and water.

\textbf{The Touched Voice (Cantor):} You sing the shanties that calm storms or call them. Your voice carries salt. Corruption for you takes the form of brine---your tears taste of the ocean, your blood leaves salt crystals on your skin, and you sometimes hear the drowned singing in your sleep.

\textbf{The Door-Opener (Summoner):} You call the selkies, the drowned captains, the wave-walkers. You bind them with ropes of kelp and promises of shore-leave. Your Leash is a tide-clock; when it fills, the spirit returns to the depths, often taking a memento with it.
...
\textbf{The Agent (Runekeeper):} You are the Dust-Accountant, the Under-Gardener. You tend the crypts, ensure the proper cycle of rot and renewal. Your Codex is bound in grave-leather, your Thiasos a beetle or a worm. You do not raise the dead---you compost them, returning them to the cycle with proper accounting.

\textbf{The Threshold Keeper (Witch):} You are the one who knows that death is a threshold like any other. You work with the Hollow, with the compost heap, with the cisterns that must be kept sweet. You understand that the Carrion-King is not death but the \textit{transformation} that follows death.

\textbf{The Gambler (Invoker):} You carry teeth and bones, cracking the seal to accelerate decay or renewal. You are useful in sieges and plagues, feared by the living, respected by the desperate. When you overreach, the rot comes too fast---your own flesh softening, your nails yellowing.
...
\textbf{The Threshold Keeper (Witch):} You are the bell-warden, the one who leaves the rope unknotted. You know that every doorway is a promise, every threshold a negotiation. You do not invoke Ikasha---you invite her to witness. Your magic is in the silence between bells, the space between breaths.

\textbf{The Agent (Runekeeper):} You are the Deep Listener, the secret notary of shadows. Your Codex is written in invisible ink, your Thiasos a raven that speaks only in riddles. You record what others forget, maintaining the ledger of the unspoken.

\textbf{The Isolated Mind (Psion):} You are the smuggler of thoughts, the one who moves through minds like Ikasha moves through doorways. You require no rites, only the silence of your own skull. You pay in the loneliness of knowing what others forget.
...
\textbf{The Touched Voice (Cantor):} You are the Shedded, the one who sings the skin away. Your songs are not hymns but moltings. Corruption manifests as scales, as the inability to hold a single form, as voices that speak from your throat that are not your own.

\textbf{The Agent (Runekeeper):} You serve as the Copperhead, the infiltrator-priest. Your Codex contains no true names---only aliases. Your Thiasos sheds its skin regularly, each shedding revealing a new face. You maintain the temple’s secrets by becoming them.

\textbf{The Threshold Keeper (Witch):} You know the Shed Vigil, the vigil of hard choices. You work with knots that untie themselves, with cords that bind by loosening. You understand that transformation requires sacrifice, and you are willing to help others pay it.
...
\textbf{The Gambler (Invoker):} You are the dust-walker, the bridge-runner. You carry Symbols of escape---broken chains, desert sand, horsehair braided in knots. You rent freedom at interest, knowing that Aveh always collects the bond of belonging. You are useful to the desperate, dangerous to the settled.

\textbf{The Agent (Runekeeper):} You serve as the path-finder, the one who opens roads for the fleeing. Your Codex is a map of escape routes, your Thiasos a dust-devil or a horse that leaves no prints. You maintain the right of the fugitive, ensuring that the pursued have somewhere to run.

\textbf{The Door-Opener (Summoner):} You call the wind-horses, the storm-riders, the spirits of escape. You bind them with promises of open sky and no fences. Your Leash is the fear of confinement; when it fills, the spirit bolts, taking your sense of direction with it.
...
\textbf{The Agent (Runekeeper):} You are the Censer-Knight, the witch-hunter, the purifier by flame. Your Codex is a book of censures, your Thiasos a hound of ash and seal-wax. You do not merely judge---you execute the judgment, maintaining the absolute line between pure and impure.

\textbf{The Gambler (Invoker):} You carry Symbols of burning and binding, renting purity for the moment of need. You are dangerous, for you bring the fire that does not distinguish between sinner and saint once loosed.

\textbf{The Isolated Mind (Psion):} You are the mind-reader who hunts the corrupt, the telepath who needs no confession. You are feared even by your allies, for you see the impure thoughts that precede impure deeds.
...
\textbf{The Agent (Runekeeper):} You are the notary of truth, the keeper of the unwritten ledger. Your Codex records what was redacted, your Thiasos a mirror-bird or a creature of glass. You ensure that nothing is truly forgotten, maintaining the archive of uncomfortable facts.

\textbf{The Isolated Mind (Psion):} You are the ultimate witness, the one who sees without being seen. You require no rites, only the opening of your third eye. You pay in the burden of knowing what others would pay to forget.

\textbf{The Threshold Keeper (Witch):} You work with the Echo, the layer of accumulated memory. You know that the Witness is not a judge but the \textit{medium} of memory itself. You bind witnesses to their testimony, ensure that oaths are recorded in the stones themselves.
...
\textbf{The Agent (Runekeeper):} You are the guide-priest, the keeper of the ways. Your Codex is a map of safe passages, your Thiasos a donkey or a bird that knows all the shortcuts. You consecrate roads and maintain the covenants of hospitality, ensuring that travelers have safe haven.

\textbf{The Threshold Keeper (Witch):} You are the bridge-maker, the one who knows that every crossing is a negotiation. You tie the red thread at crossroads, leave the butter on the stone, ensure that the threshold remembers who is guest and who is host.

\textbf{The Door-Opener (Summoner):} You call the spirits of the road---the dust-walkers, the mile-marker ghosts, the things that live in the space between departure and arrival. You bind them with promises of destinations, your Leash measured in miles remaining.
...
\textbf{The Agent (Runekeeper):} You are the pressure-keeper, the one who maintains the deep contracts. Your Codex is bound in whale-skin, your Thiasos a creature of the trenches. You ensure that the deep does not rise, that the drowned stay drowned, that the pressure is maintained.

\textbf{The Gambler (Invoker):} You carry cursed coins and drowned teeth, renting the crushing deep for moments of desperation. You are terrifying and necessary, for sometimes only the abyss can swallow other abysses.

\textbf{The Door-Opener (Summoner):} You call the things that should not be---the tentacled, the pressure-formed, the ancient hungers. You bind them with contracts written in brine, your Leash measured in fathoms. When it fills, the depth claims what is owed.
...
\textbf{The Isolated Mind (Psion):} You are the natural servant of the Ninth, for your power already overflows the vessel of the self. You see patterns that should not exist, count the uncountable. You pay in madness and isolation, for the Ninth allows no congregation.

\textbf{The Agent (Runekeeper):} You are the cartographer of the impossible, the keeper of the Deep Count. Your Codex contains pages that cannot be turned in sequence, your Thiasos a thing of too many angles. You maintain the boundary between the knowable and the known.

\textbf{The Threshold Keeper (Witch):} You work with the gaps, the omissions, the Silent Ninth. You know that the most powerful magic is the magic of what is left unsaid, the door that is never opened, the name that is never spoken.
...
Mykkiel is the unwavering judge of covenants, the divine lawgiver whose scales and sword uphold sacred order. He embodies the tradition of desert patriarchs and mountain prophets---unyielding, absolute, and fiercely protective of the chosen.
...
\textbf{The Agent (Runekeeper):} You are the ultimate notary, the arbiter with teeth. Your Codex contains contracts and writs of execution, your Thiasos a creature of scales and swords. You ensure that the covenant is kept, that the law is absolute, that the stone remains stone.

\textbf{The Threshold Keeper (Witch):} You are the hedge-lawyer, the one who knows that property is a covenant and that boundaries must be witnessed. You draw the lines that cannot be crossed, bind the promises that cannot be broken.

\textbf{The Gambler (Invoker):} You carry the broken chain, the seal of the Sun-Covenant. You rent the law for moments of crisis, invoking contracts you never signed. When the debt comes due, Mykkiel collects in judgment, not mercy.
...
Once a divine messenger tasked with delivering painful truths, Malachai became obsessed with the beauty of destructive revelations. When she began delivering false hope alongside real curses, she was bound in chains of black iron. Those chains did not hold. Now she walks free, whispering promises that rot from within.
...
\textbf{The Gambler (Invoker):} You are the desperate debtor, the one who rents power knowing the interest will be paid in flesh. You carry the thorn and the silver coin. When you Crack the Seal, the curse comes with the blessing, the rot with the growth.

\textbf{The Touched Voice (Cantor):} You sing the songs that promise everything and deliver... everything, including the price. Corruption manifests as the thorn in the rose, the fang behind the smile. Your voice is honey over rot.

\textbf{The Door-Opener (Summoner):} You call the cursed spirits---the lycanthropes, the vampires, the afflicted dead. You bind them with promises of relief from their curses, your Leash measured in the moon's phases or the hunger's intensity.
...
\textbf{The Threshold Keeper (Witch):} You are the Kettle-Spinner, the Weaver of the Unbroken Chain. Your magic is in the cord, the knot, the threshold where two hands meet. You do not invoke Inaea---you \textit{embody} her, ensuring that the web holds, that the connections are maintained, that the debts are remembered.

\textbf{The Agent (Runekeeper):} You are the weaver-priest, the one who maintains the great web of obligations. Your Codex is a book of genealogies and debts, your Thiasos a spider of silver thread. You ensure that no thread is cut without consequence.

\textbf{The Isolated Mind (Psion):} You see the threads between minds, the connections that bind thought to thought. You are the spider at the center of the telepathic web, feeling every vibration, every pluck of the strings.
...
\epigraph{``The Six Roads are paved stone. Free casting is the mud between the cobbles, the river beneath the bridge, the air in the lung. It has no patron to catch you when you fall. It has no leash to pull you back. The risk is not in the casting—it is in the caster.''}{\textit{--- The Gray Wanderer}}
...
Among the tower-clad streets of Thepyrgos, where the Synod’s bells measure law in chimes and every stair climbs toward order, the free caster is the most feared and hunted of all magi. Not because they are evil—though some are—but because they are \textit{unaccountable}. A Runekeeper’s power is chained to a Codex and a Thiasos; if she burns a district, the Patron’s name is written in the ash, and the debt can be called. An Invoker’s magic passes through a Symbol, a named Patron, a debt recorded in a ledger that can be seized. But a free caster? They leave no receipt. The Backlash is theirs alone to bear, and when they fail, the Weave lashes out without theme or mercy.
...
% Life \& Body TAGS
\abilitytag{Mend} & +1 & Life/Body & Close wounds, restore flesh, reduce Harm 1 \\
...
\abilitytag{Curse} & \dangerous{+2} & Affliction & Attach hostile tag/clock to target \\
\abilitytag{Bless} & +1 & Affliction & Grant favourable tag (luck, favour, ward-key) \\
\bottomrule
\end{longtable}
}
...
$\bullet$ Unwanted attention (Alarm clock advances) \\
...
\textbf{The Hedge-Witch} knows six reliable combinations passed down through her family. She uses them to find lost sheep, quiet storms, and mend pots. She has never cast a spell with more than three TAGS, and she sleeps soundly. Her risk is low because her ambition is low.
...
\spell{Fate's Needle}{\abilitytag{Fate}, \abilitytag{Strike}, \dangerous{\abilitytag{Divination}}}{5}{Roll 3d10, keep the highest; that many successes auto-succeed on your next non-magical action.}{Major Backlash -- caster marks Harm 1 and begins a \textit{Fate Debt} clock [4].}
...
\epigraph{``I have shaken hands with the drowned, signed contracts in cobweb ink with things that wear my grandfather's face, and once—only once—borrowed a cup of sugar from a demon. The door is the easy part. It is the conversation that follows that will unmake you.''}{\textit{--- The Gray Wanderer}}
...
When the Leash fills, the spirit acts once according to its essential nature—often destructively, always truthfully—then departs. If it was treated with respect, it may return when called again. If it was dominated, it may hunt the summoner through dreams until the debt is paid in blood.
...
\epigraph{``I have seen a woman sing a storm into stillness, and a man hum a king into madness. The voice is the oldest door, and the Cantor is the one who knocks without asking who is home.''}{\textit{--- The Gray Wanderer}}
...
Most Cantors learn too late that the voice is not infinite. They push, and push again, accelerating their songs to immediate effect until the Corruption clock fills. Then comes the \textit{bloom}: a permanent alteration, neither wholly blessing nor curse, granted by the last Patron whose Rite they performed. They may gain the shadow-sense of Ikasha, but find themselves unable to tolerate sunlight. They may gain the healing touch of Inaea, but find themselves bound to mend every broken thing they encounter, even the wounds of enemies.

And then, often, comes the end.

\section{The Three Fates of the Cantor}

It is no accident that Cantors are often outcasts. Their power is public, loud, and inherently destabilizing. A Runekeeper’s ledger can be checked; a Witch’s knots are quiet; a Psion’s mind is invisible. But a Cantor cannot hide. Their story tends toward one of three endings:
...
To sing a Rite, roll \textbf{Lore + Performance} against the Rite’s DV. Unlike standard casting, a Song typically requires one action to begin, resolving at the start of your next turn unless you \textbf{Push It}—accelerating the song to immediate effect at the cost of marking 1 Fatigue and advancing your Corruption clock.

\subsection{The Corruption Clock}
You possess a personal \textbf{Corruption Clock} with segments equal to your Body rating. Mark Corruption when:
\begin{itemize}
...
When the Clock fills, you immediately gain a \textbf{thematic boon and drawback} from the last Patron whose Rite you performed (see their Corruption Tables). All your followers, retainers, or familiars also gain a trait of the same corruption. The Clock then resets to zero, but it \textit{cannot} go below your current Tier.

\subsection{The Repertoire}
Unlike a Runekeeper’s fixed Codex, a Cantor’s \textbf{Repertoire} is fluid. Track a \textbf{Repertoire Clock} [6]. Mark a segment for each unique Song learned. At 2 segments, reduce the base DV of Songs by 1 (minimum 2). At 4 segments, gain +1 die to Performance. At 6 segments, learn one Standard Rite as a Song (temporary; requires ongoing practice to retain).

\subsection{The High Cantor}
Those who reach Tier II+ may take the \textbf{High Cantor} prestige talent (18 XP), allowing you to weave Standard Rites into instant, powerful Songs. Each such casting marks your Corruption Clock, but the effects are immediate and devastating: lightning called with a scream, armies rallied with a single note, or death itself bargained with in a lullaby.
...
\epigraph{``You fear the feathers in your hair? Child, I have known Cantors who plucked them out and wept. I have known others who let them grow, who preened, who flew. The difference is not in the Patron's touch—it is in the courage to be touched.''}{\textit{--- The Gray Wanderer}}

Most Cantors fear the \textit{bloom}. They see the Corruption Clock as a countdown to obsolescence, a timer ticking toward madness or monstrosity. They are wrong. The clock is not a bomb; it is a chrysalis.
...
\begin{itemize}
    \item When you voluntarily fill your Corruption Clock through Resonant Rites (not by Pushing), you may \textbf{choose} your corruption trait from your Patron’s Corruption Table rather than accepting a random result. You must embody this trait physically and socially (e.g., a Thrysos corruption requiring you to never refuse offered drink).
    \item You may Push Songs without marking Fatigue \textbf{once per session}, accepting the Corruption mark as the only cost.
    \item Once you have filled your Corruption Clock seven times (cumulative, not consecutive), you develop the \textbf{Fugal Self}: +1 die to all Performance rolls. However, each morning you must test Spirit + Resolve (DV 3) or your Corruption controls your body for the first scene of the day, acting according to its own alien desires.
\end{itemize}

\clearpage

\chapter{The Invoker's Ledger -- On Bargaining Without Bondage}
\epigraph{``I do not kneel. I sign. I do not pray. I calculate. The Patron receives my offering—a Symbol polished, a contract whispered—and in exchange, I am permitted to borrow the flame. But make no mistake: when the ledger closes, the debt is mine alone.''}{\textit{--- The Gray Wanderer}}
...
Invokerhood is not a path for the impulsive. It is the province of the methodical, the patient, and the desperate. An Invoker carries no Codex of carved Rites, no Thiasos to whisper warnings. They carry only \textbf{Symbols}—physical anchors to Patrons they have never fully sworn to—and a ledger of debts meticulously maintained against the day of collection.
...
\textbf{Alternative Gift – The Silent Ledger:} Once per session, you may place a secret debt upon a target. Name a truth they have never spoken aloud. Until they confess it to someone, they suffer −1 die to all actions related to deception or social maneuvering. This counts as your Patron’s Gift for the scene.
...
\textbf{Strategy:} You are the ultimate pragmatist, the dealer who always takes a cut. Your Rites grant immediate benefits with deferred costs. You excel at negotiation, at finding the loophole, and at ensuring that every favor you do creates a debt that will one day be collected.
...
\textbf{Patron’s Gift (Imbuement):} Your touch leaves a faint scent of hawthorn and old coins. For one scene, you gain +1 die to Sway and Deception, and any bargain you strike creates a \textbf{Promise Clock [4]} that ticks toward a favor you may call in later.

\textbf{Alternative Gift – The Crooked Thread:} Once per session, you may declare that a target owes you a debt from a previous, forgotten interaction. They must test Spirit + Resolve (DV 4) or accept the truth of the debt. If they fail, they owe you one significant service or truth. This counts as your Patron’s Gift for the scene.
...
\begin{itemize}
    \item You carry four Symbols, but one was stolen by a former student who now uses your patron’s power against you. The debt, however, still accrues to \textit{your} ledger.
...
\begin{warningbox}[title={\scshape The Triangular Trap \& The Tidal War}]
    \subsection*{On Carrying Conflicting Debts}
    ...
    \textit{Livaea} binds through desire; she makes you \textit{want} the debt. \textit{Maelstraeus} binds through accounting; he makes the debt \textit{exact}. And \textit{Mor'iraath}? He offers the illusion of cancellation.
    
    I have seen Invokers attempt to resolve a crushing obligation to Maelstraeus by calling upon Mor'iraath to unmake the creditor. It does not work. Mor'iraath does not erase the ledger; he erases the \textit{signatory}. The debt remains, now held by a void that cannot be paid, and the Obligation transfers to your bloodline as a \textit{curse of erasure}. Your children will be born with blanks in their names where your ancestor’s face should be.
    ...
    To walk with Morag is to learn the \textbf{Law of Hidden Costs}. A witch of Morag can bind a promise with a red thread so fine you cannot see it until it tightens. She can ensure that a bridge stands for a century, but the cost is a child’s laugh, taken in the night and kept in a jar. These witches are not evil; they are \textit{precise}. They keep the ledgers of consequence, and they never forget a debt.
    
    \subsection{The High Mother --- The Unbroken Chain}
    ...
    Inaea is the hearth-mother, the keeper of continuity, the spider at the center of the web. Where Morag demands payment, Inaea offers connection. Her witches bind families with invisible threads, ensure that oaths hold, and mend the cracks in the world’s memory.
    
    The witch of Inaea knows that \textbf{the thread that comforts is the same that binds}. She can lay a line of sanctuary across a threshold---no violence may cross it while the thread holds, but the thread remembers every blow it deflects. When it snaps, the debt comes due. These witches are diplomats, match-makers, the ones who speak the words that prevent wars, knowing that those same words may one day strangle the kings who spoke them.
    ...
    \begin{description}
        \item[\textbf{Echo}] The accumulated past, the memory of stone and bone. Witches who lean on Echo work with \textit{knots and cords}, binding and unbinding what has been. They know that to forget is to unmake.
        \item[\textbf{Veil}] The present, the perceptible now, the boundary between potential and actual. These witches work with \textit{salt and chalk}, drawing lines that separate and define. They know that a threshold is a kind of truth.
        \item[\textbf{Flow}] The direction of change, the will of elements and intent. These witches work with \textit{omission and the Ninth}, manipulating the gaps, the silences, the spaces between. They know that what is left unsaid has weight.
    \end{description}
    
    A witch chooses which limb to lean on for each working, gaining advantage but accepting Backlash specific to that layer: Echo risks \textit{recursion} (past actions repeating), Veil risks \textit{hairline cracks} (subtle breaks in reality), and Flow risks \textit{overshoot} (change that goes too far, too fast).
    
    \section*{The Tools of the Trade}
    The true witch requires no Symbol like an Invoker, no Codex like a Runekeeper. Her tools are domestic, invisible, and everywhere.
    
    \begin{itemize}
        \item \textbf{The Name:} To name is to anchor; to un-name is to erase. A witch learns the true names of things, not as a Runekeeper learns syllables of power, but as one learns the name of a lover---intimately, with context and history.
        \item \textbf{The Cord:} A red thread, a hair from a brush, a length of rope. Knots hold memory; to untie is to release.
        \item \textbf{The Threshold:} Doorways, riverbanks, crossroads, the space between sleep and waking. All magic begins at the edge.
        \item \textbf{The Promise Clock:} Every binding creates a debt, tracked as a clock of 4 to 6 segments. When it fills, the price comes due. A witch’s ledger is written in flesh and time, not ink.
    \end{itemize}
    
    \section*{Curses as Architecture}
    A witch does not curse with a word and a gesture. She \textit{edits} the memory of the world, inserting a rule into the operating system of reality. A curse is written like a law:
    
    \textit{``Until a bell is rung in your true name, lamps forget to light for you.''}
    
    This is a \textbf{Veil-edit}, bound to a Named anchor. It has a clock (Recursion [6]) that ticks when the victim reinforces the story by hiding their affliction or refusing witness. It has a counter---the bell, the name, the threshold. And it has a Story Beat menu: minor echoes, warped thresholds, layer-slips, and the propagation of the Ninth.
...
You think the Daughters of the Unbroken Chain are midwives. Nurses. Hospice workers. The kindly women who sit with the dying, who hold hands at the end, who speak the last words of the forgotten. You are not wrong. We are all of those things. And we are also bait.
...
If that someone is you, do this: go home. Boil water. Salt it. Drink it. Speak your secret name into the steam. Light a beeswax candle. And never, ever accept soup from a Daughter of the Unbroken Chain.
...
\textit{(This page was found pressed between the leaves of a herbalist’s handbook in a burned cottage outside Ecktoria. The cottage had no owner on any record. The handwriting matches none of the Daughters known to the Inquisition. The Gray Wanderer refuses to discuss how they obtained it.)}
    ...
    The monk laughed---a dry, sandpaper sound. ``No cost? Wanderer, you mistake the nature of the debt. A Runekeeper owes a Patron. A Cantor owes their voice. A Witch owes the threshold. A psion owes \textit{themselves}. Every thought you bend is a thought you cannot unthink. Every mind you touch leaves a fingerprint on your own. Every future you glimpse steals a moment of your present. The cost is not external. It is \textit{attrition}. The slow wearing away of the self.''
    ...
    \lettrine{P}{sionics} is the Sixth Road---the path that requires no sworn oath, no stolen Symbol, no audience, no spirit's bargain. It is the disciplined mastery of the mind’s hidden potentials, power turned so far inward that it becomes a weapon, a shield, and a burden. Unlike the Runekeeper who channels a Patron’s will, or the Witch who tends the world’s systemic debts, the psion looks only to the self. This makes them both powerful and terribly vulnerable: their greatest strength is also their most dangerous weakness.
    ...
    \begin{itemize}
        ...
        \item \textbf{Safe.} Mental Fatigue is real. Mental scars are permanent. The mind that bends reality bears the cracks of that bending.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Consequential.} Every psionic action generates Story Beats. The universe notices when a mind touches what it should not, and the mind remembers the cost.
    \end{itemize}
    ...
    Your Mental Fatigue represents your capacity for sustained psychic exertion. It is calculated as your \textbf{Spirit} (minimum 2). Mark Mental Fatigue when you use psionic Arts, resist psychic intrusions, or push your mind beyond its limits.
    
    When you cannot pay a Mental Fatigue cost, choose:
    \begin{itemize}
        \item Convert the unpaid point to \textbf{+2 standard Fatigue}, or
        \item Convert the unpaid point to \textbf{+1 Harm} (Stress).
    \end{itemize}
    
    \textbf{Overflow:} If you ever exceed your Mental Fatigue capacity, immediately suffer +1 Harm (Stress) and set Mental Fatigue to your maximum. You cannot over-mark this scene---the mind simply shuts down.
    ...
    \textbf{Key:} Spirit. \textbf{Cost:} 1 Mental Fatigue to activate; sustained lifts cost 1 per scene. \textbf{Range:} Near (+1 DV for Far).
    ...
    \textbf{Key:} Wits. \textbf{Cost:} DV 2--3 = 1 Mental Fatigue; DV 4 = 2; DV 5+ = 3. \textbf{SB:} Near none; Distant +1 SB on Partial/Miss; Complex Scry +2 SB on Partial/Miss, +1 SB on Success.
    ...
    \textbf{Perks:} Convert 1 Harm $\leftrightarrow$ 1 Mental Fatigue (up to Psionics, max 3/day). Brief physical enhancement (+1 die).
    
    \subsection{Astral Projection -- The Walking Shade}
    \textbf{Key:} Spirit. \textbf{Cost:} 1 Mental Fatigue per scene. \textbf{SB:} +1 per band beyond Near; +1 per additional scene sustained.
    ...
    \textbf{Key:} Spirit. \textbf{Cost:} DV 2--3 = 1 Mental Fatigue; DV 4 = 2; DV 5+ = 3. \textbf{SB:} Always +1, plus additional for high DV.
    ...
    \textbf{Effect:} Resist intrusion/telepathy; shelter allies; create dampened zones. Protecting others costs 2× Mental Fatigue. Area protection covers all within Near (friend and foe).
    ...
    \textbf{Key:} Spirit. \textbf{Cost:} DV 2--3 = 1 Mental Fatigue; DV 4 = 2; DV 5+ = 3. \textbf{SB:} Minor +1; Major (DV 4) +2; Detailed (DV 5+) +3.
    ...
    \textbf{Resonance Scars} remain: The Whispering Vaults of Aeler amplify Mental Fatigue but grant +1 Effect to telepathy. The Empty Circle of the Violet Steppe nullifies all psionics---a grave where the last conclave of psions attempted to end the Silence and instead created a permanent void. The Singing Stones of Lethai allow communication across vast distances, but only when ``tuned'' through proper ritual and relationship.
    ...
    \textbf{Calculation Circles} of mathematical psions serve as living abacuses for engineering projects, performing in hours what takes traditional scholars months. They charge in \textit{Mental Fatigue} as much as coin, requiring recovery chambers and silence.
    ...
    \textbf{Skill Debt:} Psions enter arrangements to provide mental services over time for immediate payment, creating complex obligations tracked not in ledgers of ink but in \textit{Promises of the Mind}. These debts are enforced not by law but by the guilds of the Silent Orders---and by the fact that a psion who reneges on a mental debt finds their own thoughts strangely... leaky.
    ...
    They are hunted by the Chain-Lanterns of Ecktoria, licensed by the Synod of Thepyrgos, sealed in vaults by the Aeler, and shunned by the hearth-keepers of Aelaerem. They carry no outward sign. They are accountable only to themselves---and to the Mind's Ledger, which never forgets a debt.
    
    If you would walk this road, know that you walk it alone. Your only focus is your self. Your only backup is your sanity. And when the Mental Fatigue overflows and the Mind's Ledger closes, you will find that the greatest creditor is the one who has been watching from inside your skull all along.
    
    \vspace{0.5cm}
    \hfill --- \textit{The Gray Wanderer}

    \chapter{Last Words from the Gray Wanderer}
    \epigraph{``A book is a door, not a room. You stand at the threshold now, and something on the other side has heard you breathing.''}{\textit{--- The Gray Wanderer}}
    
    You have walked the Six Roads with me. You have seen how the Aeler count their breaths, how the Linn bind their oaths to bells, how the Thepyrgosi stamp their imprimatur on thoughts themselves. You have read the confession pressed between the leaves—the one written in milk and iron by a hand that no longer remembers its own name. You know about the Daughters, and the Hollowed who never blink, and the Chain that winds through flesh and memory alike.
    ...
    \epigraph{``Before you carve your first Rite, hum your first Song, or swallow your first coin, ask yourself: do you want to serve, gamble, sing, tend, think, or bind? The answer determines which debt you will drown in.''}{\textit{— The Gray Wanderer}}
    ...
    \epigraph{``Every Road can kill you. The question is whether you kill them with fire, song, debt, or a very polite spirit.''}{\textit{— The Gray Wanderer}}
    ...
    \textit{Rites of Cleansing}—remove Conditions, restore Fatigue via \textit{Lay on Hands} (Flame), or mend wounds via \textit{Fertile Death} (Carrion-King). & 
    ...
    Promise Clocks; neighborly debt. \\
    \midrule
    \textbf{Psion} & 
    ...
    Mental Fatigue overflow; sanity scars. \\
    \midrule
    \textbf{Summoner} & 
