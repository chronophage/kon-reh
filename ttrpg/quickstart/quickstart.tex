...
The complete core rules (dice resolution, Position, Difficulty Values, Story Beats, Boons, combat, etc.) are summarized on the \textbf{Fate's Edge Player's Cyclopedia} -- a free 2-page reference sheet.  
