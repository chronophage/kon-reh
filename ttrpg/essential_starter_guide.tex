...
\usepackage{xcolor}
\usepackage{fontspec}
\setmainfont{TeX Gyre Termes}   % similar to Times

\setsansfont{TeX Gyre Heros}    % similar to Helvetica
...
% Color definitions
\definecolor{edgered}{RGB}{140,30,30}
\definecolor{edgegold}{RGB}{200,160,80}
\definecolor{edgedark}{RGB}{30,30,40}
\definecolor{edgepaper}{RGB}{250,245,235}
...
\usepackage{titlesec}
\titleformat{\section}
    {\Large\bfseries\sffamily\color{edgered}}
    {\thesection}{0.5cm}{}
\titleformat{\subsection}
    {\large\bfseries\sffamily\color{edgedark}}
    {\thesubsection}{0.5cm}{}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textit{Fate's Edge Essential Guide}}
\fancyhead[R]{\thepage}
\fancyfoot[C]{\textit{— Every choice carries weight —}}

% Document metadata
\title{\Huge\bfseries\sffamily Fate's Edge}
\author{\large The Grey Wanderer}
...
\twocolumn[
    \begin{@twocolumnfalse}
        ...
        \begin{center}
            ...
            {\large\sffamily Essential Starting Guide}\\[0.3cm]
            {\small \textit{GM \& Player Reference — One Region, One Road}}
...
\begin{tabular}{c l}
\toprule
\textbf{Earning Boons} & \textbf{Spending Boons} \\
\midrule
...
\midrule
Broken March & Margravine Morwen & Keep province from fracturing \\
...
\begin{center}
    \vspace*{\fill}
    {\Large\sffamily\textit{``The coin that never spends is the one you don't remember taking.''}}
    ...
    \vspace{0.5cm}
    {\small Fate's Edge Essential Guide — CC BY 4.0 — Nicholas A. Gasper}
