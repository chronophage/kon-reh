...
\emph{Why this matters:} When players manage their own modules, the GM spends less time bookkeeping and more time driving the story. Always verify player tracking at scene start/end.
\emph{Design Note:} This rule prevents ``GM as auditor'' syndrome. If a player forgets to track a module, the GM does not correct it mid-scene---instead, note it for downtime resolution. Trust fosters faster play.
...
\subsection{Selling the Action}

When a player provides an intricate description that reveals stakes, risks, or character investment, the GM may grant a mechanical edge—improving Position by one step, granting +1 die, or banking a Story Beat. This is a reward for engagement, not a tax for shy players. A simple 'I attack' is always valid.

No roll should result in ``nothing happens.'' Every outcome changes the situation.

\paragraph{What Are Story Beats, Really?}
Story Beats (SB) are the game's permission to make things interesting. Every time a player rolls a 1, they are inviting the world to push back. SB are not punishments—they are narrative fuel generated by player dice, telling you: \textit{``Make this interesting.''} Spend them to introduce complications, escalate threats, or reveal hidden dangers. Do not hoard SB for the climax—the climax is made of the SB you spent along the way. A scene without SB is a scene where players are in control; a scene with SB is where the world pushes back. They are your primary pacing tool.

\paragraph{Can I Roll Fewer Dice? No.}
Never reduce a player's dice pool. The dice pool is the player's primary expression of their character's competence—they invested XP to earn those dice. Reducing them breaks the math: Boons become scarce, SB dry up, and the roller-coaster effect fails. If you want to increase difficulty, use the tools the game gives you: worsen Position (make it Desperate), raise DV (to 4 or 5), add a visible Timer, or spend SB to introduce complications. The player's success should be earned, not diminished.