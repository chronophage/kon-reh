...
\begin{itemize}
  \item \textbf{Clock Limit:} Maintain at most three active clocks per scene. Combine redundant clocks or treat additional clocks as off-screen campaign clocks (ticked between scenes as a result of scene outcomes).
