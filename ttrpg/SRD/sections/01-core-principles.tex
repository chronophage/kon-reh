...
\end{itemize}
GMs retain all world-facing elements: Clocks, NPCs, faction moves, Patron intrusions, and narrative consequences.
...
\subsection{GM Guidelines for Clocks and SB}
To keep the game flowing and avoid overwhelming the table:
\begin{itemize}
  \item \textbf{Clock Limit:} Maintain at most three active timers per scene. Combine redundant timers or treat additional timers as off-screen campaign timers (ticked between scenes as a result of scene outcomes).
