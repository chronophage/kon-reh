...
\textbf{Never reduce a player's dice pool.} A player who asks to roll fewer dice to avoid Story Beats misunderstands the system. In Fate's Edge, a 1 is not a failure---it is narrative fuel. Reducing dice pools breaks the math: Boons become scarce, SB dry up, and the player's investment is undermined. If you want tension, use Position, DV, Timers, and SB---\textbf{never reduce the player's dice pool}. They earned those dice. Let them roll them.