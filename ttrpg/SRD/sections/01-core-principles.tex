...
\emph{Why this matters:} When players manage their own modules, the GM spends less time bookkeeping and more time driving the story. Always verify player tracking at scene start/end (see Section~\texttt{[MISSING REF: sec:session-checklist]}).
