...
Player charges tougher foe in melee. Risk = Controlled, Impact = Standard. "Controlled / Standard, DV 3. Roll!"
\end{quicktool}
...
Creating force wall under fire: TAG = Barrier, scale = Scene $\Rightarrow$ DV 3. Casting in melee $\Rightarrow$ Controlled. "Controlled / Standard, DV 3. Roll."
\end{quicktool}
