...
\begin{itemize}[leftmargin=*]
\item \textbf{Dominant:} Safe, prepared, low threat
...
Player charges a tougher foe in melee. Risk = Controlled, Impact = Standard. "Controlled / Standard, DV 3. Roll!"
\end{quicktool}
...
Creating a force wall under fire: TAG = Barrier, scale = Scene $\Rightarrow$ DV 3. Casting in melee $\Rightarrow$ Controlled. "Controlled / Standard, DV 3. Roll."
\end{quicktool}
...
The Quick‑Kit tools aren"t training wheels---they are professional equipment that experienced directors use to keep focus on story.
\end{recommendation}
...
\begin{enumerate}
  ...
  \item \textbf{Set stakes and Position.} "If it works, what changes? If it fails, what bites?" Start \emph{Dominant/Standard} unless fiction says otherwise.
...
\begin{itemize}
  \item \textbf{Range/Position:} Assume \emph{Near} and \emph{Dominant/Standard}. Ask: "Do you need a beat to get there?"
...
GM: "Dominant/Standard, DV 3. If it works, you"re through; if it fails, the patrol clocks closer."\\
