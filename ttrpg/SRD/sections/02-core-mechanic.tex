...
\paragraph{Example}
Lockpicking under watch (\emph{Risky}, DV 3).  
...
\midrule
1 (Winded) & Controlled → Risky (once/scene) & Breathing heavy, off-balance. \
2 (Strained) & Risky rolls create +1 SB on 1s & Mistakes creep in. \
3 (Exhausted) & Risky → Desperate (once/scene) & Desperate exertion. \
