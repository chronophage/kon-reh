...
\begin{itemize}
  ...
  \item \textbf{Harring Shot / Skirmish.} \emph{Full turn action.} Move up to two range bands away (e.g., Close $\rightarrow$ Near $\rightarrow$ Far) and make one ranged attack. Costs \textbf{1 Fatigue}. Your next defense is Desperate. Consumes both Action and Move. Requires open ground.  
...
The \textbf{Charge} and \textbf{Skirmish/Harring Shot} actions require \textbf{open ground} (no difficult terrain such as rubble, dense forest, shallow water, or steep slopes). Talents may override this restriction.
