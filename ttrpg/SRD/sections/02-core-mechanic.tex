...
\begin{itemize}
  ...
  \item \textbf{Three 10s:} Legendary success; dramatically resolve the conflict and advance related clocks by 1 segment.
  \item \textbf{Four+ 10s:} Mythic success; clear 1-2 segments from a major clock or create a significant story development.
\end{itemize}
...
\noindent
\textbg{10s are never re-rolled. Critical hit effects always take place if the roll is successful, despite any SB rolled. Critical successes may reduce Backlash/Obligation/Corruption severity by one tier.}
...
Each character takes \emph{two Actions} on their turn, in any order; repeating the same Action is not allowed unless noted.
