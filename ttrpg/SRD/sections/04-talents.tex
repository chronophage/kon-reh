...
\item \textbf{Flaming Blade (4 XP):} Deals +1 Fire damage, +1 Effect vs cold creatures
\item \textbf{Soulfire Weapon (6 XP):} Ignores 1 point of armor/resistance, deals Spirit damage
\item \textbf{Thunder Hammer (8 XP):} On 10+, knockback adjacent targets (Hazard +2)
\item \textbf{Luckblade (4 XP):} Once/scene, re-roll 1s on damage dice
\end{itemize}
...
\item \textbf{Wraithmail (8 XP):} Once/scene, become intangible for 1 exchange
\item \textbf{Spellweave Cloak (6 XP):} +2 dice to resist one chosen magical effect
\end{itemize}

\textbf{Gear Enchantments:}
\begin{itemize}
\item \textbf{Boots of Sure Step (3 XP):} Ignore difficult terrain effects
\item \textbf{Lantern of Revelation (5 XP):} Reveal [VEIL] effects within Near range
\item \textbf{Ring of Sustenance (4 XP):} Ignore first level of Fatigue each scene
\end{itemize}
