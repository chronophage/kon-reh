...
\begin{description}[leftmargin=1.5em, style=nextline]
  \item[Caster's Gift (2 XP) \textnormal{[FIRE] [WATER]}:] Grants access to Weave \& Cast freeform spellcasting using the Eight Elements. Without this, characters cannot freeform cast.
