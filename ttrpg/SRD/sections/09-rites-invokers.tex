...
Maelstraea (Temptation, Desire) & Persuade & Grants the lure of longing, beauty sharpened into power over hearts. \\
\bottomrule
\end{tabular}
...
\input{patrons/09o-patron-carrion-king.tex}
\input{patrons/09p-patron-gallows-bell.tex}
\input{patrons/09q-patron-isoka.tex}
\input{patrons/09r-patron-maelstraeus.tex}
