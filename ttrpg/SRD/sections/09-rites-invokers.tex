...
Malachai, the Chained Angel (Curses, Corruption) & Command & Grants cursed blessings—boons that shine bright yet seed hunger, power that demands a price. \\
\bottomrule
\end{longtable}
...
Rivalries set expectations for tone and friction. Use them to color rulings, nudge Position, and guide how Story Beats (SB) land. In their home domains, a Patron’s work tends to start a step better in Position; in a rival’s, a step worse (Keeper’s call).
  ...
  \begin{longtable}{@{}p{3.4cm}p{3.4cm}p{8.2cm}@{}}
    ...
    Malachai, the Chained Angel (Curses, Corruption) & Oath of Light \& Flame (Dawn, Vows) & Fallen benedictions twist vows; dawn seeks to burn corruption from blessing. \\
    \bottomrule
  \end{longtable}
