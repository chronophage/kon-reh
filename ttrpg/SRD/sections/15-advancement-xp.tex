...
\begin{quote}
\emph{Design Note:} Boon conversion is a trickle, not a primary advancement path. The real value of Boons is in the moment---re-rolling a failure, activating an Asset, or improving Position. Hoarding Boons for conversion starves the table of drama. Spend them freely; the XP will come from your adventures. This is a trap.
\end{quote}
