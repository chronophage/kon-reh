...
\index{Backlash}\index{Elements}\index{Complication Points}

Magic unsettles the weave. Each element (and its counterpart) carries a distinct backlash pattern. When a roll shows a 1 (generating a CP), or when a player accepts a CP to escalate, apply a \textbf{Minor} backlash. Players may opt to escalate to \textbf{Major} by taking +1 CP.
...
Air / Luck & Scatter, misheard words • –1 Position or Clock +1/2 (Attention). & Unlikely mishap • Lose a tool/use or CP +1. \
...
Fate / Earth & Probability resists • –1 Effect or Clock +1/2 (Inevitable). & Demand arrives • Immediate sacrifice or CP +1 & mark \textsc{Omen}. \
Life / Fire & Growth surge, vines tether • –1 Effect or \textsc{Overgrowth}. & Riot of life • Clock +1 (Biohazard) or convert healing to CP +1. \
Luck / Air & Odds flip • –1 Position or Clock +1/2 (Coincidence). & Catastrophic fluke • Force re-roll; if any 1, CP +1 and Minor repeats. \
...
\small Minor = wobble; Major = lurch. Apply once per cast. Offer players the option to escalate to Major by taking CP +1.\par\smallskip
