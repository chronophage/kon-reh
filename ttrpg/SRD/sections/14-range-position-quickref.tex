...
\begin{itemize}
  ...
  \item \textbf{Leave:} 1 Move to break off; if threatened, test \emph{Disengage} at Controlled. On Partial/Miss: soft consequence, remain in Melee.
\end{itemize}
...
\subsection{Position (Controlled / Controlled / Desperate)}
...
\begin{itemize}
  \item Default to \textbf{Near} and \textbf{Controlled/Standard}. Ask: “Do you need a beat to get there?” If yes, spend a Move.
