...
This section looks excellent already — it’s structured, concrete, and fits naturally into the SRD. I’d suggest only a few refinements for clarity and consistency with the rest of Fate’s Edge:
	1.	Consistency in terminology: Make sure “clock,” “segments,” and “Complication Points” are always capitalized consistently.
	2.	Explicit tie-in to core mechanics: Add one line connecting card results back to Boons/XP, so GMs know when to translate a Diamond result into actual player currency.
	3.	Broader suit tables: Right now each suit has 4 examples; you may want to expand that later to all 13 for full deck coverage, but leaving them as “examples” is fine for now.

Here’s a lightly polished LaTeX version with those adjustments:
