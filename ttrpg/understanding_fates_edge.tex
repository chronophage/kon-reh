...
\subsection*{Follower and Asset Management Heuristics}

\begin{itemize}
    \item \textbf{When to buy a follower (Tier I–II):} Cap 2 (4 XP) – cheap assistance, no independent actions. Cap 3 (9 XP) – unlocks independent actions (Scout \& Signal, Distract \& Draw). Buy Cap 3 when you have 15+ XP to spare.
    \item \textbf{When to upgrade to Cap 4–5 (Tier III+):} Cap 4 (16 XP) can manage 2 Assets (delegated upkeep). Cap 5 (25 XP) can manage 4 Assets – worth it if you're a Mastermind archetype.
    \item \textbf{Asset activation:} Spend 1 Boon to use an asset dramatically (e.g., safehouse escape route). This is better than re-rolling a die in most cases. Keep 1 Boon reserved for asset activation.
    \item \textbf{Neglected assets:} If you can't pay upkeep, downgrade to Intensive (1 XP + downtime scene). It's cheaper than losing the asset.
\end{itemize}
