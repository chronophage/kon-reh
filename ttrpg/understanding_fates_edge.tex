...
Why they matter strategically: Clocks turn abstract threats into tangible resources. A ``Barrow Collapse [6]'' timer means:
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Visible Tension:} Clocks advance on GM SB – the GM is forced to show pressure building (e.g., “Reinforcements timer ticks +1”).
...
Clock size determination (from generators): 2–5 rank = 4 segments; 6–10 = 6; J/Q/K = 8; A = 10. At Tier I, 6-segment timers are common.
...
\subsection{Clock Management}
Clocks often 8 segments. Use high-dice characters to advance primary timer, lower-dice to manipulate secondary timers via non-dice actions (bribes, distractions).
...
\subsection{Clock Management}
Clocks size 8–10, multiple simultaneous. GM ticks timers with SB. You cannot out-roll timers. Use assets and narrative actions to manipulate them.
...
\begin{itemize}
  \item \textbf{Accept favors only when the Debt Clock is low (0–2 segments).} A timer at 3+ segments is a ticking bomb – the patron will call in the debt soon.
...
\begin{itemize}
    ...
    \item \textbf{Clock size by tier:} Tier I: 4–6 segments. Tier II: 6–8. Tier III: 8–10. Larger timers = more guaranteed escalation.
