...
\index{Companions!types}

Companions in Fate's Edge fall into two broad categories:

\begin{description}
  \item[Familiars and Pets] \index{Companions!Familiars} — Spirit-bound or trained creatures with specific roles.
  \item[Hirelings and Followers] \index{Companions!Followers} — Professional allies who lend their skills to your cause.
\end{description}

All companions are purchased with XP and tracked through \textbf{Condition Tracks}.

\section{Familiars and Pets}
\index{Companions!Familiars}
...
\index{Companions!Familiar rules}
...
\index{Companions!Familiar roles}
...
\index{Companions!Familiar initiative}
...
\index{Companions!Familiar examples}
...
\index{Companions!Follower rules}
...
\index{Companions!Follower assistance}
...
\index{Companions!Follower initiative}
...
\index{Companions!Follower examples}
...
\index{Companions!condition tracks}
