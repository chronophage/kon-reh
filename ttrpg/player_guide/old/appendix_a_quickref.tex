...
\begin{itemize}
  ...
  \item Each \textbf{1} = 1 Story Beat (SB) \index{Story Beat (SB)}
\end{itemize}
...
\section{XP Costs}
\index{Experience Points (XP)!costs}
...
If party enters scene with 2+ structural advantages:
\begin{itemize}
  \item Start one named rail at +1, OR
  \item GM banks +1 SB for first ♠ Twist
\end{itemize}
