...
\end{itemize}
\textbf{NOTE:} Scenes start with +1 banked SB per character with initial complications until those complications have cleared.
...
\textbf{Complication Tracking:} Note any ongoing complications that generate SB debt. Each character with initial complications adds +1 banked SB per scene until cleared.
...
\textbf{SB Debt Management:} Characters with complications generate ongoing SB debt that affects the entire party. Prioritizing complication resolution benefits everyone.
