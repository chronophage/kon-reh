...
Each die that rolls \textbf{6 or higher} counts as a \textbf{Success}. Each die that rolls a \textbf{1} generates a \textbf{Story Beat (SB)} \index{Story Beat (SB)}.
...
\begin{description}
  \item[Basic Action] \index{Basic Action} Roll as normal. All 1s remain as SB.
...
\begin{enumerate}
  ...
  \item GM spends SB to add twists or tension, or draws from the Deck of Consequences.
