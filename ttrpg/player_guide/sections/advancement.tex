...
\begin{itemize}
  ...
  \item \textbf{Associated skills:} Perception, Investigation, Tactics, Lore (see \ref{sec:skills}).
\end{itemize}
\textbf{Rating guide:}
\begin{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Associated skills:} Resolve, Intuition, Magic, Faith (see \ref{sec:skills}).
\end{itemize}
\textbf{Rating guide:}
\begin{itemize}
