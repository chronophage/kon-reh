...
to \textbf{sell it} – to describe not just \textit{what} you do but \textit{how} you
do it, with sensory details, emotion, or a flourish – the GM may reward you with a
\emph{Position bonus}.

\begin{itemize}
  \item \textbf{Basic description:} “I attack the goblin with my sword.”
        No bonus.
  \item \textbf{Detailed description:} “I feint high, then drive my shoulder into
        the goblin’s shield, shoving it aside to open its flank.”
        The GM may upgrade your Position from \textit{Controlled} to \textit{Dominant}
        for this roll.
  \item \textbf{Intricate description:} “I recall the last time I fought in the rain.
        Mud sucks at my boots, but I plant my left foot, pivot, and let the goblin’s
        own momentum carry it onto my point.”
        The GM may grant a larger benefit – e.g., upgrade Position \textit{and}
        bank a Story Beat you can use later, or upgrade Effect by one step.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Be consistent.} If a player routinely offers rich descriptions,
        reward them regularly. If they improve over time, acknowledge it.
  \item \textbf{The bonus should fit the description.} A vivid description of
        desperate, reckless action might upgrade Effect but worsen Position –
        the mechanics should mirror the fiction.
  \item \textbf{Invite quiet players.} Ask leading questions: “What does it look
        like when you pick that lock?” or “What do you say to the guard?” Gentle
        prompts help shy players join the fun.
...
\textit{Selling it:} “I wait for the wind to rattle the shutters, then pad across
the wet cobblestones – heel-toe, heel-toe – keeping the stack of barrels between
me and the sentry’s gaze.” The GM nods and says: “Great. Because you’re using
the wind and the barrels, roll at \textit{Dominant} Position.”
...
\begin{description}
  ...
  \item[Cultural Abilities (variable)]  
    ...
    fictional positioning (see \ref{sec:small-folk}).  
...
\end{tabular}
\end{center}
\textbf{Planning for succession?} A loyal Follower (Cap 3+) can become your successor – see the \textbf{Legacy Engine} (\S\ref{ch:legacy}). Investing in a potential heir early pays off when your character retires or falls.
\end{tcolorbox}
...
\index{Skill challenges}\index{Clocks}
