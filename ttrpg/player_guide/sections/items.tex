...
Most magic items are tools – you pay XP, you keep them, you maintain them. **Artifacts** are different. They are not crafted; they are inherited, discovered, or earned through story. An artifact has a will of its own, however faint. It remembers every hand that held it, every oath spoken over it, every debt left unpaid.
...
\begin{itemize}
  ...
  \item \textbf{Rites.} An artifact grants one or two specific Rites (see Chapter \ref{ch:patrons}) that you can invoke without a Patron, a Codex, or a Symbol. Using a Rite from an artifact costs the normal Obligation (in addition to any Obligation from attuning to the artifact). The Rites are tied to the artifact’s nature – a sword that remembers a betrayed king might grant \textit{Rite of the Oath Unbroken}; a lantern that once lit a heretic’s pyre might grant \textit{Rite of the Revealing Flame}.
...
Unlike ordinary magic items, artifacts require **no upkeep** (no XP or downtime scenes). They maintain themselves – or rather, they maintain their hold on you. However, you cannot simply stop attuning to an artifact; it will return at dawn until your Obligation to it is cleared.
...
\begin{itemize}
  ...
  \item \textbf{Obligation Overflow:} If your Obligation to an artifact exceeds your Capacity, you suffer Fatigue as normal (see \S\ref{subsec:obligation-overflow}). Additionally, the artifact may manifest – a cold weight in your pack, a whisper in your ear, a reflection that doesn’t match the room.
\end{itemize}
...
Artifacts are **story hooks**, not power-ups. If you find one, ask yourself:
\begin{itemize}
