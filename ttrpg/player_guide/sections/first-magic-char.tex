...
Psionics (optional) & Medium & Mental Fatigue & Mental strain, social distrust & Mind‑power enthusiasts \\
\bottomrule
\end{tabular}
\end{center}
...
If you are still unsure, follow the recommendation below -- you can always learn a second path later.
...
\noindent
Still unsure? \textbf{Let's start with Runekeeper.} You can always learn a second path later (see Chapter 3 for multi‑path rules).
