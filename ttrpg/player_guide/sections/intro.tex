...
\begin{tcolorbox}[colback=red!5!white, colframe=red!75!black, title=\textbf{Safety Tools: Lines, Veils \& X‑Card}, fonttitle=\bfseries\large,breakable]
...
\item \textbf{\texttt{[MISSING REF: ch:example-concepts]}} --- Ten example characters to inspire you.
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black, title=Quick Reference: Where to Find It,breakable]
...
Travel (legs, timers, roles) & \texttt{[MISSING REF: sec:travel-framework]} (World Interaction) \\
...
\begin{tcolorbox}[colback=black!3!white, colframe=black!40!white, title=Remember, fonttitle=\bfseries,breakable]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black, title=Flavor is Free, fonttitle=\bfseries,breakable]
