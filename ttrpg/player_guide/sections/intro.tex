...
\begin{itemize}
  ...
  \item \textbf{Session 20:} You will be juggling Obligation, Corruption, faction clocks, and legacy planning without looking at the book.
\end{itemize}
...
\item \textbf{\autoref{ch:currency-free-economy}} --- No coin; use XP, Strings, and Debt Clocks.
...
Travel (legs, clocks, roles) & \autoref{sec:travel-framework} (World Interaction) \\
