...
\begin{itemize}
\item \textbf{Chapters 2--3: Core Mechanics} --- Action resolution, Position, Difficulty Values, Story Beats, Boons, and character advancement. (For the complete SRD, see the separate document.)
\item \textbf{Chapters 4--5: Attributes, Skills \& Advancement} --- Building your dice pools and growing your character.
\item \textbf{Chapters 6--7: Talents \& Character Concepts} --- Special abilities and example builds.
\item \textbf{Chapters 8--11: World \& Cultures} --- The peoples, lands, and factions of Fate's Edge.
\item \textbf{Appendices} --- Quick references, magic tags, and player tools.
\end{itemize}
...
\midrule
Core resolution (roll dice, DV, outcomes) & Chapter 2 (\ref{ch:core-mechanics}) \\
Position \& Effect & Chapter 2 (\ref{sec:position}) \\
Combat (initiative, actions, harm) & Chapter 2 (\ref{sec:combat-simple}) \\
Magic (paths, rites, backlash) & Chapter 3 (\ref{ch:magic}) \\
Travel (legs, clocks, roles) & Chapter 8 (\ref{sec:travel-framework}) \\
Clocks \& Fronts & GM Guide, Chapter 2 -- ask your GM \\
Story Beats (SB) & Chapter 2 (\ref{sec:story-beats}) \\
Boons (earning, spending, limits) & Chapter 2 (\ref{sec:boons}) \\
Assets \& Followers & Chapter 7 (\ref{ch:assets-followers}) \\
High‑tier play (Tiers IV--V) & GM Guide, Chapter 8 \\
\bottomrule
\end{tabularx}
\end{tcolorbox}
...
The next chapter covers the core mechanics that drive play. If you are eager to build a character, jump ahead to Chapter 4 (Attributes & Skills). For an overview of the world, see Chapter 11 (World Regions and Cultures).
