...
\begin{itemize}
    ...
    \item Harm 3 → Last Stand or Patron’s Claim (see \S\ref{sec:pc-death-optional}).
\end{itemize}
\end{tcolorbox}
...
\textbf{TAGS:} {[MEND]} \\
\textbf{Effect:} Close a small cut or bruise; reduce 1 Harm (Minor). \\
\textbf{DV:} 1 + 1 = \textbf{2}. \\
