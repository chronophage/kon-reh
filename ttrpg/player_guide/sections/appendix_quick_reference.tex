...
Carrion King & Survival & \emph{Grants the feast of decay...} \\
Clockwork Monad & Tinker & \emph{Grants the certainty of repetition...} \\
Gallows Bell & Command & \emph{Grants the toll of ending...} \\
Grimmir & Survival & \emph{Grants the wisdom of root and stone...} \\
Ikasha & Stealth & \emph{Grants the hush between footsteps...} \\
Inaea & Persuade & \emph{Grants the hearth's warmth...} \\
Inquisitor Prime & Insight & \emph{Grants the hunter's sight...} \\
Isoka & Skirmish & \emph{Grants the serpent's coil...} \\
Khemesh & Skirmish & \emph{Grants the crushing silence of the deep...} \\
Livaea & Sway & \emph{Grants the velvet whisper...} \\
Lunara & Notice & \emph{Grants the silver mirror...} \\
Maelstraeus & Subterfuge & \emph{Grants the crooked scale...} \\
Malachai & Deception & \emph{Grants the honeyed curse...} \\
Morag & Sway & \emph{Grants the hidden cost...} \\
Ninth & Lore & \emph{Grants the glimpse beyond...} \\
Oath of Flame \& Light & Command & \emph{Grants the fire of dawn...} \\
Oath of Mercy and Grace & Insight & \emph{Grants the spiral of mercy...} \\
Pale Shepherd & Stealth & \emph{Grants the shepherd's whisper...} \\
Palinode & Performance & \emph{Grants the unfinished chorus...} \\
Savage Heart & Intimidation & \emph{Grants the red maw...} \\
Sealed Gate & Tinker & \emph{Grants mastery of thresholds...} \\
The Traveler & Notice & \emph{Grants the open way...} \\
Thrysos & Performance & \emph{Grants the horned dance...} \\
Varnek Karn & Command & \emph{Grants the silence of the archive...} \\
The Witness & Notice & \emph{Grants the unblinking gaze...} \\
\end{longtable}

% --- Full 24-patron Fear Influence Table (for reference) ---
...
% Include all 24 rows exactly as in the original chapter (omitted here for space, but you would copy the full original table).
% For brevity, I show only the header; in practice you would paste the complete table from the original source.
...
\caption{Complete Patron Gifts and Thematic Skills (24 patrons). The +1 bonus applies only when the fiction aligns with the Patron's domain.}
