...
\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=A Word from the Raven Road,breakable]
...
\begin{itemize}
  ...
  \item Advance, suppress, or redirect a relevant Timer .
...
\begin{itemize}
  ...
  \item \textbf{Spy Network}: Surface critical intelligence, advancing an investigation Timer .
...
\begin{itemize}
  ...
  \item Advance hostile faction Timers.
...
Spend \textbf{2 XP} (see \ref{sec:spending-xp}) to use an Asset's off‑screen effect beyond its normal limit:
\begin{itemize}
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Planning for Succession (The Legacy Engine),breakable]
...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title={Assets and Followers Quick Reference},fonttitle=\bfseries,breakable]
\textbf{Assets:}
\begin{itemize}
