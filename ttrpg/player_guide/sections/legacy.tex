...
\begin{itemize}
  ...
  \item Gain a free \textbf{Boon} (see \ref{ch:core-mechanics}) when acting to uphold the predecessor's values.
\end{itemize}
...
\begin{itemize}
  \item The Iron Tide as a \textbf{Mercenary Contract (Standard Asset)} (see \ref{ch:assets-followers}).
...
\begin{enumerate}
  ...
  \item \textbf{Pass Down an Asset (Optional)} -- If your character controls a Minor or Standard Asset (see \ref{ch:assets-followers}), the GM may allow the successor to retain it with suitable narrative justification (e.g., ``The family safehouse,'' ``The guild seat passes to the heir''). Major or Tier III Assets usually require the successor to earn them through play.
  \item \textbf{Settle Outstanding Obligations} -- Clear or transfer any standing debts to terrestrial patrons (see \ref{ch:world-powers-obligation}) before stepping down. Unpaid debts may become part of the successor's burden.
