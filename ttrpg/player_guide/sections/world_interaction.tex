...
\chapter{World Powers (Brief)}
\label{ch:world-powers}
\index{factions}\index{politics}

Most major powers are described within each region’s entry above. For a quick reference of overarching factions and their public reputations:

\begin{itemize}
  \item \textbf{The Everflame Orthodoxy} (Ecktoria, Thepyrgos, parts of Vhasia): Fire‑cult that judges truth and debt.
  \item \textbf{The Condotta Brokers} (Black Banners, Acasia): Mercenary contract negotiators.
  \item \textbf{The High King Beneath the Peaks} (Aeler): Dwarven high king – nominal authority.
  \item \textbf{The Salt Prince} (Zakov): Pirate‑lord – real power is the Syndicate Silent.
  \item \textbf{The Warrior Queen} (Viterra): Hedge‑law ruler, patient and legalistic.
  \item \textbf{The Sea‑Queen} (Linn): Oath‑binder of the skerries.
\end{itemize}

For faction clocks, hidden agendas, and detailed political relationships, see the \textit{GM Guide}.

\paragraph{Remember:} The world of Fate’s Edge is alive and reactive. Your choices can shift the balance of power, forge new alliances, or break old ones. Pay attention to who holds the reins – and who might be willing to share them.