...
\textbf{Bonus --- Once per scene}, you may improve your \textbf{Position by one step} (e.g., Desperate $\rightarrow$ Controlled, Controlled $\rightarrow$ Dominant) as a free action \textbf{before} rolling an action. This represents a flash of luck, a well-timed sidestep, or an unexpected opening.
...
\emph{``Count the steps in odd numbers. Even is for the dead. \dots Wait, did I say odd? Let me check my abacus.''}  
...
\begin{itemize}
  ...
  \item \textbf{Weave Anchor (3 XP):} Passive. Reduce magical Backlash from a single 1 by one step (Minor $\rightarrow$ none, Major $\rightarrow$ Minor) once per scene.
\end{itemize}
