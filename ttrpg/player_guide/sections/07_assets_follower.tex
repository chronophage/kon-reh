...
Spend \textbf{1 Boon} to activate an Asset dramatically during a scene.
...
At higher tiers, Assets carry greater narrative weight—and greater risk.
...
Spend \textbf{2 XP} to use an Asset’s off‑screen effect beyond its normal limit:
\begin{itemize}
...
\begin{itemize}
\item \textbf{Personal Path}: 0–10\% of XP in assets/followers.
\item \textbf{Balanced Path}: 15–25\%.
\item \textbf{Influencer Path}: 35–55\%.
\end{itemize}
...
Unlike supernatural Patrons, Terrestrial Patrons do not grant magic, but they offer \textbf{leverage}: protection, resources, sanctuary, information, and political influence.
