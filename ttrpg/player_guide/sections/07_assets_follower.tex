...
Assets reshape the world around you.  
Followers stand beside you when the world pushes back.
...
\item \textbf{Assets} change the situation before or around a scene.
\item \textbf{Followers} participate directly in the moment.
\end{itemize}
...
Power creates gravity. What you rely on can be taken from you.
...
\textit{\textbf{Assets do not replace rolls.  
They change what rolls are possible.}}
...
Assets provide leverage in two primary ways: quietly and dramatically.

\paragraph{Free Off-Screen Use}
Each Asset has a defined off-screen effect usable once per session, typically during downtime or scene framing:
\begin{itemize}
...
Instead, the Asset \textbf{reshapes the fiction} so a different outcome becomes possible.
...
Assets are leverage, not immunity.
...
\index{Systems!Multi-Character Switching}

This framework allows a player to temporarily move a character offscreen while continuing play with another.  
The absent character remains active in the fiction and continues shaping the world through \textbf{Downtime Logs}, consequences, and story pressure.
