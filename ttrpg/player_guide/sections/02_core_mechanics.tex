...
\begin{itemize}
  \item \textbf{Missed Actions:} When you miss on a significant action (0 successes), you gain 1 Boon
...
\subsection*{Requirements for Miss Awards}
A miss awards a Boon only if:
\begin{enumerate}
...
\paragraph{Important Note:} Rehearsal/null-risk probes and repeated identical attempts in the same scene do not award Boons.
...
You are never punished for playing the game boldly. Even failure teaches your character something—mechanically through Boons, narratively through scars, experience, or wisdom.
...
\textbf{Boons:} Gain on significant misses \index{Boons}
\end{tcolorbox}
