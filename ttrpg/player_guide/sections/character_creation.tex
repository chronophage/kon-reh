...
2. Attributes & \ref{sec:attributes} & 2 min \\
...
For detailed descriptions see \ref{sec:attributes}.
...
\begin{itemize}
  ...
  \item \textbf{Follower (Cap² XP)} – e.g., Cap 2 scout (4 XP), Cap 3 lieutenant (9 XP)
\end{itemize}
...
\begin{itemize}
  \item Body 3 (15 XP), Wits 2 (6 XP) → 21 XP
  \item Melee 2 (6 XP), Athletics 1 (2 XP), Endurance 1 (2 XP) → 10 XP total 31
  \item Talent: Keen Senses (2 XP) → 33 XP
  \item Bond with another PC → +2 XP (now 35 – adjust by lowering one skill)
\end{itemize}
