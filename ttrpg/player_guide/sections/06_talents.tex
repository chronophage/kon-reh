...
\subsection*{Caster's Gift \textnormal{[FIRE] [WATER]}}
\textbf{Cost}: 6 XP \\
...
\begin{description}
\item[Caster's Gift \textnormal{[FIRE] [WATER] \textit{(Minor)}}] (6 XP) --- Access to Weave \& Cast freeform spellcasting using the Eight Elements.
...
\begin{description}
\item[Spell Shaping \textnormal{[CONTROL] [FORM] \textit{(Major)}}] (4 XP; Req: Caster's Gift) --- Modify spell factors (range/scale/targeting) by one step when you Weave.
