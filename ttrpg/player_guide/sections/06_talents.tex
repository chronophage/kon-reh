...
\begin{description}
\item[Caster's Gift] (6 XP) --- Access to Weave \& Cast freeform spellcasting using the Eight Elements.
...
\item[Precise Strike] (2 XP, \emph{Active}) --- Once per scene, ignore armor on one attack if you had \textbf{Dominant} or \textbf{Controlled} position.
...
\begin{itemize}
\item \textbf{Caster's Gift} (6 XP) --- Essential access to freeform casting
...
\paragraph{Counterpoise (2 XP)}
\textbf{Requirement:} Athletics 1+ or Melee 1+ \\
\textbf{Effect:} When you \textbf{Defend} and score a \emph{Partial}, you may immediately move 1 range band or reposition within Near without provoking retaliation.  
This represents instinctive recoil and evasive reflex.

\medskip

\paragraph{Riposte Instinct (4 XP)}
...
\paragraph{Guarded Step (4 XP)}
\textbf{Requirement:} Athletics 2+ or Shield Proficiency \\
\textbf{Effect:} When Defending, treat \textbf{Move} actions as free.  
You may reposition or shift cover without breaking your stance.

\medskip

\paragraph{Stand Firm (2 XP)}
...
\paragraph{High Stance Duelist (6 XP)}
...
\paragraph{Wardbreaker Reflex (4 XP)}
...
\paragraph{Shrike Parry (Prestige, 6 XP)}
...
\paragraph{Mystic Bulwark (Prestige, 6 XP)}
...
Choose one (optional):
\begin{itemize}
  \item \textbf{Evasive:} +1d to avoid, but cannot Riposte this scene.
  \item \textbf{Interposing:} You may Defend for an adjacent ally, but gain Fatigue on Miss.
  \item \textbf{Punishing:} Gain +1d to Riposte effects, but Defense rolls count 1s twice for SB.
\end{itemize}
...
\subsubsection*{Elusive Dodge (Major Talent, 8 XP)}
...
This allows you to defend even if you did not take the Defend action.
...
\subsubsection*{Miststep Reflex (Capstone Talent, 12 XP} }
...
\paragraph*{Elemental Mastery (18 XP Epic Talent)}%
\textit{Prerequisite: Tier III+, Caster's Gift, Arcana 5, 2+ Focus Elements}\\[3pt]
...
\paragraph*{Crack the Seal Mastery (18 XP Epic Talent)}%
