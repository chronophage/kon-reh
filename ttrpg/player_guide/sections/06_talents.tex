...
\subsubsection*{Berserker Rage (Major Talent -- 8 XP) \textnormal{[FURY] [POWER]}}%
...
\subsection{Cavalier}
\label{subsec:cavalier}
\index{Talents!Cavalier}
\index{Mounts!War Mount}

\paragraph{Cavalier (Major Talent, 4 XP) \textnormal{[MOBILITY] [MARTIAL]}}
\textbf{Requirements:} War Mount Asset, Melee 2+ or Ranged 2+ \\

You are trained to fight from the saddle, turning speed and mass into decisive advantage.

\textbf{Effect:}
While mounted on a \textbf{War Mount}:
\begin{itemize}
  \item Gain \textbf{+2d} to \textbf{melee attacks} made while moving from \textbf{Far → Near}.
  \item Gain \textbf{+2d} to \textbf{ranged attacks} made while moving from \textbf{Near → Far}.
\end{itemize}

These bonuses represent momentum, positioning, and trained coordination with your mount.

\textbf{Limits and Risks:}
\begin{itemize}
  \item On a \emph{Partial} or \emph{Miss}, the GM may:
    \begin{itemize}
      \item Mark \textbf{Fatigue} on the mount
      \item Damage or compromise tack, barding, or terrain access
      \item Advance an enemy or environmental Clock
    \end{itemize}
  \item Tight spaces, broken ground, or prepared defenses may negate Cavalier bonuses at the GM’s discretion.
\end{itemize}
...
\subsubsection{Hollow-Touched [Prestige, 8 XP]}

\textit{Prerequisites: Aelaerem affinity, Spirit 3+, Stealth 2+}

\textit{``You do not bleed on the threshold---you step through it, and the earth drinks your debt.''}

When you would take \textbf{Harm}, you may instead \textbf{mark that amount as Fatigue}. If you do, choose one:
\begin{itemize}
  \item The GM gains \textbf{1 Story Beat} (the Neighbors whisper of your debt in the root-ways), or
  \item Mark \textbf{1 Obligation} to the \textbf{Pale Shepherd} (he keeps a ledger of those he has guided back from the edge).
\end{itemize}

\textbf{Overflow Cost:} If this conversion fills your Fatigue track, resolve the normal overflow (clear Fatigue, increase Harm by 1) and immediately suffer the chosen cost (SB or Obligation) as the Hollow claims its tithe.

\textbf{Communal Bond:} If you use this ability while performing the \textbf{Protect} action (page 365) for an ally, you may choose to have that ally \textbf{mark 1 Fatigue} in your place (they feel the breath of the Hollow pass through them, cold and sharp). If they do, they are \textbf{bound to you by red thread} until the next dawn: they cannot willingly leave \textbf{Near} range of you without taking \textbf{1 Harm} (the thread pulls taut).

\subsubsection{Stone-Bound Interdictor [Prestige, 8 XP]}

\textit{Prerequisites: Aelinnel affinity, Body 3+, Wits 3+}

\textit{``The stone does not yield; it simply names a price and holds still.''}

When you would take \textbf{Harm}, you may instead \textbf{mark that amount as Fatigue}. If you do, choose one:
\begin{itemize}
  \item \textbf{Exact Change:} Spend \textbf{1 Boon} immediately (you pay the precise toll to the earth), or
  \item \textbf{Geas:} Speak a binding promise aloud (e.g., ``I shall not pass this threshold again until dawn''). Until you fulfill this geas, you suffer \textbf{--1 die} to all social rolls with the fae and stone-kin.
\end{itemize}

\textbf{Overflow Cost:} If this conversion fills your Fatigue track, resolve the normal overflow (clear Fatigue, increase Harm by 1) and immediately suffer the chosen cost as the ledger demands balance.
...
\subsubsection{Large Soul [Prestige, 8 XP]}

\textit{Prerequisites: Aelaerem or Aelinnel affinity, Body 4+, Spirit 3+}

\textit{``You have eaten the stone-bread or spoken the heavy word; your soul has grown large enough to fill the armor of the big folk.''}

You may wear \textbf{Heavy Armor} and wield \textbf{Heavy Weapons} without restriction. However, you lose your Small Folk racial bonuses: you no longer gain \textbf{+1 Position when Dodging} or \textbf{+1 die to Hide/Evasion rolls while in Cover}. 

\textbf{Permanent Change:} Once you take this talent, you may not unlearn it. You have grown too solid, too grounded---the threshold no longer yields to your step, and the shadows no longer part for you as they once did.