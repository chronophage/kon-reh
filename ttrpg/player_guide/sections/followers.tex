...
The courier taps twice on the shutters of the riverside inn. Inside, your \textbf{Safehouse} (\S\ref{ch:compendium-assets}) has already warmed a room, stocked dry clothes, and left an unmarked letter. Outside, your \textbf{Scout} whistles a two-note warning; the watch turns down a side street. Neither scene happens by accident. You paid for it -- in XP, in care, and sometimes in blood.
\end{tcolorbox}
...
This chapter focuses on \textbf{Followers}: the named allies who stand beside you. For Assets (safehouses, charters, networks), see \S\ref{ch:compendium-assets}.
...
\begin{itemize}
  ...
  \item They are an old contact from your background (\S\ref{ch:backgrounds}); you call in a favor.
\end{itemize}
...
\end{itemize}
Followers also have the same \emph{Maintained/Neglected/Compromised} states as Assets (\S\ref{ch:compendium-assets}), representing their availability and morale.
...
\paragraph{The Rule}
If you have a follower with \textbf{Cap 4 or 5}, they may maintain a number of your Assets (see \S\ref{ch:compendium-assets}) equal to their Cap value without requiring XP or your personal downtime scene. In effect, they \emph{become} the upkeep.

\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Delegation Example]
You have a Cap 4 Guild Factor follower. You also own four Standard Assets (Guild Seat, Trading Charter, Informant Ring, Safehouse). Normally you would need to spend XP or personal scenes each downtime to keep all four \emph{Maintained}. With delegation, your Cap 4 follower can maintain \textbf{up to 4 Assets} for you at no XP cost and without your personal attention. You are free to adventure while they handle the ledgers.

If you owned a fifth Asset, you would need to maintain it yourself (XP or a scene) -- or recruit another Cap 4+ follower.
\end{tcolorbox}
...
\begin{itemize}
  \item Advance a \emph{Faction Clock} (see \S\ref{ch:world-powers-obligation}) representing the threat.
...
A defecting follower does not steal random gear. They take \textbf{the Assets you delegated to them}. They may also recruit other dissatisfied followers or contacts, forming a \textbf{Rival Faction} (see \S\ref{sec:rival-parties} in the GM Guide for full rules).
...
A defecting Cap 4--5 follower with at least one Asset becomes a \textbf{terrestrial patron} (\S\ref{ch:world-powers-obligation}) in their own right. The GM creates a simple faction sheet:
\begin{itemize}
...
\begin{itemize}
  ...
  \item Address their personal quests (\S\ref{sec:follower-personal-quests}) promptly.
...
\textbf{Specialty (Delegation):} Can maintain up to 4 Assets without PC upkeep (see \S\ref{sec:delegation}). \\
...
\textbf{Specialty (Delegation):} Can maintain up to 5 Assets without PC upkeep (see \S\ref{sec:delegation}). \\
...
\begin{itemize}
  \item A Cap 4 or 5 follower can maintain a number of your Assets equal to their Cap without XP or personal downtime scenes.
