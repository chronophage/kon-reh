...
Not all power comes from gods or ancient Patrons. The guildmaster who controls the docks, the spymaster who knows your secret, the moneylender who holds your debt—these are patrons of a different kind. They grant no miracles, but they offer \textbf{leverage}: sanctuary, soldiers, silver, and silence.

This chapter covers \textbf{Terrestrial Patrons}—mortal factions and powerful individuals who can aid you, but at the cost of \textbf{Obligation}. The mechanics mirror those of supernatural Patrons (\S\ref{ch:magic}), but the consequences are social, legal, and economic rather than mystical.
...
\textbf{Obligation Cost} & Same track (Spirit+Presence) & Same track \\
\textbf{Overflow} & Fatigue (social/legal pressure) & Fatigue (spiritual strain) \\
\textbf{Consequences} & Bounty, blacklist, legal trouble, rivals & Corruption, Patron intrusion, curses \\
\textbf{Resolution} & Service, bribes, political favors & Rituals, sacrifices, Patron tasks \\
\bottomrule
\end{tabular}
\end{center}

\emph{Both can be powerful. Both demand payment. One leaves a mark on your soul; the other leaves a mark on your reputation.}

\section{The Obligation System (Refresher)}

Your \textbf{Obligation Capacity} equals \textbf{Spirit + Presence}. Each time you call on a Patron’s aid (or accept their “gift”), you mark +1 or more Obligation segments toward that Patron.

\begin{itemize}
  \item \textbf{Exceeding Capacity:} Each segment above capacity inflicts 1 Fatigue (stress, social pressure, legal attention).
  \item \textbf{Resolution:} Reduce Obligation by performing service, paying bribes, completing tasks, or using downtime actions.
  \item \textbf{Full Clock:} At 6 segments (or when the GM decides), the Patron makes a \textbf{demand} you cannot easily refuse.
\end{itemize}

See \S\ref{ch:magic} for full Obligation mechanics. The same rules apply to terrestrial Patrons, but the \textbf{Backlash} is always mundane: a rival faction is tipped off, a debt is called, or a favor is extracted.

\section{Major Terrestrial Patrons}

Below are examples of the kinds of mortal powers that characters might swear (or drift into) service with. Each entry includes:
\begin{itemize}
  \item \textbf{Typical Perks} (what you can get by spending a Boon or calling in a favor)
...
\textit{Every city has one. They own the shadows, the fences, and the city watch’s blind spots.}
...
\begin{itemize}
  ...
  \item A “clean” fence for stolen goods (no questions, but lower return).
\end{itemize}
...
\begin{itemize}
  \item Using any perk: +1 Obligation.
  \item Requesting a major heist or sanctuary during a manhunt: +2 Obligation.
  \item Refusing a demand outright: +1 Obligation (and possible retaliation).
\end{itemize}

\textbf{Favor (reduce Obligation by 2, gain permanent asset):}
\begin{itemize}
...
\begin{itemize}
  \item Using any perk: +1 Obligation.
  \item Requesting a major deployment (20+ soldiers): +2 Obligation.
  \item Deserting in battle or refusing a direct order: +2 Obligation and possible bounty.
\end{itemize}
...
\begin{itemize}
  \item Using any perk: +1 Obligation.
  * Large loan (200+ gold) or co-signing a risky venture: +2 Obligation.
  \item Defaulting on repayment: Obligation fills, and the Bank seizes assets (lose a Minor Asset).
\end{itemize}
...
\begin{itemize}
  \item Using any perk: +1 Obligation.
  \item Requesting a major operation (rescuing a captured agent): +2 Obligation.
  \item Betraying the network: Permanent enemy faction; Obligation becomes a Bounty clock.
\end{itemize}
...
\begin{itemize}
  \item Using any perk: +1 Obligation.
  \item Learning a major secret (e.g., a high priest’s corruption): +2 Obligation.
  \item Refusing a direct order from a cult leader: +2 Obligation and possible blackmail.
\end{itemize}
...
\begin{itemize}
  \item Using any perk: +1 Obligation.
  \item Requesting a small cohort (10–20 veterans): +2 Obligation.
  \item Betraying the remnant: Permanent enemy faction; Obligation becomes a Vendetta clock.
\end{itemize}
...
Characters may serve (or owe) more than one terrestrial patron. Keep separate Obligation tracks for each. When two patrons make conflicting demands, the GM may force a choice – refusing one adds +2 Obligation to that track and may trigger immediate consequences (e.g., the other patron gains a Boon to use against you).

\emph{Example:} You owe the Thieves’ Guild (3 Obligation) and a Royalist network (2 Obligation). The Guild demands you rob a royal courier; the Royalists ask you to protect that same courier. You cannot satisfy both. Choose one: the other track fills by 2, and the spurned patron becomes a Rival.
...
The GM should make these consequences visible and actionable – a chance to pay off debts, shift allegiances, or break free entirely.
...
\textbf{Obligation Effects:} Over capacity = Fatigue; at 6 segments = demand \\
...
\subsection*{Ecktoria}
\begin{itemize}
  \item \textbf{The Everflame Audit:} A secret committee of Lampers who keep a black ledger of corrupt nobles.
