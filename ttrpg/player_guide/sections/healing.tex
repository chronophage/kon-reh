...
\epigraph{"The HEAL tag closes small wounds and eases exhaustion. To knit broken bones or purge a curse, you need greater power---and greater risk."}{---The Gray Wanderer}
...
\midrule
\textbf{Fatigue} & Exhaustion, minor cuts, bruises, winded & HEAL cantrip, short rest, a hot meal \\
...
\begin{tcolorbox}[colback=green!5, colframe=green!75!black, title=HEAL Cantrip]
\begin{tabular}{ll}
...
\paragraph{Example:} Lyra uses HEAL on Kael after a fight. She rolls 5d10 (Spirit + Medicine), gets 3 successes vs DV 2 -- a Clean Success. Kael clears 1 Fatigue. No complication.
...
\midrule
Clear 1 Fatigue (fast) & HEAL cantrip (DV 2, 1 action) or short rest (1 hour). \\
...
\begin{itemize}
  \item \textbf{Don"t hoard your healer's resources.} Fatigue is cheap to heal; use HEAL often. Save big magic for when someone is at Harm 2 or unconscious.
  ...
  \item \textbf{Protect your healer.} If the only person with HEAL goes down, your party's recovery slows to a crawl.
