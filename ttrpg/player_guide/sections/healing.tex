...
\begin{itemize}
  ...
  \item \textbf{Summoner:} Can bargain with a spirit to transfer wounds (e.g., a spirit of sacrifice takes your Harm). Tick the \textbf{Leash} clock each time (see \ref{ch:magic}).
\end{itemize}
