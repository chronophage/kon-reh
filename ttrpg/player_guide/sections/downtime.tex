...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=When Does Downtime Happen?,breakable]
...
\label{sec:downtime-rush}

If you want to complete training faster, you may attempt a \textbf{Rush}. This carries risk.

\textbf{Rush Rule Procedure:}

\begin{enumerate}
  \item \textbf{Declare:} You state you are rushing your training.
  \item \textbf{Set Timer:} The GM creates a \textbf{Haste Timer [4]}.
  \item \textbf{Push Forward:} Each downtime action during the rush, you roll \textbf{Spirit + Endurance} (DV 3) to represent pushing through fatigue and distraction.
    \begin{itemize}
  ...
  \item \textbf{Complete:} If the timer reaches 4 before training completes, the ability or asset is flawed.
    \begin{itemize}
      \item \textbf{Attribute/Skill:} The new rating is gained, but you suffer a temporary -1 die penalty until you spend a full downtime session retraining (removing the flaw).
...
\end{itemize}
If you pay neither, the asset/follower degrades:
\begin{itemize}
