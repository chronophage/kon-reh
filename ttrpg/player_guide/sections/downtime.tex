...
\begin{itemize}
  ...
  \item \textbf{Permanent magic items:} Requires a Downtime Project Clock (6--12 segments), rare components (obtained through quests), and the XP cost of the item (see \ref{ch:gear}). You roll each downtime to advance the clock.
\end{itemize}
