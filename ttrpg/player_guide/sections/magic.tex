...
\textbf{Note:} Obligation cost cannot be reduced below 1.
...
\textit{Note:} \texttt{Leap} (short‑range teleport) is not considered a dangerous TAG; it adds +1 DV like any ordinary tag.
...
\begin{itemize}
  ...
  \item Corruption Clock (size = Spirit)
\end{itemize}
