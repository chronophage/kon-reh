...
Example: A Low Rite (Tier 1) with Obligation cost 4, Spirit 2 $\rightarrow$ DV = max(4−2, 1) = 2.
...
\subsection{Backlash for Free Casters}
\index{Backlash!Free Caster}
Choose one:
\begin{itemize}
    \item Harm 2 (Arcane)
    \item +2 Fatigue
...
\subsection{TAG Library (Abridged)}
\label{subsec:tag_library}
\index{Tags!List}
