...
\textbf{Effect:}
\begin{itemize}
  \item Gain +min(Spirit, 3) dice to all melee attacks and melee defense
...
\noindent
\textbf{Design Intent:}\\
\textit{Embody the classic berserker archetype where raw destructive power comes at the cost of protection. Players must choose between defensive security and unleashed fury.}
