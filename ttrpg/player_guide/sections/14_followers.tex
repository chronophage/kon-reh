...
\end{itemize}
Once terms are agreed, you pay XP and downtime as above. The new follower enters play with \emph{Steady} loyalty and no Exposure or Harm.
...
\begin{description}
  \item[Scout \& Signal] Shift an ally's next action to \emph{Dominant}.
  \item[Distract \& Draw] Reduce a Threat/Hunt/Escape clock by 1 tick.
  \item[Fetch \& Carry] Move an object/person through hazard.
  \item[Cover \& Protect] Eat a consequence meant for a PC (the follower takes Harm 1 or Exposure 2).
\end{description}
\textbf{Cost:} Mark +1 \emph{Exposure} or \emph{Harm 1} on that Follower (or as specified).
...
\end{description}
Loyalty shifts based on treatment, shared victories, and personal quests. A follower who is consistently paid, respected, and protected will rise; one who is ignored, underpaid, or sacrificed will fall.
...
Every follower has a hidden (or open) goal. Discover it through play. When you help them achieve it, they gain a permanent loyalty boost, may unlock a new specialization, and you earn a \textbf{Legacy Point} (see \S\ref{ch:legacy-engine} for use). Examples:
\begin{itemize}
