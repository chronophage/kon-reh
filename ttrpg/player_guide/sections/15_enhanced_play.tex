...
Combat and high-stakes scenes in Fate’s Edge reward clever thinking as much as raw dice. This section offers practical, player‑facing advice for common situations. Use these tactics to turn the fiction in your favor.
...
\begin{itemize}
  \item \textbf{Use Cover and Movement.} The game’s Position system (Dominant/Controlled/Desperate) rewards tactical positioning. Move from cover to cover. Spend a \textbf{Move action} to dash between obstacles. If you end your movement behind solid cover, the GM may set your next defense roll as \textbf{Controlled} instead of Desperate.
  \item \textbf{Create Distractions.} Spend \textbf{1 Boon} to describe a diversion — kick over a brazier, shove a table, yell a false order. On a successful \textbf{Deception} or \textbf{Command} roll, the ranged attacker may lose their瞄准 or shift their attention for one exchange, dropping your Position penalty by one step.
  \item \textbf{Teamwork: The Running Shield.} Have a heavily armored ally take the \textbf{Defend} action while moving forward. They can intercept incoming shots (converting Harm to Fatigue) while you sprint behind them. The GM may rule that the defender’s body blocks line of sight, granting you \textbf{Dominant} position for your next approach.
  \item \textbf{Suppress Them.} If you have a ranged weapon, use the \textbf{Suppress} option (see Core Mechanics). You don’t need to hit — just force the enemy to keep their head down. The GM may impose a –1 die penalty on their next attack or worsen their Position.
  \item \textbf{Spend Boons to Close.} When you’re stuck in the open, spend \textbf{1 Boon} to improve your Position by one step before rolling your movement or defense. That can mean the difference between a bolt in the chest and a glancing hit.
\end{itemize}

\paragraph{Example.} Lyra (rogue) wants to cross a courtyard to reach a mage on a balcony. She spends 1 Boon to improve her Position from Desperate to Controlled, then declares she’s staying close to a crumbling wall. The GM rules that the mage’s magic missile is at –1 die because of partial cover. Lyra makes it across with a Partial success, taking Fatigue instead of Harm.
...
\begin{itemize}
  ...
  \item \textbf{Accept Story Beats (SB) to Buy Time.} When you roll a Partial or Miss, the GM gets SB. You can proactively offer to accept \textbf{+1 SB} (banked, not spent now) in exchange for a short narrative delay: “I fall back behind a pillar – they lose sight of me for a moment.” This doesn’t change the roll’s outcome, but it gives you a breath to reposition.
  \item \textbf{Spend Boons on Defense, Not Offense.} When you’re outnumbered, a missed attack hurts less than a received hit. Save Boons to re‑roll failed defense rolls or to improve your Position before an enemy’s big swing. A \textbf{Boon spent to re‑roll a 1 on a defense roll} can prevent Harm 2 or 3.
  \item \textbf{Escape and Reset.} There’s no shame in running. Use the \textbf{Withdraw} action (see Core Mechanics). Spend 1 Boon to make it a \textbf{Controlled} withdrawal instead of Desperate. You live to fight another scene.
  \item \textbf{Use the Environment as a Weapon.} Ask the GM: “Is there a chandelier I can drop? A sand pile? A steep stair?” If the answer is yes, describe how you trigger it. The GM may set a low DV (2–3) and on success, the obstacle deals Harm, imposes a Condition, or improves the party’s Position for a round.
\end{itemize}

\paragraph{Example.} Kael (fighter) is alone against three bandits. Instead of attacking, he spends 1 Boon to assist the group’s archer, then uses his action to kick over a brazier. The GM calls for a Body + Athletics roll (DV 2). Kael succeeds — the fire creates a smoky screen, worsening the bandits’ Position to Desperate for one exchange. The archer picks one off.

\subsection{When to Push It — and When Not To}

The \textbf{Push It} mechanic (usually on Rites or Cantor Songs) lets you escalate an effect immediately at a cost: extra Obligation, Fatigue, Corruption, or a GM Story Beat. Use it wisely.

\subsubsection*{Good Times to Push}
\begin{itemize}
  \item \textbf{Preventing a Party Wipe.} If a teammate is about to take lethal Harm, Push to get that heal or ward off now.
...
\begin{itemize}
  ...
  \item \textbf{A Partial Success Is Enough.} Many Rites and Songs still work on a Partial — just weaker or shorter. Sometimes that’s all you need. Don’t pay extra for power you don’t require.
  \item \textbf{The GM Is Low on SB.} If the GM has 0–1 SB banked, they can’t immediately punish a miss. But if they have 3+, a failed Push could trigger a major twist. Check the table’s SB tracker before deciding.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Lower the DV with Fiction.} Describe how you create ideal conditions. “I wait for the guards to change shift” might lower DV by 1. “I use my Scholar’s Cell free use to research the ward’s pattern” could drop DV from 4 to 3.
  \item \textbf{Accept Failure and Bank Boons.} A Miss gives you 2 Boons. Sometimes it’s better to fail now, take the 2 Boons, and try again next round with a bigger pool or better Position.
\end{itemize}

\paragraph{Example.} Sariel (Cantor) needs to charm a guard quickly. She could Push to resolve the Song instantly, but she’s already at Fatigue 2. Instead, she spends 1 Boon to improve her Position from Controlled to Dominant, then has an ally whisper a distraction (assist, another Boon). She rolls 4 dice (Lore + Performance) against DV 3. She gets 3 successes – a Clean Success. No Push needed, and she saved her Fatigue.

\subsection{General Player Tips for Enhanced Experience}

\begin{itemize}
  \item \textbf{Track Your Boons, Fatigue, and Obligation.} These are your resources. Know them as well as your hit points in other games. A character with 4 Boons and 0 Fatigue is much stronger than one with 0 Boons and Fatigue 2.
  \item \textbf{Use Bonds to Shift Boons.} At Tier III, you can transfer up to 2 Boons to a bonded ally as a free action. This lets you fuel the party’s best character for a crucial roll. Don’t hoard.
  ...
  \item \textbf{Know When to Fold.} Not every fight is winnable. Spending 2 Boons to escape with everyone alive is a victory. The game rewards survival and smart choices, not just corpse counts.
  \item \textbf{Use Downtime.} Between sessions, update your logs, tend your Assets, and clear Complications. A well‑maintained Asset (Neglected → Maintained) can save your life next session. A cleared Complication removes a GM “free SB” button.
