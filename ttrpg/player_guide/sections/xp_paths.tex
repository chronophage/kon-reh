...
Ask yourself:
\begin{itemize}
  \item Do I want my character to be self-sufficient and always ready? → \textbf{Solo}
  \item Do I enjoy having a helpful sidekick or a home base, but not too much bookkeeping? → \textbf{Mixed}
  \item Do I love managing networks, commanding troops, and solving problems through influence? → \textbf{Mastermind}
\end{itemize}
