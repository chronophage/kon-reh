...
\item \textbf{Bonds and Complications}: You may take up to \textbf{two total} from any mix of meaningful \emph{Bonds} (up to 2, +2 XP each) and significant \emph{Complications} (up to 2, +2 XP each), granting maximum \textbf{+4 XP}. (See Bonds, \ref{sec:bonds}.)
...
\begin{itemize}
  \item \textbf{Follower:} A Cap 4–5 follower (16–25 XP) can become a successor (see \ref{ch:legacy}) – invest in someone who could carry on your cause.
...
a Legacy Bond (see \textbf{Chapter 13: The Legacy Engine}). A loyal apprentice,
a trusted lieutenant, or a family member can carry your story forward.
