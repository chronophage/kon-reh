...
\item \textbf{Build Blocks}: A \emph{32 XP} starting build, plus an optional \emph{36 XP} variant using Bonds/Complications (+4 XP) (see \ref{ch:advancement} for XP rules)
\end{itemize}
...
\item \textbf{Track Spirit Bonds.} If you summon the same spirit repeatedly, you can build a Spirit Bond Clock, reducing Leash ticks over time.
\end{itemize}
