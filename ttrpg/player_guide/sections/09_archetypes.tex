...
\item \textbf{Talents}: Defensive Stance, Combat Reflexes, Conditioning (see \ref{ch:talents})
\end{itemize}
...
\item \textbf{Talents}: Spellcraft (freeform, see \ref{ch:magic}), Codex (runekeeper), Patron’s Symbol (invoker)
\end{itemize}
...
\item \textbf{Talents}: Technical Expert, Quick Study, (optionally) Magical Laboratory asset (see \ref{ch:assets-followers})
\end{itemize}
