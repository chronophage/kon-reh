...
The \textbf{Casting Loop}\index{magic!casting loop} requires the \textbf{Caster's Gift}\index{Caster's Gift} talent (6 XP) and creates spotlight tension: describe effect now, risk \textbf{Backlash} on each roll.
...
\begin{itemize}
  \item \textbf{TAGS per casting:} Up to 6 total; more is legendary/suicidal.
...
\subsection{Ritual Optimization and Collaborative Casting}
...
\begin{itemize}
\item Requires Talent: \textbf{Caster's Gift} (6 XP)
