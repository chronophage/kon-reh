...
\item \textbf{Risky}\index{magic!risk}: Every use generates \textbf{Setback Points (SP)}\index{Setback Points} that manifest as backlash
...
\item Each 1 rolled generates a \textbf{Setback Point}\index{Setback Points} immediately
...
\item Additional \textbf{Setback Points}\index{Setback Points} may be generated
\end{itemize}

\subsection*{Phase 3: Backlash} \index{magic!backlash}
Setback Points manifest as magical consequences:
\begin{itemize}
\item The Game Master spends \textbf{SP}\index{Setback Points} thematically
...
\item \textbf{Backlash}\index{magic!backlash}: SP spent thematically
\end{itemize}
...
\item \textbf{Backlash}\index{magic!backlash}: 2 SP spent—nearby foliage smolders, creating smoke
\end{itemize}
