...
\textbf{Tick Leash} & Whenever the spirit takes Harm; you command it against its nature; you split focus; a rival contests it; it moves \textit{Close} $\rightarrow$ \textit{Far} rapidly; or it crosses a \texttt{[WARD]} \big($\mathrm{DV}=\mathrm{Cap}$\big). \\
...
The following orders qualify as \emph{Quick Command} and do not consume a full Action:
\begin{itemize}
