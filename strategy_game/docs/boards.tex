...
\begin{figure}[H]
  ...
  {\footnotesize\itshape
   One special per Blue turn. Slide$\rightarrow$special is legal \emph{unless} the slide entered enemy ZoC (entering ZoC ends the move). No special$\rightarrow$slide.}
...
% Panels: (a) Slide$\rightarrow$Seed$\rightarrow$Rooted. (b) Reforge$\rightarrow$Sanctum, later Seed from other Sanctum.
% Sanctums at (8,8) and (1,1) to match earlier anatomy figure.
% =========================================
\begin{figure}[H]
  \centering

  % ---------- (a) Slide $\rightarrow$ Seed $\rightarrow$ Rooted ----------
  \begin{subfigure}[t]{0.48\linewidth}
    \centering
  ...
  \end{subfigure}
  \hfill
  % ---------- (b) Reforge $\rightarrow$ Sanctum; later Seed from the other Sanctum ----------
  \begin{subfigure}[t]{0.48\linewidth}
    \centering
  ...
  \caption{Twin Apex Seed and Mobilization delay: (a) Slide$\rightarrow$Seed$\rightarrow$Rooted; (b) Reforge$\rightarrow$Sanctum, then a later Seed from the opposite Sanctum (same-Sanctum Seed banned).}
...
\begin{figure}[H]
  ...
  \caption{Cross timers illustrated over seven plies (A/B/A/\dots): two counted stays inside the Cross, then exit; the next two A turns are exclusion (no re-entry).}
