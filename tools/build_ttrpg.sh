...
cd $git_root/ttrpg/reference/expansions/
	...
	../../../tools/compile_latex.sh -f  caravans-way-of-silk.tex -n "Fate's Edge Realms - Caravans, The Way of Silk.pdf" > /dev/null 2>&1|| echo "#11. Did not build"
	...
	../../../tools/compile_latex.sh -f dhahara.tex -n "Fate's Edge Realms - Dhahara, Kingdom of Brass.pdf" > /dev/null 2>&1|| echo "#34. Did not build"
	../../../tools/compile_latex.sh -f eastern_realms.tex -n "Fate's Edge Realms - The Eastern Realms.pdf" > /dev/null 2>&1|| echo "#36. Did not build"
...
../../../tools/compile_latex.sh -f akilan.tex -n "Fate's Edge Realms - Akilan, The Southern Realms.pdf" > /dev/null 2>&1|| echo "#42. Did not build"
