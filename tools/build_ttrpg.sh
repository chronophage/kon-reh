...
../../../tools/compile_latex.sh -f caravans-way-of-silk.tex -n "Fate's Edge Expansion - Caravans, The Way of Silk.pdf" > /dev/null 2>&1|| echo "#35. Did not build"
../../../tools/compile_latex.sh -f eastern_realms.tex -n "Fate's Edge Expansion - Eastern Realms.pdf" > /dev/null 2>&1|| echo "#36. Did not build"
...
../../../tools/compile_latex.sh -f knights_tale.tex -n "Fate's Edge Expansion - Viterra, The Knight's Tale.pdf" > /dev/null 2>&1|| echo "#49. Did not build"
