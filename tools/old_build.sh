...
../../../tools/compile_latex.sh -x -f  between-knot-and-gate.tex -n "Fate's Edge - Between Knot & Gate.pdf" > /dev/null 2>&1|| echo "#2. Did not build"
	...
	../../../tools/compile_latex.sh -x -f clockwork-cathedral.tex -n "Fate's Edge - The Timer work Cathedral.pdf" > /dev/null 2>&1|| echo "#32. Did not build"
...
cd $git_root/ttrpg/reference/expansions/
	...
	../../../tools/compile_latex.sh -x -f wandering_cycle.tex -n "Fate's Edge Expansion - The Wandering Ledger.pdf" > /dev/null 2>&1|| echo "#28. Did not build"
	../../../tools/compile_latex.sh -x -f salt_cycle.tex -n "Fate's Edge Expansion - The Salt Ledger.pdf" > /dev/null 2>&1|| echo "#28. Did not build"
	../../../tools/compile_latex.sh -x -f whisper_cycle.tex -n "Fate's Edge Expansion - The Whisper Ledger.pdf" > /dev/null 2>&1|| echo "#29. Did not build"
	../../../tools/compile_latex.sh -x -f hearth_cycle.tex -n "Fate's Edge Expansion - The Hearth Ledger.pdf" > /dev/null 2>&1|| echo "#30. Did not build"
    ...
    ../../../tools/compile_latex.sh -x -f frost_cycle.tex -n "Fate's Edge Expansion - The Frost Ledger.pdf" > /dev/null 2>&1|| echo "#41. Did not build"
